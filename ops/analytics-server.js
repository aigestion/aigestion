...
class AnalyticsMCPServer {
      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              widgets: { type: 'array', items: { type: 'object' }, description: 'Dashboard widgets' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              report_type: { type: 'string', enum: ['executive', 'technical', 'marketing', 'sales', 'financial'], description: 'Report type' },
              data_source: { type: 'string', description: 'Data source' },
              time_range: { type: 'string', description: 'Time range' },
              format: { type: 'string', enum: ['pdf', 'excel', 'csv', 'json'], description: 'Report format' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              chart_type: { type: 'string', enum: ['bar', 'line', 'pie', 'scatter', 'heatmap', 'treemap', 'gauge'], description: 'Chart type' },
              data_source: { type: 'string', description: 'Data source' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              data_source: { type: 'string', description: 'Data source' },
              time_range: { type: 'string', description: 'Time range' },
              conversion_events: { type: 'array', items: { type: 'string' }, description: 'Conversion events' }
            },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              data_source: { type: 'string', description: 'Data source' },
              time_range: { type: 'string', description: 'Time range' },
              behavior_metrics: { type: 'array', items: { type: 'string' }, description: 'Behavior metrics' }
            },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            required: ['test_name', 'control_group', 'variant_group', 'traffic_allocation', 'success_metric']
          }
        },
        {
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              operation: { type: 'string', enum: ['create', 'update', 'query', 'delete'], description: 'Warehouse operation' },
  ...
  async abTesting(args) {
    const { test_name, control_group, variant_group, traffic_allocation, success_metric, test_duration } = args;
