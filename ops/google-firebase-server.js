        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              operation: {
                type: 'string',
                enum: ['set', 'get', 'update', 'delete', 'push'],
                description: 'Operation type',
              },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              operation: {
                type: 'string',
                enum: ['signup', 'login', 'logout', 'update', 'delete'],
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              operation: {
                type: 'string',
                enum: ['send', 'subscribe', 'unsubscribe', 'get_tokens'],
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              operation: {
                type: 'string',
                enum: ['log_event', 'set_user_property', 'get_report'],
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              operation: {
                type: 'string',
                enum: ['report_crash', 'get_crash_report', 'get_crash_reports'],
                description: 'Crashlytics operation',
              },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              operation: {
                type: 'string',
                enum: ['get_config', 'set_config', 'publish_config'],
                description: 'Remote config operation',
              },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              operation: {
                type: 'string',
                enum: ['deploy', 'list', 'invoke', 'delete'],
                description: 'Functions operation',
              },
