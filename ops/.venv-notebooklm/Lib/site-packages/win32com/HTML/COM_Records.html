  ...
  <head>
    ...
    <style>
      ...
      .gist .code-navigation-banner {
        background: linear-gradient(180deg, rgba(242, 248, 254, 0), rgba(242, 248, 254, 0.47));
      }
      ...
      .gist .reorderable-task-lists .markdown-body ol:not(.contains-task-list) li,
      .gist .reorderable-task-lists .markdown-body ul:not(.contains-task-list) li {
        margin-left: 0;
      }
                ...
                >
                  <article class="markdown-body entry-content container-lg" itemprop="text">
                    <div class="markdown-heading">
                      <h1 class="heading-element">COM Record support in pywin32</h1>
                      <a
                    ...
                    <p>
                      The pywin32 package provides COM Record support for late-bound and early-bound
                      objects. In both cases it is required that the Type Library which defines the
                      COM Record has been registered in Windows.
                    </p>
                    <div class="markdown-heading">
                    ...
                    <p>
                      For late-bound objects, were makepy-support is not available, it is possible
                      to create a particular COM Record if the following is known:
                    </p>
                    <ul>
                      <li>GUID of the Type Library were the Record is defined</li>
...
record1 = pythoncom.GetRecordFromGuids(PyCOMTestLib_GUID, MAJVER, MINVER, LCID, TestStruct1_GUID)
                    ...
                    <p>The Python type of the returned COM Record instance is:</p>
                    <pre><code>&gt;&gt;&gt; type(record1)
    &lt;class 'com_record'&gt;
</code></pre>
                    <p>
                      which is a generic type that is returned for all COM Records, i.e. COM Records
                      with different GUIDs nevertheless all have the same Python type
                      <code>pythoncom.com_record</code>.
                    </p>
                    <p>
                      Instances of <code>&lt;class 'com_record'&gt;</code> can be used as method
                      parameters and are returned by COM methods that return a COM Record. However,
                      it is not possible to differentiate the COM Record Types, i.e. COM Records of
                      different GUID at runtime.
                    </p>
                    <div class="markdown-heading">
                    ...
                    <p>
                      The availability of makepy-support does in its basic form offer the
                      convenience function <code>win32com.client.Record</code> to create COM Record
                      instances using the COM Record name from the Type Library and an interface
                      object of the same Type Library:
                    </p>
...
record1 = win32com.client.Record('TestStruct1' ,com_test)
                    ...
                    <p>Still the Python type of the returned COM Record instance is:</p>
                    <pre><code>&gt;&gt;&gt; type(record1)
    &lt;class 'com_record'&gt;
</code></pre>
                    ...
                    <p>
                      ...
                      <code>pythoncom.com_record</code> type and register such a subclass for a
                      particular COM Record type. As a prerequisite, it is mandatory for the
                      subclass to define the following class attributes:
                    </p>
                    <ul>
                      <li>TLBID : The GUID of the containing TypeLibrary as a string</li>
                      <li>MJVER : The major version number of the TypeLibrary as an integer</li>
                      <li>MNVER : The minor version number of the TypeLibrary as an integer</li>
...
class TestStruct1(pythoncom.com_record):
  ...
  GUID = '{7a4ce6a7-7959-4e85-a3c0-b41442ff0f67}'
                    ...
                    <p>
                      Before this subclass can be used to create <em>TestStruct1</em> instances, it
                      has to be registered with <code>win32com.client.register_record_class</code>,
                      e.g.:
                    </p>
...
register_record_class(TestStruct1)
                    ...
                    <p>
                      With such a class, registered for a particular COM Record type, it is possible
                      to identify the COM Record type at runtime:
                    </p>
...
&gt;&gt;&gt; type(record1)
    &lt;class 'main.TestStruct1'&gt;
                    ...
                    <p>
                      Also COM methods that return a COM Record type for which a Python class was
                      registered as described above, will return values of the proper Python class
                      type, e.g.:
                    </p>
...
&gt;&gt;&gt; type(retval)
    &lt;class 'main.TestStruct1'&gt;
                    ...
                    <p>
                      COM methods that return a COM Record type for which no Python class was
                      registered will continue to return values of the generic type
                      <code>pythoncom.com_record</code>, e.g.:
                    </p>
                    <pre><code>&gt;&gt;&gt; # Given the following definition in the Type Library IDL-file:
