<html>
  <body>
    ...
    <p>
      The caption on the first button is set by the Window Load code. Clicking that button changes
      the text in the first edit box.
    </p>

    <p>The second button changes its own text when clicked.</p>

    <p>
      The fourth button calls a global function, defined in the global 'script' scope, rather than
      the 'MyForm' scope.
    </p>
