# 🚀 WINDOWS NIVEL DIOS - SCRIPT DEFINITIVO
...
# Crear script de monitoreo sin here-string problemático
...
$monitorScriptContent | Set-Content -Path "C:\Scripts\system-monitor.ps1" -Force
...
# Crear script de verificación sin here-string problemático
$verifyScriptContent = @"
...
$verifyScriptContent | Set-Content -Path "C:\Scripts\verify-system-status.ps1" -Force
