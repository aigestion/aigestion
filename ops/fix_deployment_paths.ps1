function Fix-Paths($folder, $prefix) {
    if (Test-Path "$folder/index.html") {
        ...
        # Replace absolute paths with relative ones or prefix them
...
Fix-Paths "deploy_dist/admin" "/admin"
Fix-Paths "deploy_dist/client" "/client"
Fix-Paths "deploy_dist/demo" "/demo"
