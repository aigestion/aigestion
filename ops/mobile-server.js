      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              platform: {
                type: 'string',
                enum: ['ios', 'android', 'react-native', 'flutter', 'ionic'],
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              store_type: {
                type: 'string',
                enum: ['appstore', 'playstore', 'testflight', 'internal'],
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              analysis_type: {
                type: 'string',
                enum: ['symbolicated', 'stack_trace', 'root_cause'],
      ...
      content: [
        {
          ...
          text: `Mobile Project Creation:\n\nPlatform: ${platform}\nApp Name: ${app_name}\nPackage Name: ${package_name}\nTemplate: ${template || 'default'}\nOrganization: ${organization || 'com.aigestion'}\n\nProject structure:\n${Object.entries(
            projectStructure[platform] || {}
          )
            .map(
              ([key, value]) =>
                `${key}: ${value.directories ? value.directories.join(', ') : 'N/A'}\nFiles: ${value.files ? value.files.join(', ') : 'N/A'}`
            )
            .join(
              '\n'
