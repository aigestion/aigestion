...
class GoogleCloudFunctionsMCPServer {
      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              runtime: {
                type: 'string',
                enum: ['nodejs20', 'python311', 'go119', 'java17', 'ruby33'],
                description: 'Runtime environment',
              },
              trigger_type: {
                type: 'string',
                enum: ['http', 'pubsub', 'storage', 'scheduler', 'eventarc'],
  ...
  async createFunction(args) {
    const { function_name, runtime, trigger_type, source_code, entry_point, memory, timeout } =
      args;
