...
import { Smartphone, Apple, PlayCircle, QrCode } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-24 items-center relative z-10">
                ...
                >
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <span className="text-[10px] font-orbitron text-nexus-cyan-glow tracking-[0.5em] uppercase font-black">Nexus_Mobile_v1.0</span>
                    </div>

                    <h2 className="text-5xl md:text-7xl font-orbitron font-black text-white mb-8 leading-tight uppercase">
                        TU COMANDO <br />
                        <span className="text-nexus-violet-glow italic underline decoration-nexus-cyan-glow/30 underline-offset-8">EN EL BOLSILLO</span>
                    </h2>

                    <p className="text-nexus-silver/40 text-lg mb-12 font-light leading-relaxed max-w-xl">
                        Lleva la potencia de Daniela AI y la transparencia de AIGestion a cualquier parte. Sincronización instantánea con el núcleo mediante biometría avanzada.
                    </p>

                    <div className="flex flex-wrap gap-6">
                        <button className="flex items-center gap-4 px-8 py-4 bg-white text-black rounded-2xl hover:scale-105 active:scale-95 transition-all group">
                            <Apple size={24} />
                        ...
                        <button className="flex items-center gap-4 px-8 py-4 bg-nexus-obsidian-deep border border-white/10 text-white rounded-2xl hover:bg-white/5 hover:scale-105 active:scale-95 transition-all group">
                            <PlayCircle size={24} className="text-nexus-cyan-glow" />
                            <div className="text-left">
                                <p className="text-[8px] uppercase font-bold opacity-40">Disponible en</p>
                                <p className="text-sm font-black font-orbitron tracking-tight">Google Play</p>
                            </div>
                        </button>
                    </div>
                    ...
                    <div className="mt-12 flex items-center gap-6 p-6 rounded-3xl bg-white/[0.02] border border-white/5 w-fit">
                        ...
                        <div>
                            <p className="text-[9px] font-orbitron font-black text-nexus-cyan-glow uppercase tracking-widest mb-1">ACCESO RÁPIDO</p>
                            <p className="text-[7px] font-mono text-nexus-silver/20 uppercase">Escanea para descargar la APK de comando</p>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative mx-auto w-72 h-[600px] bg-nexus-obsidian-deep border-[8px] border-white/5 rounded-[3rem] shadow-[0_0_100px_rgba(138,43,226,0.1)] overflow-hidden">
                        ...
                        <div className="p-6 pt-12 space-y-6">
                            ...
                            <h4 className="text-xs font-orbitron font-black text-white uppercase tracking-widest">NEXUS_IOS_STATUS</h4>
