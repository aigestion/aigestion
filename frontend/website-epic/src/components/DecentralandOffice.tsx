...
import { Box, ExternalLink, MapPin, Users } from 'lucide-react';
...
export const DecentralandOffice: React.FC = () => {
  ...
  useEffect(() => {
    // Simulate real-time updates from metaverse
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors group">
                ...
                <span className="text-xs text-gray-500 uppercase tracking-wider">Performance</span>
              </div>
              <div className="p-4 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors group">
