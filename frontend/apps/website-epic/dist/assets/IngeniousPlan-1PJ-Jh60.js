...
const t = [
    {
      title: 'Fase 1 \xb7 Diagn\xf3stico Inteligente',
      description:
        'Mapeamos procesos, riesgos y oportunidades. Creamos un blueprint con prioridades y quick wins.',
      outcomes: ['Mapa de procesos cr\xedticos', 'Matriz de impacto', 'Propuesta de pilotos'],
    },
    {
      title: 'Fase 2 \xb7 Piloto de Alto Impacto',
      description:
        'Implementamos un MVP con IA aplicada y m\xe9tricas claras para validar el ROI en semanas.',
      outcomes: ['Automatizaci\xf3n inicial', 'KPIs con tablero', 'Validaci\xf3n ejecutiva'],
    },
    {
      title: 'Fase 3 \xb7 Escala Soberana',
      description:
        'Extendemos la IA al resto del ecosistema con gobernanza, seguridad y optimizaci\xf3n continua.',
      outcomes: [
        'Orquestaci\xf3n multi-\xe1rea',
            ...
            e.jsxs(a.div, {
              ...
              children: [
                ...
                e.jsx('p', {
                  ...
                  children:
                    'Un enfoque estrat\xe9gico para desplegar IA con resultados r\xe1pidos y escalables.',
                }),
              ],
            }),
            e.jsx('div', {
              ...
              children: t.map((t, s) =>
                e.jsxs(
                  a.div,
                  {
                    ...
                    initial: { opacity: 0, y: 30 },
                    whileInView: { opacity: 1, y: 0 },
                    transition: { duration: 0.6, delay: 0.1 * s },
                    viewport: { once: !0 },
                    children: [
                      e.jsx('h3', {
