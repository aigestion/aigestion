...
import { L as t, r as a } from './vendor-react-DzSuaLpV.js';
import { u as s, M as r } from './main-B5DH-ZW_.js';
import { G as o } from './GlitchText-B2uVSyOl.js';
import { u as i, d as n, m as l, b as c } from './vendor-motion-I6wcTx_q.js';
import { U as d, J as p, ai as m, aj as u, $ as x } from './vendor-ui-DAuP2EEx.js';
import './vendor-data-BRBMd6Um.js';
const h = () => {
  const { playHover: h, playClick: v, playWhoosh: g } = s(),
    { scrollY: b } = i(),
    f = n(b, [0, 500], [0, 200]),
    j = n(b, [0, 300], [1, 0]),
    y = [
      {
        ...
        description:
          'Un lugar donde puedes hablar con otras personas como si estuvieras all\xed mismo. Ideal para charlar y compartir ideas.',
        icon: d,
        color: 'from-blue-500/20 to-cyan-500/20',
        border: 'group-hover:neon-glow-cyan',
      },
      {
        title: 'Exposici\xf3n de Inventos',
        description:
          'Mira nuestros proyectos y productos en 3D. Puedes moverlos y verlos desde todos los \xe1ngulos.',
        icon: p,
      ...
      },
      {
        ...
        description:
          'Un espacio tranquilo donde tienes toda la informaci\xf3n de tu negocio siempre a mano.',
        icon: m,
      ...
      },
      {
        title: 'Fotos con IA',
        description:
          'Usa nuestra tecnolog\xeda para crear im\xe1genes incre\xedbles de tu oficina o productos al instante.',
        icon: u,
        color: 'from-orange-500/20 to-yellow-500/20',
        border: 'group-hover:shadow-[0_0_30px_rgba(245,158,11,0.3)]',
      },
    ],
    w = ({ children: t, className: s = '' }) => {
      ...
      return e.jsx(l.div, {
        ...
        onMouseEnter: () => h(),
        style: { rotateX: d, rotateY: p, transformStyle: 'preserve-3d' },
        className: s,
        children: t,
      });
    };
          ...
          e.jsxs(l.header, {
            ...
            children: [
              e.jsx('h1', {
                ...
                children: e.jsx(o, { text: 'TU OFICINA DEL FUTURO' }),
              }),
              e.jsxs('p', {
                className:
                  'text-nexus-silver/70 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed',
                children: [
                  e.jsx('span', { className: 'text-nexus-cyan-glow', children: '\u25cf' }),
              ...
              return e.jsx(
                w,
                {
                  ...
                  children: e.jsxs(l.div, {
                    initial: { opacity: 0, x: a % 2 == 0 ? -50 : 50 },
                    whileInView: { opacity: 1, x: 0 },
                    viewport: { once: !0 },
                    transition: { delay: 0.1 * a, type: 'spring' },
                    className: `relative z-10 h-full p-8 rounded-[2rem] bg-gradient-to-br ${t.color} border border-white/5 backdrop-blur-sm group transition-all duration-300 ${t.border}`,
                    children: [
                      e.jsxs('div', {
                        className:
                        ...
                        children: [
                          e.jsx('div', {
                            ...
                            children: e.jsx(s, { className: 'w-8 h-8 text-white' }),
                          }),
                          e.jsxs('div', {
                            children: [
                              e.jsx('h2', {
          ...
          e.jsxs(l.section, {
            ...
            children: [
              ...
              e.jsx('h3', {
                ...
                children: '\xbfEst\xe1s listo para el viaje?',
              }),
              e.jsx('p', {
                className: 'text-nexus-silver/70 mb-10 max-w-xl mx-auto relative z-10',
                children:
                  'Haz clic en el bot\xf3n de abajo y te llevaremos directamente a tu sede oficial. Solo necesitas tu rat\xf3n para moverte y explorar.',
              }),
              e.jsx('div', {
                ...
                children: e.jsx(r, {
                  ...
                  children: e.jsxs(t, {
                    ...
                    children: ['ENTRAR AHORA ', e.jsx(x, { className: 'w-6 h-6 animate-pulse' })],
                  }),
                }),
              }),
              e.jsxs('div', {
