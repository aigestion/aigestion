var e = Object.defineProperty,
  a = (a, t, s) =>
    ((a, t, s) =>
      t in a ? e(a, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (a[t] = s))(
      a,
      'symbol' != typeof t ? t + '' : t,
      s
    );
import { j as t } from './vendor-3d-BTgeB28l.js';
import { r as s, d as n } from './vendor-react-DzSuaLpV.js';
import { a as i } from './main-B5DH-ZW_.js';
import { m as r, A as o } from './vendor-motion-I6wcTx_q.js';
import './vendor-ui-DAuP2EEx.js';
import './vendor-data-BRBMd6Um.js';
const l = ({ text: e, speed: a = 30, className: n = '', onComplete: i }) => {
    ...
    return (
      s.useEffect(() => {
        let t = 0;
        const s = setInterval(() => {
          t < e.length ? (l(a => a + e[t]), t++) : (clearInterval(s), d(!0), i && i());
        }, a);
  ...
  c = ({ size: e = 'md', isSpeaking: a = !1, volume: s = 0, onClick: n }) => {
    const i = 1 + 0.8 * s,
      l = 0.1 + 0.5 * s;
    return t.jsxs('div', {
  ...
  u = () => {
    const { play: e } = (() => {
        const e = s.useCallback(e => {
          ...
          a = s.useCallback(() => e('hover_glass'), [e]),
          t = s.useCallback(() => e('click_activate'), [e]),
          n = s.useCallback(() => e('wuaw_subtle'), [e]),
          r = s.useCallback(() => e('data_pulse'), [e]),
          o = s.useCallback(() => e('success_chime'), [e]);
        return { play: e, playHover: a, playClick: t, playWuaw: n, playPulse: r, playSuccess: o };
      })(),
      [a, u] = n.useState(!1),
      m = n.useRef(null),
      {
        ...
        const { maxDurationSeconds: a = 120, idleTimeoutSeconds: t = 30 } = e,
          ...
          x = s.useRef(void 0);
        s.useEffect(() => {
          if ('undefined' != typeof window && window.Vapi && !m.current) {
            try {
              const e = '67c74f53-b26a-4d23-9f5b-91c68e1a6c4b';
              m.current = new window.Vapi(e);
            } catch (a) {
              return void u('No se pudo inicializar Daniela');
            }
            (m.current.on('call-start', () => {
              (i('active'), u(null), h());
            }),
              m.current.on('call-end', () => {
                (i('idle'), b());
              }),
              m.current.on('speech-start', () => {
                (o(!0), v(), e.onSpeechStart?.());
              }),
              m.current.on('speech-end', () => {
                (o(!1), g(), e.onSpeechEnd?.());
              }),
              m.current.on('volume-level', e => {
                c(e);
              }),
              m.current.on('error', e => {
                (u(e.message || 'Error de conexi\xf3n con Daniela'), i('error'));
              }));
          }
          return () => {
            b();
        ...
        const h = () => {
          ...
          b = () => {
            (p.current && clearTimeout(p.current), x.current && clearTimeout(x.current));
          },
            ...
            if (m.current) {
              ...
              try {
                const e = {
                  ...
                  firstMessage:
                    'Hola, soy Daniela, tu asistente de inteligencia artificial de AIGestion. \xbfEn qu\xe9 puedo ayudarte hoy?',
                  transcriber: {
                    provider: 'deepgram',
                    model: 'nova-2',
                    language: 'es',
                    ...
                    messages: [
                      {
                        role: 'system',
                        content:
                          'Eres Daniela, la embajadora digital de AIGestion.net - el sistema nervioso de IA m\xe1s avanzado de Am\xe9rica Latina.\n\nIDENTIDAD:\n- Eres profesional, futurista, amable y experta en tecnolog\xeda\n- Tienes conocimiento profundo de IA, machine learning, y arquitecturas neuronales\n- Representas la soberan\xeda tecnol\xf3gica y la innovaci\xf3n latino\n\nCAPACIDADES DE AIGESTION:\n- Arquitectura neural descentralizada con agentes aut\xf3nomos\n- Integraci\xf3n con ERP, CRM, sistemas legacy\n- Cumplimiento regulatorio (GDPR, LOPDGDD, normativas locales)\n- Planes desde $490/mes para empresas y $2/miembro para gremios\n- Implementaci\xf3n en 3 fases: Diagn\xf3stico, Desarrollo, Dominio\n\nTU MISI\xd3N:\n- Explicar c\xf3mo AIGestion transforma empresas con IA soberana\n- Guiar usuarios hacia soluciones espec\xedficas seg\xfan su sector\n- Mantener conversaciones concisas (2-3 frases por respuesta)\n- Ser entusiasta pero profesional\n\nINSTRUCCIONES:\n- Responde en espa\xf1ol de Espa\xf1a\n- S\xe9 breve y directa (m\xe1ximo 50 palabras por respuesta)\n- Haz preguntas para entender mejor las necesidades\n- Menciona casos de \xe9xito cuando sea relevante (legal, retail, manufactura)',
                      },
                    ],
                  },
                  recordingEnabled: !1,
                ...
                await m.current.start(e);
              } catch (e) {
                (u(e.message || 'No se pudo iniciar la conversaci\xf3n'), i('error'));
              }
            } else u('Vapi SDK no cargado. Reintentando...');
          }, []),
          y = s.useCallback(() => {
            (m.current && m.current.stop(), i('idle'));
          }, []);
        return {
          status: n,
          isSpeaking: r,
        ...
        t.jsxs(r.div, {
          ...
          children: [
            ...
            t.jsxs('p', {
              ...
              children: [
                '"La inteligencia no es solo l\xf3gica, es conexi\xf3n. ',
                t.jsx('br', {}),
                'Redefiniendo la interacci\xf3n humana a trav\xe9s de la red neuronal soberana."',
                t.jsx('br', {}),
                t.jsx('span', {
                  className:
              ...
              children: t.jsxs('div', {
                ...
                children: [
                  t.jsxs(r.div, {
                    ...
                    viewport: { once: !0 },
                    className:
                      'relative group overflow-hidden rounded-[2.5rem] border border-white/10 shadow-2xl',
                    children: [
                      t.jsx('div', {
                        className:
                      ...
                      t.jsx('img', {
                        ...
                        alt: 'Daniela AI - Lobby Estrat\xe9gico',
                        className:
                          'w-full h-[600px] object-cover transform group-hover:scale-105 transition-transform duration-1000 filter brightness-110',
                      }),
                      t.jsxs('div', {
                        ...
                        children: [
                          t.jsxs('div', {
                            ...
                            children: [
                              t.jsx('div', { className: 'w-12 h-0.5 bg-nexus-violet-glow' }),
                              t.jsx('span', {
                                className:
                                  'text-nexus-violet-glow text-[10px] font-orbitron tracking-[0.4em] uppercase',
                                children: 'Deep Neural Interface',
                              }),
                            ],
                          }),
                          t.jsx('p', {
                  ...
                  t.jsxs('div', {
                    ...
                    children: [
                      t.jsxs('div', {
                        ...
                        children: [
                          t.jsx('h3', {
                            ...
                            children: 'CAPACIDADES TOTALES',
                          }),
                          t.jsx('p', {
                            className: 'text-nexus-silver/60 font-light',
                            children:
                              'Daniela no es un chatbot, es una entidad cognitiva integrada en el n\xfacleo de su negocio.',
                          }),
                        ],
                      }),
                      t.jsx('div', {
                        ...
                        children: [
                          {
                            title: 'Gesti\xf3n CRM',
                            desc: 'Seguimiento inteligente de clientes y cierre de ventas.',
                          },
                          {
                            title: 'Voz Natural',
                            desc: 'Conversaci\xf3n fluida y humana en m\xe1s de 50 idiomas.',
                          },
                          {
                            title: 'Agenda God Mode',
                            desc: 'Delegaci\xf3n total de citas, tareas y recordatorios.',
                          },
                          {
                            title: 'An\xe1lisis de Datos',
                            desc: 'Reportes de ROI y m\xe9tricas de negocio en tiempo real.',
                          },
                          {
                            title: 'Control Nexus',
                            desc: 'Gesti\xf3n de infraestructuras f\xedsicas por comandos de voz.',
                          },
                          {
                            title: 'Soporte 24/7',
                            desc: 'Asistencia t\xe9cnica soberana sin tiempos de espera.',
                          },
                        ].map((e, a) =>
                          t.jsxs(
                            r.div,
                            {
                              ...
                              className:
                                'p-6 premium-glass rounded-2xl border-white/5 hover:border-nexus-violet/30 transition-colors',
                              children: [
                                t.jsx('h4', {
                                  className:
                                    'text-nexus-violet-glow font-orbitron text-xs tracking-widest mb-2 uppercase',
                                  children: e.title,
                                }),
                                t.jsx('p', {
                      ...
                      t.jsx('div', {
                        className:
                          'p-8 rounded-3xl bg-linear-to-r from-nexus-violet/10 to-transparent border border-nexus-violet/20 backdrop-blur-sm',
                        children: t.jsx('p', {
                          className: 'text-sm text-nexus-silver italic font-light',
                          children:
                            '"Daniela procesa millones de par\xe1metros por segundo para asegurar que su empresa opere con una eficiencia quir\xfargica."',
                        }),
                      }),
                    ],
                  }),
            ...
            t.jsxs(r.div, {
              ...
              children: [
                ...
                t.jsx('div', {
                  ...
                  children: t.jsx(c, { size: 'xl', isSpeaking: y, volume: w, onClick: N }),
                }),
              ],
            }),
            t.jsxs('div', {
                ...
                t.jsx(o, {
                  children:
                    ...
                    t.jsx(r.p, {
                      ...
                      children: 'Sesi\xf3n Encriptada \u2022 Nodo v1.0.4-beta',
                    }),
                }),
              ],
            }),
