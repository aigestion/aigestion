import { j as t } from './vendor-3d-BTgeB28l.js';
import { r as e } from './vendor-react-DzSuaLpV.js';
...
const E = t => e => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  A = t => e => 1 - t(1 - e),
  C = b(0.33, 1.53, 0.69, 0.99),
  M = A(C),
  V = E(M),
  k = t => ((t *= 2) < 1 ? 0.5 * M(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
...
function N(t, e) {
  ...
  const s = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    g = () => {
      const o = u.useManualTiming ? s.timestamp : performance.now();
      ((n = !1),
        u.useManualTiming || (s.delta = i ? 1e3 / 60 : Math.max(Math.min(o - s.timestamp, 40), 1)),
        (s.timestamp = o),
        (s.isProcessing = !0),
        a.process(s),
        l.process(s),
...
const G = {
    now: () => (
      void 0 === H && G.set(Y.isProcessing || u.useManualTiming ? Y.timestamp : performance.now()),
      H
    ),
    set: t => {
...
const rt =
  ...
  ct = { ...et, transform: t => Math.round((t => c(0, 255, t))(t)) },
  ut = {
    test: at('rgb', 'red'),
...
const ht = {
  ...
  wt = {
    test: t => ut.test(t) || ht.test(t) || xt.test(t),
    parse: t => (ut.test(t) ? ut.parse(t) : xt.test(t) ? xt.parse(t) : ht.parse(t)),
    transform: t =>
      'string' == typeof t ? t : t.hasOwnProperty('red') ? ut.transform(t) : xt.transform(t),
    getAnimatableNone: t => {
      const e = wt.parse(t);
...
const Mt = t => ('number' == typeof t ? 0 : wt.test(t) ? wt.getAnimatableNone(t) : t);
const Vt = {
  test: function (t) {
    return (
      isNaN(t) &&
      'string' == typeof t &&
      (t.match(ot)?.length || 0) + (t.match(Tt)?.length || 0) > 0
    );
  },
  parse: At,
      ...
      (i = (function ({ hue: t, saturation: e, lightness: n, alpha: i }) {
        ...
        if ((e /= 100)) {
          const i = n < 0.5 ? n * (1 + e) : n + e - n * e,
            a = 2 * n - i;
          ((s = kt(a, i, t + 1 / 3)), (o = kt(a, i, t)), (r = kt(a, i, t - 1 / 3)));
        } else s = o = r = n;
        return {
...
const Yt = t => {
    ...
    return {
      ...
      stop: () => X(e),
      now: () => (Y.isProcessing ? Y.timestamp : G.now()),
    };
  },
  zt = (t, e, n = 10) => {
    let i = '';
...
const qt = 100,
  ...
  ae = 1,
  le = 0.001;
function ce({ duration: t = Qt, bounce: e = te, velocity: n = Jt, mass: i = _t }) {
  let s,
    o,
    r = 1 - e;
  ((r = c(re, ae, r)),
      ...
      if (!me(t, pe) && me(t, de))
        if (t.visualDuration) {
          const n = t.visualDuration,
            i = (2 * Math.PI) / (1.2 * n),
            s = i * i,
            o = 2 * c(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(s);
...
function xe({ duration: t = 300, keyframes: e, times: n, ease: i = 'easeInOut' }) {
  const s = (t => Array.isArray(t) && 'number' != typeof t[0])(i) ? i.map(U) : U(i),
    ...
    a = ye(r, e, {
      ease: Array.isArray(s) ? s : ((l = e), (c = s), l.map(() => c || F).splice(0, l.length - 1)),
    });
  var l, c;
...
class Ae extends be {
  ...
  initAnimation() {
    ...
    a !== xe &&
      'number' != typeof r[0] &&
      ((this.mixKeyframes = y(Ee, Xt(r[0], r[1]))), (r = [0, 100]));
  ...
  tick(t, e = !1) {
    ...
    return (
      S && m !== ge && (T.value = Te(u, this.options, g, this.speed)),
      f && f(T.value),
      S && this.finish(),
      T
    );
  ...
  play() {
    ...
    const { driver: t = Yt, startTime: e } = this.options;
...
const Ce = t => (180 * t) / Math.PI,
  ...
  De = t => Math.sqrt(t[0] * t[0] + t[1] * t[1]),
  ...
  Le = {
    ...
    scaleY: Re,
    scale: t => (De(t) + Re(t)) / 2,
    rotateX: t => ke(Ce(Math.atan2(t[6], t[5]))),
    rotateY: t => ke(Ce(Math.atan2(-t[2], t[0]))),
    rotateZ: Me,
    rotate: Me,
...
function Ke() {
  if (ze) {
    const t = Array.from(Xe).filter(t => t.needsMeasurement),
  ...
  ((ze = !1), (Ye = !1), Xe.forEach(t => t.complete(He)), Xe.clear());
}
function Ge() {
  Xe.forEach(t => {
...
class qe {
  ...
  scheduleResolve() {
    ((this.state = 'scheduled'),
      this.isAsync
        ? (Xe.add(this), Ye || ((Ye = !0), $.read(Ge), $.resolveKeyframes(Ke)))
  ...
  cancel() {
    'scheduled' === this.state && (Xe.delete(this), (this.state = 'pending'));
  }
  resume() {
...
const an = { anticipate: k, backInOut: V, circInOut: L };
function ln(t) {
...
class mn extends be {
  ...
  onKeyframesResolved(t, e, n, i) {
    ...
    ((this.resolvedAt = G.now()),
      (function (t, e, n, i) {
        ...
        ((!u.instantAnimations && a) || c?.(Te(t, n, e)),
        (t[0] = t[t.length - 1]),
        hn(n),
        (n.repeat = 0)));
    const h = {
      ...
      d =
        ...
        (function (t) {
          ...
          ? new cn({ ...h, element: h.motionValue.owner.current })
          : new Ae(h);
    (d.finished.then(() => this.notifyFinished()).catch(f),
  ...
  get animation() {
    return (
      this._animation || (this.keyframeResolver?.resume(), (He = !0), Ge(), Ke(), (He = !1)),
      this._animation
    );
  }
  get duration() {
...
const bn =
    ...
    r => {
      ...
      if (
        ((!1 === h.type || (0 === h.duration && !h.repeatDelay)) &&
          (hn(h), 0 === h.delay && (d = !0)),
        (u.instantAnimations || u.skipAnimations) && ((d = !0), hn(h), (h.delay = 0)),
  ...
  En = new Set(['width', 'height', 'top', 'left', 'right', 'bottom', ...Ie]),
  An = { current: void 0 };
class Cn {
  constructor(t, e = {}) {
  ...
  get() {
    return (An.current && An.current.push(this), this.current);
  }
  getPrevious() {
    return this.prev;
  }
...
function Dn(t, e, n) {
  const i = t.getProps();
  return kn(i, e, void 0 !== n ? n : i.custom, t);
}
...
function Nn(t, e, { delay: n = 0, transitionOverride: i, type: s } = {}) {
  ...
  for (const u in a) {
    const e = t.getValue(u, t.latestValues[u] ?? null),
      i = a[u];
    if (void 0 === i || (c && Wn(c, u))) continue;
    const s = { delay: n, ...yn(o || {}, u) },
      r = e.get();
    ...
    if (window.MotionHandoffAnimation) {
      const e = Un(t);
      if (e) {
        const t = window.MotionHandoffAnimation(e, u, $);
        null !== t && ((s.startTime = t), (h = !0));
      }
    }
    (Fn(t, u), e.start(bn(u, e, i, t.shouldReduceMotion && En.has(u) ? { type: !1 } : s, t, h)));
    const d = e.animation;
    d && l.push(d);
  }
  return (
...
function $n(t, e, n = {}) {
  const i = Dn(t, e, 'exit' === n.type ? t.presenceContext?.custom : void 0);
  let { transition: s = t.getDefaultTransition() || {} } = i || {};
  n.transitionOverride && (s = n.transitionOverride);
  const o = i ? () => Promise.all(Nn(t, i, n)) : () => Promise.resolve(),
    r =
                ...
                (l.notify('AnimationStart', e),
                  a.push(
                    $n(l, e, {
                      ...r,
                      delay:
                        n + ('function' == typeof i ? 0 : i) + Sn(t.variantChildren, l, i, s, o),
...
const Xn = t => e => e.test(t),
  Yn = [et, ft, mt, pt, yt, gt, { test: t => 'auto' === t, parse: t => t }],
  zn = t => Yn.find(Xn(t));
function Hn(t) {
...
class ii extends qe {
  ...
  measureEndState() {
    ...
    const s = n.length - 1,
      o = n[s];
    ((n[s] = $e[e](t.measureViewportBox(), window.getComputedStyle(t.current))),
...
function Ci({ target: t, borderBoxSize: e }) {
  Pi.get(t)?.forEach(n => {
    n(t, {
      get width() {
        return Ei(t, e);
...
function Vi(t, e) {
  Si || ('undefined' != typeof ResizeObserver && (Si = new ResizeObserver(Mi)));
  const n = si(t);
  return (
    n.forEach(t => {
      let n = Pi.get(t);
      (n || ((n = new Set()), Pi.set(t, n)), n.add(e), Si?.observe(t));
    }),
    () => {
      n.forEach(t => {
        const n = Pi.get(t);
        (n?.delete(e), n?.size || Si?.unobserve(t));
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      (ki.delete(t),
        ki.size ||
          'function' != typeof Di ||
          (window.removeEventListener('resize', Di), (Di = void 0)));
    }
  );
}
function Li(t, e) {
...
const zi = ['animate', 'whileInView', 'whileFocus', 'whileHover', 'whileTap', 'whileDrag', 'exit'],
  Hi = ['initial', ...zi];
function Ki(t) {
  return Xi(t.animate) || Hi.some(e => Yi(t[e]));
}
function Gi(t) {
...
class Ji {
  ...
  constructor(
    ...
    const { willChange: c, ...u } = this.scrapeMotionValuesFromProps(e, {}, this);
    for (const h in u) {
      const t = u[h];
  ...
  update(t, e) {
    ...
    ((this.prevMotionValues = (function (t, e, n) {
      for (const i in e) {
        ...
        else if (jn(o)) t.addValue(i, Mn(s, { owner: t }));
        else if (o !== s)
          if (t.hasValue(i)) {
            ...
            t.addValue(i, Mn(void 0 !== e ? e : s, { owner: t }));
          }
      }
  ...
  getValue(t, e) {
    ...
    return (
      void 0 === n &&
        void 0 !== e &&
        ((n = Mn(null === e ? void 0 : e, { owner: this })), this.addValue(t, n)),
      n
    );
  }
  readValue(t, e) {
    ...
    return (
      null != n &&
        ('string' == typeof n && (h(n) || p(n))
          ? (n = parseFloat(n))
          : ((i = n), !Ii.find(Xn(i)) && Vt.test(e) && (n = ei(t, e))),
  ...
  getBaseTarget(t) {
    ...
    if ('string' == typeof e || 'object' == typeof e) {
      const i = kn(this.props, e, this.presenceContext?.custom);
      i && (n = i[t]);
    }
    if (e && void 0 !== n) return n;
    const i = this.getBaseTargetFromProps(this.props, t);
    return void 0 === i || jn(i)
...
function cs(t, e = 0, n = 1, i, s) {
  ((t.min = ls(t.min, e, n, i, s)), (t.max = ls(t.max, e, n, i, s)));
}
function us(t, { x: e, y: n }) {
  (cs(t.x, e.translate, e.scale, e.originPoint), cs(t.y, n.translate, n.scale, n.originPoint));
}
...
function As(t, e, n) {
  ...
  if (!i) return o;
  for (const r in i)
    (jn(i[r]) || (s && jn(s[r])) || Es(r, t) || void 0 !== n?.getValue(r)?.liveStyle) &&
      (o[r] = i[r]);
  return o;
}
class Cs extends ts {
  ...
  readValueFromInstance(t, e) {
          ...
          })(t, e);
    {
      const i = ((n = t), window.getComputedStyle(n)),
        s = (Z(e) ? i.getPropertyValue(e) : i[e]) || 0;
...
const Ms = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' },
...
function Ds(
  ...
  if ((xs(t, a, c), l)) return void (t.style.viewBox && (t.attrs.viewBox = t.style.viewBox));
  ...
  for (const p of ks) void 0 !== h[p] && ((d[p] = h[p]), delete h[p]);
  (void 0 !== e && (h.x = e),
    void 0 !== n && (h.y = n),
    void 0 !== i && (h.scale = i),
    void 0 !== s &&
      (function (t, e, n = 1, i = 0, s = !0) {
        t.pathLength = 1;
        const o = s ? Ms : Vs;
        t[o.offset] = ft.transform(-i);
        const r = ft.transform(e),
          a = ft.transform(n);
        t[o.array] = `${r} ${a}`;
      })(h, s, o, r, !1));
}
...
class js extends ts {
  ...
  build(t, e, n) {
    Ds(t, e, this.isSVGTag, n.transformTemplate, n.style);
  }
      ...
      e.map(({ animation: e, options: n }) =>
        (function (t, e, n = {}) {
          ...
          if ((t.notify('AnimationStart', e), Array.isArray(e))) {
            ...
            const s = 'function' == typeof e ? Dn(t, e, n.custom) : e;
...
function $s(t) {
  let e = Ns(t),
    ...
    i = !0;
  const s = e => (n, i) => {
    const s = Dn(t, i, 'exit' === e ? t.presenceContext?.custom : void 0);
    if (s) {
  ...
  function o(o) {
    ...
    for (let e = 0; e < Ws; e++) {
      ...
      if (
        ...
        (p.protectedKeys = { ...u }),
        (!p.isActive && null === g) || (!m && !p.prevProp) || Xi(m) || 'boolean' == typeof m)
      )
        continue;
      const v = Xs(p.prevProp, m);
          ...
          ...T.map(e => {
            ...
            if ('string' == typeof e && i && !A && t.manuallyAnimateOnMount && t.parent) {
              ...
              if (i.enteringChildren && s) {
                ...
                n.delay = Sn(i.enteringChildren, t, e);
              }
            }
    ...
    if (c.size) {
      ...
      if ('boolean' != typeof r.initial) {
        const n = Dn(t, Array.isArray(r.initial) ? r.initial[0] : r.initial);
...
function Gs(t, e, n, i) {
  (Ks(t.x, e.x, n.x, i ? i.originX : void 0), Ks(t.y, e.y, n.y, i ? i.originY : void 0));
}
function qs(t, e, n) {
  ((t.min = n.min + e.min), (t.max = t.min + Hs(e)));
}
function Zs(t, e, n) {
  ((t.min = e.min - n.min), (t.max = t.min + Hs(e)));
}
function _s(t, e, n) {
...
function Lo({
  ...
  return class {
          ...
          t(e, () => {
            ...
            t !== i &&
              ...
              (n = (function (t, e) {
                ...
                return ($.setup(i, !0), () => X(i));
              })(s, 250)),
              Mo.hasAnimatedSinceResize &&
                ((Mo.hasAnimatedSinceResize = !1), this.nodes.forEach($o)));
          }));
      }
          ...
          this.addEventListener(
            ...
            ({ delta: t, hasLayoutChanged: e, hasRelativeLayoutChanged: n, layout: i }) => {
              ...
              const s = this.options.transition || o.getDefaultTransition() || Zo,
                ...
                l = !this.targetLayout || !uo(this.targetLayout, i),
                c = !e && n;
              if (
                ...
                const e = { ...yn(s, 'layout'), onPlay: r, onComplete: a };
    ...
    update() {
      ...
      const t = G.now();
      ((Y.delta = c(0, 1e3 / 60, t - Y.timestamp)),
        (Y.timestamp = t),
        (Y.isProcessing = !0),
        z.update.process(Y),
        z.preRender.process(Y),
        z.render.process(Y),
        (Y.isProcessing = !1));
    }
    didUpdate() {
    ...
    updateSnapshot() {
      !this.snapshot &&
        ...
        !this.snapshot ||
          Hs(this.snapshot.measuredBox.x) ||
          Hs(this.snapshot.measuredBox.y) ||
    ...
    measurePageBox() {
      ...
      if (!(this.scroll?.wasRoot || this.path.some(er))) {
        const { scroll: t } = this.root;
        t && (ps(e.x, t.offset.x), ps(e.y, t.offset.y));
      }
      return e;
    }
    removeElementScroll(t) {
      const e = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } };
      if ((so(e, t), this.scroll?.wasRoot)) return e;
      for (let n = 0; n < this.path.length; n++) {
        const i = this.path[n],
        ...
        i !== this.root &&
          s &&
          o.layoutScroll &&
          (s.wasRoot && so(e, t), ps(e.x, s.offset.x), ps(e.y, s.offset.y));
      }
      return e;
    }
    ...
    removeTransform(t) {
      ...
      for (let n = 0; n < this.path.length; n++) {
        ...
        const i = Oi();
        (so(i, t.measurePageBox()),
          no(e, t.latestValues, t.snapshot ? t.snapshot.layoutBox : void 0, i));
      }
      return (ss(this.latestValues) && no(e, this.latestValues), e);
    }
    setTargetDelta(t) {
        ...
        this.relativeParent.target
          ...
          : this.targetDelta
            ? (Boolean(this.resumingFrom)
                ...
                : so(this.target, this.layout.layoutBox),
              us(this.target, this.targetDelta))
            : so(this.target, this.layout.layoutBox),
        this.attemptToResolveRelativeTarget &&
    ...
    createRelativeTarget(t, e, n) {
      ((this.relativeParent = t),
        ...
        _s(this.relativeTargetOrigin, e, n),
        so(this.relativeTarget, this.relativeTargetOrigin));
    }
    ...
    calcProjection() {
      ...
      if (
        ...
        this.resolvedRelativeTargetAt === Y.timestamp && (n = !1),
        n)
      )
        return;
      const { layout: i, layoutId: s } = this.options;
      if (
        ...
        return;
      so(this.layoutCorrected, this.layout.layoutBox);
      ...
      (!(function (t, e, n, i = !1) {
        ...
        for (let a = 0; a < s; a++) {
          ...
          (s && s.props.style && 'contents' === s.props.style.display) ||
            ...
            r && ((e.x *= r.x.scale), (e.y *= r.y.scale), us(t, r)),
      ...
      a
        ? (this.projectionDelta && this.prevProjectionDelta
            ? (oo(this.prevProjectionDelta.x, this.projectionDelta.x),
              oo(this.prevProjectionDelta.y, this.projectionDelta.y))
            : this.createProjectionDeltas(),
          Gs(this.projectionDelta, this.layoutCorrected, a, this.latestValues),
          (this.treeScale.x === o &&
            this.treeScale.y === r &&
    ...
    setAnimationOrigin(t, e = !1) {
      ...
      const r = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } },
        ...
        u = Boolean(a && !c && !0 === this.options.crossfade && !this.path.some(qo));
      let h;
      ((this.animationProgress = 0),
        (this.mixTargetDelta = e => {
          ...
          (Ko(o.x, t.x, n),
            ...
            this.relativeTarget &&
              ...
              (_s(r, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
      ...
      (this.notifyListeners('animationStart'),
        ...
        (this.pendingAnimation = $.update(() => {
          ((Mo.hasAnimatedSinceResize = !0),
            this.motionValue || (this.motionValue = Mn(0)),
    ...
    applyTransformsToTarget() {
      ...
      if (e && n && i) {
        if (
          ...
          const e = Hs(this.layout.layoutBox.x);
          ((n.x.min = t.target.x.min), (n.x.max = n.x.min + e));
          const i = Hs(this.layout.layoutBox.y);
          ((n.y.min = t.target.y.min), (n.y.max = n.y.min + i));
        }
        (so(e, n), fs(e, s), Gs(this.projectionDeltaWithTransform, this.layoutCorrected, e, s));
      }
    }
    registerSharedNode(t, e) {
      this.sharedNodes.has(t) || this.sharedNodes.set(t, new Co());
    ...
    resetSkewAndRotation() {
      ...
      if (
        ...
        return;
      const i = {};
      n.z && Do('z', t, i, this.animationValues);
      for (let s = 0; s < Vo.length; s++)
        (Do(`rotate${Vo[s]}`, t, i, this.animationValues),
          Do(`skew${Vo[s]}`, t, i, this.animationValues));
      t.render();
      for (const s in i)
    ...
    applyProjectionStyles(t, e) {
      ...
      if (this.needsReset)
        return (
          ...
          (t.visibility = ''),
          (t.opacity = ''),
          (t.pointerEvents = bo(e?.pointerEvents) || ''),
      ...
      this.options.layoutId && (t.pointerEvents = i === this ? bo(e?.pointerEvents) || '' : 'none');
    }
    clearSnapshot() {
...
function jo(t) {
  ...
  if (t.isLead() && t.layout && e && t.hasListeners('didUpdate')) {
    ...
    o ? Gs(a, t.applyTransform(i, !0), e.measuredBox) : Gs(a, n, e.layoutBox);
    const l = !ao(r);
    let c = !1;
    if (!t.resumeFrom) {
...
function cr({ children: n, isPresent: i, anchorX: s, root: o }) {
  const r = e.useId(),
    a = e.useRef(null),
    l = e.useRef({ width: 0, height: 0, top: 0, left: 0, right: 0 }),
    { nonce: c } = e.useContext(or),
    u = n.props?.ref ?? n?.ref,
    h = ar(a, u);
  return (
    e.useInsertionEffect(() => {
      const { width: t, height: e, top: n, left: u, right: h } = l.current;
      if (i || !a.current || !t || !e) return;
      const d = 'left' === s ? `left: ${u}` : `right: ${h}`;
    ...
    t.jsx(lr, { isPresent: i, childRef: a, sizeRef: l, children: e.cloneElement(n, { ref: h }) })
  );
}
const ur = ({
  children: n,
  ...
  return (
    ...
    'popLayout' === u && (n = t.jsx(cr, { isPresent: o, anchorX: h, root: d, children: n })),
    t.jsx(r.Provider, { value: g, children: n })
  );
};
function hr() {
  return new Map();
...
const fr = ({
    ...
    const [m, f] = dr(h),
      ...
      [b, E] = e.useState(g);
    o(() => {
      ((v.current = !1), (x.current = g));
      for (let t = 0; t < b.length; t++) {
        const e = pr(b[t]);
        y.includes(e) ? (w.delete(e), T.current.delete(e)) : !0 !== w.get(e) && w.set(e, !1);
      }
    }, [b, y.length, y.join('-')]);
    const A = [];
    if (g !== P) {
      ...
      for (let e = 0; e < b.length; e++) {
        const n = b[e],
          i = pr(n);
        y.includes(i) || (t.splice(e, 0, n), A.push(n));
      }
      return ('wait' === u && A.length && (t = A), E(mr(t)), S(g), null);
    }
    const { forceRender: C } = e.useContext(n);
    return t.jsx(t.Fragment, {
      children: b.map(e => {
        const n = pr(e),
          i = !(h && !m) && (g === b || y.includes(n));
        return t.jsx(
          ur,
          {
            isPresent: i,
            initial: !(v.current && !a) && void 0,
            custom: r,
            presenceAffectsLayout: c,
            mode: u,
            root: p,
...
function Er(t) {
  const { initial: n, animate: i } = (function (t, e) {
    if (Ki(t)) {
      ...
      return { initial: !1 === e || Yi(e) ? e : void 0, animate: Yi(n) ? n : void 0 };
    }
...
const Cr = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
function Mr(t, e, n) {
...
const Dr = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {}, attrs: {} });
function Rr(t, n, i, s) {
  const o = e.useMemo(() => {
    const e = { style: {}, transform: {}, transformOrigin: {}, vars: {}, attrs: {} };
    return (Ds(e, n, Ls(s), t.transformTemplate, t.style), { ...e.attrs, style: { ...e.style } });
  }, [n]);
  if (t.style) {
    const e = {};
    (Mr(e, t.style, t), (o.style = { ...e, ...o.style }));
  }
  return o;
}
const Lr = [
...
function jr(t, n, i, { latestValues: s }, o, r = !1, a) {
  const l = ((a ?? Br(t)) ? Rr : kr)(n, s, o, t),
    ...
    u = t !== e.Fragment ? { ...c, ...l, ref: i } : {},
    { children: h } = n,
    d = e.useMemo(() => (jn(h) ? h.get() : h), [h]);
  return e.createElement(t, { ...u, children: d });
}
function Fr(t, e, n, i) {
  const s = {},
    o = i(t, {});
  for (const d in o) s[d] = bo(o[d]);
...
const Ir = t => (n, s) => {
  ...
  Or = Ir({ scrapeMotionValuesFromProps: As, createRenderState: Cr }),
  Ur = Ir({ scrapeMotionValuesFromProps: Bs, createRenderState: Dr }),
...
function Nr(t, n, i) {
  ...
  return e.useCallback(
    e => {
      (e && t.onMount?.(e), n && (e ? n.mount(e) : n.unmount()));
      const i = s.current;
...
function Yr(t, n, i, s, a, l) {
  const { visualElement: c } = e.useContext(br),
    u = e.useContext(gr),
    h = e.useContext(r),
    d = e.useContext(or).reducedMotion,
    p = e.useRef(null);
  ((s = s || u.renderer),
    !p.current &&
      s &&
    ...
    (function (t, e, n, i) {
      ...
      ((t.projection = new n(t.latestValues, e['data-framer-portal-id'] ? void 0 : zr(t.parent))),
        t.projection.setOptions({
          layoutId: s,
          layout: o,
          alwaysMeasureLayout: Boolean(r) || (a && Xr(a)),
          visualElement: t,
  ...
  const g = e.useRef(!1);
  e.useInsertionEffect(() => {
    m && g.current && m.update(i, h);
  });
  const y = i[On],
    v = e.useRef(
      Boolean(y) && !window.MotionHandoffIsComplete?.(y) && window.MotionHasOptimisedAnimation?.(y)
    );
  return (
    o(() => {
      m &&
...
function Hr(n, { forwardMotionProps: i = !1, type: o } = {}, r, a) {
  ...
  function u(o, r) {
    ...
    if (!d && s) {
      ...
      ((u = t.MeasureLayout), (p.visualElement = Yr(n, m, h, a, t.ProjectionNode, l)));
    }
    return t.jsxs(br.Provider, {
      value: p,
      children: [
        u && p.visualElement ? t.jsx(u, { visualElement: p.visualElement, ...h }) : null,
        jr(n, o, Nr(m, p.visualElement, r), m, d, i, l),
      ],
    });
  }
  u.displayName = `motion.${'string' == typeof n ? n : `create(${n.displayName ?? n.name ?? ''})`}`;
  const h = e.forwardRef(u);
  return ((h[Wr] = n), h);
}
...
const qr = (t, n) =>
  (n.isSVG ?? Br(t)) ? new js(n) : new Cs(n, { allowProjection: t !== e.Fragment });
let Zr = 0;
const _r = {
  animation: {
    Feature: class extends Qi {
      constructor(t) {
        (super(t), t.animationState || (t.animationState = $s(t)));
      }
      updateAnimationControlsSubscription() {
        const { animate: t } = this.node.getProps();
        Xi(t) && (this.unmountControls = t.subscribe(this.node));
      }
      mount() {
...
function ra({ point: t }, e) {
  return { point: t, delta: oa(t, la(e)), offset: oa(t, aa(e)), velocity: ca(e, 0.1) };
}
function aa(t) {
  return t[0];
}
...
class ga {
    ...
    (t && Xr(t)
      ...
      : (this.constraints =
          ...
          (function (t, { top: e, left: n, bottom: i, right: s }) {
            return { x: ua(t.x, n, s), y: ua(t.y, e, i) };
          })(n.layoutBox, t)),
  ...
  scalePositionWithinConstraints() {
    ...
    if (!Xr(e) || !n || !this.constraints) return;
    this.stopAnimation();
    const i = { x: 0, y: 0 };
    mo(t => {
  ...
  addListeners() {
    ...
    const t = Qr(this.visualElement.current, 'pointerdown', t => {
        const { drag: e, dragListener: n = !0 } = this.getProps();
        e && n && !fi(t.target) && this.start(t);
      }),
      e = () => {
        const { dragConstraints: t } = this.getProps();
        Xr(t) && t.current && (this.constraints = this.resolveRefConstraints());
      },
      { projection: n } = this.visualElement,
      i = n.addEventListener('measure', e);
    (n && !n.layout && (n.root && n.root.updateScroll(), n.updateLayout()), $.read(e));
    const s = So(window, 'resize', () => this.scalePositionWithinConstraints()),
...
function Va(t, e, n) {
  const i = (function ({ root: t, ...e }) {
    ...
    const i = Aa.get(n),
      s = JSON.stringify(e);
    return (i[s] || (i[s] = new IntersectionObserver(Ma, { root: t, ...e })), i[s]);
  })(e);
  return (
    Ea.set(t, n),
    i.observe(t),
            ...
            startObserver() {
              ...
              const { viewport: t = {} } = this.node.getProps(),
                ...
                o = {
                  ...
                  rootMargin: n,
                  threshold: 'number' == typeof i ? i : ka[i],
                };
...
function La(t, e, n, i) {
  ...
  const c = i - l;
  s.velocity = c > 50 ? 0 : P(s.current - a, c);
}
...
function Wa(t, e, n) {
  ...
  const d = i.length;
  for (let c = 0; c < d; c++) {
    const t = Ia(i[c], u[r], l[r], a[o]);
    (h || t === e[o].interpolatorOffsets[c] || (h = !0), (e[o].offset[c] = t));
  }
  (h &&
    ((e[o].interpolate = ye(e[o].offset, ve(i), { clamp: !1 })),
    (e[o].interpolatorOffsets = [...e[o].offset])),
    (e[o].progress = c(0, 1, e[o].interpolate(e[o].current))));
}
function Na(t, e, n, i = {}) {
  return {
    measure: e => {
...
const $a = new WeakMap(),
  Xa = new WeakMap(),
  Ya = new WeakMap(),
  za = t => (t === document.scrollingElement ? window : t);
function Ha(t, { container: e = document.scrollingElement, ...n } = {}) {
  if (!e) return f;
  let i = Ya.get(e);
  i || ((i = new Set()), Ya.set(e, i));
  const s = Na(
    e,
    t,
    {
  ...
  if ((i.add(s), !$a.has(e))) {
    const t = () => {
        for (const t of i) t.measure(Y.timestamp);
        $.preUpdate(n);
      },
      n = () => {
    ...
    (window.addEventListener('resize', s, { passive: !0 }),
      e !== document.documentElement &&
        Xa.set(e, ((r = s), 'function' == typeof (o = e) ? Ri(o) : Vi(o, r))),
  ...
  return (
    ...
    () => {
      ...
      ($a.delete(e),
        n &&
          (za(e).removeEventListener('scroll', n),
          Xa.get(e)?.(),
...
const Ka = new Map();
function Ga({ source: t, container: e, ...n }) {
  const { axis: i } = n;
  t && (e = t);
  const s = Ka.get(e) ?? new Map();
  Ka.set(e, s);
...
function qa(t, { axis: e = 'y', container: n = document.scrollingElement, ...i } = {}) {
  if (!n) return f;
...
const Za = () => ({
    scrollX: Mn(0),
    scrollY: Mn(0),
    scrollXProgress: Mn(0),
    scrollYProgress: Mn(0),
  }),
  _a = t => !!t && !t.current;
function Ja({ container: t, target: n, ...s } = {}) {
  const r = i(Za),
    a = e.useRef(null),
    l = e.useRef(!1),
    c = e.useCallback(
      () => (
        (a.current = qa(
          ...
          { ...s, container: t?.current || void 0, target: n?.current || void 0 }
        )),
        () => {
          a.current?.();
        }
  ...
  return (
    o(() => ((l.current = !1), _a(t) || _a(n) ? void (l.current = !0) : c()), [c]),
    e.useEffect(() => (l.current ? (_a(t), _a(n), c()) : void 0), [c]),
    r
  );
}
function Qa(t) {
...
function el(t, ...e) {
  const n = t.length;
  return tl(e.filter(jn), function () {
    let i = '';
    for (let s = 0; s < n; s++) {
      i += t[s];
      const n = e[s];
...
function nl(t, e, n, s) {
  if ('function' == typeof t)
    return (function (t) {
      ((An.current = []), t());
      const e = tl(An.current, t);
      return ((An.current = void 0), e);
    })(t);
  if (void 0 !== n && !Array.isArray(n) && 'function' != typeof e)
    return (function (t, e, n, s) {
      const o = i(() => Object.keys(n)),
        r = i(() => ({}));
      for (const i of o) r[i] = nl(t, e, n[i], s);
      return r;
    })(t, e, n, s);
  const o =
    'function' == typeof e
  ...
  return Array.isArray(t) ? il(t, o) : il([t], ([t]) => o(t));
}
function il(t, e) {
  const n = i(() => []);
  return tl(t, () => {
...
export { fr as A, sl as a, Qa as b, el as c, nl as d, Da as m, Ja as u };
