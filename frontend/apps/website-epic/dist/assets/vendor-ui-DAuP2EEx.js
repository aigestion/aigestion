 ...
 */ const a = e.forwardRef(
    (
      ...
      e.createElement(
        'svg',
        {
          ...
          height: o,
          stroke: a,
          strokeWidth: n ? (24 * Number(l)) / Number(o) : l,
          className: t('lucide', s),
          ...c,
        },
        [...d.map(([t, r]) => e.createElement(t, r)), ...(Array.isArray(i) ? i : [i])]
      )
  ),
  o = (r, o) => {
    const l = e.forwardRef(({ className: l, ...n }, s) => {
      return e.createElement(a, {
        ref: s,
        iconNode: o,
        className: t(
          `lucide-${((i = r), i.replace(/([a-z0-9])([A-Z])/g, '$1-$2').toLowerCase())}`,
          l
        ),
        ...n,
      });
  ...
  m = o('Check', [['path', { d: 'M20 6 9 17l-5-5', key: '1gmf2c' }]]),
  k = o('ChevronRight', [['path', { d: 'm9 18 6-6-6-6', key: 'mthhwq' }]]),
  g = o('CircleAlert', [
  ...
  $ = o('LoaderCircle', [['path', { d: 'M21 12a9 9 0 1 1-6.219-8.56', key: '13zald' }]]),
  W = o('Lock', [
  ...
  Y = o('Play', [['polygon', { points: '6 3 20 12 6 21 6 3', key: '1oa8hb' }]]),
  ee = o('PlugZap', [
    [
      'path',
 ...
 */ function Me(e) {
  ...
  if ('string' == typeof e || 'number' == typeof e) a += e;
    ...
    if (Array.isArray(e)) {
      var o = e.length;
      for (t = 0; t < o; t++) e[t] && (r = Me(e[t])) && (a && (a += ' '), (a += r));
    } else for (r in e) e[r] && (a && (a += ' '), (a += r));
  return a;
}
function ze() {
  for (var e, t, r = 0, a = '', o = arguments.length; r < o; r++)
    (e = arguments[r]) && (t = Me(e)) && (a && (a += ' '), (a += t));
  return a;
}
const Ce = e => {
    const t = Le(e),
    ...
    return {
      getClassGroupId: e => {
        const r = e.split('-');
        return ('' === r[0] && 1 !== r.length && r.shift(), je(r, t) || Ae(e));
      },
  ...
  Le = e => {
    ...
    return (
      He(Object.entries(e.classGroups), r).forEach(([e, r]) => {
        Se(r, a, e, t);
      }),
      a
    );
  ...
  Se = (e, t, r, a) => {
    e.forEach(e => {
      if ('string' == typeof e) {
        return void (('' === e ? t : Ne(t, e)).classGroupId = r);
      }
  ...
  Ve = e => {
    ...
    let t = 0,
      ...
      a = new Map();
    const o = (o, l) => {
      (r.set(o, l), t++, t > e && ((t = 0), (a = r), (r = new Map())));
    };
    return {
      get(e) {
        let t = r.get(e);
        return void 0 !== t ? t : void 0 !== (t = a.get(e)) ? (o(e, t), t) : void 0;
      },
      set(e, t) {
  ...
  Pe = e => {
    ...
    return r ? e => r({ className: e, parseClassName: n }) : n;
  },
  Be = e => {
...
function Ie() {
  let e,
    ...
    r = 0,
    a = '';
  for (; r < arguments.length; ) (e = arguments[r++]) && (t = Re(e)) && (a && (a += ' '), (a += t));
  return a;
}
const Re = e => {
  ...
  let t,
    r = '';
  for (let a = 0; a < e.length; a++) e[a] && (t = Re(e[a])) && (r && (r += ' '), (r += t));
  return r;
};
function Ze(e, ...t) {
  let r,
    ...
    o,
    l = function (s) {
      const i = t.reduce((e, t) => t(e), e());
      return (
        (r = (e => ({ cache: Ve(e.cacheSize), parseClassName: Pe(e), ...Ce(e) }))(i)),
        (a = r.cache.get),
        (o = r.cache.set),
        (l = n),
        n(s)
  ...
  function n(e) {
    ...
    if (t) return t;
    const l = ((e, t) => {
      const { parseClassName: r, getClassGroupId: a, getConflictingClassGroupIds: o } = t,
        l = [],
        n = e.trim().split(Ee);
      let s = '';
...
const $e = e => {
  ...
  Je = e => Qe(e) || Te.has(e) || Oe.test(e),
  Ke = e => pt(e, 'length', ht),
  Qe = e => Boolean(e) && !Number.isNaN(Number(e)),
  Ye = e => pt(e, 'number', Qe),
  et = e => Boolean(e) && Number.isInteger(Number(e)),
  tt = e => e.endsWith('%') && Qe(e.slice(0, -1)),
  rt = e => We.test(e),
  at = e => De.test(e),
  ot = new Set(['length', 'size', 'percentage']),
  lt = e => pt(e, ot, yt),
  nt = e => pt(e, 'position', yt),
  ...
  mt = Ze(() => {
    const e = $e('colors'),
      ...
      p = $e('invert'),
      h = $e('gap'),
      y = $e('gradientColorStops'),
      u = $e('gradientColorStopPositions'),
      b = $e('inset'),
      m = $e('margin'),
      k = $e('opacity'),
      g = $e('padding'),
    ...
    return {
      ...
      theme: {
        ...
        gradientColorStopPositions: [tt, Ke],
        inset: C(),
        margin: C(),
        opacity: S(),
        padding: j(),
      ...
      classGroups: {
        ...
        grow: [{ grow: L() }],
        shrink: [{ shrink: L() }],
        order: [{ order: ['first', 'last', 'none', et, rt] }],
        'grid-cols': [{ 'grid-cols': [ct] }],
        'col-start-end': [{ col: ['auto', { span: ['full', et, rt] }, rt] }],
        'col-start': [{ 'col-start': A() }],
        'col-end': [{ 'col-end': A() }],
        'grid-rows': [{ 'grid-rows': [ct] }],
        'row-start-end': [{ row: ['auto', { span: [et, rt] }, rt] }],
        ...
        w: [{ w: ['auto', 'min', 'max', 'fit', 'svw', 'lvw', 'dvw', rt, t] }],
        'min-w': [{ 'min-w': [rt, t, 'min', 'max', 'fit'] }],
        'max-w': [
          { 'max-w': [rt, t, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [at] }, at] },
        ],
        h: [{ h: [rt, t, 'auto', 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
        'min-h': [{ 'min-h': [rt, t, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
        'max-h': [{ 'max-h': [rt, t, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
        size: [{ size: [rt, t, 'auto', 'min', 'max', 'fit'] }],
        'font-size': [{ text: ['base', at, Ke] }],
        ...
        'line-clamp': [{ 'line-clamp': ['none', Qe, Ye] }],
        leading: [{ leading: ['none', 'tight', 'snug', 'normal', 'relaxed', 'loose', Je, rt] }],
        ...
        'text-decoration-thickness': [{ decoration: ['auto', 'from-font', Je, Ke] }],
        'underline-offset': [{ 'underline-offset': ['auto', Je, rt] }],
        ...
        'bg-image': [
          { bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, it] },
        ],
        'bg-color': [{ bg: [e] }],
        ...
        'outline-offset': [{ 'outline-offset': [Je, rt] }],
        'outline-w': [{ outline: [Je, Ke] }],
        'outline-color': [{ outline: [e] }],
        'ring-w': [{ ring: q() }],
        'ring-w-inset': ['ring-inset'],
        'ring-color': [{ ring: [e] }],
        'ring-opacity': [{ 'ring-opacity': [k] }],
        'ring-offset-w': [{ 'ring-offset': [Je, Ke] }],
        'ring-offset-color': [{ 'ring-offset': [e] }],
        shadow: [{ shadow: ['', 'inner', 'none', at, dt] }],
        ...
        contrast: [{ contrast: [i] }],
        'drop-shadow': [{ 'drop-shadow': ['', 'none', at, rt] }],
