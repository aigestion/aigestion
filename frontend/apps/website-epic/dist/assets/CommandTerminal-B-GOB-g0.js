...
const o = () => {
  ...
  (a.useEffect(() => {
    const e = e => {
      (e.ctrlKey && '`' === e.key && (o ? l() : i(), r(e => !e)), 'Escape' === e.key && o && r(!1));
    };
    return (window.addEventListener('keydown', e), () => window.removeEventListener('keydown', e));
  }, [o]),
    a.useEffect(() => {
      o && setTimeout(() => u.current?.focus(), 100);
    }, [o]));
  return e.jsx(n, {
    children:
      o &&
      e.jsx(t.div, {
        ...
        children: e.jsxs('div', {
          ...
          children: [
            e.jsx('div', { className: 'scanline pointer-events-none' }),
            e.jsx('div', {
              className:
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsxs('span', {
                  ...
                  children: [
                    e.jsx('span', { className: 'animate-pulse', children: '\u25cf' }),
            ...
            e.jsx('div', {
              ...
              children: m.map((a, s) =>
                e.jsx(
                  'div',
                  {
                    className: a.startsWith('>') ? 'text-nexus-cyan-glow' : 'text-nexus-silver',
                    children: a,
                  },
                  s
                )
            ...
            e.jsxs('form', {
                ...
                switch (a) {
                  case 'help':
                    s.push(
                      ...
                      '- daniela: Estado del n\xfacleo de voz',
                  ...
                  case 'daniela':
                    s.push(
                      ...
                      'Latencia: 12ms',
                      'Sentimiento: Neutral/Anal\xedtico'
                    );
                    break;
                  case 'status':
                    s.push('NODOS ACTIVOS: 142', 'Carga de Red: 24%', 'Sincronizaci\xf3n: 100%');
                    break;
                  case 'exit':
                    r(!1);
                    break;
              ...
              children: [
                e.jsx('span', { className: 'text-nexus-cyan-glow font-mono', children: '$' }),
                e.jsx('input', {
                  ref: u,
                  type: 'text',
                  value: c,
