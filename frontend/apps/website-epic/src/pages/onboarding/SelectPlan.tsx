...
const plans = [
  {
    ...
    price: '$0',
    period: '/mes',
    description: 'Acceso básico para empezar a organizarte.',
    features: ['Acceso Básico', '5 Ayudas al día', 'Soporte por Chat', 'Espacio para papeles'],
    color: 'nexus-silver',
    icon: Star,
  },
  {
    ...
    price: '$29',
    period: '/mes',
    description: 'Perfecto para autónomos y pequeñas tiendas.',
    features: [
      'Ayudas Ilimitadas',
      'Atención Rápida',
      'Soporte Prioritario',
      'Mucho espacio (50GB)',
      'Funciones Nuevas Primero',
    ],
    color: 'nexus-cyan',
    icon: Zap,
    popular: true,
  },
  {
    ...
    price: '$99',
    period: '/mes',
    description: 'Control absoluto para los que quieren lo mejor.',
    features: [
      'Equipo Dedicado',
      'Ayuda 24/7 para ti',
      'Espacio Ilimitado',
      'Conexión total con tus apps',
      'Consejos Personalizados',
      'Instalación en casa/oficina',
    ],
    color: 'nexus-violet',
    icon: Crown,
  },
