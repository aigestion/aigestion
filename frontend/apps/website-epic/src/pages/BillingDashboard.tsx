  ...
  return (
    <div className="min-h-screen bg-nexus-obsidian pt-24 pb-12 px-6 selection:bg-nexus-cyan/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-orbitron font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-nexus-silver to-white mb-6 drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] animate-gradient-x">
            CENTRO DE{' '}
            <span className="text-nexus-cyan drop-shadow-[0_0_20px_rgba(6,182,212,0.8)]">
              FACTURACIÓN
            </span>
          </h1>
        ...
        <motion.div
          ...
          className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 mb-20 overflow-hidden group"
        >
            ...
            <div>
              <h2 className="text-2xl font-orbitron text-white mb-3 flex items-center gap-4">
                ...
                {snapshot?.hasActiveSubscription ? (
                  <span className="flex items-center gap-2 bg-green-500/10 text-green-400 text-xs px-4 py-1.5 rounded-full border border-green-500/30 shadow-[0_0_15px_rgba(74,222,128,0.2)]">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-20">
            {tiers.map((tier, index) => (
              <motion.div
                ...
                className={`relative p-8 rounded-[2rem] border flex flex-col group overflow-hidden transition-all duration-500 ${
                  tier.popular
              ...
              >
                ...
                <motion.button
                  ...
                  className={`w-full py-4 rounded-xl font-bold transition-all flex items-center justify-center gap-2 relative overflow-hidden group/btn ${
                    tier.popular
                      ? 'bg-nexus-cyan text-black hover:bg-cyan-300'
                ...
                >
                  ...
                  {tier.priceId && !processing && <CreditCard className="w-4 h-4 relative z-10" />}
                </motion.button>
              </motion.div>
            ))}
          </div>
                ...
                <tbody className="divide-y divide-white/5">
                  {snapshot.invoices.map((invoice, idx) => (
                    ...
                    >
                      ...
                      <td className="p-6">
                        <span className="bg-green-500/10 text-green-400 text-[10px] uppercase font-bold px-3 py-1 rounded-full border border-green-500/20 shadow-[0_0_10px_rgba(74,222,128,0.1)]">
                          COMPLETADO
                        </span>
                      </td>
