...
const Card = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const variantClasses = {
      ...
      elevated: ['bg-white/5', 'border', 'border-white/10', 'shadow-lg', 'shadow-black/50'],
    ...
    const hoverClasses = hover
      ? {
          default: ['hover:shadow-md', 'hover:border-white/20'],
          elevated: ['hover:shadow-xl', 'hover:shadow-black/60'],
          outlined: ['hover:border-white/40', 'hover:bg-white/5'],
