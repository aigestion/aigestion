        ...
        <section className="py-32 bg-nexus-obsidian text-white text-center relative overflow-hidden">
            ...
            <div className="flex flex-col items-center justify-center space-y-16 relative z-10">
                ...
                >
                    ...
                    <div className="relative premium-glass p-6 rounded-full border-nexus-violet-glow/20 shadow-[0_0_60px_rgba(138,43,226,0.3)] hover:border-nexus-violet-glow/50 transition-all duration-700">
                        <DanielaAvatar
                            size="xl"
