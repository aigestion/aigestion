...
export const ROICalculator: React.FC = () => {
  ...
  return (
    <section
      className="py-32 bg-nexus-obsidian text-white relative overflow-hidden"
      id="roi-calculator"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-nexus-silver/60 text-lg mb-12 font-light max-w-xl">
              ...
              escalar tu facturación de forma exponencial.
            </p>
          ...
          <div className="premium-glass p-12 rounded-[2.5rem] border-white/5 relative bg-linear-to-br from-white/2 to-transparent">
            ...
            <div className="space-y-12">
              <div>
                <span className="text-[10px] font-orbitron tracking-[0.4em] text-nexus-cyan-glow uppercase block mb-2">
                  Impacto Total Estimado
                </span>
                <div className="text-6xl font-orbitron font-black text-white text-glow">
                  ${totalImpact.toLocaleString()}
                  <span className="text-xs text-nexus-silver/40 font-normal tracking-normal ml-3">
                    /mes
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/5">
                <div>
                  <span className="text-[9px] font-orbitron tracking-[0.3em] text-nexus-silver/40 uppercase block mb-2">
                    Ahorro Operativo
                  </span>
                  <div className="text-2xl font-orbitron font-bold text-nexus-cyan-glow">+70%</div>
                  <span className="text-[10px] text-nexus-silver/30 font-mono mt-1 block">
                    (-${aiSavings.toLocaleString()})
                  </span>
                </div>
                <div>
                  <span className="text-[9px] font-orbitron tracking-[0.3em] text-nexus-silver/40 uppercase block mb-2">
                  ...
                  <span className="text-[10px] text-nexus-silver/30 font-mono mt-1 block">
                    (+${efficiencyBoost.toLocaleString()})
                  </span>
                </div>
              </div>
