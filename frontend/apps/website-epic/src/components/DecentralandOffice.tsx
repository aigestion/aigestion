...
import { ExternalLink, Users, MapPin, Box, Wifi, Shield } from 'lucide-react';
    ...
    return (
        <div className="relative min-h-screen bg-nexus-obsidian overflow-hidden flex items-center justify-center p-6">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute inset-0 bg-[url('/images/nexus/grid.png')] opacity-20 bg-repeat" />
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-xs font-orbitron tracking-[0.3em] font-bold text-nexus-violet-glow uppercase">Metaverso Corporativo</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors group">
                                ...
                                <span className="text-xs text-gray-500 uppercase tracking-wider">Coordenadas DCL</span>
                            </div>
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors group">
                                ...
                                <span className="text-xs text-gray-500 uppercase tracking-wider">Usuarios Online</span>
                            </div>
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors group">
                                ...
                                <span className="text-xs text-gray-500 uppercase tracking-wider">Ancho de Banda Neural</span>
                            </div>
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors group">
                                ...
                                <span className="text-xs text-gray-500 uppercase tracking-wider">Seguridad Perimetral</span>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className={`absolute inset-0 z-20 pointer-events-none transition-opacity duration-500 ${isHovering ? 'opacity-0' : 'opacity-100'}`}>
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/40 backdrop-blur-md border border-white/10 px-6 py-3 rounded-full flex items-center gap-3">
                                ...
                                <span className="text-white/80 text-xs font-bold uppercase tracking-widest">Arrastra para explorar 3D</span>
                            </div>
                        </div>
