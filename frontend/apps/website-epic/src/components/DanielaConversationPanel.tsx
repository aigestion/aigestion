            ...
            <div className="flex items-center gap-3">
                <div className="relative">
                    <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-nexus-cyan">
                        <img src="/images/daniela-avatar.jpg" alt="Daniela" className="w-full h-full object-cover" onError={(e) => e.currentTarget.src = 'https://ui-avatars.com/api/?name=Daniela+AI&background=00f5ff&color=fff'} />
                    </div>
            ...
            <div className="flex gap-2">
                {isSpeaking && (
                    <div className="flex gap-1 h-3 items-end">
                        <motion.div className="w-1 bg-nexus-cyan" animate={{ height: [4, 12, 4] }} transition={{ repeat: Infinity, duration: 0.5 }} />
                        <motion.div className="w-1 bg-nexus-cyan" animate={{ height: [6, 10, 2] }} transition={{ repeat: Infinity, duration: 0.4 }} />
                        <motion.div className="w-1 bg-nexus-cyan" animate={{ height: [2, 8, 3] }} transition={{ repeat: Infinity, duration: 0.6 }} />
                    </div>
                )}
            </div>
        </div>
