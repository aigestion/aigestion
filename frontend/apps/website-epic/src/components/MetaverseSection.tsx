        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-orbitron font-black text-white mb-6 tracking-tight">
              ARQUITECTURA <span className="kinetic-text bg-linear-to-r from-nexus-cyan to-nexus-violet bg-clip-text text-transparent">PERSISTENTE</span>
            </h2>
            <p className="text-xl text-nexus-silver/60 max-w-2xl mx-auto font-light leading-relaxed">
              ...
              Nexo de conexión entre el mundo físico y el <span className="text-white border-b border-nexus-cyan/30">espacio sintético</span>.
            </p>
          </motion.div>
          ...
          {activeTab === 'hq' ? (
            ...
            >
              ...
              <div className="relative group perspective-1000">
                ...
                <NexusCard variant="cyan" glow className="relative p-1 overflow-hidden" padding="none">
                  <div className="relative aspect-video overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <motion.div
                        ...
                        animate={{
                          ...
                          boxShadow: ['0 0 20px rgba(0,245,255,0.1)', '0 0 50px rgba(0,245,255,0.3)', '0 0 20px rgba(0,245,255,0.1)']
                        }}
                    ...
                    <div className="absolute bottom-6 left-6 z-20">
                      <div className="flex flex-col gap-2">
                         <NexusStatusBadge status="online" label="STITCH BRIDGE ACTIVE" size="sm" />
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-4xl font-orbitron font-black mb-6 tracking-tight">SEDE CENTRAL <span className="text-nexus-cyan">STITCH</span></h3>
                  <p className="text-nexus-silver/70 leading-relaxed text-lg font-light">
                    Nuestra flagship office en Decentraland funciona como el nexo principal del ecosistema. Un espacio diseñado para reuniones inmersivas de alta fidelidad y gobernanza descentralizada.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-4 glass-premium rounded-xl border-white/5 hover:border-nexus-cyan/20 transition-all">
                      <div className="flex items-center gap-3">
                        <div className="w-1.5 h-1.5 bg-nexus-cyan rounded-full shadow-[0_0_8px_rgba(0,245,255,0.8)]" />
                        <span className="text-sm font-orbitron tracking-wider text-white/80">{item.label}</span>
                      </div>
                      <span className="text-[10px] font-mono text-nexus-cyan/60 tracking-widest">{item.status}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <NexusCard variant="violet" glow className="p-10 group overflow-hidden relative">
                    ...
                    <h4 className="text-2xl font-orbitron font-black mb-2 tracking-tight group-hover:text-nexus-violet-glow transition-colors">ALQUILER DE ESPACIO</h4>
                    <p className="text-sm text-nexus-silver/50 mb-8 h-12 leading-relaxed">
                      Parcelas premium en distritos comerciales de alto tráfico. Listas para despliegue inmediato con conectividad multiversal.
                    </p>
                    ...
                    <div className="space-y-6 mb-10 relative z-10">
                      <div className="flex justify-between items-baseline border-b border-white/5 pb-4 group-hover:border-nexus-violet/20 transition-colors">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-mono text-white/30 ml-1 uppercase">/mes</span>
                        </div>
                      </div>
                      <div className="flex justify-between items-baseline border-b border-white/5 pb-4 group-hover:border-nexus-violet/20 transition-colors">
                  ...
                  <NexusCard variant="cyan" glow className="p-10 group overflow-hidden relative">
                    ...
                    <h4 className="text-2xl font-orbitron font-black mb-2 tracking-tight group-hover:text-nexus-cyan-glow transition-colors">ARQUITECTURA NEXUS</h4>
                    <p className="text-sm text-nexus-silver/50 mb-8 h-12 leading-relaxed">
                      Ingeniería y diseño de activos digitales persistentes, showrooms y experiencias multimodales para la marca.
                    </p>
                    ...
                    <div className="space-y-6 mb-10 relative z-10">
                      ...
                      <div className="flex justify-between items-baseline border-b border-white/5 pb-4 group-hover:border-nexus-cyan/20 transition-colors">
                        ...
                        <span className="text-[10px] font-mono text-nexus-cyan/60 tracking-[0.2em] uppercase">CUSTOM QUOTE</span>
                      </div>
                    </div>
