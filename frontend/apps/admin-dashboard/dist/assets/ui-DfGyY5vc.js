import { r as S } from './vendor-DjL-6nTd.js';
var Es = { exports: {} },
  Xt = {};
/**
 * @license React
 ...
 */ var vr = S,
  ...
  wr = vr.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function Rs(t, e, n) {
  ...
  for (s in e) Sr.call(e, s) && !Pr.hasOwnProperty(s) && (i[s] = e[s]);
  if (t && t.defaultProps) for (s in ((e = t.defaultProps), e)) i[s] === void 0 && (i[s] = e[s]);
  return { $$typeof: xr, type: t, key: o, ref: r, props: i, _owner: wr.current };
}
Xt.Fragment = Tr;
Xt.jsx = Rs;
Xt.jsxs = Rs;
Es.exports = Xt;
var me = Es.exports;
const ks = S.createContext({});
function Ar(t) {
  const e = S.useRef(null);
  return (e.current === null && (e.current = t()), e.current);
}
const Ls = typeof window < 'u',
  br = Ls ? S.useLayoutEffect : S.useEffect,
...
function Xs(t, e) {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    p = () => {
      ...
      ((n = !1),
        X.useManualTiming || (i.delta = s ? 1e3 / 60 : Math.max(Math.min(v - i.timestamp, Br), 1)),
        (i.timestamp = v),
        (i.isProcessing = !0),
        a.process(i),
        l.process(i),
  ...
  return {
    schedule: Ft.reduce((v, A) => {
      const w = r[A];
      return ((v[A] = (b, E = !1, P = !1) => (n || x(), w.schedule(b, E, P))), v);
    }, {}),
    cancel: v => {
      for (let A = 0; A < Ft.length; A++) r[Ft[A]].cancel(v);
    },
    state: i,
    steps: r,
  };
...
const I = {
    now: () => (
      Ot === void 0 && I.set(L.isProcessing || X.useManualTiming ? L.timestamp : performance.now()),
      Ot
    ),
    set: t => {
...
function ei(t) {
  ...
  return i => {
    ...
    for (let r = 0; r < s; r++)
      if (((o += e[r]), i[r] !== void 0)) {
        const a = n[r];
        a === Js ? (o += St(i[r])) : a === Qs ? (o += D.transform(i[r])) : (o += i[r]);
      }
    return o;
  };
}
...
function uo({
  ...
  const a = 5 / t,
    l = fo(i, o, a);
  if (((t = z(t)), isNaN(l))) return { stiffness: M.stiffness, damping: M.damping, duration: t };
  {
...
function $t(t = M.visualDuration, e = M.bounce) {
  ...
  if (p < 1) {
    ...
    v = b => {
      ...
      return r - E * (((m + p * g * x) / w) * Math.sin(w * b) + x * Math.cos(w * b));
    };
  } else if (p === 1) v = w => r - Math.exp(-g * w) * (x + (m + g * x) * w);
  else {
    const w = g * Math.sqrt(p * p - 1);
    v = b => {
      const E = Math.exp(-p * g * b),
        P = Math.min(w * b, 300);
      return r - (E * ((m + p * g * x) * Math.sinh(P) + w * x * Math.cosh(P))) / w;
    };
  }
  const A = {
    ...
    toString: () => {
      const w = Math.min(Ye(A), Kt),
        b = ii(E => A.next(w * E).value, w, 30);
      return w + 'ms ' + b;
    },
    toTransition: () => {},
  };
  ...
  return (
    E(0),
    {
      ...
      next: P => {
        let O = !1;
        return (
          !b && w === void 0 && ((O = !0), A(P), E(P)),
          w !== void 0 && P >= w ? b.next(P - w) : (!O && A(P), f)
        );
      },
    }
  );
...
function wt({ duration: t = 300, keyframes: e, times: n, ease: s = 'easeInOut' }) {
  const i = kr(s) ? s.map(yn) : yn(s),
    o = { done: !1, value: e[0] },
    r = So(n && n.length === e.length ? n : To(e), t),
    a = vo(r, e, { ease: Array.isArray(i) ? i : wo(e, i) });
...
const Ao = { decay: ve, inertia: ve, tween: wt, keyframes: wt, spring: $t };
function oi(t) {
...
class Je extends Ze {
  constructor(e) {
    (super(),
      ...
      (this.stop = () => {
        ...
        (n && n.updatedAt !== I.now() && this.tick(I.now()),
          (this.isStopped = !0),
          this.state !== 'idle' &&
  ...
  initAnimation() {
    ...
    oi(e);
    const { type: n = wt, repeat: s = 0, repeatDelay: i = 0, repeatType: o, velocity: r = 0 } = e;
    let { keyframes: a } = e;
    const l = n || wt;
    l !== wt &&
      typeof a[0] != 'number' &&
  ...
  tick(e, n = !1) {
    ...
    const w = T ? { done: !1, value: c[0] } : A.next(v);
    o && (w.value = o(w.value));
    let { done: b } = w;
    !T &&
      l !== null &&
    ...
    return (
      E && m !== ve && (w.value = qe(c, this.options, x, this.speed)),
      p && p(w.value),
      E && this.finish(),
      w
    );
...
const Z = {
  ...
  x: (t, { transform: e }) => we(e, 'x'),
  y: (t, { transform: e }) => we(e, 'y'),
};
Z.translateX = Z.x;
Z.translateY = Z.y;
const ot = new Set();
...
const Io = t => t.startsWith('--');
function Bo(t, e, n) {
  Io(e) ? t.style.setProperty(e, n) : (t.style[e] = n);
}
    ...
    ((this.animation = Uo(n, s, i, u, o)),
      ...
      (this.animation.onfinish = () => {
        if (((this.finishedTime = this.time), !o)) {
          ...
          (this.updateMotionValue ? this.updateMotionValue(c) : Bo(n, s, c),
...
class Go extends Ko {
  ...
  updateMotionValue(e) {
    ...
    const a = new Je({ ...r, autoplay: !1 }),
      l = Math.max(se, I.now() - this.startTime),
      u = H(0, se, l - se);
...
class Jo extends Ze {
  ...
  onKeyframesResolved(e, n, s, i) {
    ...
    ((this.resolvedAt = I.now()),
      zo(e, o, r, a) ||
        ((X.instantAnimations || !l) && (c == null || c(qe(e, s, n))),
        (e[0] = e[e.length - 1]),
        Ve(s),
        (s.repeat = 0)));
    const f = {
  ...
  get animation() {
    var e;
    return (
      this._animation || ((e = this.keyframeResolver) == null || e.resume(), Fo()),
      this._animation
    );
  }
  get duration() {
...
const en =
    ...
    r => {
      ...
      (oa(a) || Object.assign(c, ra(t, c)),
        c.duration && (c.duration = z(c.duration)),
        c.repeatDelay && (c.repeatDelay = z(c.repeatDelay)),
        c.from !== void 0 && (c.keyframes[0] = c.from));
      let h = !1;
      if (
        ((c.type === !1 || (c.duration === 0 && !c.repeatDelay)) &&
          (Ve(c), c.delay === 0 && (h = !0)),
        (X.instantAnimations || X.skipAnimations) && ((h = !0), Ve(c), (c.delay = 0)),
...
function Ca(t, e, n) {
  ...
  if (i && n) for (const o of e) t[o] = wi(n, i);
}
class Ma extends Qe {
...
function ka(t, e, n = {}) {
  const [s, i, o] = bi(t, n),
    r = a => {
      ...
      const c = h => {
        Fn(h) && (u(h), l.removeEventListener('pointerleave', c));
      };
      ...
      const u = e(l, a),
        c = (d, m) => {
          (window.removeEventListener('pointerup', h),
            ...
            Bn(d) && typeof u == 'function' && u(d, { success: m }));
        },
        h = d => {
  ...
  return (
    s.forEach(a => {
      ((n.useGlobalTarget ? window : a).addEventListener('pointerdown', r, i),
        Ea(a) &&
          (a.addEventListener('focus', u => Fa(u, i)),
...
function Ka(t, e, n) {
  for (const s in e) {
    ...
    else if (F(o)) t.addValue(s, mt(i, { owner: t }));
    else if (o !== i)
      if (t.hasValue(s)) {
...
class _a {
  ...
  readValue(e, n) {
    ...
    return (
      s != null &&
        (typeof s == 'string' && (Fs(s) || Bs(s))
          ? (s = parseFloat(s))
          : !ja(s) && Q.test(n) && (s = wi(e, n)),
...
function st(t) {
  return ke(t) || Fi(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY;
}
function Fi(t) {
...
function ji(t, { layout: e, layoutId: n }) {
  return (
    yt.has(t) || t.startsWith('origin') || ((e || n !== void 0) && (!!Fe[t] || t === 'opacity'))
  );
}
function hn(t, e, n) {
  var r;
...
class tl extends ki {
  ...
  readValueFromInstance(e, n) {
    var s;
    if (yt.has(n)) return (s = this.projection) != null && s.isProjecting ? Se(n) : Do(e, n);
    {
      const i = Qa(e),
  ...
  function r(l) {
    ...
    for (let x = 0; x < cl; x++) {
      const g = ll[x],
        ...
        A = Mt(v),
        w = g === l ? T.isActive : null;
      w === !1 && (m = x);
      let b = v === c[g] && v !== u[g] && A;
      if (
        (b && s && t.manuallyAnimateOnMount && (b = !1),
        (T.protectedKeys = { ...d }),
        (!T.isActive && w === null) || (!v && !T.prevProp) || Yt(v) || typeof v == 'boolean')
      )
        continue;
...
function Jn(t, e, n, s) {
  (Zn(t.x, e, Tl, n ? n.x : void 0, s ? s.x : void 0),
    Zn(t.y, e, Sl, n ? n.y : void 0, s ? s.y : void 0));
}
function Qn(t, e) {
...
function Ji({
  ...
  return class {
    ...
    mount(r) {
      ...
      ((this.isSVG = Mi(r) && !Ba(r)), (this.instance = r));
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || ke(this.parent.latestValues) || Fi(this.parent.latestValues)))
      ...
      ((this.mixTargetDelta = A => {
        ...
        (fs(h.x, r.x, w),
          ...
          this.relativeTarget &&
            ...
            Gl(this.relativeTarget, this.relativeTargetOrigin, f, w),
            v && wl(this.relativeTarget, v) && (this.isProjectionDirty = !1),
            v || (v = R()),
            $(v, this.relativeTarget)),
          p && ((this.animationValues = c), bl(c, u, this.latestValues, w, T, g)),
    ...
    applyProjectionStyles(r, a) {
      ...
      for (const m in Fe) {
        ...
        const { correct: p, applyTo: x, isCSSVariable: g } = Fe[m],
...
const ql = Ji({
  ...
  er = S.createContext({ transformPagePoint: t => t, isStatic: !1, reducedMotion: 'never' });
function Zl(t = !0) {
  const e = S.useContext(Oe);
...
const nr = S.createContext({ strict: !1 }),
  ys = {
    animation: [
      'animate',
      'variants',
...
function ic(t) {
  const { initial: e, animate: n } = sc(t, S.useContext(Zt));
...
function yc(t, e, n, s, i, o) {
  var x, g;
  const { visualElement: r } = S.useContext(Zt),
    a = S.useContext(nr),
    l = S.useContext(Oe),
    u = S.useContext(er).reducedMotion,
    c = S.useRef(null);
  ((s = s || a.renderer),
    !c.current &&
      s &&
...
function ce(t, { forwardMotionProps: e = !1, type: n } = {}, s, i) {
  ...
  function a(u, c) {
    let h;
    const f = { ...S.useContext(er), ...u, layoutId: xc(u) },
      { isStatic: d } = f,
      m = ic(u),
      p = r(u, d);
    if (!d && Ls) {
...
function xc({ layoutId: t }) {
  const e = S.useContext(ks).id;
  return e && t !== void 0 ? e + '-' + t : t;
}
function Tc(t, e) {
  S.useContext(nr).strict;
}
function Sc(t) {
  const e = sr(),
    { drag: n, layout: s } = e;
...
const Pc = (t, e) =>
  (e.isSVG ?? dn(t)) ? new ol(e) : new tl(e, { allowProjection: t !== S.Fragment });
class Ac extends tt {
  constructor(e) {
...
class hr {
  ...
  startScrollTracking(e) {
    ...
    for (; n; ) {
      ...
      ((Ss.has(s.overflowX) || Ss.has(s.overflowY)) &&
...
function he({ point: t }, e) {
  return { point: t, delta: ws(t, fr(e)), offset: ws(t, Ec(e)), velocity: Rc(e, 0.1) };
}
function Ec(t) {
  return t[0];
}
      ...
      i !== this.constraints &&
        ...
        U(r => {
          this.constraints !== !1 &&
            ...
            (this.constraints[r] = Bc(s.layoutBox[r], this.constraints[r]));
        }));
  }
  ...
  scalePositionWithinConstraints() {
    ...
    U(r => {
      ...
      if (a && this.constraints !== !1) {
        const l = a.get();
        i[r] = Ic({ min: l, max: l }, this.constraints[r]);
      }
    });
...
function dr(t) {
  ...
  return me.jsx($c, {
    ...t,
    layoutGroup: s,
    switchLayoutGroup: S.useContext(lr),
    isPresent: e,
    safeToRemove: n,
  });
}
 ...
 */ const ou = S.forwardRef(
  (
    ...
    S.createElement(
      ...
      [...r.map(([u, c]) => S.createElement(u, c)), ...(Array.isArray(o) ? o : [o])]
    )
);
/**
 * @license lucide-react v0.468.0 - ISC
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ const Y = (t, e) => {
  const n = S.forwardRef(({ className: s, ...i }, o) =>
    S.createElement(ou, { ref: o, iconNode: e, className: pr(`lucide-${iu(t)}`, s), ...i })
  );
...
//# sourceMappingURL=ui-DfGyY5vc.js.map
