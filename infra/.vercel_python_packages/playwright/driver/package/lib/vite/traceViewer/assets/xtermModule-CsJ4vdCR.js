                      ...
                      function (e, t, o, f) {
                        ...
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          ...
                          for (var m = e.length - 1; m >= 0; m--)
                            (u = e[m]) && (c = (p < 3 ? u(c) : p > 3 ? u(t, o, c) : u(t, o)) || c);
                  ...
                  let s = (r.AccessibilityManager = class extends v.Disposable {
                    constructor(e, t, o, f) {
                      ...
                      if (
                        ...
                        (this._bottomBoundaryFocusListener = u => this._handleBoundaryFocus(u, 1)),
...
` &&
                    ...
                    _renderRows(e, t) {
                      ...
                      for (let u = e; u <= t; u++) {
                        const p = o.lines.get(o.ydisp + u),
                          c = [],
                          m =
                            (p == null ? void 0 : p.translateToString(!0, void 0, void 0, c)) || '',
                          y = (o.ydisp + u + 1).toString(),
                          k = this._rowElements[u];
                        k &&
                          (m.length === 0
                            ? ((k.innerText = ' '), this._rowColumns.set(k, [0, 1]))
                            : ((k.textContent = m), this._rowColumns.set(k, c)),
                          k.setAttribute('aria-posinset', y),
                    ...
                    _handleSelectionChange() {
                      ...
                      if (
                        (o.node.compareDocumentPosition(f) &
                          ...
                          (o = {
                            node: f,
                            offset: ((m = f.textContent) == null ? void 0 : m.length) ?? 0,
                          }),
                      ...
                      const u = ({ node: y, offset: k }) => {
                          ...
                          let w =
                            parseInt(L == null ? void 0 : L.getAttribute('aria-posinset'), 10) - 1;
                          if (isNaN(w))
                ...
                3551: function (O, r, a) {
                  ...
                  let i = (r.Linkifier = class extends v.Disposable {
                        ...
                        this.register(
                          (0, v.toDisposable)(() => {
                            ...
                            ((this._lastMouseEvent = void 0),
                              (u = this._activeProviderReplies) == null || u.clear());
                          })
                        ),
                        this.register(
                      ...
                      for (const [u, p] of this._linkProviderService.linkProviders.entries())
                        e
                          ? (f = this._activeProviderReplies) != null &&
                            f.get(u) &&
                            (t = this._checkLinkProviderResult(u, s, t))
                          : p.provideLinks(s.y, c => {
                              var y, k;
                              if (this._isMouseOut) return;
                              const m = c == null ? void 0 : c.map(L => ({ link: L }));
                              ((y = this._activeProviderReplies) == null || y.set(u, m),
                                (t = this._checkLinkProviderResult(u, s, t)),
                                ((k = this._activeProviderReplies) == null ? void 0 : k.size) ===
                    ...
                    _checkLinkProviderResult(s, e, t) {
                      ...
                      let f = !1;
                      for (let p = 0; p < s; p++)
                        (this._activeProviderReplies.has(p) &&
                          !this._activeProviderReplies.get(p)) ||
                          (f = !0);
                      if (!f && o) {
                      ...
                      if (
                        ...
                        for (let p = 0; p < this._activeProviderReplies.size; p++) {
                          const c =
                            (u = this._activeProviderReplies.get(p)) == null
                              ? void 0
                              : u.find(m => this._linkAtPosition(m.link, e));
                          if (c) {
                      ...
                      e &&
                        ...
                        Object.defineProperties(s.link.decorations, {
                          pointerCursor: {
                            get: () => {
                              var t, o;
                              return (o = (t = this._currentLink) == null ? void 0 : t.state) ==
                                null
                                ? void 0
                          ...
                          underline: {
                            ...
                            set: t => {
                              ...
                              (o = this._currentLink) != null &&
                                o.state &&
                                ((u = (f = this._currentLink) == null ? void 0 : f.state) == null
                                  ? void 0
                        ...
                        this._linkCacheDisposables.push(
                          this._renderService.onRenderedViewportChange(t => {
                            ...
                            if (
                              this._currentLink.link.range.start.y >= o &&
                              this._currentLink.link.range.end.y <= f &&
                              (this._clearCurrentLink(o, f), this._lastMouseEvent)
                            ) {
                    ...
                    _linkAtPosition(s, e) {
                      const t = s.range.start.y * this._bufferService.cols + s.range.start.x,
                        o = s.range.end.y * this._bufferService.cols + s.range.end.x,
                    ...
                    _createLinkUnderlineEvent(s, e, t, o, f) {
                      return { x1: s, y1: e, x2: t, y2: o, cols: this._bufferService.cols, fg: f };
                    }
                  });
                  r.Linkifier = i = l(
                    [
                      ...
                      function (h, i, s, e) {
                        ...
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          ...
                          for (var u = h.length - 1; u >= 0; u--)
                            (t = h[u]) && (f = (o < 3 ? t(f) : o > 3 ? t(i, s, f) : t(i, s)) || f);
                        return (o > 3 && f && Object.defineProperty(i, s, f), f);
                      },
                    _ =
                      (this && this.__param) ||
                      function (h, i) {
                    ...
                    provideLinks(h, i) {
                      ...
                      for (let y = 0; y < f; y++)
                        if (p !== -1 || s.hasContent(y)) {
                          ...
                          if (c || (p !== -1 && y === f - 1)) {
                            const k =
                              (m = this._oscLinkService.getLinkData(u)) == null ? void 0 : m.uri;
                            if (k) {
                              const L = {
                                start: { x: p + 1, y: h },
                                end: { x: y + (c || y !== f - 1 ? 0 : 1), y: h },
                              };
                              let w = !1;
                              if (!(t != null && t.allowNonHttpProtocols))
                                try {
                                  const x = new URL(k);
                                  ['http:', 'https:'].includes(x.protocol) || (w = !0);
                                } catch {
                                  w = !0;
                                }
                              w ||
                                e.push({
                                  text: k,
                                  range: L,
                                  activate: (x, B) => (t ? t.activate(x, B, L) : g(0, B)),
                                  hover: (x, B) => {
                                    var P;
                                    return (P = t == null ? void 0 : t.hover) == null
                                      ? void 0
                                      : P.call(t, x, B, L);
                                  },
                                  leave: (x, B) => {
                                    var P;
                                    return (P = t == null ? void 0 : t.leave) == null
                                      ? void 0
                                      : P.call(t, x, B, L);
                                  },
                                });
...
WARNING: This link could potentially be dangerous`)
                    ...
                    (r.RenderDebouncer = class {
                      ...
                      refresh(a, l, _) {
                        ((this._rowCount = _),
                          ...
                          (this._rowStart =
                            this._rowStart !== void 0 ? Math.min(this._rowStart, a) : a),
                  ...
                  class N extends L.CoreTerminal {
                    ...
                    constructor(R = {}) {
                      (super(R),
                        ...
                        this.register(
                          this._inputHandler.onRequestRefreshRows((C, M) => this.refresh(C, M))
                        ),
                        this.register(
                        ...
                        this.register(
                          (0, x.toDisposable)(() => {
                            ...
                            ((this._customKeyEventHandler = void 0),
                              (M = (C = this.element) == null ? void 0 : C.parentNode) == null ||
                            ...
                            case 0:
                              const W = k.color.toColorRGB(
                                M === 'ansi'
                                  ...
                                  : this._themeService.colors[M]
                              );
                              this.coreService.triggerDataEvent(
                                `${U.C0.ESC}]${A};${(0, S.toRgbString)(W)}${U.C1_ESCAPED.ST}`
                              );
                              break;
                            case 1:
                              if (M === 'ansi')
                    ...
                    _handleScreenReaderModeOptionChange(R) {
                      R
                        ? !this._accessibilityManager.value &&
                          this._renderService &&
                          (this._accessibilityManager.value =
                            this._instantiationService.createInstance(T.AccessibilityManager, this))
                    ...
                    _syncTextArea() {
                      ...
                      if (!C) return;
                      const M = Math.min(this.buffer.x, this.cols - 1),
                        A = this._renderService.dimensions.css.cell.height,
                        W = C.getWidth(M),
                        F = this._renderService.dimensions.css.cell.width * W,
                        z = this.buffer.y * this._renderService.dimensions.css.cell.height,
                        q = M * this._renderService.dimensions.css.cell.width;
                      ((this.textarea.style.left = q + 'px'),
                        (this.textarea.style.top = z + 'px'),
                        (this.textarea.style.width = F + 'px'),
                        (this.textarea.style.height = A + 'px'),
                        (this.textarea.style.lineHeight = A + 'px'),
                    ...
                    open(R) {
                      ...
                      if (
                        ...
                        ((M = this.element) == null ? void 0 : M.ownerDocument.defaultView) &&
                      ...
                      ((this._viewportElement = this._document.createElement('div')),
                        ...
                        B.isChromeOS || this.textarea.setAttribute('aria-multiline', 'false'),
                        ...
                        this.register(
                          this._renderService.onRenderedViewportChange(A => this._onRender.fire(A))
                        ),
                    ...
                    bindMouse() {
                      ...
                      const A = { mouseup: null, wheel: null, mousedrag: null, mousemove: null },
                        W = {
                          mouseup: F => (
                            M(F),
                            F.buttons ||
                              (this._document.removeEventListener('mouseup', A.mouseup),
                              A.mousedrag &&
                                this._document.removeEventListener('mousemove', A.mousedrag)),
                            this.cancel(F)
                          ),
                          wheel: F => (M(F), this.cancel(F, !0)),
                          mousedrag: F => {
                            F.buttons && M(F);
                          },
                          mousemove: F => {
                          ...
                          (F
                            ...
                            8 & F
                              ? A.mousemove ||
                                ...
                                (A.mousemove = W.mousemove))
                              : (C.removeEventListener('mousemove', A.mousemove),
                                (A.mousemove = null)),
                            16 & F
                              ? A.wheel ||
                                (C.addEventListener('wheel', W.wheel, { passive: !1 }),
                                (A.wheel = W.wheel))
                              : (C.removeEventListener('wheel', A.wheel), (A.wheel = null)),
                            2 & F
                              ? A.mouseup || (A.mouseup = W.mouseup)
                              : (this._document.removeEventListener('mouseup', A.mouseup),
                                (A.mouseup = null)),
                            4 & F
                              ? A.mousedrag || (A.mousedrag = W.mousedrag)
                              : (this._document.removeEventListener('mousemove', A.mousedrag),
                                (A.mousedrag = null)));
                        })
                      ),
                        ...
                        this.register(
                          (0, _.addDisposableDomListener)(C, 'mousedown', F => {
                            if (
                              ...
                              return (
                                M(F),
                                A.mouseup && this._document.addEventListener('mouseup', A.mouseup),
                                A.mousedrag &&
                                  this._document.addEventListener('mousemove', A.mousedrag),
                                this.cancel(F)
                              );
                          })
                        ),
                    ...
                    updateCursorStyle(R) {
                      var C;
                      (C = this._selectionService) != null && C.shouldColumnSelect(R)
                    ...
                    scrollLines(R, C, M = 0) {
                      var A;
                      M === 1
                        ? (super.scrollLines(R, C, M), this.refresh(0, this.rows - 1))
                        : (A = this.viewport) == null || A.scrollLines(R);
                    }
                    paste(R) {
                    ...
                    _keyDown(R) {
                      ...
                      const M = (0, I.evaluateKeyboardEvent)(
                        R,
                        this.coreService.decPrivateModes.applicationCursorKeys,
                        this.browser.isMac,
                      ...
                      if ((this.updateCursorStyle(R), M.type === 3 || M.type === 2)) {
                        const A = this.rows - 1;
                        return (this.scrollLines(M.type === 2 ? -A : A), this.cancel(R, !0));
                      }
                      return (
                        M.type === 1 && this.selectAll(),
                        !!this._isThirdLevelShift(this.browser, R) ||
                          (M.cancel && this.cancel(R, !0),
                          !M.key ||
                            !!(
                              R.key &&
                              !R.ctrlKey &&
                            ...
                            (this._unprocessedDeadKey
                              ...
                              : ((M.key !== U.C0.ETX && M.key !== U.C0.CR) ||
                                  (this.textarea.value = ''),
                                this._onKey.fire({ key: M.key, domEvent: R }),
                                this._showCursor(),
                                this.coreService.triggerDataEvent(M.key, !0),
                    ...
                    _afterResize(R, C) {
                      var M, A;
                      ((M = this._charSizeService) == null || M.measure(),
                        (A = this.viewport) == null || A.syncScrollArea(!0));
                    }
                    clear() {
                      var R;
                      if (this.buffer.ybase !== 0 || this.buffer.y !== 0) {
                        ...
                        for (let C = 1; C < this.rows; C++)
                          this.buffer.lines.push(this.buffer.getBlankLine(P.DEFAULT_ATTR_DATA));
                        (this._onScroll.fire({ position: this.buffer.ydisp, source: 0 }),
                          (R = this.viewport) == null || R.reset(),
                          this.refresh(0, this.rows - 1));
                      }
                    }
                    reset() {
                    ...
                    _reportFocus() {
                      var R;
                      (R = this.element) != null && R.classList.contains('focus')
                        ? this.coreService.triggerDataEvent(U.C0.ESC + '[I')
                        : this.coreService.triggerDataEvent(U.C0.ESC + '[O');
                    }
                        ...
                        switch (R) {
                          case D.WindowsOptionsReportType.GET_WIN_SIZE_PIXELS:
                            const C = this._renderService.dimensions.css.canvas.width.toFixed(0),
                              M = this._renderService.dimensions.css.canvas.height.toFixed(0);
                            this.coreService.triggerDataEvent(`${U.C0.ESC}[4;${M};${C}t`);
                            break;
                          case D.WindowsOptionsReportType.GET_CELL_SIZE_PIXELS:
                            const A = this._renderService.dimensions.css.cell.width.toFixed(0),
                  ...
                  let i = (r.Viewport = class extends g.Disposable {
                    constructor(s, e, t, o, f, u, p, c) {
                      (super(),
                        ...
                        this.register(
                          this._renderService.onDimensionsChange(m => (this._renderDimensions = m))
                        ),
                    ...
                    getBufferElements(s, e) {
                      ...
                      for (let m = s; m < u; m++) {
                        ...
                        if (((o += y.translateToString(!k)), !k || m === p.length - 1)) {
                          ...
                          ((L.textContent = o), f.push(L), o.length > 0 && (t = L), (o = ''));
                        }
                      }
                  ...
                  let g = (r.BufferDecorationRenderer = class extends d.Disposable {
                    constructor(h, i, s, e, t) {
                      (super(),
                        ...
                        this.register(
                          this._decorationService.onDecorationRemoved(o =>
                            this._removeDecoration(o)
                          )
                        ),
                        this.register(
                          (0, d.toDisposable)(() => {
                    ...
                    _createElement(h) {
                      ...
                      (i.classList.add('xterm-decoration'),
                        i.classList.toggle(
                          ...
                          ((e = h == null ? void 0 : h.options) == null ? void 0 : e.layer) ===
                            'top'
                        ),
                    ...
                    _removeDecoration(h) {
                      var i;
                      ((i = this._decorationElements.get(h)) == null || i.remove(),
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.ColorZoneStore = class {
                      ...
                      addDecoration(a) {
                        if (a.options.overviewRulerOptions) {
                          for (const l of this._zones)
                            if (
                              l.color === a.options.overviewRulerOptions.color &&
                              l.position === a.options.overviewRulerOptions.position
                            ) {
                          ...
                          if (this._zonePoolIndex < this._zonePool.length)
                            return (
                              ...
                              (this._zonePool[this._zonePoolIndex].position =
                                a.options.overviewRulerOptions.position),
                              (this._zonePool[this._zonePoolIndex].startBufferLine = a.marker.line),
                              (this._zonePool[this._zonePoolIndex].endBufferLine = a.marker.line),
                      ...
                      _lineAdjacentToZone(a, l, _) {
                        return (
                          l >= a.startBufferLine - this._linePadding[_ || 'full'] &&
                          l <= a.endBufferLine + this._linePadding[_ || 'full']
                        );
                      }
                      _addLineToZone(a, l) {
                        ((a.startBufferLine = Math.min(a.startBufferLine, l)),
                          (a.endBufferLine = Math.max(a.endBufferLine, l)));
                      }
                    }));
                },
                5744: function (O, r, a) {
                        ...
                        var p,
                          ...
                          m =
                            c < 3
                              ? o
                              : u === null
                                ? (u = Object.getOwnPropertyDescriptor(o, f))
                                : u;
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          m = Reflect.decorate(t, o, f, u);
                        else
                          for (var y = t.length - 1; y >= 0; y--)
                            (p = t[y]) && (m = (c < 3 ? p(m) : c > 3 ? p(o, f, m) : p(o, f)) || m);
                        return (c > 3 && m && Object.defineProperty(o, f, m), m);
                      },
                    _ =
                      (this && this.__param) ||
                      function (t, o) {
                  ...
                  let e = (r.OverviewRulerRenderer = class extends v.Disposable {
                    ...
                    constructor(t, o, f, u, p, c, m) {
                      ...
                      (super(),
                        ...
                        (k = this._viewportElement.parentElement) == null ||
                          k.insertBefore(this._canvas, this._viewportElement));
                    ...
                    _refreshDrawHeightConstants() {
                      ...
                      const t = this._canvas.height / this._bufferService.buffer.lines.length,
                        o = Math.round(Math.max(Math.min(t, 12), 6) * this._coreBrowserService.dpr);
                    ...
                    _queueRefresh(t, o) {
                      ((this._shouldUpdateDimensions = t || this._shouldUpdateDimensions),
                        (this._shouldUpdateAnchor = o || this._shouldUpdateAnchor),
                        this._animationFrame === void 0 &&
                          (this._animationFrame =
                            this._coreBrowserService.window.requestAnimationFrame(() => {
                      ...
                      if (this._isComposing) {
                        if (this._bufferService.buffer.isCursorInViewport) {
                          ...
                          ((this._textarea.style.left = t + 'px'),
                            ...
                            (this._textarea.style.width = Math.max(o.width, 1) + 'px'),
                            (this._textarea.style.height = Math.max(o.height, 1) + 'px'),
                ...
                9504: (O, r, a) => {
                  ...
                  function n(i, s) {
                    ...
                    for (; o && i >= 0 && i < s.rows; )
                      (e++, (t = s.buffer.lines.get(--i)), (o = t == null ? void 0 : t.isWrapped));
                    return e;
                  }
                  function d(i, s) {
                    return i > s ? 'A' : 'B';
                  }
                  function v(i, s, e, t, o, f) {
                    let u = i,
                      p = s,
                      c = '';
                    for (; u !== e || p !== t; )
                  ...
                  r.moveToCellSequence = function (i, s, e, t) {
                    ...
                    if (!e.buffer.hasScrollback)
                      return (
                        (function (c, m, y, k, L, w) {
                          return _(m, k, L, w).length === 0
                            ? ''
                            : h(v(c, m, c, m - n(m, L), !1, L).length, g('D', w));
                        })(o, f, 0, s, e, t) +
                        _(f, s, e, t) +
                        (function (c, m, y, k, L, w) {
                          let x;
                          x = _(m, k, L, w).length > 0 ? k - n(k, L) : m;
                          const B = k,
                            P = (function (U, I, S, b, E, D) {
                              let T;
                              return (
                                (T = _(S, b, E, D).length > 0 ? b - n(b, E) : I),
                                (U < S && T <= b) || (U >= S && T < b) ? 'C' : 'D'
                              );
                            })(c, m, y, k, L, w);
                    ...
                    let u;
                    if (f === s) return ((u = o > i ? 'D' : 'C'), h(Math.abs(o - i), g(u, t)));
                    u = f > s ? 'D' : 'C';
                        ...
                        var U,
                          ...
                          S =
                            I < 3
                              ? x
                              : P === null
                                ? (P = Object.getOwnPropertyDescriptor(x, B))
                                : P;
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          S = Reflect.decorate(w, x, B, P);
                        else
                          for (var b = w.length - 1; b >= 0; b--)
                            (U = w[b]) && (S = (I < 3 ? U(S) : I > 3 ? U(x, B, S) : U(x, B)) || S);
                    ...
                    L = (r.DomRenderer = class extends t.Disposable {
                      constructor(w, x, B, P, U, I, S, b, E, D, T, H, N) {
                        (super(),
                          ...
                          this._selectionContainer.classList.add(y),
                          ...
                          this.register(this._themeService.onChangeColors($ => this._injectCss($))),
                          this._injectCss(this._themeService.colors),
                          (this._rowFactory = b.createInstance(n.DomRendererRowFactory, document)),
                      ...
                      _updateDimensions() {
                        ...
                        ((this.dimensions.device.char.width = this._charSizeService.width * w),
                          (this.dimensions.device.char.height = Math.ceil(
                            this._charSizeService.height * w
                          )),
                          ...
                          (this.dimensions.css.canvas.width = Math.round(
                            this.dimensions.device.canvas.width / w
                          )),
                          (this.dimensions.css.canvas.height = Math.round(
                            this.dimensions.device.canvas.height / w
                          )),
                      ...
                      _injectCss(w) {
                        ...
                        let x = `${this._terminalSelector} .${u} { color: ${w.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
                        ((x += `${this._terminalSelector} .${u} .xterm-dim { color: ${s.color.multiplyOpacity(w.foreground, 0.5).css};}`),
                        ...
                        const B = `blink_underline_${this._terminalClass}`,
                          P = `blink_bar_${this._terminalClass}`,
                          U = `blink_block_${this._terminalClass}`;
                        ((x += `@keyframes ${B} { 50% {  border-bottom-style: hidden; }}`),
                          (x += `@keyframes ${P} { 50% {  box-shadow: none; }}`),
                          (x += `@keyframes ${U} { 0% {  background-color: ${w.cursor.css};  color: ${w.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${w.cursor.css}; }}`),
                          (x += `${this._terminalSelector} .${u}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${B} 1s step-end infinite;}${this._terminalSelector} .${u}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${P} 1s step-end infinite;}${this._terminalSelector} .${u}.${m} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${U} 1s step-end infinite;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-block { background-color: ${w.cursor.css}; color: ${w.cursorAccent.css};}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${w.cursor.css} !important; color: ${w.cursorAccent.css} !important;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${w.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${w.cursor.css} inset;}${this._terminalSelector} .${u} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${w.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`),
                          (x += `${this._terminalSelector} .${y} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${y} div { position: absolute; background-color: ${w.selectionBackgroundOpaque.css};}${this._terminalSelector} .${y} div { position: absolute; background-color: ${w.selectionInactiveBackgroundOpaque.css};}`));
                        for (const [I, S] of w.ansi.entries())
                          x += `${this._terminalSelector} .${p}${I} { color: ${S.css}; }${this._terminalSelector} .${p}${I}.xterm-dim { color: ${s.color.multiplyOpacity(S, 0.5).css}; }${this._terminalSelector} .${c}${I} { background-color: ${S.css}; }`;
                        ((x += `${this._terminalSelector} .${p}${v.INVERTED_DEFAULT_COLOR} { color: ${s.color.opaque(w.background).css}; }${this._terminalSelector} .${p}${v.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${s.color.multiplyOpacity(s.color.opaque(w.background), 0.5).css}; }${this._terminalSelector} .${c}${v.INVERTED_DEFAULT_COLOR} { background-color: ${w.foreground.css}; }`),
                          (this._themeStyleElement.textContent = x));
                      }
                      _setDefaultSpacing() {
                        const w =
                          this.dimensions.css.cell.width - this._widthCache.get('W', !1, !1);
                        ((this._rowContainer.style.letterSpacing = `${w}px`),
                          (this._rowFactory.defaultSpacing = w));
                      }
                      ...
                      handleSelectionChanged(w, x, B) {
                        if (
                          ...
                          this._rowFactory.handleSelectionChanged(w, x, B),
                          this.renderRows(0, this._bufferService.rows - 1),
                          !w || !x)
                        )
                          return;
                        this._selectionRenderModel.update(this._terminal, w, x, B);
                        const P = this._selectionRenderModel.viewportStartRow,
                        ...
                        if (B) {
                          ...
                          const E = P === I ? w[0] : 0,
                            D = I === U ? x[0] : this._bufferService.cols;
                          b.appendChild(this._createSelectionElement(I, E, D));
                          const T = S - I - 1;
                          if (
                            (b.appendChild(
                              this._createSelectionElement(I + 1, 0, this._bufferService.cols, T)
                            ),
                            I !== S)
                          ) {
                      ...
                      _createSelectionElement(w, x, B, P = 1) {
                        const U = this._document.createElement('div'),
                          I = x * this.dimensions.css.cell.width;
                        let S = this.dimensions.css.cell.width * (B - x);
                        return (
                          I + S > this.dimensions.css.canvas.width &&
                            (S = this.dimensions.css.canvas.width - I),
                          (U.style.height = P * this.dimensions.css.cell.height + 'px'),
                          (U.style.top = w * this.dimensions.css.cell.height + 'px'),
                          (U.style.left = `${I}px`),
                          (U.style.width = `${S}px`),
                          U
                        );
                      ...
                      renderRows(w, x) {
                        const B = this._bufferService.buffer,
                          P = B.ybase + B.y,
                          U = Math.min(B.x, this._bufferService.cols - 1),
                          I = this._optionsService.rawOptions.cursorBlink,
                          S = this._optionsService.rawOptions.cursorStyle,
                          b = this._optionsService.rawOptions.cursorInactiveStyle;
                        for (let E = w; E <= x; E++) {
                          const D = E + B.ydisp,
                            T = this._rowElements[E],
                            H = B.lines.get(D);
                          if (!T || !H) break;
                          T.replaceChildren(
                      ...
                      _setCellUnderline(w, x, B, P, U, I) {
                        ...
                        ((B = Math.max(Math.min(B, S), 0)),
                          (P = Math.max(Math.min(P, S), 0)),
                          (U = Math.min(U, this._bufferService.cols)));
                        const b = this._bufferService.buffer,
                          E = b.ybase + b.y,
                          D = Math.min(b.x, U - 1),
                          T = this._optionsService.rawOptions.cursorBlink,
                ...
                3787: function (O, r, a) {
                          ...
                          L =
                            k < 3
                              ...
                              : m === null
                                ...
                                : m;
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          L = Reflect.decorate(u, p, c, m);
                        else
                          for (var w = u.length - 1; w >= 0; w--)
                            (y = u[w]) && (L = (k < 3 ? y(L) : k > 3 ? y(p, c, L) : y(p, c)) || L);
                  ...
                  let o = (r.DomRendererRowFactory = class {
                    ...
                    createRow(u, p, c, m, y, k, L, w, x, B, P) {
                      const U = [],
                        I = this._characterJoinerService.getJoinedCharacters(p),
                      ...
                      for (let z = 0; z < E; z++) {
                        ...
                        if (
                          ...
                          (A = q * w - x.get(ae, j.isBold(), j.isItalic())),
                          b)
                        ) {
                          if (
                            D &&
                            ((se && M) || (!se && !M && j.bg === H)) &&
                            ((se && M && S.selectionForeground) || j.fg === N) &&
                            j.extended.ext === $ &&
                            de === R &&
                            A === C &&
                            !le &&
                            ...
                            (j.isInvisible() ? (T += d.WHITESPACE_CELL_CHAR) : (T += ae), D++);
                            continue;
                          }
                          (D && (b.textContent = T),
                        ...
                        if (
                          ...
                          if (j.isUnderlineColorRGB())
                            b.style.textDecorationColor = `rgb(${t.AttributeData.toColorRGB(j.getUnderlineColor()).join(',')})`;
                          else {
                            ...
                            (this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                              ...
                              K < 8 &&
                              (K += 8),
                              (b.style.textDecorationColor = S.ansi[K].css));
                          }
                        (j.isOverline() && (W.push('xterm-overline'), T === ' ' && (T = ' ')),
                          j.isStrikethrough() && W.push('xterm-strikethrough'),
                          de && (b.style.textDecoration = 'underline'));
                        let J = j.getFgColor(),
                          re = j.getFgColorMode(),
                          Z = j.getBgColor(),
                          ne = j.getBgColorMode();
                        ...
                        switch (
                          ...
                          case 33554432:
                            (j.isBold() &&
                              ...
                              this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                              (J += 8),
                              this._applyMinimumContrast(b, te, S.ansi[J], j, ee, void 0) ||
                                W.push(`xterm-fg-${J}`));
                            break;
                          case 50331648:
                            const K = h.channels.toColor((J >> 16) & 255, (J >> 8) & 255, 255 & J);
                            this._applyMinimumContrast(b, te, K, j, ee, he) ||
                              this._addStyle(b, `color:#${f(J.toString(16), '0', 6)}`);
                            break;
                          default:
                            this._applyMinimumContrast(b, te, S.foreground, j, ee, he) ||
                              (ue && W.push(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`));
                        }
                        (W.length && ((b.className = W.join(' ')), (W.length = 0)),
                          le || V || _e ? (b.textContent = T) : D++,
                          A !== this.defaultSpacing && (b.style.letterSpacing = `${A}px`),
                          U.push(b),
                          (z = X));
                      }
                      return (b && D && (b.textContent = T), U);
                    }
                    _applyMinimumContrast(u, p, c, m, y, k) {
                      if (
                      ...
                      if ((y || k || (w = L.getColor(p.rgba, c.rgba)), w === void 0)) {
                        const x =
                          ...
                          (m.isDim() ? 2 : 1);
                        ((w = h.color.ensureContrastRatio(y || p, k || c, x)),
                          L.setColor((y || p).rgba, (k || c).rgba, w ?? null));
                      }
                      return !!w && (this._addStyle(u, `color:${w.css}`), !0);
                    }
                    _getContrastCache(u) {
                      return u.isDim()
                ...
                2550: (O, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.WidthCache = class {
                      ...
                      get(a, l, _) {
                        let n = 0;
                        if (!l && !_ && a.length === 1 && (n = a.charCodeAt(0)) < 256) {
                        ...
                        if (this.selectionStart) {
                              ...
                              ? a % this._bufferService.cols == 0
                                ? [
                                    ...
                                    this.selectionStart[1] +
                                      Math.floor(a / this._bufferService.cols) -
                                      1,
                                  ]
                                : [
                          ...
                          if (
                            ...
                            return a > this._bufferService.cols
                              ? [
                                  a % this._bufferService.cols,
                                  this.selectionStart[1] + Math.floor(a / this._bufferService.cols),
                                ]
                              : [Math.max(a, this.selectionEnd[0]), this.selectionEnd[1]];
                          }
                  ...
                  class h extends v.Disposable {
                    ...
                    _validateAndSet(t, o) {
                      t !== void 0 &&
                        ...
                        o !== void 0 &&
                        o > 0 &&
                        ((this._result.width = t), (this._result.height = o));
                    }
                  }
                  class i extends h {
                    constructor(t, o, f) {
                      ...
                      for (let k = 0; k < t.getTrimmedLength(); k++)
                        if ((t.loadCell(k, this._workCell), this._workCell.getWidth() !== 0)) {
                          if (this._workCell.fg !== m || this._workCell.bg !== y) {
                            if (k - u > 1) {
                              const L = this._getJoinedRanges(f, c, p, t, u);
                              for (let w = 0; w < L.length; w++) o.push(L[w]);
                            }
                            ((u = k), (c = p), (m = this._workCell.fg), (y = this._workCell.bg));
                          }
                    ...
                    static _mergeRanges(e, t) {
                      ...
                      for (let f = 0; f < e.length; f++) {
                        ...
                        if (o) {
                          ...
                          t[0] < u[1] && ((u[0] = Math.min(t[0], u[0])), (o = !0));
                        }
                      }
                  ...
                  class d extends l.Disposable {
                    constructor(h, i, s) {
                      (super(),
                        ...
                        this.register(
                          (0, _.forwardEvent)(this._screenDprMonitor.onDprChange, this._onDprChange)
                        ),
                          ...
                          o =
                            t < 3
                              ...
                              : s === null
                                ...
                                : s;
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          o = Reflect.decorate(g, h, i, s);
                        else
                          for (var f = g.length - 1; f >= 0; f--)
                            (e = g[f]) && (o = (t < 3 ? e(o) : t > 3 ? e(h, i, o) : e(h, i)) || o);
                  ...
                  let s = (r.RenderService = class extends g.Disposable {
                    ...
                    constructor(e, t, o, f, u, p, c, m) {
                      (super(),
                        ...
                        this.register(
                          p.buffers.onBufferActivate(() => {
                            var y;
                            return (y = this._renderer.value) == null ? void 0 : y.clear();
                          })
                        ),
                        this.register(o.onOptionChange(() => this._handleOptionsChanged())),
                        this.register(
                        ...
                        this.register(
                          o.onMultipleOptionChange(['cursorBlink', 'cursorStyle'], () =>
                        ...
                        this.register(
                          c.onWindowChange(y => this._registerIntersectionObserver(y, t))
                        ));
                    }
                    ...
                    clearTextureAtlas() {
                      var e, t;
                      this._renderer.value &&
                        ((t = (e = this._renderer.value).clearTextureAtlas) == null || t.call(e),
                        this._fullRefresh());
                    }
                    handleDevicePixelRatioChange() {
                      (this._charSizeService.measure(),
                    ...
                    handleSelectionChanged(e, t, o) {
                      ...
                      ((this._selectionState.start = e),
                        ...
                        (f = this._renderer.value) == null || f.handleSelectionChanged(e, t, o));
                    }
                    handleCursorMove() {
                      var e;
                        ...
                        var L,
                          ...
                          x =
                            w < 3
                              ? m
                              : k === null
                                ? (k = Object.getOwnPropertyDescriptor(m, y))
                                : k;
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          x = Reflect.decorate(c, m, y, k);
                        else
                          for (var B = c.length - 1; B >= 0; B--)
                            (L = c[B]) && (x = (w < 3 ? L(x) : w > 3 ? L(m, y, x) : L(m, y)) || x);
                    ...
                    get selectionText() {
                      ...
                      if (this._activeSelectionMode === 3) {
                        ...
                        for (let x = c[1]; x <= m[1]; x++) {
                          const B = y.translateBufferLineToString(x, !0, L, w);
                          k.push(B);
                        }
                      } else {
                        ...
                        for (let w = c[1] + 1; w <= m[1] - 1; w++) {
                          const x = y.lines.get(w),
                            B = y.translateBufferLineToString(w, !0);
                          x != null && x.isWrapped ? (k[k.length - 1] += B) : k.push(B);
                        }
                        if (c[1] !== m[1]) {
                          const w = y.lines.get(m[1]),
                            x = y.translateBufferLineToString(m[1], !0, 0, m[0]);
...
`
                    ...
                    _areCoordsInSelection(c, m, y) {
                      return (
                        (c[1] > m[1] && c[1] < y[1]) ||
                        (m[1] === y[1] && c[1] === m[1] && c[0] >= m[0] && c[0] < y[0]) ||
                        (m[1] < y[1] && c[1] === y[1] && c[0] < y[0]) ||
                        (m[1] < y[1] && c[1] === m[1] && c[0] >= m[0])
                      );
                    }
                    _selectWordAtCursor(c, m) {
                      var L, w;
                      const y =
                        (w = (L = this._linkifier.currentLink) == null ? void 0 : L.link) == null
                          ? void 0
                          : w.range;
                      if (y)
                        return (
                          (this._model.selectionStart = [y.start.x - 1, y.start.y - 1]),
                    ...
                    _handleMouseUp(c) {
                      ...
                      if (
                        ...
                        if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
                          const y = this._mouseService.getCoords(
                            c,
                            this._element,
                            this._bufferService.cols,
                            this._bufferService.rows,
                      ...
                      y
                        ? c &&
                          ...
                          ((this._oldSelectionStart &&
                            ...
                            this._fireOnSelectionChange(c, m, y))
                        : this._oldHasSelection && this._fireOnSelectionChange(c, m, y);
                    }
                    _fireOnSelectionChange(c, m, y) {
                      ((this._oldSelectionStart = c),
                        (this._oldSelectionEnd = m),
                        (this._oldHasSelection = y),
                        this._onSelectionChange.fire());
                    }
                    ...
                    setSelection(c, m, y) {
                      (this._model.clearSelection(),
                        ...
                        (this._model.selectionStartLength = y),
                        this.refresh(),
                    ...
                    _getWordAt(c, m, y = !0, k = !0) {
                      ...
                      const L = this._bufferService.buffer,
                        w = L.lines.get(c[1]);
                      if (!w) return;
                      const x = L.translateBufferLineToString(c[1], !1);
                      let B = this._convertViewportColToCharacterIndex(w, c[0]),
                        P = B;
                      const U = c[0] - B;
                      let I = 0,
                        S = 0,
                      ...
                      if (x.charAt(B) === ' ') {
                        ...
                        for (
                          ...
                          H > 0 &&
                          B > 0 &&
                          !this._isCharWordSeparator(w.loadCell(H - 1, this._workCell));
                        ) {
                        ...
                        for (
                          ...
                          N < w.length &&
                          P + 1 < x.length &&
                          !this._isCharWordSeparator(w.loadCell(N + 1, this._workCell));
                        ) {
                      ...
                      P++;
                      let D = B + U - I + b,
                        T = Math.min(this._bufferService.cols, P - B + I + S - b - E);
                      if (m || x.slice(B, P).trim() !== '') {
                        ...
                        if (
                          k &&
                          D + T === this._bufferService.cols &&
                          w.getCodePoint(this._bufferService.cols - 1) !== 32
                        ) {
                          const H = L.lines.get(c[1] + 1);
                    ...
                    _selectWordAt(c, m) {
                      ...
                      if (y) {
                        ...
                        ((this._model.selectionStart = [y.start, c[1]]),
                          (this._model.selectionStartLength = y.length));
                      }
                    }
                    _selectToWordAt(c) {
                      ...
                      if (m) {
                        ...
                        if (!this._model.areSelectionValuesReversed())
                          for (; m.start + m.length > this._bufferService.cols; )
                            ((m.length -= this._bufferService.cols), y++);
                        this._model.selectionEnd = [
                ...
                6731: function (O, r, a) {
                        ...
                        var k,
                          ...
                          w =
                            L < 3
                              ? c
                              : y === null
                                ? (y = Object.getOwnPropertyDescriptor(c, m))
                                : y;
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          w = Reflect.decorate(p, c, m, y);
                        else
                          for (var x = p.length - 1; x >= 0; x--)
                            (k = p[x]) && (w = (L < 3 ? k(w) : L > 3 ? k(c, m, w) : k(c, m)) || w);
                  ...
                  const n = a(7239),
                    ...
                    o = { css: 'rgba(255, 255, 255, 0.3)', rgba: 4294967117 };
                    ...
                    (() => {
                      ...
                      for (let m = 0; m < 216; m++) {
                        const y = c[((m / 36) % 6) | 0],
                          ...
                          L = c[m % 6];
                        p.push({
                          css: d.channels.toCss(y, k, L),
                          rgba: d.channels.toRgba(y, k, L),
                        });
                      }
                      for (let m = 0; m < 24; m++) {
                        const y = 8 + 10 * m;
                        p.push({
                          css: d.channels.toCss(y, y, y),
                          rgba: d.channels.toRgba(y, y, y),
                        });
                      }
                      return p;
                    })()
                  ...
                  let f = (r.ThemeService = class extends g.Disposable {
                    ...
                    constructor(p) {
                      (super(),
                        ...
                        (this._colors = {
                          ...
                          selectionBackgroundOpaque: d.color.blend(s, o),
                          selectionInactiveBackgroundTransparent: o,
                          selectionInactiveBackgroundOpaque: d.color.blend(s, o),
                    ...
                    _setTheme(p = {}) {
                      ...
                      if (
                        ...
                        (c.selectionBackgroundTransparent = u(p.selectionBackground, o)),
                        ...
                        for (let y = 0; y < m; y++)
                          c.ansi[y + 16] = u(p.extendedAnsi[y], r.DEFAULT_ANSI_COLORS[y + 16]);
                      }
                      (this._contrastCache.clear(),
                ...
                1439: (O, r) => {
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.clone = function a(l, _ = 5) {
                      ...
                      for (const d in l) n[d] = _ <= 1 ? l[d] : l[d] && a(l[d], _ - 1);
                      return n;
                    }));
                },
                8055: (O, r) => {
                  ...
                  ((r.NULL_COLOR = { css: '#00000000', rgba: 0 }),
                    (function (t) {
                      ((t.toCss = function (o, f, u, p) {
                        return p !== void 0
                          ? `#${s(o)}${s(f)}${s(u)}${s(p)}`
                          : `#${s(o)}${s(f)}${s(u)}`;
                      }),
                        (t.toRgba = function (o, f, u, p = 255) {
                          return ((o << 24) | (f << 16) | (u << 8) | p) >>> 0;
                        }),
                        (t.toColor = function (o, f, u, p) {
                          return { css: t.toCss(o, f, u, p), rgba: t.toRgba(o, f, u, p) };
                        }));
                    })(d || (r.channels = d = {})),
                    (function (t) {
                      function o(f, u) {
                        return (
                          (n = Math.round(255 * u)),
                          ([a, l, _] = i.toChannels(f.rgba)),
                          { css: d.toCss(a, l, _, n), rgba: d.toRgba(a, l, _, n) }
                        );
                      }
                      ((t.blend = function (f, u) {
                        ...
                        const p = (u.rgba >> 24) & 255,
                          ...
                          L = (f.rgba >> 8) & 255;
                        return (
                          (a = y + Math.round((p - y) * n)),
                          (l = k + Math.round((c - k) * n)),
                          (_ = L + Math.round((m - L) * n)),
                          { css: d.toCss(a, l, _), rgba: d.toRgba(a, l, _) }
                        );
                      }),
                      ...
                      t.toColor = function (u) {
                        if (u.match(/#[\da-f]{3,8}/i))
                          switch (u.length) {
                            case 4:
                              return (
                                (a = parseInt(u.slice(1, 2).repeat(2), 16)),
                        ...
                        if (!o || !f) throw new Error('css.toColor: Unsupported css format');
                        if (((o.fillStyle = f), (o.fillStyle = u), typeof o.fillStyle != 'string'))
                          throw new Error('css.toColor: Unsupported css format');
                        if (
                          (o.fillRect(0, 0, 1, 1),
                          ([a, l, _, n] = o.getImageData(0, 0, 1, 1).data),
                          n !== 255)
                        )
                          throw new Error('css.toColor: Unsupported css format');
                    ...
                    (function (t) {
                      function o(f, u, p) {
                        ...
                        return (
                          ...
                          0.0722 * (y <= 0.03928 ? y / 12.92 : Math.pow((y + 0.055) / 1.055, 2.4))
                        );
                      }
                      ((t.relativeLuminance = function (f) {
                        return o((f >> 16) & 255, (f >> 8) & 255, 255 & f);
                      }),
                    ...
                    (function (t) {
                      function o(u, p, c) {
                        ...
                        let L = (p >> 24) & 255,
                          w = (p >> 16) & 255,
                          x = (p >> 8) & 255,
                          B = e(h.relativeLuminance2(L, w, x), h.relativeLuminance2(m, y, k));
                        for (; B < c && (L > 0 || w > 0 || x > 0); )
                          ((L -= Math.max(0, Math.ceil(0.1 * L))),
                            (w -= Math.max(0, Math.ceil(0.1 * w))),
                      ...
                      function f(u, p, c) {
                        ...
                        let L = (p >> 24) & 255,
                          ...
                          x = (p >> 8) & 255,
                          B = e(h.relativeLuminance2(L, w, x), h.relativeLuminance2(m, y, k));
                        for (; B < c && (L < 255 || w < 255 || x < 255); )
                          ((L = Math.min(255, L + Math.ceil(0.1 * (255 - L)))),
                            (w = Math.min(255, w + Math.ceil(0.1 * (255 - w)))),
                      ...
                      ((t.blend = function (u, p) {
                        ...
                        return (
                          ...
                          (_ = w + Math.round((y - w) * n)),
                          d.toRgba(a, l, _)
                        );
                      }),
                        (t.ensureContrastRatio = function (u, p, c) {
                          const m = h.relativeLuminance(u >> 8),
                            y = h.relativeLuminance(p >> 8);
                          if (e(m, y) < c) {
                            if (y < m) {
                              const w = o(u, p, c),
                                x = e(m, h.relativeLuminance(w >> 8));
                              if (x < c) {
                                const B = f(u, p, c);
                ...
                8969: (O, r, a) => {
                  ...
                  class m extends l.Disposable {
                    ...
                    constructor(k) {
                      (super(),
                        ...
                        (this._writeBuffer = this.register(
                          new u.WriteBuffer((L, w) => this._inputHandler.parse(L, w))
                        )),
                        this.register(
                    ...
                    _handleWindowsPtyOptionChange() {
                      ...
                      (L && L.buildNumber !== void 0 && L.buildNumber !== void 0
                        ? (k = L.backend === 'conpty' && L.buildNumber < 21376)
                    ...
                    _enableWindowsWrappingHeuristics() {
                      if (!this._windowsWrappingHeuristics.value) {
                        ...
                        (k.push(
                          this.onLineFeed(
                            o.updateWindowsModeWrappedState.bind(null, this._bufferService)
                          )
                        ),
                          k.push(
                            this.registerCsiHandler(
                              { final: 'H' },
                              () => ((0, o.updateWindowsModeWrappedState)(this._bufferService), !1)
                            )
                          ),
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.EventEmitter = class {
                      ...
                      fire(a, l) {
                        ...
                        for (let n = 0; n < _.length; n++) _[n].call(void 0, a, l);
                      }
                      dispose() {
                        ...
                        var D,
                          ...
                          H =
                            T < 3
                              ? S
                              : E === null
                                ? (E = Object.getOwnPropertyDescriptor(S, b))
                                : E;
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          H = Reflect.decorate(I, S, b, E);
                        else
                          for (var N = I.length - 1; N >= 0; N--)
                            (D = I[N]) && (H = (T < 3 ? D(H) : T > 3 ? D(S, b, H) : D(S, b)) || H);
                  ...
                  class B extends g.Disposable {
                    ...
                    constructor(S, b, E, D, T, H, N, $, R = new v.EscapeSequenceParser()) {
                      (super(),
                        ...
                        (this._dirtyRowTracker = new P(this._bufferService)),
                        (this._activeBuffer = this._bufferService.buffer),
                        this.register(
                          this._bufferService.buffers.onBufferActivate(
                        ...
                        this._parser.setCsiHandlerFallback((C, M) => {
                        ...
                        this._parser.setPrintHandler((C, M, A) => this.print(C, M, A)),
                        ...
                        this._parser.registerCsiHandler({ final: 'C' }, C => this.cursorForward(C)),
                        ...
                        this._parser.registerCsiHandler({ final: 'n' }, C => this.deviceStatus(C)),
                        ...
                        this._parser.registerCsiHandler({ final: 't' }, C => this.windowOptions(C)),
                        this._parser.registerCsiHandler({ final: 'u' }, C => this.restoreCursor(C)),
                        this._parser.registerCsiHandler({ intermediates: "'", final: '}' }, C =>
                        ...
                        this._parser.registerOscHandler(2, new p.OscHandler(C => this.setTitle(C))),
                        this._parser.registerOscHandler(
                          4,
                    ...
                    parse(S, b) {
                      ...
                      if (N) {
                        ...
                        ((D = this._parseStack.cursorStartX),
                          (T = this._parseStack.cursorStartY),
                      ...
                      if (
                        ...
                        if ((E = this._parser.parse(this._parseBuffer, C)))
                          return (
                            this._preserveStack(D, T, C, 0),
                            this._logSlowResolvingAsync(E),
                            E
                          );
                      }
                      (this._activeBuffer.x === D && this._activeBuffer.y === T) ||
                    ...
                    print(S, b, E) {
                      ...
                      (this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                        this._activeBuffer.x &&
                          E - b > 0 &&
                          A.getWidth(this._activeBuffer.x - 1) === 2 &&
                          A.setCellFromCodepoint(this._activeBuffer.x - 1, 0, 1, M));
                      ...
                      for (let F = b; F < E; ++F) {
                          ...
                          if (R) {
                            ...
                            for (
                              this._activeBuffer.x = V,
                                ...
                                A = this._activeBuffer.lines.get(
                                  this._activeBuffer.ybase + this._activeBuffer.y
                                ),
                                V > 0 &&
                                  A instanceof i.BufferLine &&
                                  A.copyCellsFrom(X, j, 0, V, !1);
                              j < $;
                            )
                              X.setCellFromCodepoint(j++, 0, 1, M);
                        ...
                        if (q && this._activeBuffer.x) {
                          ...
                          for (let j = T - V; --j >= 0; )
                            A.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, M);
                        } else if (
                          (C &&
                            (A.insertCells(
                              this._activeBuffer.x,
                              T - V,
                              this._activeBuffer.getNullCell(M)
                            ),
                            A.getWidth($ - 1) === 2 &&
                              A.setCellFromCodepoint(
                                $ - 1,
                                e.NULL_CELL_CODE,
                                e.NULL_CELL_WIDTH,
                                M
                              )),
                          A.setCellFromCodepoint(this._activeBuffer.x++, D, T, M),
                          T > 0)
                        )
                          for (; --T; ) A.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, M);
                      }
                      ((this._parser.precedingJoinState = W),
                        this._activeBuffer.x < $ &&
                          E - b > 0 &&
                          A.getWidth(this._activeBuffer.x) === 0 &&
                          !A.hasContent(this._activeBuffer.x) &&
                          A.setCellFromCodepoint(this._activeBuffer.x, 0, 1, M),
                        this._dirtyRowTracker.markDirty(this._activeBuffer.y));
                    }
                    registerCsiHandler(S, b) {
                      return S.final !== 't' || S.prefix || S.intermediates
                        ? this._parser.registerCsiHandler(S, b)
                        : this._parser.registerCsiHandler(
                            S,
                            E =>
                              !L(E.params[0], this._optionsService.rawOptions.windowOptions) || b(E)
                          );
                    }
                    ...
                    backspace() {
                      ...
                      if (
                        ...
                        const b = this._activeBuffer.lines.get(
                          this._activeBuffer.ybase + this._activeBuffer.y
                        );
                        b.hasWidth(this._activeBuffer.x) &&
                      ...
                      (this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                        this._coreService.decPrivateModes.origin
                          ? ((this._activeBuffer.x = S),
                            (this._activeBuffer.y = this._activeBuffer.scrollTop + b))
                          : ((this._activeBuffer.x = S), (this._activeBuffer.y = b)),
                        this._restrictCursor(),
                        this._dirtyRowTracker.markDirty(this._activeBuffer.y));
                    }
                    _moveCursor(S, b) {
                      (this._restrictCursor(),
                        this._setCursor(this._activeBuffer.x + S, this._activeBuffer.y + b));
                    }
                    cursorUp(S) {
                      const b = this._activeBuffer.y - this._activeBuffer.scrollTop;
                      return (
                        b >= 0
                          ? this._moveCursor(0, -Math.min(b, S.params[0] || 1))
                    ...
                    selectProtected(S) {
                      const b = S.params[0];
                      return (
                        b === 1 && (this._curAttrData.bg |= 536870912),
                        (b !== 2 && b !== 0) || (this._curAttrData.bg &= -536870913),
                        !0
                      );
                    }
                    _eraseInBufferLine(S, b, E, D = !1, T = !1) {
                    ...
                    _resetBufferLine(S, b = !1) {
                      ...
                      E &&
                        (E.fill(this._activeBuffer.getNullCell(this._eraseAttrData()), b),
                      ...
                      switch ((this._restrictCursor(this._bufferService.cols), S.params[0])) {
                        ...
                        case 1:
                          for (
                            E = this._activeBuffer.y,
                              this._dirtyRowTracker.markDirty(E),
                              this._eraseInBufferLine(E, 0, this._activeBuffer.x + 1, !0, b),
                              this._activeBuffer.x + 1 >= this._bufferService.cols &&
                                (this._activeBuffer.lines.get(E + 1).isWrapped = !1);
                            E--;
                          )
                            this._resetBufferLine(E, b);
                        ...
                        case 2:
                          for (
                            E = this._bufferService.rows, this._dirtyRowTracker.markDirty(E - 1);
                            E--;
                          )
                            this._resetBufferLine(E, b);
                          this._dirtyRowTracker.markDirty(0);
                        ...
                        case 3:
                          ...
                          D > 0 &&
                            (this._activeBuffer.lines.trimStart(D),
                            (this._activeBuffer.ybase = Math.max(this._activeBuffer.ybase - D, 0)),
                            (this._activeBuffer.ydisp = Math.max(this._activeBuffer.ydisp - D, 0)),
                    ...
                    insertLines(S) {
                      ...
                      const E = this._activeBuffer.ybase + this._activeBuffer.y,
                        D = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom,
                        T = this._bufferService.rows - 1 + this._activeBuffer.ybase - D + 1;
                      for (; b--; )
                        (this._activeBuffer.lines.splice(T - 1, 1),
                    ...
                    deleteLines(S) {
                      ...
                      for (
                        D = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom,
                          D = this._bufferService.rows - 1 + this._activeBuffer.ybase - D;
                        b--;
                      )
                    ...
                    scrollLeft(S) {
                      ...
                      for (
                        ...
                        (D.deleteCells(0, b, this._activeBuffer.getNullCell(this._eraseAttrData())),
                          (D.isWrapped = !1));
                      }
                      return (
                        this._dirtyRowTracker.markRangeDirty(
                    ...
                    scrollRight(S) {
                      ...
                      for (
                        ...
                        const D = this._activeBuffer.lines.get(this._activeBuffer.ybase + E);
                        (D.insertCells(0, b, this._activeBuffer.getNullCell(this._eraseAttrData())),
                          (D.isWrapped = !1));
                      }
                      return (
                        this._dirtyRowTracker.markRangeDirty(
                    ...
                    repeatPrecedingCharacter(S) {
                      ...
                      const E = S.params[0] || 1,
                        D = u.UnicodeService.extractWidth(b),
                        T = this._activeBuffer.x - D,
                        H = this._activeBuffer.lines
                          .get(this._activeBuffer.ybase + this._activeBuffer.y)
                          .getString(T),
                        N = new Uint32Array(H.length * E);
                      let $ = 0;
                        ...
                        switch (S.params[b]) {
                          ...
                          case 1047:
                            (this._bufferService.buffers.activateNormalBuffer(),
                              S.params[b] === 1049 && this.restoreCursor(),
                              (this._coreService.isCursorInitialized = !0),
                              this._onRequestRefreshRows.fire(0, this._bufferService.rows - 1),
                              this._onRequestSyncScrollBar.fire());
                            break;
                    ...
                    requestMode(S, b) {
                      const E = this._coreService.decPrivateModes,
                        { activeProtocol: D, activeEncoding: T } = this._coreMouseService,
                        H = this._coreService,
                        { buffers: N, cols: $ } = this._bufferService,
                        { active: R, alt: C } = N,
                        M = this._optionsService.rawOptions,
                        A = q => (q ? 1 : 2),
                        W = S.params[0];
                      return (
                        (F = W),
                            ...
                            : W === 4
                              ...
                              : W === 12
                                ...
                                : W === 20
                                  ...
                                  : 0
                          : W === 1
                            ? A(E.applicationCursorKeys)
                            : W === 3
                              ? M.windowOptions.setWinLines
                                ? $ === 80
                                  ? 2
                                  : $ === 132
                                    ? 1
                                    ...
                                    : W === 9
                                      ...
                                      : W === 12
                                        ...
                                        : W === 25
                                          ? A(!H.isCursorHidden)
                                          : W === 45
                                            ? A(E.reverseWraparound)
                                            : W === 66
                                              ? A(E.applicationKeypad)
                                              : W === 67
                                                ? 4
                                                : W === 1e3
                                                  ? A(D === 'VT200')
                                                                ...
                                                                : W === 1048
                                                                  ...
                                                                  : W === 47 ||
                                                                    ...
                                                                    : W === 2004
                                                                      ...
                                                                      : 0),
                        H.triggerDataEvent(`${n.C0.ESC}[${b ? '' : '?'}${F};${z}$y`),
                        !0
                      );
                      var F, z;
                    }
                    _updateAttrColor(S, b, E, D, T) {
                      return (
                        b === 2
                          ? ((S |= 50331648),
                            (S &= -16777216),
                            (S |= o.AttributeData.fromColorRGB([E, D, T])))
                          : b === 5 && ((S &= -50331904), (S |= 33554432 | (255 & E))),
                        S
                      );
                    }
                    _extractColor(S, b, E) {
                      ...
                      switch (D[0]) {
                        ...
                        case 58:
                          ((E.extended = E.extended.clone()),
                            (E.extended.underlineColor = this._updateAttrColor(
                    ...
                    _processUnderline(S, b) {
                      ((b.extended = b.extended.clone()),
                        (!~S || S > 5) && (S = 1),
                        (b.extended.underlineStyle = S),
                        (b.fg |= 268435456),
                        S === 0 && (b.fg &= -268435457),
                        b.updateExtended());
                    }
                    ...
                    charAttributes(S) {
                      ...
                      for (let T = 0; T < b; T++)
                        ((E = S.params[T]),
                          E >= 30 && E <= 37
                            ? ((D.fg &= -50331904), (D.fg |= 16777216 | (E - 30)))
                            : E >= 40 && E <= 47
                              ? ((D.bg &= -50331904), (D.bg |= 16777216 | (E - 40)))
                              : E >= 90 && E <= 97
                                ? ((D.fg &= -50331904), (D.fg |= 16777224 | (E - 90)))
                                : E >= 100 && E <= 107
                                  ? ((D.bg &= -50331904), (D.bg |= 16777224 | (E - 100)))
                                  : E === 0
                                    ? this._processSGR0(D)
                                    : E === 1
                                      ? (D.fg |= 134217728)
                                        ...
                                        : E === 4
                                          ? ((D.fg |= 268435456),
                                            this._processUnderline(
                                              S.hasSubParams(T) ? S.getSubParams(T)[0] : 1,
                                              D
                                            ))
                                          : E === 5
                                            ? (D.fg |= 536870912)
                    ...
                    deviceStatus(S) {
                      switch (S.params[0]) {
                        case 5:
                          ...
                          break;
                        case 6:
                          const b = this._activeBuffer.y + 1,
                    ...
                    setScrollRegion(S) {
                      ...
                      let E;
                      return (
                        (S.length < 2 || (E = S.params[1]) > this._bufferService.rows || E === 0) &&
                          (E = this._bufferService.rows),
                        E > b &&
                          ((this._activeBuffer.scrollTop = b - 1),
                    ...
                    windowOptions(S) {
                      ...
                      switch (S.params[0]) {
                        case 14:
                          b !== 2 &&
                            this._onRequestWindowsOptionsReport.fire(w.GET_WIN_SIZE_PIXELS);
                          break;
                        case 16:
                    ...
                    setHyperlink(S) {
                      ...
                      return (
                        !(b.length < 2) &&
                        (b[1]
                          ? this._createHyperlink(b[0], b[1])
                          : !b[0] && this._finishHyperlink())
                      );
                    }
                    ...
                    _setOrReportSpecialColor(S, b) {
                      const E = S.split(';');
                      for (let D = 0; D < E.length && !(b >= this._specialColors.length); ++D, ++b)
                        if (E[D] === '?')
                          ...
                          T &&
                            this._onColor.fire([
                              { type: 1, index: this._specialColors[b], color: T },
                            ]);
                        }
                      return !0;
                    }
                    ...
                    screenAlignmentPattern() {
                      ...
                      for (let b = 0; b < this._bufferService.rows; ++b) {
                        const E = this._activeBuffer.ybase + this._activeBuffer.y + b,
                          D = this._activeBuffer.lines.get(E);
                    ...
                    requestStatusString(S, b) {
                      ...
                      return (T => (
                        this._coreService.triggerDataEvent(`${n.C0.ESC}${T}${n.C0.ESC}\\`),
                        !0
                      ))(
                        S === '"q'
                          ...
                          : S === '"p'
                            ...
                            : S === 'r'
                              ...
                              : S === 'm'
                                ? 'P1$r0m'
                                : S === ' q'
                                  ? `P1$r${{ block: 2, underline: 4, bar: 6 }[D.cursorStyle] - (D.cursorBlink ? 1 : 0)} q`
                                  : 'P0$r'
                      );
                    }
                    markRangeDirty(S, b) {
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.MutableDisposable = class {
                      ...
                      set value(l) {
                        ...
                        this._isDisposed ||
                          l === this._value ||
                          ((_ = this._value) == null || _.dispose(), (this._value = l));
                      }
                      clear() {
                        this.value = void 0;
                      }
                ...
                1505: (O, r) => {
                  ...
                  ((r.TwoKeyMap = a),
                    (r.FourKeyMap = class {
                      ...
                      set(l, _, n, d, v) {
                        (this._data.get(l, _) || this._data.set(l, _, new a()),
                          this._data.get(l, _).set(n, d, v));
                      }
                      get(l, _, n, d) {
                        var v;
                        return (v = this._data.get(l, _)) == null ? void 0 : v.get(n, d);
                      }
                      clear() {
                        this._data.clear();
                      }
                ...
                6114: (O, r) => {
                  ...
                  ((r.isFirefox = a.includes('Firefox')),
                    ...
                    (r.isSafari = /^((?!chrome|android).)*safari/i.test(a)),
                ...
                6106: (O, r) => {
                  ...
                  r.SortedList = class {
                    ...
                    insert(l) {
                      this._array.length !== 0
                        ? ((a = this._search(this._getKey(l))), this._array.splice(a, 0, l))
                        : this._array.push(l);
                    }
                    delete(l) {
                      ...
                      if (
                        ...
                        return !1;
                      do if (this._array[a] === l) return (this._array.splice(a, 1), !0);
                    ...
                    *getKeyIterator(l) {
                      if (
                        this._array.length !== 0 &&
                        ((a = this._search(l)),
                        !(a < 0 || a >= this._array.length) && this._getKey(this._array[a]) === l)
                      )
                ...
                9092: (O, r, a) => {
                  ...
                  ((r.MAX_BUFFER_SIZE = 4294967295),
                    (r.Buffer = class {
                            ...
                            for (let c = this._rows; c < t; c++)
                              this.lines.length < t + this.ybase &&
                                ...
                                this._optionsService.rawOptions.windowsPty.buildNumber !== void 0
                                  ? this.lines.push(new d.BufferLine(e, o))
                                  : this.ybase > 0 &&
                      ...
                      _reflowLarger(e, t) {
                        const o = (0, v.reflowLargerGetLinesToRemove)(
                          this.lines,
                          this._cols,
                          e,
                          this.ybase + this.y,
                        ...
                        if (o.length > 0) {
                          const f = (0, v.reflowLargerCreateNewLayout)(this.lines, o);
                      ...
                      _reflowSmaller(e, t) {
                        ...
                        for (let p = this.lines.length - 1; p >= 0; p--) {
                          ...
                          const k = m[m.length - 1].getTrimmedLength(),
                            L = (0, v.reflowSmallerGetNewLineLengths)(m, this._cols, e),
                            w = L.length - m.length;
                          let x;
                          x =
                            this.ybase === 0 && this.y !== this.lines.length - 1
                              ? Math.max(0, this.y - this.lines.maxLength + w)
                              : Math.max(0, this.lines.length - this.lines.maxLength + w);
                          const B = [];
                          for (let E = 0; E < w; E++) {
                          ...
                          (B.length > 0 &&
                            (f.push({ start: p + m.length + u, newLines: B }), (u += B.length)),
                            m.push(...B));
                          let P = L.length - 1,
                            U = L[P];
                          U === 0 && (P--, (U = L[P]));
                          ...
                          for (; I >= 0; ) {
                            ...
                            if (m[P] === void 0) break;
                            if (
                              (m[P].copyCellsFrom(m[I], S - E, U - E, E, !0),
                              (U -= E),
                              U === 0 && (P--, (U = L[P])),
                              (S -= E),
                              S === 0)
                        ...
                        if (f.length > 0) {
                          ...
                          let w = 0;
                          for (let P = Math.min(this.lines.maxLength - 1, m + u - 1); P >= 0; P--)
                            if (L && L.start > y + w) {
                              for (let U = L.newLines.length - 1; U >= 0; U--)
                                this.lines.set(P--, L.newLines[U]);
                              (P++,
                                p.push({ index: y + 1, amount: L.newLines.length }),
                                (w += L.newLines.length),
                                (L = f[++k]));
                          ...
                          for (let P = p.length - 1; P >= 0; P--)
                            ((p[P].index += x),
                              this.lines.onInsertEmitter.fire(p[P]),
                              (x += p[P].amount));
                          const B = Math.max(0, m + u - this.lines.maxLength);
                        ...
                        return (
                          ...
                          t.register(
                            this.lines.onDelete(o => {
                              (t.line >= o.index && t.line < o.index + o.amount && t.dispose(),
                                t.line > o.index && (t.line -= o.amount));
                            })
                          ),
                  ...
                  class g {
                    ...
                    insertCells(i, s, e) {
                      if (
                        ...
                        for (let o = this.length - i - s - 1; o >= 0; --o)
                          this.setCell(i + s + o, this.loadCell(i + o, t));
                    ...
                    deleteCells(i, s, e) {
                      if (((i %= this.length), s < this.length - i)) {
                        const t = new _.CellData();
                        for (let o = 0; o < this.length - i - s; ++o)
                          this.setCell(i + o, this.loadCell(i + s + o, t));
                ...
                4634: (O, r) => {
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                        ...
                        for (; f < e.length; ) {
                          ...
                          (e[t].copyCellsFrom(e[f], u, o, k, !1),
                            ...
                            o === 0 &&
                              ...
                              (e[t].copyCellsFrom(e[t - 1], n - 1, o++, 1, !1),
                              e[t - 1].setCell(n - 1, v)));
                        }
                    ...
                    (r.reflowSmallerGetNewLineLengths = function (l, _, n) {
                      const d = [],
                        v = l.map((s, e) => a(l, e, _)).reduce((s, e) => s + e);
                      let g = 0,
                        h = 0,
                        i = 0;
                      for (; i < v; ) {
...
`),
                      ...
                      default:
                        if (!n.ctrlKey || n.shiftKey || n.altKey || n.metaKey)
                          if ((v && !g) || !n.altKey || n.metaKey)
                            ...
                            const s = _[n.keyCode],
                              e = s == null ? void 0 : s[n.shiftKey ? 1 : 0];
                    ...
                    (r.DcsHandler = class {
                      ...
                      unhook(g) {
                        ...
                        if (this._hitLimit) h = !1;
                          ...
                          return h.then(
                            i => ((this._params = v), (this._data = ''), (this._hitLimit = !1), i)
                          );
                ...
                2015: (O, r, a) => {
                  ...
                  class v {
                    ...
                    addMany(s, e, t, o) {
                      for (let f = 0; f < s.length; f++) this.table[(e << 8) | s[f]] = (t << 4) | o;
                    }
                  }
                  r.TransitionTable = v;
                  const g = 160;
                      ...
                      if (this._parseStack.state)
                        if (this._parseStack.state === 2)
                          ...
                          switch (this._parseStack.state) {
                            case 3:
                              if (t === !1 && m > -1) {
                                for (; m >= 0 && ((o = c[m](this._params)), o !== !0); m--)
                                  if (o instanceof Promise)
                                    return ((this._parseStack.handlerPos = m), o);
                              }
                            ...
                            case 6:
                              if (
                                ...
                                (o = this._dcsParser.unhook(f !== 24 && f !== 26, t)),
                                o)
                              )
                                return o;
                            ...
                            case 5:
                              if (
                                ((f = s[this._parseStack.chunkPos]),
                                (o = this._oscParser.end(f !== 24 && f !== 26, t)),
                                o)
                              )
                                return o;
                              (f === 27 && (this._parseStack.transition |= 1),
                      ...
                      for (let c = p; c < e; ++c) {
                        switch (
                          ...
                          case 7:
                            ...
                            for (; y >= 0 && ((o = m[y](this._params)), o !== !0); y--)
                              if (o instanceof Promise)
                                return (this._preserveStack(3, m, y, u, c), o);
                            (y < 0 && this._csiHandlerFb((this._collect << 8) | f, this._params),
                              (this.precedingJoinState = 0));
                            break;
                          case 8:
                            do
                          ...
                          case 10:
                            ...
                            for (; L >= 0 && ((o = k[L]()), o !== !0); L--)
                              if (o instanceof Promise)
                                return (this._preserveStack(4, k, L, u, c), o);
                            (L < 0 && this._escHandlerFb((this._collect << 8) | f),
                              (this.precedingJoinState = 0));
                            break;
                          case 11:
                          ...
                          case 13:
                            ...
                            break;
                          case 14:
                            if (((o = this._dcsParser.unhook(f !== 24 && f !== 26)), o))
                              return (this._preserveStack(6, [], 0, u, c), o);
                            (f === 27 && (u |= 1),
                              this._params.reset(),
                              this._params.addParam(0),
                              (this._collect = 0),
                          ...
                          case 5:
                            for (let w = c + 1; ; w++)
                              if (w >= e || (f = s[w]) < 32 || (f > 127 && f < g)) {
                                (this._oscParser.put(s, c, w), (c = w - 1));
                                break;
                              }
                            break;
                          case 6:
                            if (((o = this._oscParser.end(f !== 24 && f !== 26)), o))
                              return (this._preserveStack(5, [], 0, u, c), o);
                            (f === 27 && (u |= 1),
                              this._params.reset(),
                              this._params.addParam(0),
                              (this._collect = 0),
                    ...
                    addSubParam(n) {
                      if (((this._digitIsSub = !0), this.length))
                        if (this._rejectDigits || this._subParamsLength >= this.maxSubParamsLength)
                          ...
                          if (n < -1) throw new Error('values lesser than -1 are not allowed');
                          ((this._subParams[this._subParamsLength++] = n > a ? a : n),
                  ...
                  (Object.defineProperty(r, '__esModule', { value: !0 }),
                    ...
                    (r.ParserApi = class {
                      ...
                      registerCsiHandler(a, l) {
                        return this._core.registerCsiHandler(a, _ => l(_.toArray()));
                      }
                      addCsiHandler(a, l) {
                        return this.registerCsiHandler(a, l);
                      }
                      registerDcsHandler(a, l) {
                        return this._core.registerDcsHandler(a, (_, n) => l(_, n.toArray()));
                      }
                      addDcsHandler(a, l) {
                      ...
                      function (i, s, e, t) {
                        ...
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          ...
                          for (var p = i.length - 1; p >= 0; p--)
                            (o = i[p]) && (u = (f < 3 ? o(u) : f > 3 ? o(s, e, u) : o(s, e)) || u);
                  ...
                  let h = (r.BufferService = class extends d.Disposable {
                    ...
                    scroll(i, s = !1) {
                      ...
                      if (e.scrollTop === 0) {
                        ...
                        const u = f - o + 1;
                        (e.lines.shiftElements(o + 1, u - 1, -1), e.lines.set(f, t.clone()));
                      }
                    ...
                    scrollLines(i, s, e) {
                      ...
                      ((t.ydisp = Math.max(Math.min(t.ydisp + i, t.ybase), 0)),
                        o !== t.ydisp && (s || this._onScroll.fire(t.ydisp)));
                    }
                  });
                ...
                1753: function (O, r, a) {
                    ...
                    return (
                      t.button === 4
                        ...
                        : ((f |= 3 & t.button),
                          4 & t.button && (f |= 64),
                          8 & t.button && (f |= 128),
                          t.action === 32 ? (f |= 32) : t.action !== 0 || o || (f |= 3)),
                      f
                    );
                  }
                  ...
                  let e = (r.CoreMouseService = class extends v.Disposable {
                    ...
                    _equalEvents(t, o, f) {
                      ...
                      } else if (t.col !== o.col || t.row !== o.row) return !1;
                      return (
                        t.button === o.button &&
                        t.action === o.action &&
                        t.ctrl === o.ctrl &&
                    ...
                    forEachDecorationAtCell(e, t, o, f) {
                      this._decorations.forEachByKey(t, u => {
                        ((v = u.options.x ?? 0),
                          ...
                          e >= v && e < g && (!o || (u.options.layer ?? 'bottom') === o) && f(u));
                      });
                    }
                  }
                    ...
                    h = (r.LogService = class extends n.Disposable {
                      ...
                      trace(i, ...s) {
                        ...
                        this._logLevel <= d.LogLevelEnum.TRACE &&
                          this._log(
                            ((e = this._optionsService.options.logger) == null
                              ? void 0
                              : e.trace.bind(this._optionsService.options.logger)) ?? console.log,
                            i,
                            s
                          );
                      }
                      debug(i, ...s) {
                        ...
                        this._logLevel <= d.LogLevelEnum.DEBUG &&
                          this._log(
                            ((e = this._optionsService.options.logger) == null
                              ? void 0
                              : e.debug.bind(this._optionsService.options.logger)) ?? console.log,
                            i,
                            s
                          );
                      }
                      info(i, ...s) {
                        ...
                        this._logLevel <= d.LogLevelEnum.INFO &&
                          this._log(
                            ((e = this._optionsService.options.logger) == null
                              ? void 0
                              : e.info.bind(this._optionsService.options.logger)) ?? console.info,
                            i,
                            s
                          );
                      }
                      warn(i, ...s) {
                        ...
                        this._logLevel <= d.LogLevelEnum.WARN &&
                          this._log(
                            ((e = this._optionsService.options.logger) == null
                              ? void 0
                              : e.warn.bind(this._optionsService.options.logger)) ?? console.warn,
                            i,
                            s
                          );
                      }
                      error(i, ...s) {
                        ...
                        this._logLevel <= d.LogLevelEnum.ERROR &&
                          this._log(
                            ((e = this._optionsService.options.logger) == null
                              ? void 0
                              : e.error.bind(this._optionsService.options.logger)) ?? console.error,
                            i,
                            s
                          );
                      }
                      ...
                      function (v, g, h, i) {
                        ...
                        if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                          ...
                          for (var o = v.length - 1; o >= 0; o--)
                            (s = v[o]) && (t = (e < 3 ? s(t) : e > 3 ? s(g, h, t) : s(g, h)) || t);
                    ...
                    registerLink(v) {
                      ...
                      if (v.id === void 0) {
                        const o = g.addMarker(g.ybase + g.y),
                          f = { data: v, id: this._nextId++, lines: [o] };
                        return (
                          o.onDispose(() => this._removeMarkerFromLink(f, o)),
            ...
            function G(O) {
              ...
              var a = (Y[O] = { exports: {} });
              return (ie[O].call(a.exports, a, a.exports, G), a.exports);
            }
            var Q = {};
            return (
              (() => {
                ...
                class h extends l.Disposable {
                  constructor(s) {
                    (super(),
                      (this._core = this.register(new a.Terminal(s))),
                      (this._addonManager = this.register(new _.AddonManager())),
                      (this._publicOptions = { ...this._core.options }));
                    const e = o => this._core.options[o],
                      t = (o, f) => {
                        (this._checkReadonlyOptions(o), (this._core.options[o] = f));
                      };
                    for (const o in this._core.options) {
                      const f = { get: e.bind(this, o), set: t.bind(this, o) };
...
var Ee = ye();
const ke = { Terminal: we.Terminal, FitAddon: Ee.FitAddon };
