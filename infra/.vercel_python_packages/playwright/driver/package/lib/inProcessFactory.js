...
function createInProcessPlaywright() {
  const playwright = (0, import_server.createPlaywright)({
  ...
  playwrightAPI.chromium._serverLauncher = new import_browserServerImpl.BrowserServerLauncherImpl(
    'chromium'
  );
  playwrightAPI.firefox._serverLauncher = new import_browserServerImpl.BrowserServerLauncherImpl(
    'firefox'
  );
  playwrightAPI.webkit._serverLauncher = new import_browserServerImpl.BrowserServerLauncherImpl(
    'webkit'
  );
  ...
  clientConnection.toImpl = x => {
    ...
    if (!x) return dispatcherConnection._dispatcherByGuid.get('');
