  ...
  async newContext(options = {}) {
    ...
    const storageState =
      typeof options.storageState === 'string'
        ? JSON.parse(
            await this._playwright._platform.fs().promises.readFile(options.storageState, 'utf8')
          )
    ...
    const context = APIRequestContext.from(
      (
        await this._playwright._channel.newRequest({
          ...
          clientCertificates: await (0, import_browserContext.toClientCertificatesProtocol)(
...
class APIRequestContext extends import_channelOwner.ChannelOwner {
  ...
  async _innerFetch(options = {}) {
    return await this._wrapApiCall(async () => {
      if (this._closeReason) throw new import_errors.TargetClosedError(this._closeReason);
      (0, import_assert.assert)(
        options.request || typeof options.url === 'string',
        'First argument must be either URL string or Request'
      );
      (0, import_assert.assert)(
        (options.data === void 0 ? 0 : 1) +
          (options.form === void 0 ? 0 : 1) +
          (options.multipart === void 0 ? 0 : 1) <=
          1,
      ...
      if (
        postDataBuffer === void 0 &&
        jsonData === void 0 &&
        formData === void 0 &&
        multipartData === void 0
      )
...
class APIResponse {
  ...
  async body() {
    return await this._request._wrapApiCall(
      async () => {
        try {
...
function objectToArray(map) {
  ...
  for (const [name, value] of Object.entries(map)) {
    if (value !== void 0) result.push({ name, value: String(value) });
  }
  return result;
}
