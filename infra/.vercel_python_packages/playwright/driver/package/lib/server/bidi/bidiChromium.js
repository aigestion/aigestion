...
class BidiChromium extends import_browserType.BrowserType {
  ...
  async connectToTransport(transport, options, browserLogsCollector) {
    ...
    try {
      return import_bidiBrowser.BidiBrowser.connect(
  ...
  attemptToGracefullyCloseBrowser(transport) {
    ...
    transport.send({
      ...
      params: {},
      id: import_bidiConnection.kBrowserCloseMessageId,
    });
  }
  ...
  _innerDefaultArgs(options) {
    ...
    const chromeArguments = [
      ...(0, import_chromiumSwitches.chromiumSwitches)(options.assistantMode),
    ];
