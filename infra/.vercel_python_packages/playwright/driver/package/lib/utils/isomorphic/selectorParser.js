...
const kNestedSelectorNames = /* @__PURE__ */ new Set([
  'internal:has',
  'internal:has-not',
  'internal:and',
  'internal:or',
...
const kNestedSelectorNamesWithDistance = /* @__PURE__ */ new Set([
  'left-of',
  'right-of',
  'above',
  'below',
...
const customCSSNames = /* @__PURE__ */ new Set([
  'not',
  'is',
  'where',
  'has',
    ...
    if (kNestedSelectorNames.has(part.name)) {
      ...
      try {
        ...
        if (
          ...
          throw new import_cssParser.InvalidSelectorError(
