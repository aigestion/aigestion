      ...
      t = t
        .replace(/(?:r)\$(\d+)(i)?/g, (_, ordinal, suffix) => {
          ...
          if (
            ...
            return (
              (0, import_stringUtils.escapeForAttributeSelector)(new RegExp(param.text), false) +
              (suffix || '')
            );
          return (0, import_stringUtils.escapeForTextSelector)(
            new RegExp(param.text, suffix),
            false
          );
        })
...
function unsafeLocatorOrSelectorAsSelector(language, locator, testIdAttributeName) {
  ...
  const locators = (0, import_locatorGenerators.asLocators)(
    language,
    selector,
    void 0,
    void 0,
