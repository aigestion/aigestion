...
(function (exports$1) {
  ...
  exports$1.unstable_scheduleCallback = function (a, b, c) {
    ...
    c > d
      ...
      : ((a.sortIndex = e), f(r2, a), A2 || z2 || ((A2 = true), I2(J2)));
    return a;
  };
  ...
  Jb(function () {
    ...
    a: {
      ...
      if (void 0 !== h2) {
        ...
        0 < t2.length &&
          ((h2 = new k2(h2, n2, null, c, e2)), g2.push({ event: h2, listeners: t2 }));
      }
    }
    if (0 === (b & 7)) {
      a: {
...
function Og(a) {
  ...
  function k(a2, b2, c2, d2) {
    ...
    if (
      null !== b2 &&
      (b2.elementType === f2 ||
        ('object' === typeof f2 && null !== f2 && f2.$$typeof === Ha && Ng(f2) === b2.type))
    )
  ...
  function n2(e2, g2, h2, k2) {
    for (
      var l3 = null, m2 = null, u2 = g2, w2 = (g2 = 0), x2 = null;
    ...
    if (null === u2) {
      for (; w2 < h2.length; w2++)
        ((u2 = q2(e2, h2[w2], k2)),
          null !== u2 &&
            ((g2 = f(u2, g2, w2)), null === m2 ? (l3 = u2) : (m2.sibling = u2), (m2 = u2)));
      I && tg(e2, w2);
      return l3;
    }
    for (u2 = d(e2, u2); w2 < h2.length; w2++)
      ((x2 = y2(u2, e2, w2, h2[w2], k2)),
        null !== x2 &&
          (a && null !== x2.alternate && u2.delete(null === x2.key ? w2 : x2.key),
          (g2 = f(x2, g2, w2)),
          null === m2 ? (l3 = x2) : (m2.sibling = x2),
          (m2 = x2)));
    a &&
  ...
  function t2(e2, g2, h2, k2) {
    ...
    for (
      var u2 = (l3 = null), m2 = g2, w2 = (g2 = 0), x2 = null, n3 = h2.next();
      null !== m2 && !n3.done;
      w2++, n3 = h2.next()
    ) {
    ...
    if (n3.done) return (c(e2, m2), I && tg(e2, w2), l3);
    if (null === m2) {
      for (; !n3.done; w2++, n3 = h2.next())
        ((n3 = q2(e2, n3.value, k2)),
          null !== n3 &&
            ((g2 = f(n3, g2, w2)), null === u2 ? (l3 = n3) : (u2.sibling = n3), (u2 = n3)));
      I && tg(e2, w2);
      return l3;
    }
    for (m2 = d(e2, m2); !n3.done; w2++, n3 = h2.next())
      ((n3 = y2(m2, e2, w2, n3.value, k2)),
        null !== n3 &&
          (a && null !== n3.alternate && m2.delete(null === n3.key ? w2 : n3.key),
          (g2 = f(n3, g2, w2)),
      ...
      switch (f2.$$typeof) {
        case va:
          a: {
            ...
            f2.type === ya
              ? ((d2 = Tg(f2.props.children, a2.mode, h2, f2.key)), (d2.return = a2), (a2 = d2))
    ...
    return ('string' === typeof f2 && '' !== f2) || 'number' === typeof f2
      ? ((f2 = '' + f2),
        null !== d2 && 6 === d2.tag
          ...
          : (c(a2, d2), (d2 = Qg(f2, a2.mode, h2)), (d2.return = a2), (a2 = d2)),
        g(a2))
      : c(a2, d2);
  }
  return J2;
...
function qh(a, b, c, d) {
  ...
  if (null !== h) {
    ...
    null !== m &&
      ((m = m.updateQueue),
      (h = m.lastBaseUpdate),
      h !== g && (null === h ? (m.firstBaseUpdate = l2) : (h.next = l2), (m.lastBaseUpdate = k)));
  }
  if (null !== f) {
    var q2 = e.baseState;
    g = 0;
    ...
    do {
      ...
      if ((d & r2) === r2) {
        ...
        ((y2 = {
          ...
          null === m ? ((l2 = m = y2), (k = q2)) : (m = m.next = y2),
          (g |= r2));
      h = h.next;
      if (null === h)
...
function hj(a, b, c, d, e) {
  ...
  if (null === b.stateNode) (ij(a, b), Gi(b, c, d), Ii(b, c, d, e), (d = true));
    ...
    var m = c.getDerivedStateFromProps,
      q2 = 'function' === typeof m || 'function' === typeof g.getSnapshotBeforeUpdate;
    q2 ||
      ('function' !== typeof g.UNSAFE_componentWillReceiveProps &&
        'function' !== typeof g.componentWillReceiveProps) ||
      ((h !== d || k !== l2) && Hi(b, g, d, l2));
    jh = false;
    var r2 = b.memoizedState;
    g.state = r2;
    qh(b, d, g, e);
    k = b.memoizedState;
    h !== d || r2 !== k || Wf.current || jh
      ? ('function' === typeof m && (Di(b, c, m, d), (k = b.memoizedState)),
        (h = jh || Fi(b, c, h, d, r2, k, l2))
          ? (q2 ||
    ...
    (m = 'function' === typeof y2 || 'function' === typeof g.getSnapshotBeforeUpdate) ||
      ('function' !== typeof g.UNSAFE_componentWillReceiveProps &&
        'function' !== typeof g.componentWillReceiveProps) ||
      ((h !== q2 || r2 !== k) && Hi(b, g, d, k));
    jh = false;
    r2 = b.memoizedState;
    g.state = r2;
    qh(b, d, g, e);
    ...
    h !== q2 || r2 !== n2 || Wf.current || jh
      ? ('function' === typeof y2 && (Di(b, c, y2, d), (n2 = b.memoizedState)),
        (l2 = jh || Fi(b, c, l2, d, r2, n2, k) || false)
          ? (m ||
              ('function' !== typeof g.UNSAFE_componentWillUpdate &&
                'function' !== typeof g.componentWillUpdate) ||
              ('function' === typeof g.componentWillUpdate && g.componentWillUpdate(d, n2, k),
              'function' === typeof g.UNSAFE_componentWillUpdate &&
                g.UNSAFE_componentWillUpdate(d, n2, k)),
      ...
      if (!d.hasOwnProperty(l2) && e.hasOwnProperty(l2) && null != e[l2])
        if ('style' === l2) {
          ...
          'dangerouslySetInnerHTML' !== l2 &&
            ...
            'autoFocus' !== l2 &&
            (ea.hasOwnProperty(l2) ? f || (f = []) : (f = f || []).push(l2, null));
    for (l2 in d) {
      var k = d[l2];
      ...
      if (d.hasOwnProperty(l2) && k !== h && (null != k || null != h))
        if ('style' === l2)
          ...
          } else (c || (f || (f = []), f.push(l2, c)), (c = k));
        else
          'dangerouslySetInnerHTML' === l2
            ? ((k = k ? k.__html : void 0),
              (h = h ? h.__html : void 0),
              null != k && h !== k && (f = f || []).push(l2, k))
            : 'children' === l2
              ? ('string' !== typeof k && 'number' !== typeof k) || (f = f || []).push(l2, '' + k)
              : 'suppressContentEditableWarning' !== l2 &&
                'suppressHydrationWarning' !== l2 &&
                (ea.hasOwnProperty(l2)
                  ? (null != k && 'onScroll' === l2 && D('scroll', a), f || h === k || (f = []))
                  : (f = f || []).push(l2, k));
    }
    c && (f = f || []).push('style', c);
    var l2 = f;
          ...
          for (var g in f)
            if (f.hasOwnProperty(g)) {
              ...
              'children' === g
                ? 'string' === typeof h
                  ? d.textContent !== h &&
                    (true !== f.suppressHydrationWarning && Af(d.textContent, h, a),
                    (e = ['children', h]))
                  : 'number' === typeof h &&
                    d.textContent !== '' + h &&
                    (true !== f.suppressHydrationWarning && Af(d.textContent, h, a),
  ...
  if (0 !== b) {
    ...
    if (6 === b) Ck(a, d);
      ...
      if (
        0 === (d & 30) &&
        !Ok(e) &&
        ((b = Ik(a, d)), 2 === b && ((f = xc(a)), 0 !== f && ((d = f), (b = Nk(a, f)))), 1 === b)
      )
      ...
      a: {
        ...
        if (null !== k && 'object' === typeof k && 'function' === typeof k.then) {
          ...
          if (0 === (m.mode & 1) && (0 === q2 || 11 === q2 || 15 === q2)) {
            var r2 = m.alternate;
            r2
              ? ((m.updateQueue = r2.updateQueue),
                (m.memoizedState = r2.memoizedState),
                (m.lanes = r2.lanes))
...
export { React$1 as R, reactDomExports as a, React as b, commonjsGlobal as c, reactExports as r };
