var t = Object.defineProperty,
  e = (e, n, i) =>
    ((e, n, i) =>
      n in e ? t(e, n, { enumerable: !0, configurable: !0, writable: !0, value: i }) : (e[n] = i))(
      e,
      'symbol' != typeof n ? n + '' : n,
      i
    );
import { r as n, a as i } from './vendor-CzpUEfg8.js';
var r = { exports: {} },
  a = {},
  s = n,
  ...
  h = s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function d(t, e, n) {
  ...
  e))
    c.call(e, i) && !u.hasOwnProperty(i) && (r[i] = e[i]);
  if (t && t.defaultProps) for (i in (e = t.defaultProps)) void 0 === r[i] && (r[i] = e[i]);
  return { $$typeof: o, type: t, key: a, ref: s, props: r, _owner: h.current };
}
((a.Fragment = l), (a.jsx = d), (a.jsxs = d), (r.exports = a));
var p = r.exports,
  f = {},
  m = i;
((f.createRoot = m.createRoot), (f.hydrateRoot = m.hydrateRoot));
const g = {},
  _ = function (t, e, n) {
    ...
    if (e && e.length > 0) {
      ...
      const t = document.querySelector('meta[property=csp-nonce]'),
        n = (null == t ? void 0 : t.nonce) || (null == t ? void 0 : t.getAttribute('nonce'));
    ...
    return i.then(e => {
      for (const t of e || []) 'rejected' === t.status && r(t.reason);
      return t().catch(r);
    });
  },
  v = '182',
  ...
  setQuaternionFromProperEuler: function (t, e, n, i, r) {
    ...
    switch (r) {
      ...
      case 'ZYZ':
        ...
        break;
      default:
        hn('MathUtils: .setQuaternionFromProperEuler() encountered an unknown order: ' + r);
    }
  },
  normalize: bn,
  denormalize: Sn,
...
class En {
  ...
  clamp(t, e) {
    return ((this.x = xn(this.x, t.x, e.x)), (this.y = xn(this.y, t.y, e.y)), this);
  }
  clampScalar(t, e) {
    return ((this.x = xn(this.x, t, e)), (this.y = xn(this.y, t, e)), this);
  }
  clampLength(t, e) {
    const n = this.length();
    return this.divideScalar(n || 1).multiplyScalar(xn(n, t, e));
  }
  floor() {
  ...
  setFromEuler(t, e = !0) {
    ...
    switch (a) {
      ...
      case 'XZY':
        ...
        break;
      default:
        hn('Quaternion: .setFromEuler() encountered an unknown order: ' + a);
    }
...
class An {
  ...
  applyEuler(t) {
    return this.applyQuaternion(Cn.setFromEuler(t));
  }
  applyAxisAngle(t, e) {
  ...
  clamp(t, e) {
    return (
      (this.x = xn(this.x, t.x, e.x)),
      (this.y = xn(this.y, t.y, e.y)),
      (this.z = xn(this.z, t.z, e.z)),
      this
    );
  }
  clampScalar(t, e) {
    return (
      (this.x = xn(this.x, t, e)),
      (this.y = xn(this.y, t, e)),
      (this.z = xn(this.z, t, e)),
      this
    );
  }
  clampLength(t, e) {
...
class Pn {
  ...
  scale(t, e) {
    return (this.premultiply(In.makeScale(t, e)), this);
  }
  rotate(t) {
    return (this.premultiply(In.makeRotation(-t)), this);
  }
  translate(t, e) {
    return (this.premultiply(In.makeTranslation(t, e)), this);
  }
  makeTranslation(t, e) {
    return (
...
function Dn() {
  const t = {
      ...
      getTransfer: function (t) {
        return t === Ve ? Ge : this.spaces[t].transfer;
      },
      ...
      toWorkingColorSpace: function (e, n) {
        return (
          dn('ColorManagement: .toWorkingColorSpace() has been renamed to .colorSpaceToWorking().'),
...
class zn {
  static getDataURL(t, e = 'image/png') {
    ...
    if (t instanceof HTMLCanvasElement) n = t;
      ...
      (void 0 === Bn && (Bn = sn('canvas')), (Bn.width = t.width), (Bn.height = t.height));
      const e = Bn.getContext('2d');
  ...
  static sRGBToLinear(t) {
    ...
    return (
      hn('ImageUtils.sRGBToLinear(): Unsupported image type. No color space conversion applied.'),
      t
    );
  }
}
    ...
    if (null !== i) {
      ...
      if (Array.isArray(i)) {
        ...
        for (let e = 0, n = i.length; e < n; e++)
          i[e].isDataTexture ? t.push(Hn(i[e].image)) : t.push(Hn(i[e]));
      } else t = Hn(i);
      n.url = t;
    }
...
function Hn(t) {
  return ('undefined' != typeof HTMLImageElement && t instanceof HTMLImageElement) ||
    ...
    : t.data
      ...
      : (hn('Texture: Unable to serialize Texture.'), {});
}
let Gn = 0;
const Wn = new An();
class Xn extends pn {
  ...
  get width() {
    return this.source.getSize(Wn).x;
  }
  get height() {
    return this.source.getSize(Wn).y;
  }
  get depth() {
    return this.source.getSize(Wn).z;
  }
  get image() {
  ...
  setValues(t) {
    for (const e in t) {
      const n = t[e];
      if (void 0 === n) {
        hn(`Texture.setValues(): parameter '${e}' has value of undefined.`);
        continue;
      }
      const i = this[e];
      void 0 !== i
        ? (i && n && i.isVector2 && n.isVector2) ||
          ...
          ? i.copy(n)
          : (this[e] = n)
        : hn(`Texture.setValues(): property '${e}' does not exist.`);
    }
  }
  toJSON(t) {
    const e = void 0 === t || 'string' == typeof t;
...
((Xn.DEFAULT_IMAGE = null), (Xn.DEFAULT_MAPPING = ct), (Xn.DEFAULT_ANISOTROPY = 1));
class jn {
  constructor(t = 0, e = 0, n = 0, i = 1) {
    ((jn.prototype.isVector4 = !0), (this.x = t), (this.y = e), (this.z = n), (this.w = i));
  }
  get width() {
    return this.z;
  }
...
class qn extends pn {
  constructor(t = 1, e = 1, n = {}) {
    (super(),
      ...
      (this.height = e),
      (this.depth = n.depth),
      (this.scissor = new jn(0, 0, t, e)),
      (this.scissorTest = !1),
      (this.viewport = new jn(0, 0, t, e)));
  ...
  copy(t) {
    ...
    for (let e = 0, n = t.textures.length; e < n; e++) {
      ...
      this.textures[e].source = new kn(n);
    }
    return (
...
class Jn {
  constructor(t = new An(1 / 0, 1 / 0, 1 / 0), e = new An(-1 / 0, -1 / 0, -1 / 0)) {
  ...
  setFromArray(t) {
    this.makeEmpty();
    for (let e = 0, n = t.length; e < n; e += 3) this.expandByPoint(Qn.fromArray(t, e));
    return this;
  }
  setFromBufferAttribute(t) {
    this.makeEmpty();
    for (let e = 0, n = t.count; e < n; e++) this.expandByPoint(Qn.fromBufferAttribute(t, e));
    return this;
  }
  setFromPoints(t) {
    this.makeEmpty();
  ...
  setFromCenterAndSize(t, e) {
    const n = Qn.copy(e).multiplyScalar(0.5);
    ...
    if (void 0 !== n) {
      ...
      if (!0 === e && void 0 !== i && !0 !== t.isInstancedMesh)
        for (let e = 0, n = i.count; e < n; e++)
          (!0 === t.isMesh ? t.getVertexPosition(e, Qn) : Qn.fromBufferAttribute(i, e),
            Qn.applyMatrix4(t.matrixWorld),
            this.expandByPoint(Qn));
      else
        (void 0 !== t.boundingBox
          ? (null === t.boundingBox && t.computeBoundingBox(), ti.copy(t.boundingBox))
          : (null === n.boundingBox && n.computeBoundingBox(), ti.copy(n.boundingBox)),
  ...
  intersectsSphere(t) {
    return (this.clampPoint(t.center, Qn), Qn.distanceToSquared(t.center) <= t.radius * t.radius);
  }
  intersectsPlane(t) {
    let e, n;
    return (
  ...
  intersectsTriangle(t) {
    ...
    (this.getCenter(oi),
      ...
      ei.subVectors(t.a, oi),
      ni.subVectors(t.b, oi),
      ii.subVectors(t.c, oi),
      ri.subVectors(ni, ei),
      ai.subVectors(ii, ni),
      si.subVectors(ei, ii));
    let e = [
    ...
    return (
      ...
      ((e = [1, 0, 0, 0, 1, 0, 0, 0, 1]),
      !!ui(e, ei, ni, ii, li) &&
        (ci.crossVectors(ri, ai), (e = [ci.x, ci.y, ci.z]), ui(e, ei, ni, ii, li)))
    );
  }
  clampPoint(t, e) {
  ...
  distanceToPoint(t) {
    return this.clampPoint(t, Qn).distanceTo(t);
  }
  getBoundingSphere(t) {
    return (
      this.isEmpty()
        ? t.makeEmpty()
        : (this.getCenter(t.center), (t.radius = 0.5 * this.getSize(Qn).length())),
      t
    );
  }
  intersect(t) {
  ...
  applyMatrix4(t) {
    return (
      this.isEmpty() ||
        ($n[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(t),
        $n[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(t),
        $n[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(t),
        $n[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(t),
        $n[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(t),
        $n[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(t),
        $n[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(t),
        $n[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(t),
...
const $n = [new An(), new An(), new An(), new An(), new An(), new An(), new An(), new An()],
  Qn = new An(),
  ti = new Jn(),
  ei = new An(),
  ni = new An(),
...
class mi {
  ...
  setFromPoints(t, e) {
    const n = this.center;
    void 0 !== e ? n.copy(e) : di.setFromPoints(t).getCenter(n);
    let i = 0;
  ...
  expandByPoint(t) {
    ...
    if (e > this.radius * this.radius) {
      const t = Math.sqrt(e),
        n = 0.5 * (t - this.radius);
      (this.center.addScaledVector(pi, n / t), (this.radius += n));
    }
    return this;
  }
  union(t) {
    return t.isEmpty()
      ...
      : this.isEmpty()
        ...
        : (!0 === this.center.equals(t.center)
            ...
            : (fi.subVectors(t.center, this.center).setLength(t.radius),
              this.expandByPoint(pi.copy(t.center).add(fi)),
              this.expandByPoint(pi.copy(t.center).sub(fi))),
          this);
  }
  equals(t) {
...
class bi {
  ...
  distanceSqToPoint(t) {
    ...
    return e < 0
      ...
      : (gi.copy(this.origin).addScaledVector(this.direction, e), gi.distanceToSquared(t));
  }
  distanceSqToSegment(t, e, n, i) {
    ...
    if (c > 0)
      ...
      ((u = a > 0 ? -r : r), (h = Math.max(0, -(a * u + s))), (d = -h * h + u * (u + 2 * o) + l));
    return (
      n && n.copy(this.origin).addScaledVector(this.direction, h),
      i && i.copy(_i).addScaledVector(vi, u),
      d
    );
  }
  intersectSphere(t, e) {
  ...
  intersectTriangle(t, e, n, i, r) {
    (Mi.subVectors(e, t), yi.subVectors(n, t), Si.crossVectors(Mi, yi));
    let a,
      s = this.direction.dot(Si);
    if (s > 0) {
      if (i) return null;
      a = 1;
    } else {
    ...
    xi.subVectors(this.origin, t);
    const o = a * this.direction.dot(yi.crossVectors(xi, yi));
    if (o < 0) return null;
    const l = a * this.direction.dot(Mi.cross(xi));
    if (l < 0) return null;
...
class Ti {
  ...
  extractRotation(t) {
    ...
    const e = this.elements,
      ...
      a = 1 / Ei.setFromMatrixColumn(t, 2).length();
    return (
      (e[0] = n[0] * i),
      (e[1] = n[1] * i),
      (e[2] = n[2] * i),
  ...
  lookAt(t, e, n) {
    ...
    return (
      ...
      Ii.normalize(),
      Ci.crossVectors(n, Ii),
      0 === Ci.lengthSq() &&
        (1 === Math.abs(n.z) ? (Ii.x += 1e-4) : (Ii.z += 1e-4),
        Ii.normalize(),
        Ci.crossVectors(n, Ii)),
      Ci.normalize(),
      Pi.crossVectors(Ii, Ci),
      (i[0] = Ci.x),
      (i[4] = Pi.x),
      (i[8] = Ii.x),
      (i[1] = Ci.y),
  ...
  multiplyMatrices(t, e) {
    ...
    return (
      ...
      (r[4] = a * S + s * w + o * P + l * D),
      (r[8] = a * b + s * A + o * I + l * N),
      (r[12] = a * T + s * R + o * L + l * F),
      (r[1] = c * y + h * E + u * C + d * U),
      (r[5] = c * S + h * w + u * P + d * D),
      (r[9] = c * b + h * A + u * I + d * N),
      (r[13] = c * T + h * R + u * L + d * F),
      (r[2] = p * y + f * E + m * C + g * U),
      (r[6] = p * S + f * w + m * P + g * D),
      (r[10] = p * b + f * A + m * I + g * N),
      (r[14] = p * T + f * R + m * L + g * F),
      (r[3] = _ * y + v * E + x * C + M * U),
      (r[7] = _ * S + v * w + x * P + M * D),
      (r[11] = _ * b + v * A + x * I + M * N),
      (r[15] = _ * T + v * R + x * L + M * F),
      this
    );
  }
  multiplyScalar(t) {
  ...
  decompose(t, e, n) {
    ...
    (this.determinant() < 0 && (r = -r), wi.copy(this));
    const o = 1 / r,
      l = 1 / a,
      c = 1 / s;
    return (
  ...
  makePerspective(t, e, n, i, r, a, s = 2e3, o = !1) {
    ...
    else if (s === nn) ((p = -(a + r) / (a - r)), (f = (-2 * a * r) / (a - r)));
    else {
      if (s !== rn)
  ...
  makeOrthographic(t, e, n, i, r, a, s = 2e3, o = !1) {
    ...
    else if (s === nn) ((p = -2 / (a - r)), (f = -(a + r) / (a - r)));
    else {
      if (s !== rn)
...
const Ei = new An(),
  ...
  Ui = new wn();
class Di {
  constructor(t = 0, e = 0, n = 0, i = Di.DEFAULT_ORDER) {
  ...
  setFromRotationMatrix(t, e = this._order, n = !0) {
    ...
    switch (e) {
      ...
      case 'YZX':
        ...
        break;
      case 'XZY':
        ((this._z = Math.asin(-xn(a, -1, 1))),
          Math.abs(a) < 0.9999999
            ? ((this._x = Math.atan2(u, l)), (this._y = Math.atan2(s, r)))
            : ((this._x = Math.atan2(-c, d)), (this._y = 0)));
        break;
      default:
        hn('Euler: .setFromRotationMatrix() encountered an unknown order: ' + e);
    }
...
const Oi = new An(),
  ...
  qi = { type: 'added' },
  Yi = { type: 'removed' },
  Ki = { type: 'childadded', child: null },
  Zi = { type: 'childremoved', child: null };
class Ji extends pn {
  constructor() {
    (super(),
      (this.isObject3D = !0),
    ...
    (e._onChange(function () {
      ...
      (this.matrixAutoUpdate = Ji.DEFAULT_MATRIX_AUTO_UPDATE),
      (this.matrixWorldAutoUpdate = Ji.DEFAULT_MATRIX_WORLD_AUTO_UPDATE),
  ...
  worldToLocal(t) {
    return (this.updateWorldMatrix(!0, !1), t.applyMatrix4(zi.copy(this.matrixWorld).invert()));
  }
  lookAt(t, e, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight ? zi.lookAt(ki, Vi, this.up) : zi.lookAt(Vi, ki, this.up),
      this.quaternion.setFromRotationMatrix(zi),
      i &&
        (zi.extractRotation(i.matrixWorld),
        Bi.setFromRotationMatrix(zi),
  ...
  add(t) {
    ...
    return t === this
      ? (un("Object3D.add: object can't be added as a child of itself.", t), this)
      : (t && t.isObject3D
          ? (t.removeFromParent(),
            (t.parent = this),
            ...
            (Ki.child = null))
          : un('Object3D.add: object not an instance of THREE.Object3D.', t),
        this);
  }
  remove(t) {
    if (arguments.length > 1) {
  ...
  attach(t) {
    return (
      this.updateWorldMatrix(!0, !1),
      zi.copy(this.matrixWorld).invert(),
      null !== t.parent && (t.parent.updateWorldMatrix(!0, !1), zi.multiply(t.parent.matrixWorld)),
      t.applyMatrix4(zi),
      t.removeFromParent(),
      (t.parent = this),
      this.children.push(t),
  ...
  getWorldQuaternion(t) {
    return (this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ki, t, Hi), t);
  }
  getWorldScale(t) {
    return (this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ki, Gi, t), t);
  }
  getWorldDirection(t) {
    this.updateWorldMatrix(!0, !1);
...
((Ji.DEFAULT_UP = new An(0, 1, 0)),
  (Ji.DEFAULT_MATRIX_AUTO_UPDATE = !0),
  (Ji.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0));
const $i = new An(),
  Qi = new An(),
  tr = new An(),
  er = new An(),
...
class ur {
  ...
  static getNormal(t, e, n, i) {
    (i.subVectors(n, e), $i.subVectors(t, e), i.cross($i));
    const r = i.lengthSq();
    return r > 0 ? i.multiplyScalar(1 / Math.sqrt(r)) : i.set(0, 0, 0);
  }
  static getBarycoord(t, e, n, i, r) {
    ($i.subVectors(i, e), Qi.subVectors(n, e), tr.subVectors(t, e));
    const a = $i.dot($i),
      s = $i.dot(Qi),
      o = $i.dot(tr),
      l = Qi.dot(Qi),
  ...
  static containsPoint(t, e, n, i) {
    return null !== this.getBarycoord(t, e, n, i, er) && er.x >= 0 && er.y >= 0 && er.x + er.y <= 1;
  }
  static getInterpolation(t, e, n, i, r, a, s, o) {
    return null === this.getBarycoord(t, e, n, i, er)
      ? ((o.x = 0), (o.y = 0), 'z' in o && (o.z = 0), 'w' in o && (o.w = 0), null)
      : (o.setScalar(0),
        o.addScaledVector(r, er.x),
        o.addScaledVector(a, er.y),
        o.addScaledVector(s, er.z),
        o);
  }
  ...
  static isFrontFacing(t, e, n, i) {
    return ($i.subVectors(n, e), Qi.subVectors(t, e), $i.cross(Qi).dot(i) < 0);
  }
  set(t, e, n) {
  ...
  getArea() {
    return (
      $i.subVectors(this.c, this.b),
      Qi.subVectors(this.a, this.b),
      0.5 * $i.cross(Qi).length()
    );
  }
  getMidpoint(t) {
    return t
  ...
  getInterpolation(t, e, n, i, r) {
    return ur.getInterpolation(t, this.a, this.b, this.c, e, n, i, r);
  }
  containsPoint(t) {
    return ur.containsPoint(t, this.a, this.b, this.c);
  }
  isFrontFacing(t) {
    return ur.isFrontFacing(this.a, this.b, this.c, t);
  }
  intersectsBox(t) {
  ...
  closestPointToPoint(t, e) {
    const n = this.a,
      ...
      r = this.c;
    let a, s;
    (nr.subVectors(i, n), ir.subVectors(r, n), ar.subVectors(t, n));
    const o = nr.dot(ar),
      l = ir.dot(ar);
    ...
    const u = o * h - c * l;
    if (u <= 0 && o >= 0 && c <= 0) return ((a = o / (o - c)), e.copy(n).addScaledVector(nr, a));
    or.subVectors(t, r);
    const d = nr.dot(or),
      p = ir.dot(or);
    if (p >= 0 && d <= p) return e.copy(r);
    const f = d * l - o * p;
    if (f <= 0 && l >= 0 && p <= 0) return ((s = l / (l - p)), e.copy(n).addScaledVector(ir, s));
    const m = c * p - d * h;
    if (m <= 0 && h - c >= 0 && d - p >= 0)
      return (
        rr.subVectors(r, i),
        (s = (h - c) / (h - c + (d - p))),
        e.copy(i).addScaledVector(rr, s)
      );
    const g = 1 / (m + f + u);
    return ((a = f * g), (s = u * g), e.copy(n).addScaledVector(nr, a).addScaledVector(ir, s));
  }
  equals(t) {
...
class gr {
  ...
  setHex(t, e = ke) {
    return (
      ...
      (this.g = ((t >> 8) & 255) / 255),
      (this.b = (255 & t) / 255),
      Nn.colorSpaceToWorking(this, e),
      this
    );
  }
  setRGB(t, e, n, i = Nn.workingColorSpace) {
    return ((this.r = t), (this.g = e), (this.b = n), Nn.colorSpaceToWorking(this, i), this);
  }
  setHSL(t, e, n, i = Nn.workingColorSpace) {
    if (((t = Mn(t, 1)), (e = xn(e, 0, 1)), (n = xn(n, 0, 1)), 0 === e))
      this.r = this.g = this.b = n;
    else {
      const i = n <= 0.5 ? n * (1 + e) : n + e - n * e,
        r = 2 * n - i;
      ((this.r = mr(r, i, t + 1 / 3)), (this.g = mr(r, i, t)), (this.b = mr(r, i, t - 1 / 3)));
    }
    return (Nn.colorSpaceToWorking(this, i), this);
  }
  setStyle(t, e = ke) {
    function n(e) {
      void 0 !== e &&
        parseFloat(e) < 1 &&
        hn('Color: Alpha component of ' + t + ' will be ignored.');
    }
    let i;
    if ((i = /^(\w+)\(([^\)]*)\)/.exec(t))) {
      let r;
      ...
      switch (a) {
        ...
        case 'hsla':
          ...
          break;
        default:
          hn('Color: Unknown color model ' + t);
      }
      ...
      hn('Color: Invalid hex color ' + t);
    } else if (t && t.length > 0) return this.setColorName(t, e);
    return this;
  }
  setColorName(t, e = ke) {
    const n = dr[t.toLowerCase()];
    return (void 0 !== n ? this.setHex(n, e) : hn('Color: Unknown color ' + t), this);
  }
  clone() {
  ...
  getHex(t = ke) {
    return (
      Nn.workingToColorSpace(_r.copy(this), t),
      65536 * Math.round(xn(255 * _r.r, 0, 255)) +
        256 * Math.round(xn(255 * _r.g, 0, 255)) +
        Math.round(xn(255 * _r.b, 0, 255))
    );
  }
  getHexString(t = ke) {
    return ('000000' + this.getHex(t).toString(16)).slice(-6);
  }
  getHSL(t, e = Nn.workingColorSpace) {
    Nn.workingToColorSpace(_r.copy(this), e);
    const n = _r.r,
      i = _r.g,
      r = _r.b,
      a = Math.max(n, i, r),
  ...
  getRGB(t, e = Nn.workingColorSpace) {
    return (Nn.workingToColorSpace(_r.copy(this), e), (t.r = _r.r), (t.g = _r.g), (t.b = _r.b), t);
  }
  getStyle(t = ke) {
    Nn.workingToColorSpace(_r.copy(this), t);
    const e = _r.r,
  ...
  offsetHSL(t, e, n) {
    return (this.getHSL(pr), this.setHSL(pr.h + t, pr.s + e, pr.l + n));
  }
  add(t) {
    return ((this.r += t.r), (this.g += t.g), (this.b += t.b), this);
  }
  ...
  lerpHSL(t, e) {
    (this.getHSL(pr), t.getHSL(fr));
    const n = yn(pr.h, fr.h, e),
      i = yn(pr.s, fr.s, e),
      r = yn(pr.l, fr.l, e);
  ...
  setValues(t) {
    if (void 0 !== t)
      for (const e in t) {
        const n = t[e];
        if (void 0 === n) {
          hn(`Material: parameter '${e}' has value of undefined.`);
          continue;
        }
        const i = this[e];
        void 0 !== i
          ? i && i.isColor
            ...
            : i && i.isVector3 && n && n.isVector3
              ? i.copy(n)
              : (this[e] = n)
          : hn(`Material: '${e}' is not a property of THREE.${this.type}.`);
      }
  }
  toJSON(t) {
    const e = void 0 === t || 'string' == typeof t;
    ...
    if (
      ...
      this.stencilFail !== Xe && (n.stencilFail = this.stencilFail),
      this.stencilZFail !== Xe && (n.stencilZFail = this.stencilZFail),
      this.stencilZPass !== Xe && (n.stencilZPass = this.stencilZPass),
      ...
      : t < -14
        ...
        : t <= 15
          ...
          : t < 128
            ...
            : ((i[l] = 31744), (i[256 | l] = 64512), (r[l] = 13), (r[256 | l] = 13));
  }
...
class br {
  static toHalfFloat(t) {
    return (function (t) {
      (Math.abs(t) > 65504 && hn('DataUtils.toHalfFloat(): Value out of range.'),
        (t = xn(t, -65504, 65504)),
        (yr.floatView[0] = t));
      const e = yr.uint32View[0],
        n = (e >> 23) & 511;
      return yr.baseTable[n] + ((8388607 & e) >> yr.shiftTable[n]);
    })(t);
  }
  static fromHalfFloat(t) {
    return (function (t) {
      const e = t >> 10;
      return (
        (yr.uint32View[0] = yr.mantissaTable[yr.offsetTable[e] + (1023 & t)] + yr.exponentTable[e]),
        yr.floatView[0]
      );
    })(t);
  }
...
class Ar {
  ...
  applyMatrix3(t) {
    if (2 === this.itemSize)
      for (let e = 0, n = this.count; e < n; e++)
        (Er.fromBufferAttribute(this, e), Er.applyMatrix3(t), this.setXY(e, Er.x, Er.y));
    else if (3 === this.itemSize)
      for (let e = 0, n = this.count; e < n; e++)
        (Tr.fromBufferAttribute(this, e), Tr.applyMatrix3(t), this.setXYZ(e, Tr.x, Tr.y, Tr.z));
    return this;
  }
  applyMatrix4(t) {
    for (let e = 0, n = this.count; e < n; e++)
      (Tr.fromBufferAttribute(this, e), Tr.applyMatrix4(t), this.setXYZ(e, Tr.x, Tr.y, Tr.z));
    return this;
  }
  applyNormalMatrix(t) {
    for (let e = 0, n = this.count; e < n; e++)
      (Tr.fromBufferAttribute(this, e), Tr.applyNormalMatrix(t), this.setXYZ(e, Tr.x, Tr.y, Tr.z));
    return this;
  }
  transformDirection(t) {
    for (let e = 0, n = this.count; e < n; e++)
      (Tr.fromBufferAttribute(this, e), Tr.transformDirection(t), this.setXYZ(e, Tr.x, Tr.y, Tr.z));
    return this;
  }
  set(t, e = 0) {
  ...
  getComponent(t, e) {
    ...
    return (this.normalized && (n = Sn(n, this.array)), n);
  }
  setComponent(t, e, n) {
    return (
  ...
  setX(t, e) {
    return (this.normalized && (e = bn(e, this.array)), (this.array[t * this.itemSize] = e), this);
  }
  getY(t) {
  ...
  setXYZ(t, e, n, i) {
    return (
      (t *= this.itemSize),
      this.normalized &&
        ((e = bn(e, this.array)), (n = bn(n, this.array)), (i = bn(i, this.array))),
      (this.array[t + 0] = e),
      (this.array[t + 1] = n),
      (this.array[t + 2] = i),
      this
  ...
  toJSON() {
    ...
    return (
      ...
      this.usage !== tn && (t.usage = this.usage),
      t
    );
  }
}
...
class Br extends pn {
  ...
  setIndex(t) {
    return (Array.isArray(t) ? (this.index = new (an(t) ? Cr : Rr)(t, 1)) : (this.index = t), this);
  }
  setIndirect(t, e = 0) {
  ...
  applyMatrix4(t) {
    ...
    if (void 0 !== n) {
      const e = new Pn().getNormalMatrix(t);
  ...
  applyQuaternion(t) {
    return (Lr.makeRotationFromQuaternion(t), this.applyMatrix4(Lr), this);
  }
  rotateX(t) {
  ...
  computeBoundingBox() {
    ...
    if (void 0 !== t) {
      if ((this.boundingBox.setFromBufferAttribute(t), e))
        for (let n = 0, i = e.length; n < i; n++) {
          const t = e[n];
          (Nr.setFromBufferAttribute(t),
            this.morphTargetsRelative
              ? (Or.addVectors(this.boundingBox.min, Nr.min),
                this.boundingBox.expandByPoint(Or),
                Or.addVectors(this.boundingBox.max, Nr.max),
                this.boundingBox.expandByPoint(Or))
      ...
      if ((Nr.setFromBufferAttribute(t), e))
        for (let t = 0, r = e.length; t < r; t++) {
          ...
          (Fr.setFromBufferAttribute(n),
            this.morphTargetsRelative
              ? (Or.addVectors(Nr.min, Fr.min),
                Nr.expandByPoint(Or),
                Or.addVectors(Nr.max, Fr.max),
                Nr.expandByPoint(Or))
              : (Nr.expandByPoint(Fr.min), Nr.expandByPoint(Fr.max)));
        }
      Nr.getCenter(n);
      let i = 0;
      for (let e = 0, r = t.count; e < r; e++)
        (Or.fromBufferAttribute(t, e), (i = Math.max(i, n.distanceToSquared(Or))));
      if (e)
        for (let r = 0, a = e.length; r < a; r++) {
          const a = e[r],
            s = this.morphTargetsRelative;
          for (let e = 0, r = a.count; e < r; e++)
            (Or.fromBufferAttribute(a, e),
              s && (Dr.fromBufferAttribute(t, e), Or.add(Dr)),
  ...
  computeTangents() {
    ...
    !1 === this.hasAttribute('tangent') &&
      this.setAttribute('tangent', new Ar(new Float32Array(4 * n.count), 4));
    const a = this.getAttribute('tangent'),
      s = [],
      o = [];
    for (let b = 0; b < n.count; b++) ((s[b] = new An()), (o[b] = new An()));
    const l = new An(),
      c = new An(),
      h = new An(),
      u = new En(),
    ...
    function g(t, e, i) {
      ...
      isFinite(a) &&
        (f.copy(c).multiplyScalar(p.y).addScaledVector(h, -d.y).multiplyScalar(a),
        m.copy(h).multiplyScalar(d.x).addScaledVector(c, -p.x).multiplyScalar(a),
        s[t].add(f),
        s[e].add(f),
        s[i].add(f),
        o[t].add(m),
    ...
    function S(t) {
      ...
      const e = s[t];
      (v.copy(e), v.sub(M.multiplyScalar(M.dot(e))).normalize(), x.crossVectors(y, e));
  ...
  computeVertexNormals() {
    ...
    if (void 0 !== e) {
      ...
      if (void 0 === n)
        ((n = new Ar(new Float32Array(3 * e.count), 3)), this.setAttribute('normal', n));
  ...
  normalizeNormals() {
    ...
    for (let e = 0, n = t.count; e < n; e++)
      (Or.fromBufferAttribute(t, e), Or.normalize(), t.setXYZ(e, Or.x, Or.y, Or.z));
  }
  toNonIndexed() {
    function t(t, e) {
      const n = t.array,
    ...
    if (null === this.index)
      return (hn('BufferGeometry.toNonIndexed(): BufferGeometry is already non-indexed.'), this);
    const e = new Br(),
      n = this.index.array,
      i = this.attributes;
    for (const s in i) {
    ...
    if (r && s) {
      ...
      for (let n = 0, i = r.length; n < i; n++) {
        const i = s[n],
          o = r[n];
        0 !== i &&
          (jr.fromBufferAttribute(o, t),
          a ? qr.addScaledVector(jr, i) : qr.addScaledVector(jr.sub(e), i));
      }
      e.add(qr);
    }
    return e;
  ...
  raycast(t, e) {
    ...
    if (void 0 !== i) {
      if (
        ...
        kr.copy(n.boundingSphere),
        kr.applyMatrix4(r),
        Vr.copy(t.ray).recast(t.near),
        !1 === kr.containsPoint(Vr.origin))
      ) {
        if (null === Vr.intersectSphere(kr, Hr)) return;
        if (Vr.origin.distanceToSquared(Hr) > (t.far - t.near) ** 2) return;
      }
      (zr.copy(r).invert(),
        Vr.copy(t.ray).applyMatrix4(zr),
        (null !== n.boundingBox && !1 === Vr.intersectsBox(n.boundingBox)) ||
          this._computeIntersections(t, e, Vr));
    }
  }
    ...
    if (null !== s)
      if (Array.isArray(a))
        for (let p = 0, f = u.length; p < f; p++) {
          ...
          for (
            let a = Math.max(r.start, d.start),
              u = Math.min(s.count, Math.min(r.start + r.count, d.start + d.count));
            a < u;
            a += 3
          ) {
            ((i = Jr(this, o, t, n, l, c, h, s.getX(a), s.getX(a + 1), s.getX(a + 2))),
              i &&
        ...
        for (
          ...
          ((i = Jr(this, a, t, n, l, c, h, s.getX(r), s.getX(r + 1), s.getX(r + 2))),
      ...
      if (Array.isArray(a))
        for (let p = 0, f = u.length; p < f; p++) {
          ...
          for (
            let a = Math.max(r.start, d.start),
              u = Math.min(o.count, Math.min(r.start + r.count, d.start + d.count));
            a < u;
            a += 3
          ) {
            ((i = Jr(this, s, t, n, l, c, h, a, a + 1, a + 2)),
              i &&
                ((i.faceIndex = Math.floor(a / 3)),
                (i.face.materialIndex = r.materialIndex),
                e.push(i)));
        ...
        for (
          ...
          ((i = Jr(this, a, t, n, l, c, h, r, r + 1, r + 2)),
            i && ((i.faceIndex = Math.floor(r / 3)), e.push(i)));
        }
      }
  }
}
function Jr(t, e, n, i, r, a, s, o, l, c) {
  (t.getVertexPosition(o, Gr), t.getVertexPosition(l, Wr), t.getVertexPosition(c, Xr));
  const h = (function (t, e, n, i, r, a, s, o) {
    ...
    if (
      ...
      return null;
    (Kr.copy(o), Kr.applyMatrix4(t.matrixWorld));
    const c = n.ray.origin.distanceTo(Kr);
    return c < n.near || c > n.far ? null : { distance: c, point: Kr.clone(), object: t };
  })(t, e, n, i, Gr, Wr, Xr, Yr);
  if (h) {
    const t = new An();
    (ur.getBarycoord(Yr, Gr, Wr, Xr, t),
      r && (h.uv = ur.getInterpolatedAttribute(r, o, l, c, t, new En())),
      a && (h.uv1 = ur.getInterpolatedAttribute(a, o, l, c, t, new En())),
      s &&
        ((h.normal = ur.getInterpolatedAttribute(s, o, l, c, t, new An())),
        h.normal.dot(i.direction) > 0 && h.normal.multiplyScalar(-1)));
    const e = { a: o, b: l, c: c, normal: new An(), materialIndex: 0 };
    (ur.getNormal(Gr, Wr, Xr, e.normal), (h.face = e), (h.barycoord = t));
  }
  return h;
}
class $r extends Br {
  ...
  static fromJSON(t) {
    return new $r(t.width, t.height, t.depth, t.widthSegments, t.heightSegments, t.depthSegments);
  }
}
function Qr(t) {
  const e = {};
...
class la extends ra {
  ...
  getEffectiveFOV() {
    return 2 * _n * Math.atan(Math.tan(0.5 * gn * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewBounds(t, e, n) {
    (aa.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      e.set(aa.x, aa.y).multiplyScalar(-t / aa.z),
      aa.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      n.set(aa.x, aa.y).multiplyScalar(-t / aa.z));
  }
  getViewSize(t, e) {
    return (this.getViewBounds(t, sa, oa), e.subVectors(oa, sa));
  }
...
class ha extends Ji {
  constructor(t, e, n) {
    ...
    const i = new la(ca, 1, t, e);
    ((i.layers = this.layers), this.add(i));
    const r = new la(ca, 1, t, e);
    ((r.layers = this.layers), this.add(r));
    const a = new la(ca, 1, t, e);
    ((a.layers = this.layers), this.add(a));
    const s = new la(ca, 1, t, e);
    ((s.layers = this.layers), this.add(s));
    const o = new la(ca, 1, t, e);
    ((o.layers = this.layers), this.add(o));
    const l = new la(ca, 1, t, e);
...
class da extends Yn {
  ...
  fromEquirectangularTexture(t, e) {
    ...
    const a = new Zr(i, r),
      s = e.minFilter;
    e.minFilter === St && (e.minFilter = Mt);
    return (
      new ha(1, 10, this).update(t, a),
      (e.minFilter = s),
      a.geometry.dispose(),
      a.material.dispose(),
      this
...
class xa {
  ...
  applyMatrix4(t) {
    for (let e = 0, n = this.data.count; e < n; e++)
      (va.fromBufferAttribute(this, e), va.applyMatrix4(t), this.setXYZ(e, va.x, va.y, va.z));
    return this;
  }
  applyNormalMatrix(t) {
    for (let e = 0, n = this.count; e < n; e++)
      (va.fromBufferAttribute(this, e), va.applyNormalMatrix(t), this.setXYZ(e, va.x, va.y, va.z));
    return this;
  }
  transformDirection(t) {
    for (let e = 0, n = this.count; e < n; e++)
      (va.fromBufferAttribute(this, e), va.transformDirection(t), this.setXYZ(e, va.x, va.y, va.z));
    return this;
  }
  getComponent(t, e) {
  ...
  clone(t) {
    if (void 0 === t) {
      ...
      return new Ar(new this.array.constructor(t), this.itemSize, this.normalized);
    }
    return (
      void 0 === t.interleavedBuffers && (t.interleavedBuffers = {}),
      void 0 === t.interleavedBuffers[this.data.uuid] &&
        (t.interleavedBuffers[this.data.uuid] = this.data.clone(t)),
      new xa(t.interleavedBuffers[this.data.uuid], this.itemSize, this.offset, this.normalized)
    );
  }
  toJSON(t) {
    if (void 0 === t) {
...
class Ca extends Zr {
  ...
  computeBoundingBox() {
    ...
    (null === this.boundingBox && (this.boundingBox = new Jn()), this.boundingBox.makeEmpty());
    const e = t.getAttribute('position');
    for (let n = 0; n < e.count; n++)
      (this.getVertexPosition(n, Ea), this.boundingBox.expandByPoint(Ea));
  }
  computeBoundingSphere() {
    const t = this.geometry;
    (null === this.boundingSphere && (this.boundingSphere = new mi()),
    ...
    const e = t.getAttribute('position');
    for (let n = 0; n < e.count; n++)
      (this.getVertexPosition(n, Ea), this.boundingSphere.expandByPoint(Ea));
  }
  copy(t, e) {
    return (
      super.copy(t, e),
  ...
  raycast(t, e) {
    ...
    void 0 !== n &&
      (null === this.boundingSphere && this.computeBoundingSphere(),
      wa.copy(this.boundingSphere),
      wa.applyMatrix4(i),
      !1 !== t.ray.intersectsSphere(wa) &&
        (Aa.copy(i).invert(),
        Ra.copy(t.ray).applyMatrix4(Aa),
        (null !== this.boundingBox && !1 === Ra.intersectsBox(this.boundingBox)) ||
          this._computeIntersections(t, e, Ra)));
  }
  getVertexPosition(t, e) {
    ...
    (super.updateMatrixWorld(t),
      this.bindMode === lt
        ...
        : 'detached' === this.bindMode
          ...
          : hn('SkinnedMesh: Unrecognized bindMode: ' + this.bindMode));
  }
  applyBoneTransform(t, e) {
    ...
    (ya.fromBufferAttribute(i.attributes.skinIndex, t),
      ...
      e.set(0, 0, 0));
    for (let r = 0; r < 4; r++) {
      const t = Sa.getComponent(r);
      if (0 !== t) {
        const i = ya.getComponent(r);
        (Ta.multiplyMatrices(n.bones[i].matrixWorld, n.boneInverses[i]),
          e.addScaledVector(ba.copy(Ma).applyMatrix4(Ta), t));
      }
    }
...
class Da {
  ...
  init() {
    ...
    if (((this.boneMatrices = new Float32Array(16 * t.length)), 0 === e.length))
      ...
      (hn('Skeleton: Number of inverse bone matrices does not match amount of bones.'),
        (this.boneInverses = []));
      for (let t = 0, e = this.bones.length; t < e; t++) this.boneInverses.push(new Ti());
    }
  }
  calculateInverses() {
  ...
  update() {
    ...
    for (let r = 0, a = t.length; r < a; r++) {
      const i = t[r] ? t[r].matrixWorld : Ua;
      (La.multiplyMatrices(i, e[r]), La.toArray(n, 16 * r));
    }
  ...
  fromJSON(t, e) {
    ...
    for (let n = 0, i = t.bones.length; n < i; n++) {
      const i = t.bones[n];
      let r = e[i];
      (void 0 === r && (hn('Skeleton: No bone found with UUID:', i), (r = new Pa())),
        this.bones.push(r),
...
class Ga extends Zr {
  constructor(t, e, n) {
    (super(t, e),
      ...
      (this.instanceMatrix = new Na(new Float32Array(16 * n), 16)),
      (this.instanceColor = null),
      (this.morphTexture = null),
      (this.count = n),
      (this.boundingBox = null),
      (this.boundingSphere = null));
    for (let i = 0; i < n; i++) this.setMatrixAt(i, Va);
  }
  computeBoundingBox() {
    const t = this.geometry,
      e = this.count;
    ...
    for (let n = 0; n < e; n++)
      (this.getMatrixAt(n, Fa),
        za.copy(t.boundingBox).applyMatrix4(Fa),
        this.boundingBox.union(za));
  }
  computeBoundingSphere() {
    const t = this.geometry,
      e = this.count;
    ...
    for (let n = 0; n < e; n++)
      (this.getMatrixAt(n, Fa),
        Ha.copy(t.boundingSphere).applyMatrix4(Fa),
        this.boundingSphere.union(Ha));
  }
  copy(t, e) {
    return (
      super.copy(t, e),
  ...
  getMorphAt(t, e) {
    const n = e.morphTargetInfluences,
      ...
      r = t * (n.length + 1) + 1;
    for (let a = 0; a < n.length; a++) n[a] = i[r + a];
  }
  raycast(t, e) {
    ...
    if (
      ...
      void 0 !== ka.material &&
        (null === this.boundingSphere && this.computeBoundingSphere(),
        Ha.copy(this.boundingSphere),
        Ha.applyMatrix4(n),
        !1 !== t.ray.intersectsSphere(Ha)))
    )
      for (let r = 0; r < i; r++) {
        (this.getMatrixAt(r, Fa),
          Oa.multiplyMatrices(n, Fa),
          (ka.matrixWorld = Oa),
          ka.raycast(t, Ba));
  ...
  setColorAt(t, e) {
    (null === this.instanceColor &&
      (this.instanceColor = new Na(new Float32Array(3 * this.instanceMatrix.count).fill(1), 3)),
  ...
  setMorphAt(t, e) {
    ...
    null === this.morphTexture &&
      (this.morphTexture = new Ia(new Float32Array(i * this.count), i, this.count, Vt, Ct));
...
class qa {
  ...
  setFromCoplanarPoints(t, e, n) {
    const i = Wa.subVectors(n, e).cross(Xa.subVectors(t, e)).normalize();
  ...
  applyMatrix4(t, e) {
    const n = e || ja.getNormalMatrix(t),
      i = this.coplanarPoint(Wa).applyMatrix4(t),
...
const Ya = new mi(),
  ...
  Za = new An();
class Ja {
  constructor(t = new qa(), e = new qa(), n = new qa(), i = new qa(), r = new qa(), a = new qa()) {
  ...
  setFromProjectionMatrix(t, e = 2e3, n = !1) {
    ...
    if (
      ...
      (i[4].setComponents(o, u, m, x).normalize(),
        i[5].setComponents(l - o, d - u, g - m, M - x).normalize());
    else if ((i[4].setComponents(l - o, d - u, g - m, M - x).normalize(), e === nn))
      i[5].setComponents(l + o, d + u, g + m, M + x).normalize();
    else {
      if (e !== rn)
  ...
  intersectsObject(t) {
    if (void 0 !== t.boundingSphere)
      (null === t.boundingSphere && t.computeBoundingSphere(),
        Ya.copy(t.boundingSphere).applyMatrix4(t.matrixWorld));
    else {
      const e = t.geometry;
      (null === e.boundingSphere && e.computeBoundingSphere(),
        Ya.copy(e.boundingSphere).applyMatrix4(t.matrixWorld));
    }
    return this.intersectsSphere(Ya);
  }
  intersectsSprite(t) {
    Ya.center.set(0, 0, 0);
    const e = Ka.distanceTo(t.center);
    return (
      (Ya.radius = 0.7071067811865476 + e),
      Ya.applyMatrix4(t.matrixWorld),
  ...
  intersectsBox(t) {
    ...
    for (let n = 0; n < 6; n++) {
      const i = e[n];
      if (
        ((Za.x = i.normal.x > 0 ? t.max.x : t.min.x),
        (Za.y = i.normal.y > 0 ? t.max.y : t.min.y),
        (Za.z = i.normal.z > 0 ? t.max.z : t.min.z),
        i.distanceToPoint(Za) < 0)
      )
        return !1;
    }
    return !0;
    ...
    if (null === t.index) {
      ...
      for (let t = 1, i = e.count; t < i; t++)
        (Qa.fromBufferAttribute(e, t - 1),
          ...
          (n[t] = n[t - 1]),
          (n[t] += Qa.distanceTo(ts)));
      t.setAttribute('lineDistance', new Pr(n, 1));
    } else
      hn('Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.');
    return this;
  }
  raycast(t, e) {
    const n = this.geometry,
    ...
    if (
      ...
      return;
    (es.copy(i).invert(), ns.copy(t.ray).applyMatrix4(es));
    ...
    if (null !== c) {
      ...
      for (let r = n, a = i - 1; r < a; r += l) {
        const n = c.getX(r),
          i = c.getX(r + 1),
          a = os(this, t, ns, o, n, i, r);
        a && e.push(a);
      }
      if (this.isLineLoop) {
        const r = c.getX(i - 1),
          a = c.getX(n),
          s = os(this, t, ns, o, r, a, i - 1);
        s && e.push(s);
      }
    } else {
      const n = Math.max(0, a.start),
      ...
      for (let r = n, a = i - 1; r < a; r += l) {
        const n = os(this, t, ns, o, r, r + 1, r);
        n && e.push(n);
      }
      if (this.isLineLoop) {
        const r = os(this, t, ns, o, i - 1, n, i - 1);
        r && e.push(r);
      }
    }
  }
...
function os(t, e, n, i, r, a, s) {
  const o = t.geometry.attributes.position;
  (Qa.fromBufferAttribute(o, r), ts.fromBufferAttribute(o, a));
  if (n.distanceSqToSegment(Qa, ts, rs, as) > i) return;
  ...
  return l < e.near || l > e.far
    ...
    : {
        distance: l,
        point: as.clone().applyMatrix4(t.matrixWorld),
        index: s,
        face: null,
        faceIndex: null,
        barycoord: null,
...
class _s extends Ji {
  ...
  raycast(t, e) {
    ...
    if (
      ...
      return;
    (ps.copy(i).invert(), fs.copy(t.ray).applyMatrix4(ps));
    const s = r / ((this.scale.x + this.scale.y + this.scale.z) / 3),
      o = s * s,
      l = n.index,
    ...
    if (null !== l) {
      for (let n = Math.max(0, a.start), r = Math.min(l.count, a.start + a.count); n < r; n++) {
        const r = l.getX(n);
        (gs.fromBufferAttribute(c, r), vs(gs, r, o, i, t, e, this));
      }
    } else {
      for (let n = Math.max(0, a.start), r = Math.min(c.count, a.start + a.count); n < r; n++)
        (gs.fromBufferAttribute(c, n), vs(gs, n, o, i, t, e, this));
    }
  }
  updateMorphTargets() {
    const t = this.geometry.morphAttributes,
...
function vs(t, e, n, i, r, a, s) {
  const o = fs.distanceSqToPoint(t);
  if (o < n) {
    const n = new An();
    (fs.closestPointToPoint(t, n), n.applyMatrix4(i));
...
class xs extends Xn {
  constructor(t, e, n, i, r = 1006, a = 1006, s, o, l) {
    ...
    'requestVideoFrameCallback' in t &&
      (this._requestVideoFrameCallbackId = t.requestVideoFrameCallback(function e() {
        ((c.needsUpdate = !0), (c._requestVideoFrameCallbackId = t.requestVideoFrameCallback(e)));
      }));
  }
  clone() {
...
class Ss extends Ms {
  constructor(t, e, n) {
    (super(void 0, t[0].width, t[0].height, e, n, ht),
...
class bs extends Xn {
  constructor(t, e, n, i, r, a, s, o, l) {
    (super(t, e, n, i, r, a, s, o, l), (this.isCanvasTexture = !0), (this.needsUpdate = !0));
  }
}
class Ts extends Xn {
  constructor(t, e, n = 1014, i, r, a, s = 1003, o = 1003, l, c = 1026, h = 1) {
    ...
    (super({ width: t, height: e, depth: h }, i, r, a, s, o, c, n, l),
...
class Es extends Ts {
  constructor(t, e = 1014, n = 301, i, r, a = 1003, s = 1003, o, l = 1026) {
    const c = { width: t, height: t, depth: 1 },
      h = [c, c, c, c, c, c];
    (super(t, t, e, n, i, r, a, s, o, l),
      (this.image = h),
...
class As extends Br {
  ...
  static fromJSON(t) {
    return new As(t.width, t.height, t.widthSegments, t.heightSegments);
  }
}
class Rs extends Br {
  constructor(t = 1, e = 32, n = 16, i = 0, r = 2 * Math.PI, a = 0, s = Math.PI) {
    ...
    for (let g = 0; g <= n; g++) {
      const d = [],
        _ = g / n;
      let v = 0;
      0 === g && 0 === a ? (v = 0.5 / e) : g === n && o === Math.PI && (v = -0.5 / e);
      for (let n = 0; n <= e; n++) {
        const o = n / e;
    ...
    for (let g = 0; g < n; g++)
      for (let t = 0; t < e; t++) {
        const e = c[g][t + 1],
          ...
          r = c[g + 1][t],
          s = c[g + 1][t + 1];
        ((0 !== g || a > 0) && d.push(e, i, s), (g !== n - 1 || o < Math.PI) && d.push(i, r, s));
      }
    (this.setIndex(d),
      this.setAttribute('position', new Pr(p, 3)),
      this.setAttribute('normal', new Pr(f, 3)),
...
class Is extends Ps {
  constructor(t) {
    (super(),
      ...
      (this.attenuationDistance = 1 / 0),
      (this.attenuationColor = new gr(1, 1, 1)),
      (this.specularIntensity = 1),
      (this.specularIntensityMap = null),
      (this.specularColor = new gr(1, 1, 1)),
...
class zs extends Bs {
  ...
  interpolate_(t, e, n, i) {
    const r = this.resultBuffer,
      ...
      x = d * m - d * f;
    for (let M = 0; M !== s; ++M) r[M] = g * a[c + M] + _ * a[l + M] + v * a[o + M] + x * a[h + M];
    return r;
  }
}
class Vs extends Bs {
  ...
  interpolate_(t, e, n, i) {
    const r = this.resultBuffer,
      ...
      c = (n - e) / (i - e),
      h = 1 - c;
    for (let u = 0; u !== s; ++u) r[u] = a[l + u] * h + a[o + u] * c;
    return r;
  }
}
class ks extends Bs {
...
class Hs {
  constructor(t, e, n, i) {
    ...
    ((this.name = t),
      (this.times = Ds(e, this.TimeBufferType)),
  ...
  static toJSON(t) {
    ...
    if (e.toJSON !== this.toJSON) n = e.toJSON(t);
      ...
      n = { name: t.name, times: Ds(t.times, Array), values: Ds(t.values, Array) };
  ...
  setInterpolation(t) {
    ...
    if (void 0 === e) {
      ...
      return (hn('KeyframeTrack:', e), this);
    }
  ...
  trim(t, e) {
    ...
    if ((++a, 0 !== r || a !== i)) {
      ...
      ((this.times = n.slice(r, a)), (this.values = this.values.slice(r * t, a * t)));
    }
    return this;
  }
  validate() {
    ...
    e - Math.floor(e) !== 0 && (un('KeyframeTrack: Invalid value size in track.', this), (t = !1));
    const n = this.times,
      i = this.values,
      r = n.length;
    0 === r && (un('KeyframeTrack: Track is empty.', this), (t = !1));
    let a = null;
    for (let o = 0; o !== r; o++) {
      const e = n[o];
      if ('number' == typeof e && isNaN(e)) {
        (un('KeyframeTrack: Time is not a valid number.', this, o, e), (t = !1));
        break;
      }
      if (null !== a && a > e) {
        (un('KeyframeTrack: Out of order keys.', this, o, e, a), (t = !1));
        break;
      }
      a = e;
    }
    if (void 0 !== i && ((s = i), ArrayBuffer.isView(s) && !(s instanceof DataView)))
      for (let o = 0, l = i.length; o !== l; ++o) {
        const e = i[o];
        if (isNaN(e)) {
          (un('KeyframeTrack: Value is not a valid number.', this, o, e), (t = !1));
          break;
        }
      }
    var s;
...
((Gs.prototype.ValueTypeName = 'bool'),
  ...
  (Gs.prototype.DefaultInterpolation = Pe),
...
class js extends Bs {
  ...
  interpolate_(t, e, n, i) {
    const r = this.resultBuffer,
      ...
      o = (n - e) / (i - e);
    let l = t * s;
    for (let c = l + s; l !== c; l += 4) wn.slerpFlat(r, 0, a, l - s, a, l, o);
    return r;
  }
}
class qs extends Hs {
...
((Ys.prototype.ValueTypeName = 'string'),
  ...
  (Ys.prototype.DefaultInterpolation = Pe),
...
class Zs {
  ...
  static parse(t) {
    const e = [],
      n = t.tracks,
      i = 1 / (t.fps || 1);
    for (let a = 0, s = n.length; a !== s; ++a) e.push(Js(n[a]).scale(i));
  ...
  static toJSON(t) {
    ...
    for (let r = 0, a = n.length; r !== a; ++r) e.push(Hs.toJSON(n[r]));
    return i;
  }
  static CreateFromMorphTargetSequence(t, e, n, i) {
    ...
    for (let s = 0; s < r; s++) {
      let t = [],
        o = [];
      (t.push((s + r - 1) % r, s, (s + 1) % r), o.push(0, 1, 0));
      const l = Ns(t);
      ((t = Fs(t, 1, l)),
        (o = Fs(o, 1, l)),
        i || 0 !== t[0] || (t.push(r), o.push(o[0])),
        a.push(new Xs('.morphTargetInfluences[' + e[s].name + ']', t, o).scale(1 / n)));
    }
  ...
  static CreateClipsFromMorphTargetSequences(t, e, n) {
    ...
    const a = [];
    for (const s in i) a.push(this.CreateFromMorphTargetSequence(s, i[s], e, n));
    return a;
  }
  static parseAnimation(t, e) {
    if ((hn('AnimationClip: parseAnimation() is deprecated and will be removed with r185'), !t))
      return (un('AnimationClip: No animation in JSONLoader data.'), null);
    const n = function (t, e, n, i, r) {
        if (0 !== n.length) {
          const a = [],
            s = [];
          (Os(n, a, s, i), 0 !== a.length && r.push(new t(e, a, s)));
        }
      },
      i = [],
      r = t.name || 'default',
      ...
      if (t && 0 !== t.length)
        if (t[0].morphTargets) {
          ...
          for (const r in e) {
            ...
            i.push(new Xs('.morphTargetInfluence[' + r + ']', e, a));
          }
          o = e.length * a;
        } else {
          const r = '.bones[' + e[c].name + ']';
          (n(Ks, r + '.position', t, 'pos', i),
            n(qs, r + '.quaternion', t, 'rot', i),
            n(Ks, r + '.scale', t, 'scl', i));
        }
    }
...
function Js(t) {
  ...
  if (void 0 === t.times) {
    const e = [],
      n = [];
    (Os(t.keys, e, n, 'value'), (t.times = e), (t.values = n));
  }
    ...
    (fetch(a)
      .then(e => {
        if (200 === e.status || 0 === e.status) {
          if (
            (0 === e.status && hn('FileLoader: HTTP Status 0 received.'),
        ...
        throw new io(`fetch for "${e.url}" responded with ${e.status}: ${e.statusText}`, e);
      })
      .then(t => {
        switch (o) {
          case 'arraybuffer':
  ...
  load(t, e, n, i) {
    ...
    if (void 0 !== a) {
      if (!0 === a.complete)
        ...
        let t = ao.get(a);
        (void 0 === t && ((t = []), ao.set(a, t)), t.push({ onLoad: e, onError: i }));
      }
      return a;
    }
    const s = sn('img');
    function o() {
      ...
      (ao.delete(this), r.manager.itemEnd(t));
    }
    function l(e) {
      (c(), i && i(e), $s.remove(`image:${t}`));
      const n = ao.get(this) || [];
      for (let t = 0; t < n.length; t++) {
        const i = n[t];
        i.onError && i.onError(e);
      }
      (ao.delete(this), r.manager.itemError(t), r.manager.itemEnd(t));
    }
    function c() {
      ...
      s.load(
        ...
        function (t) {
          ...
          (void 0 !== n.image
            ...
            (a.wrapS = void 0 !== n.wrapS ? n.wrapS : mt),
            (a.wrapT = void 0 !== n.wrapT ? n.wrapT : mt),
            (a.magFilter = void 0 !== n.magFilter ? n.magFilter : Mt),
            ...
            void 0 !== n.mipmaps && ((a.mipmaps = n.mipmaps), (a.minFilter = St)),
...
class fo {
  ...
  updateMatrices(t) {
    ...
    (uo.setFromMatrixPosition(t.matrixWorld),
      e.position.copy(uo),
      po.setFromMatrixPosition(t.target.matrixWorld),
      e.lookAt(po),
      e.updateMatrixWorld(),
      ho.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
      this._frustum.setFromProjectionMatrix(ho, e.coordinateSystem, e.reversedDepth),
      e.reversedDepth
...
class go extends co {
  constructor(t, e, n = 0, i = Math.PI / 3, r = 0, a = 2) {
    (super(t, e),
      (this.isSpotLight = !0),
      (this.type = 'SpotLight'),
      this.position.copy(Ji.DEFAULT_UP),
      this.updateMatrix(),
      (this.target = new Ji()),
      (this.distance = n),
      (this.angle = i),
...
class _o extends fo {
  constructor() {
    (super(new la(90, 1, 0.5, 500)), (this.isPointLightShadow = !0));
  }
}
class vo extends co {
...
class Mo extends fo {
  constructor() {
    (super(new xo(-5, 5, 5, -5, 0.5, 500)), (this.isDirectionalLightShadow = !0));
  }
}
class yo extends co {
  constructor(t, e) {
...
class wo extends eo {
  constructor(t) {
    (super(t),
      ...
      'undefined' == typeof createImageBitmap &&
        hn('ImageBitmapLoader: createImageBitmap() not supported.'),
      'undefined' == typeof fetch && hn('ImageBitmapLoader: fetch() not supported.'),
  ...
  load(t, e, n, i) {
    (void 0 === t && (t = ''),
      ...
      (t = this.manager.resolveURL(t)));
    const r = this,
      a = $s.get(`image-bitmap:${t}`);
    if (void 0 !== a)
      return (
        r.manager.itemStart(t),
        a.then
          ? void a.then(n => {
              if (!0 !== Eo.has(a)) return (e && e(n), r.manager.itemEnd(t), n);
              (i && i(Eo.get(a)), r.manager.itemError(t), r.manager.itemEnd(t));
            })
          : (setTimeout(function () {
              (e && e(a), r.manager.itemEnd(t));
            }, 0),
    ...
    const o = fetch(t, s)
      ...
      .then(function (n) {
        return ($s.add(`image-bitmap:${t}`, n), e && e(n), r.manager.itemEnd(t), n);
      })
      .catch(function (e) {
        (i && i(e),
          Eo.set(o, e),
          $s.remove(`image-bitmap:${t}`),
          r.manager.itemError(t),
          r.manager.itemEnd(t));
      });
    ($s.add(`image-bitmap:${t}`, o), r.manager.itemStart(t));
  }
  abort() {
    return (this._abortController.abort(), (this._abortController = new AbortController()), this);
  }
...
class Ro {
  ...
  _slerp(t, e, n, i) {
    wn.slerpFlat(t, e, t, e, t, n, i);
  }
  _slerpAdditive(t, e, n, i, r) {
    const a = this._workIndex * r;
    (wn.multiplyQuaternionsFlat(t, a, t, e, t, n), wn.slerpFlat(t, e, t, e, t, a, i));
  }
  _lerp(t, e, n, i, r) {
    const a = 1 - i;
    for (let s = 0; s !== r; ++s) {
...
const Co = '\\[\\]\\.:\\/',
  ...
  Uo = new RegExp(
    '^' +
      /((?:WC+[\/:])*)/.source.replace('WC', Io) +
      /(WCOD+)?/.source.replace('WCOD', Lo) +
      /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace('WC', Io) +
      /\.(WC+)(?:\[(.+)\])?/.source.replace('WC', Io) +
      '$'
  ),
  Do = ['material', 'materials', 'bones', 'map'];
class No {
  constructor(t, e, n) {
    ((this.path = e),
      (this.parsedPath = n || No.parseTrackName(e)),
      (this.node = No.findNode(t, this.parsedPath.nodeName)),
      (this.rootNode = t),
      (this.getValue = this._getValue_unbound),
      (this.setValue = this._setValue_unbound));
  }
  static create(t, e, n) {
    return t && t.isAnimationObjectGroup ? new No.Composite(t, e, n) : new No(t, e, n);
  }
  ...
  static parseTrackName(t) {
    ...
    if (void 0 !== i && -1 !== i) {
      ...
      -1 !== Do.indexOf(t) && ((n.nodeName = n.nodeName.substring(0, i)), (n.objectName = t));
    }
  ...
  bind() {
    ...
    if (
      (t || ((t = No.findNode(this.rootNode, e.nodeName)), (this.node = t)),
      (this.getValue = this._getValue_unavailable),
      (this.setValue = this._setValue_unavailable),
      !t)
    )
      return void hn('PropertyBinding: No target node found for track: ' + this.path + '.');
    if (n) {
      let i = e.objectIndex;
      switch (n) {
        case 'materials':
        ...
        default:
          if (void 0 === t[n])
            return void un('PropertyBinding: Can not bind to objectName of node undefined.', this);
          t = t[n];
      }
      if (void 0 !== i) {
        if (void 0 === t[i])
    ...
    ((this.targetObject = t),
      !0 === t.isMaterial
        ...
        : !0 === t.isObject3D && (s = this.Versioning.MatrixWorldNeedsUpdate));
...
((No.Composite = class {
  ...
  (No.prototype.BindingType = { Direct: 0, EntireArray: 1, ArrayElement: 2, HasFromToArray: 3 }),
  (No.prototype.Versioning = { None: 0, NeedsUpdate: 1, MatrixWorldNeedsUpdate: 2 }),
...
class Fo {
  ...
  _update(t, e, n, i) {
    ...
    if (s > 0) {
      ...
      else for (let n = 0, r = t.length; n !== r; ++n) (t[n].evaluate(a), e[n].accumulate(i, s));
    }
  }
  _updateWeight(t) {
    let e = 0;
  ...
  _setEndings(t, e, n) {
    ...
    n
      ...
      : ((i.endingStart = t ? (this.zeroSlopeAtStart ? De : Ue) : Ne),
        (i.endingEnd = e ? (this.zeroSlopeAtEnd ? De : Ue) : Ne));
  }
...
class Bo extends pn {
  ...
  _bindAction(t, e) {
    ...
    for (let h = 0; h !== r; ++h) {
      const t = i[h],
        r = t.name;
      let l = c[r];
      if (void 0 !== l) (++l.referenceCount, (a[h] = l));
      else {
        if (((l = a[h]), void 0 !== l)) {
        ...
        ((l = new Ro(No.create(n, r, i), t.ValueTypeName, t.getValueSize())),
          ++l.referenceCount,
  ...
  _lendControlInterpolant() {
    ...
    return (
      void 0 === n &&
        ((n = new Vs(new Float32Array(2), new Float32Array(2), 1, Oo)),
        (n.__cacheIndex = e),
        (t[e] = n)),
      n
    );
  ...
  clipAction(t, e, n) {
    const i = e || this._root,
      r = i.uuid;
    let a = 'string' == typeof t ? Zs.findByName(i, t) : t;
    const s = null !== a ? a.uuid : t,
      o = this._actionsByClip[s];
    let l = null;
    if ((void 0 === n && (n = null !== a ? a.blendMode : Fe), void 0 !== o)) {
      const t = o.actionByRoot[r];
      if (void 0 !== t && t.blendMode === n) return t;
      ((l = o.knownActions[0]), null === a && (a = l._clip));
    }
    if (null === a) return null;
    const c = new Fo(this, a, e, n);
    return (this._bindAction(c, l), this._addInactiveAction(c, s, r), c);
  }
  existingAction(t, e) {
    const n = e || this._root,
      i = n.uuid,
      r = 'string' == typeof t ? Zs.findByName(n, t) : t,
      a = r ? r.uuid : t,
    ...
    e.isPerspectiveCamera
      ...
      : e.isOrthographicCamera
        ? (this.ray.origin.set(t.x, t.y, (e.near + e.far) / (e.near - e.far)).unproject(e),
          ...
          (this.camera = e))
        : un('Raycaster: Unsupported camera type: ' + e.type);
  }
  setFromXRController(t) {
    return (
      zo.identity().extractRotation(t.matrixWorld),
      this.ray.origin.setFromMatrixPosition(t.matrixWorld),
      this.ray.direction.set(0, 0, -1).applyMatrix4(zo),
      this
    );
  }
  intersectObject(t, e = !0, n = []) {
    return (Ho(t, this, n, e), n.sort(ko), n);
  }
  intersectObjects(t, e = !0, n = []) {
    for (let i = 0, r = t.length; i < r; i++) Ho(t[i], this, n, e);
    return (n.sort(ko), n);
  }
}
function ko(t, e) {
...
function Ho(t, e, n, i) {
  ...
  if (!0 === r && !0 === i) {
    const i = t.children;
    for (let t = 0, r = i.length; t < r; t++) Ho(i[t], e, n, !0);
  }
}
class Go {
  ...
  makeSafe() {
    const t = 1e-6;
    return ((this.phi = xn(this.phi, t, Math.PI - t)), this);
  }
  setFromVector3(t) {
  ...
  setFromCartesianCoords(t, e, n) {
    return (
      ...
      0 === this.radius
        ...
        : ((this.theta = Math.atan2(t, n)), (this.phi = Math.acos(xn(e / this.radius, -1, 1)))),
      this
    );
  }
  clone() {
        ...
        (!(function (e, n, i) {
          ...
          if ((t.bindBuffer(i, e), 0 === a.length)) t.bufferSubData(i, 0, r);
            ...
            for (let n = 0, s = a.length; n < s; n++) {
              const e = a[n];
              t.bufferSubData(i, e.start * r.BYTES_PER_ELEMENT, r, e.start, e.count);
            }
            n.clearUpdateRanges();
          }
          n.onUploadCallback();
...
('undefined' != typeof __THREE_DEVTOOLS__ &&
  __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent('register', { detail: { revision: v } })),
  'undefined' != typeof window &&
    (window.__THREE__
      ? hn('WARNING: Multiple instances of Three.js being imported.')
      : (window.__THREE__ = v)));
const qo = {
    alphahash_fragment:
  ...
  Yo = {
    ...
    specularmap: { specularMap: { value: null }, specularMapTransform: { value: new Pn() } },
    envmap: {
      envMap: { value: null },
    ...
    emissivemap: { emissiveMap: { value: null }, emissiveMapTransform: { value: new Pn() } },
    metalnessmap: { metalnessMap: { value: null }, metalnessMapTransform: { value: new Pn() } },
    roughnessmap: { roughnessMap: { value: null }, roughnessMapTransform: { value: new Pn() } },
    gradientmap: { gradientMap: { value: null } },
    fog: {
      fogDensity: { value: 25e-5 },
      fogNear: { value: 1 },
      fogFar: { value: 2e3 },
      fogColor: { value: new gr(16777215) },
    },
    lights: {
  ...
  Ko = {
    basic: {
      uniforms: ta([Yo.common, Yo.specularmap, Yo.envmap, Yo.aomap, Yo.lightmap, Yo.fog]),
    ...
    depth: {
      uniforms: ta([Yo.common, Yo.displacementmap]),
    ...
    normal: {
      ...
      vertexShader: qo.meshnormal_vert,
      fragmentShader: qo.meshnormal_frag,
    },
    sprite: {
      uniforms: ta([Yo.sprite, Yo.fog]),
    ...
    backgroundCube: {
      ...
      vertexShader: qo.backgroundCube_vert,
      fragmentShader: qo.backgroundCube_frag,
    },
    cube: {
    ...
    distance: {
      ...
      vertexShader: qo.distance_vert,
      fragmentShader: qo.distance_frag,
    },
    shadow: {
      uniforms: ta([Yo.lights, Yo.fog, { color: { value: new gr(0) }, opacity: { value: 1 } }]),
...
Ko.physical = {
  uniforms: ta([
    Ko.standard.uniforms,
    {
      ...
      attenuationColor: { value: new gr(0) },
      specularColor: { value: new gr(1, 1, 1) },
...
function Qo(t, e, n, i, r, a, s) {
  ...
  function m(e, n) {
    (e.getRGB(Zo, ea(t)), i.buffers.color.setClear(Zo.r, Zo.g, Zo.b, n, s));
  }
  return {
    ...
    addToRenderList: function (e, n) {
      const i = f(n);
      i && (i.isCubeTexture || i.mapping === pt)
        ? (void 0 === c &&
            ((c = new Zr(
              new $r(1, 1, 1),
              new ia({
                name: 'BackgroundCubeMaterial',
                uniforms: Qr(Ko.backgroundCube.uniforms),
            ...
            r.update(c)),
          Jo.copy(n.backgroundRotation),
          (Jo.x *= -1),
          (Jo.y *= -1),
          (Jo.z *= -1),
          i.isCubeTexture && !1 === i.isRenderTargetTexture && ((Jo.y *= -1), (Jo.z *= -1)),
          ...
          c.material.uniforms.backgroundRotation.value.setFromMatrix4($o.makeRotationFromEuler(Jo)),
          (c.material.toneMapped = Nn.getTransfer(i.colorSpace) !== We),
        ...
        : i &&
          ...
          (void 0 === l &&
            ((l = new Zr(
              ...
              new ia({
                ...
                uniforms: Qr(Ko.background.uniforms),
          ...
          (l.material.toneMapped = Nn.getTransfer(i.colorSpace) !== We),
        ...
        (_ = (function (t, e, n, i) {
          ...
          for (const a in l) {
            if (l[a].location >= 0) {
              ...
              if (
                (void 0 === n &&
                  ('instanceMatrix' === a && t.instanceMatrix && (n = t.instanceMatrix),
          ...
          (function (t, e, n, i) {
            ...
            for (const a in l) {
              if (l[a].location >= 0) {
                ...
                const n = {};
                ((n.attribute = e), e && e.data && (n.data = e.data), (r[a] = n), o++);
              }
            }
          ...
          (function (n, i, r, a) {
            ...
            for (const c in o) {
              ...
              if (i.location >= 0) {
                ...
                if (
                  (void 0 === r &&
                    ('instanceMatrix' === c && n.instanceMatrix && (r = n.instanceMatrix),
                    'instanceColor' === c && n.instanceColor && (r = n.instanceColor)),
                  void 0 !== r)
                ) {
                  ...
                  const c = l.buffer,
                    h = l.type,
                    p = l.bytesPerElement,
                    m = h === t.INT || h === t.UNSIGNED_INT || r.gpuType === At;
                  if (r.isInterleavedBufferAttribute) {
                    ...
                    } else for (let t = 0; t < i.locationSize; t++) u(i.location + t);
...
function nl(t, e, n, i) {
  ...
  const o = a(s);
  o !== s && (hn('WebGLRenderer:', s, 'not supported, using', o, 'instead.'), (s = o));
  return {
    isWebGL2: !0,
    ...
    textureFormatReadable: function (e) {
      return e === Ot || i.convert(e) === t.getParameter(t.IMPLEMENTATION_COLOR_READ_FORMAT);
    },
    textureTypeReadable: function (n) {
      const r =
        n === Pt && (e.has('EXT_color_buffer_half_float') || e.has('EXT_color_buffer_float'));
      return !(
        n !== bt &&
    ...
    if (0 !== a) {
      if (((c = l.value), !0 !== r || null === c)) {
        ...
        for (let n = 0, l = i; n !== a; ++n, l += 4)
          (s.copy(t[n]).applyMatrix4(r, o), s.normal.toArray(c, l), (c[l + 3] = s.constant));
      }
...
function rl(t) {
  let e = new WeakMap();
  function n(t, e) {
    return (e === dt ? (t.mapping = ht) : 304 === e && (t.mapping = ut), t);
  }
  function i(t) {
    const n = t.target;
...
const al = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
  sl = 20,
  ol = new xo(),
  ll = new gr();
let cl = null,
...
class fl {
  ...
  fromScene(t, e = 0, n = 0.1, i = 100, r = {}) {
    const { size: a = 256, position: s = pl } = r;
    ((cl = this._renderer.getRenderTarget()),
      (hl = this._renderer.getActiveCubeFace()),
      (ul = this._renderer.getActiveMipmapLevel()),
      (dl = this._renderer.xr.enabled),
      (this._renderer.xr.enabled = !1),
      this._setSize(a));
    const o = this._allocateTargets();
    return (
      (o.depthBuffer = !0),
      this._sceneToCubeUV(t, n, i, o, s),
  ...
  compileCubemapShader() {
    null === this._cubemapMaterial &&
      ((this._cubemapMaterial = vl()), this._compileMaterial(this._cubemapMaterial));
  }
  compileEquirectangularShader() {
    null === this._equirectMaterial &&
      ((this._equirectMaterial = _l()), this._compileMaterial(this._equirectMaterial));
  }
  dispose() {
    (this._dispose(),
  ...
  _cleanup(t) {
    (this._renderer.setRenderTarget(cl, hl, ul),
      (this._renderer.xr.enabled = dl),
      (t.scissorTest = !1),
      gl(t, 0, 0, t.width, t.height));
  }
  _fromTexture(t, e) {
    (t.mapping === ht || t.mapping === ut
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (null !== this._pingPongRenderTarget && this._dispose(),
        (this._pingPongRenderTarget = ml(t, e, n)));
      ...
      (({
        ...
        const e = [],
          ...
          i = [];
        let r = t;
        const a = t - 4 + 1 + al.length;
        for (let s = 0; s < a; s++) {
          const a = Math.pow(2, r);
          e.push(a);
          let o = 1 / a;
          (s > t - 4 ? (o = al[s - t + 4 - 1]) : 0 === s && (o = 0), n.push(o));
          const l = 1 / (a - 2),
            c = -l,
            h = 1 + l,
          ...
          const M = new Br();
          (M.setAttribute('position', new Ar(_, f)),
            M.setAttribute('uv', new Ar(v, m)),
            M.setAttribute('faceIndex', new Ar(x, g)),
            i.push(new Zr(M, null)),
            r > 4 && r--);
        }
        return { lodMeshes: i, sizeLods: e, sigmas: n };
      })(i)),
        (this._blurMaterial = (function (t, e, n) {
          const i = new Float32Array(sl),
            r = new An(0, 1, 0),
            a = new ia({
  ...
  _compileMaterial(t) {
    const e = new Zr(new Br(), t);
    this._renderer.compile(e, ol);
  }
  _sceneToCubeUV(t, e, n, i, r) {
    const a = new la(90, 1, e, n),
      s = [1, -1, 1, 1, 1, 1],
      o = [1, 1, 1, -1, -1, -1],
      l = this._renderer,
      c = l.autoClear,
      h = l.toneMapping;
    (l.getClearColor(ll), (l.toneMapping = 0), (l.autoClear = !1));
    (l.state.buffers.depth.getReversed() &&
      (l.setRenderTarget(i), l.clearDepth(), l.setRenderTarget(null)),
      null === this._backgroundBox &&
        (this._backgroundBox = new Zr(
          new $r(),
          new Mr({ name: 'PMREM.Background', side: 1, depthWrite: !1, depthTest: !1 })
        )));
    ...
    for (let m = 0; m < 6; m++) {
      const e = m % 3;
      0 === e
        ? (a.up.set(0, s[m], 0), a.position.set(r.x, r.y, r.z), a.lookAt(r.x + o[m], r.y, r.z))
        : 1 === e
          ? (a.up.set(0, 0, s[m]), a.position.set(r.x, r.y, r.z), a.lookAt(r.x, r.y + o[m], r.z))
          : (a.up.set(0, s[m], 0), a.position.set(r.x, r.y, r.z), a.lookAt(r.x, r.y, r.z + o[m]));
      const n = this._cubeSize;
      (gl(i, e * n, m > 2 ? n : 0, n, n),
        l.setRenderTarget(i),
        p && l.render(u, a),
        l.render(t, a));
    }
  ...
  _textureToCubeUV(t, e) {
    const n = this._renderer,
      i = t.mapping === ht || t.mapping === ut;
    i
      ? (null === this._cubemapMaterial && (this._cubemapMaterial = vl()),
        (this._cubemapMaterial.uniforms.flipEnvMap.value = !1 === t.isRenderTargetTexture ? -1 : 1))
      : null === this._equirectMaterial && (this._equirectMaterial = _l());
    const r = i ? this._cubemapMaterial : this._equirectMaterial,
      a = this._lodMeshes[0];
    a.material = r;
    r.uniforms.envMap.value = t;
    const s = this._cubeSize;
    (gl(e, 0, 0, 3 * s, 2 * s), n.setRenderTarget(e), n.render(a, ol));
  }
  _applyPMREM(t) {
  ...
  _halfBlur(t, e, n, i, r, a, s) {
    ...
    'latitudinal' !== a &&
      'longitudinal' !== a &&
      un('blur direction must be either latitudinal or longitudinal!');
    ...
    const h = l.uniforms,
      ...
      p = r / d,
      f = isFinite(r) ? 1 + Math.floor(3 * p) : sl;
    f > sl &&
      hn(
    ...
    (gl(e, 3 * v * (i > _ - 4 ? i - _ + 4 : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v),
      o.setRenderTarget(e),
      o.render(c, ol));
  }
}
function ml(t, e, n) {
  const i = new Yn(t, e, n);
  return ((i.texture.mapping = pt), (i.texture.name = 'PMREM.cubeUv'), (i.scissorTest = !0), i);
}
...
function yl(t) {
  ...
  return {
    ...
    get: function (t) {
      const e = n(t);
      return (null === e && dn('WebGLRenderer: ' + t + ' extension not supported.'), e);
    },
  };
}
function Sl(t, e, n, i) {
  ...
  return {
    get: function (t, e) {
      return (
        !0 === r[e.id] || (e.addEventListener('dispose', s), (r[e.id] = !0), n.memory.geometries++),
        e
      );
    },
    update: function (n) {
    ...
    update: function (n, i, r) {
      switch ((e.calls++, i)) {
        ...
        case t.POINTS:
          ...
          break;
        default:
          un('WebGLInfo: Unknown draw mode:', i);
      }
    },
  };
}
  ...
  return {
    update: function (a, s, o) {
      ...
      if (void 0 === u || u.count !== h) {
        ...
        ((u = { count: h, texture: _, size: new En(f, m) }),
          i.set(s, u),
...
const Al = {
  [et]: 'LINEAR_TONE_MAPPING',
  [nt]: 'REINHARD_TONE_MAPPING',
  [it]: 'CINEON_TONE_MAPPING',
  [rt]: 'ACES_FILMIC_TONE_MAPPING',
  [st]: 'AGX_TONE_MAPPING',
  [ot]: 'NEUTRAL_TONE_MAPPING',
  [at]: 'CUSTOM_TONE_MAPPING',
};
function Rl(t, e, n, i, r) {
  const a = new Yn(e, n, { type: t, depthBuffer: i, stencilBuffer: r }),
    s = new Yn(e, n, { type: Pt, depthBuffer: !1, stencilBuffer: !1 }),
    o = new Br();
  (o.setAttribute('position', new Pr([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)),
    o.setAttribute('uv', new Pr([0, 2, 0, 0, 2, 0], 2)));
  const l = new Cs({
  ...
  ((this.setSize = function (t, e) {
    ...
    (this.begin = function (t, e) {
      ...
      if (((m = e), null !== e)) {
        const t = e.width,
          n = e.height;
        (a.width === t && a.height === n) || this.setSize(t, n);
      }
      return (!1 === _ && t.setRenderTarget(a), (u = t.toneMapping), (t.toneMapping = 0), !0);
    }),
    ...
    (this.end = function (t, e) {
      ...
      for (let r = 0; r < g.length; r++) {
        const a = g[r];
        if (!1 !== a.enabled && (a.render(t, i, n, e), !1 !== a.needsSwap)) {
          const t = n;
          ((n = i), (i = t));
        }
      }
      if (d !== t.outputColorSpace || p !== t.toneMapping) {
        ((d = t.outputColorSpace),
          (p = t.toneMapping),
          (l.defines = {}),
          Nn.getTransfer(d) === We && (l.defines.SRGB_TRANSFER = ''));
        const e = Al[p];
    ...
    (this.dispose = function () {
      (a.dispose(), s.dispose(), o.dispose(), l.dispose());
    }));
}
const Cl = new Xn(),
  Pl = new Ts(1, 1),
...
function zl(t, e, n) {
  ...
  const r = e * n;
  let a = Dl[r];
  if ((void 0 === a && ((a = new Float32Array(r)), (Dl[r] = a)), 0 !== e)) {
    i.toArray(a, 0);
...
function Hl(t, e) {
  let n = Nl[e];
  void 0 === n && ((n = new Int32Array(e)), (Nl[e] = n));
...
function Wl(t, e) {
  ...
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform2fv(this.addr, e), kl(n, e));
  }
}
function Xl(t, e) {
  const n = this.cache;
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform3fv(this.addr, e), kl(n, e));
  }
}
function jl(t, e) {
  const n = this.cache;
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform4fv(this.addr, e), kl(n, e));
  }
}
function ql(t, e) {
  const n = this.cache,
  ...
  if (void 0 === i) {
    if (Vl(n, e)) return;
    (t.uniformMatrix2fv(this.addr, !1, e), kl(n, e));
  } else {
    if (Vl(n, i)) return;
    (Bl.set(i), t.uniformMatrix2fv(this.addr, !1, Bl), kl(n, i));
  }
}
function Yl(t, e) {
  const n = this.cache,
  ...
  if (void 0 === i) {
    if (Vl(n, e)) return;
    (t.uniformMatrix3fv(this.addr, !1, e), kl(n, e));
  } else {
    if (Vl(n, i)) return;
    (Ol.set(i), t.uniformMatrix3fv(this.addr, !1, Ol), kl(n, i));
  }
}
function Kl(t, e) {
  const n = this.cache,
  ...
  if (void 0 === i) {
    if (Vl(n, e)) return;
    (t.uniformMatrix4fv(this.addr, !1, e), kl(n, e));
  } else {
    if (Vl(n, i)) return;
    (Fl.set(i), t.uniformMatrix4fv(this.addr, !1, Fl), kl(n, i));
  }
}
function Zl(t, e) {
  const n = this.cache;
...
function Jl(t, e) {
  ...
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform2iv(this.addr, e), kl(n, e));
  }
}
function $l(t, e) {
  const n = this.cache;
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform3iv(this.addr, e), kl(n, e));
  }
}
function Ql(t, e) {
  const n = this.cache;
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform4iv(this.addr, e), kl(n, e));
  }
}
function tc(t, e) {
  const n = this.cache;
...
function ec(t, e) {
  ...
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform2uiv(this.addr, e), kl(n, e));
  }
}
function nc(t, e) {
  const n = this.cache;
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform3uiv(this.addr, e), kl(n, e));
  }
}
function ic(t, e) {
  const n = this.cache;
  if (void 0 !== e.x)
    ...
    if (Vl(n, e)) return;
    (t.uniform4uiv(this.addr, e), kl(n, e));
  }
}
function rc(t, e, n) {
  const i = this.cache,
  ...
  (i[0] !== r && (t.uniform1i(this.addr, r), (i[0] = r)),
    this.type === t.SAMPLER_2D_SHADOW
      ? ((Pl.compareFunction = n.isReversedDepthBuffer() ? 518 : 515), (a = Pl))
      : (a = Cl),
...
function ac(t, e, n) {
  const i = this.cache,
    r = n.allocateTextureUnit();
  (i[0] !== r && (t.uniform1i(this.addr, r), (i[0] = r)), n.setTexture3D(e || Ll, r));
}
function sc(t, e, n) {
  const i = this.cache,
    r = n.allocateTextureUnit();
  (i[0] !== r && (t.uniform1i(this.addr, r), (i[0] = r)), n.setTextureCube(e || Ul, r));
}
function oc(t, e, n) {
  const i = this.cache,
    r = n.allocateTextureUnit();
  (i[0] !== r && (t.uniform1i(this.addr, r), (i[0] = r)), n.setTexture2DArray(e || Il, r));
}
function lc(t, e) {
  t.uniform1fv(this.addr, e);
}
function cc(t, e) {
  const n = zl(e, this.size, 2);
  t.uniform2fv(this.addr, n);
}
function hc(t, e) {
  const n = zl(e, this.size, 3);
  t.uniform3fv(this.addr, n);
}
function uc(t, e) {
  const n = zl(e, this.size, 4);
...
function pc(t, e) {
  const n = zl(e, this.size, 9);
  t.uniformMatrix3fv(this.addr, !1, n);
}
function fc(t, e) {
  const n = zl(e, this.size, 16);
...
function bc(t, e, n) {
  const i = this.cache,
    ...
    a = Hl(n, r);
  let s;
  (Vl(i, a) || (t.uniform1iv(this.addr, a), kl(i, a)),
    (s = this.type === t.SAMPLER_2D_SHADOW ? Pl : Cl));
  for (let o = 0; o !== r; ++o) n.setTexture2D(e[o] || s, a[o]);
}
function Tc(t, e, n) {
  const i = this.cache,
    r = e.length,
    a = Hl(n, r);
  Vl(i, a) || (t.uniform1iv(this.addr, a), kl(i, a));
  for (let s = 0; s !== r; ++s) n.setTexture3D(e[s] || Ll, a[s]);
}
function Ec(t, e, n) {
  const i = this.cache,
    r = e.length,
    a = Hl(n, r);
  Vl(i, a) || (t.uniform1iv(this.addr, a), kl(i, a));
  for (let s = 0; s !== r; ++s) n.setTextureCube(e[s] || Ul, a[s]);
}
function wc(t, e, n) {
  const i = this.cache,
    r = e.length,
    a = Hl(n, r);
  Vl(i, a) || (t.uniform1iv(this.addr, a), kl(i, a));
  for (let s = 0; s !== r; ++s) n.setTexture2DArray(e[s] || Il, a[s]);
}
class Ac {
  constructor(t, e, n) {
    ((this.id = t),
...
function Lc(t, e, n) {
  ...
  for (Pc.lastIndex = 0; ; ) {
    ...
    if ((l && (o |= 0), void 0 === c || ('[' === c && s + 2 === r))) {
      Ic(n, void 0 === c ? new Ac(o, t, e) : new Rc(o, t, e));
      break;
    }
    {
      let t = n.map[o];
      (void 0 === t && ((t = new Cc(o)), Ic(n, t)), (n = t));
    }
  }
}
class Uc {
  constructor(t, e) {
    ...
    for (let a = 0; a < n; ++a) {
      const n = t.getActiveUniform(e, a);
      Lc(n, t.getUniformLocation(e, n.name), this);
    }
    const i = [],
      r = [];
...
function Bc(t, e) {
  const n = (function (t) {
    Nn._getMatrix(Fc, Nn.workingColorSpace, t);
    const e = `mat3( ${Fc.elements.map(t => t.toFixed(4))} )`;
    switch (Nn.getTransfer(t)) {
      case Ge:
        return [e, 'LinearTransferOETF'];
      case We:
        return [e, 'sRGBTransferOETF'];
      default:
        return (hn('WebGLProgram: Unsupported color space: ', t), [e, 'LinearTransferOETF']);
    }
  })(e);
  return [
    `vec4 ${t}( vec4 value ) {`,
...
function Kc(t, e) {
  ...
  if (void 0 === n) {
    ...
    ((n = qo[t]),
      hn('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.', e, t));
  }
  return qc(n);
}
const Zc =
...
const th = { [x]: 'SHADOWMAP_TYPE_PCF', [M]: 'SHADOWMAP_TYPE_VSM' };
const eh = { [ht]: 'ENVMAP_TYPE_CUBE', [ut]: 'ENVMAP_TYPE_CUBE', [pt]: 'ENVMAP_TYPE_CUBE_UV' };
const nh = { [ut]: 'ENVMAP_MODE_REFRACTION' };
const ih = {
...
function rh(t, e, n, i) {
  ...
  let s = n.vertexShader,
    o = n.fragmentShader;
  const l = (function (t) {
      return th[t.shadowMapType] || 'SHADOWMAP_TYPE_BASIC';
    })(n),
    c = (function (t) {
      return !1 === t.envMap ? 'ENVMAP_TYPE_CUBE' : eh[t.envMapMode] || 'ENVMAP_TYPE_CUBE';
    })(n),
    h = (function (t) {
      return !1 === t.envMap
        ? 'ENVMAP_MODE_REFLECTION'
        : nh[t.envMapMode] || 'ENVMAP_MODE_REFLECTION';
    })(n),
    u = (function (t) {
      return !1 === t.envMap ? 'ENVMAP_BLENDING_NONE' : ih[t.combine] || 'ENVMAP_BLENDING_NONE';
    })(n),
    d = (function (t) {
  ...
  (n.isRawShaderMaterial
    ? ((g = ['#define SHADER_TYPE ' + n.shaderType, '#define SHADER_NAME ' + n.shaderName, f]
        .filter(Gc)
        .join('\n')),
      g.length > 0 && (g += '\n'),
      (_ = ['#define SHADER_TYPE ' + n.shaderType, '#define SHADER_NAME ' + n.shaderName, f]
        .filter(Gc)
        .join('\n')),
      _.length > 0 && (_ += '\n'))
    : ((g = [
      ...
      (_ = [
        ...
        0 !== n.toneMapping ? qo.tonemapping_pars_fragment : '',
        0 !== n.toneMapping ? Vc('toneMapping', n.toneMapping) : '',
        n.dithering ? '#define DITHERING' : '',
        n.opaque ? '#define OPAQUE' : '',
        qo.colorspace_pars_fragment,
    ...
    !0 !== n.isRawShaderMaterial &&
      ...
      (_ =
        [
          '#define varying in',
          n.glslVersion === en ? '' : 'layout(location = 0) out highp vec4 pc_fragColor;',
          n.glslVersion === en ? '' : '#define gl_FragColor pc_fragColor',
  ...
  const x = v + g + s,
    M = v + _ + o,
    y = Dc(r, r.VERTEX_SHADER, x),
    S = Dc(r, r.FRAGMENT_SHADER, M);
  function b(e) {
    if (t.debug.checkShaderErrors) {
      const n = r.getProgramInfoLog(m) || '',
        i = r.getShaderInfoLog(y) || '',
        a = r.getShaderInfoLog(S) || '',
        s = n.trim(),
        o = i.trim(),
        l = a.trim();
      let c = !0,
      ...
      if (!1 === r.getProgramParameter(m, r.LINK_STATUS))
        if (((c = !1), 'function' == typeof t.debug.onShaderError))
          t.debug.onShaderError(r, m, y, S);
        else {
          const t = Oc(r, y, 'vertex'),
            n = Oc(r, S, 'fragment');
          un(
      ...
      else '' !== s ? hn('WebGLProgram: Program Info Log:', s) : ('' !== o && '' !== l) || (h = !1);
      h &&
        (e.diagnostics = {
          runnable: c,
          programLog: s,
          vertexShader: { log: o, prefix: g },
          fragmentShader: { log: l, prefix: _ },
        });
    }
    (r.deleteShader(y),
      r.deleteShader(S),
...
class sh {
  ...
  _getShaderStage(t) {
    ...
    let n = e.get(t);
    return (void 0 === n && ((n = new oh(t)), e.set(t, n)), n);
  }
}
class oh {
  constructor(t) {
    ((this.id = ah++), (this.code = t), (this.usedTimes = 0));
  }
}
function lh(t, e, n, i, r, a, s) {
  const o = new Ni(),
    l = new sh(),
    c = new Set(),
    h = [],
  ...
  return {
    getParameters: function (a, o, h, u, g) {
      const _ = u.fog,
        v = g.geometry,
        x = a.isMeshStandardMaterial ? u.environment : null,
        M = (a.isMeshStandardMaterial ? n : e).get(a.envMap || x),
        y = M && M.mapping === pt ? M.image.height : null,
        S = f[a.type];
      null !== a.precision &&
        ((p = r.getMaxPrecision(a.precision)),
        p !== a.precision &&
          hn('WebGLProgram.getParameters:', a.precision, 'not supported, using', p, 'instead.'));
      const b = v.morphAttributes.position || v.morphAttributes.normal || v.morphAttributes.color,
      ...
      const P = t.getRenderTarget(),
        ...
        mt = !!a.extensions;
      let gt = 0;
      a.toneMapped && ((null !== P && !0 !== P.isXRRenderTarget) || (gt = t.toneMapping));
      const _t = {
        shaderID: S,
        shaderType: a.type,
        shaderName: a.name,
        ...
        precision: p,
        batching: U,
        batchingColor: U && null !== g._colorsTexture,
        instancing: L,
        instancingColor: L && null !== g.instanceColor,
        instancingMorph: L && null !== g.morphTexture,
        outputColorSpace:
          null === P ? t.outputColorSpace : !0 === P.isXRRenderTarget ? P.texture.colorSpace : He,
        ...
        lightMapUv: B && m(a.lightMap.channel),
        ...
        vertexTangents: !!v.attributes.tangent && (V || X),
        vertexColors: a.vertexColors,
        vertexAlphas:
          !0 === a.vertexColors && !!v.attributes.color && 4 === v.attributes.color.itemSize,
        pointsUvs: !0 === g.isPoints && !!v.attributes.uv && (D || ut),
        fog: !!_,
        useFog: !0 === a.fog,
        ...
        toneMapping: gt,
        decodeVideoTexture:
          D && !0 === a.map.isVideoTexture && Nn.getTransfer(a.map.colorSpace) === We,
        decodeVideoTextureEmissive:
          H &&
          !0 === a.emissiveMap.isVideoTexture &&
          Nn.getTransfer(a.emissiveMap.colorSpace) === We,
        ...
        extensionClipCullDistance:
          mt && !0 === a.extensions.clipCullDistance && i.has('WEBGL_clip_cull_distance'),
        extensionMultiDraw:
          ((mt && !0 === a.extensions.multiDraw) || U) && i.has('WEBGL_multi_draw'),
    ...
    getProgramCacheKey: function (e) {
      ...
      return (
        !1 === e.isRawShaderMaterial &&
          ...
          (function (t, e) {
            (o.disableAll(), e.instancing && o.enable(0));
            e.instancingColor && o.enable(1);
            e.instancingMorph && o.enable(2);
            e.matcap && o.enable(3);
            e.envMap && o.enable(4);
            e.normalMapObjectSpace && o.enable(5);
            e.normalMapTangentSpace && o.enable(6);
            e.clearcoat && o.enable(7);
            e.iridescence && o.enable(8);
            e.alphaTest && o.enable(9);
            e.vertexColors && o.enable(10);
            e.vertexAlphas && o.enable(11);
            e.vertexUv1s && o.enable(12);
            e.vertexUv2s && o.enable(13);
            e.vertexUv3s && o.enable(14);
            e.vertexTangents && o.enable(15);
            e.anisotropy && o.enable(16);
            e.alphaHash && o.enable(17);
            e.batching && o.enable(18);
            e.dispersion && o.enable(19);
            e.batchingColor && o.enable(20);
            e.gradientMap && o.enable(21);
    ...
    getUniforms: function (t) {
      ...
      if (e) {
        const t = Ko[e];
        n = na.clone(t.uniforms);
      } else n = t.uniforms;
      return n;
    },
    acquireProgram: function (e, n) {
      let i = u.get(n);
      return (void 0 !== i ? ++i.usedTimes : ((i = new rh(t, n, e, a)), h.push(i), u.set(n, i)), i);
    },
    releaseProgram: function (t) {
      if (0 === --t.usedTimes) {
        const e = h.indexOf(t);
        ((h[e] = h[h.length - 1]), h.pop(), u.delete(t.cacheKey), t.destroy());
      }
    },
...
function dh() {
  ...
  return {
    ...
    sort: function (t, e) {
      (n.length > 1 && n.sort(t || hh),
        i.length > 1 && i.sort(e || uh),
        r.length > 1 && r.sort(e || uh));
    },
  };
}
function ph() {
    ...
    get: function (e) {
      ...
      switch (e.type) {
        case 'DirectionalLight':
          n = { direction: new An(), color: new gr() };
          break;
        case 'SpotLight':
          n = {
            position: new An(),
          ...
          break;
        case 'PointLight':
          n = { position: new An(), color: new gr(), distance: 0, decay: 0 };
          break;
        case 'HemisphereLight':
          n = { direction: new An(), skyColor: new gr(), groundColor: new gr() };
          break;
        case 'RectAreaLight':
          n = { color: new gr(), position: new An(), halfWidth: new An(), halfHeight: new An() };
      }
      return ((t[e.id] = n), n);
    },
  };
...
function _h(t) {
  ...
  for (let o = 0; o < 9; o++) i.probe.push(new An());
  const r = new An(),
    a = new Ti(),
    s = new Ti();
  return {
    setup: function (r) {
      ...
      for (let t = 0, M = r.length; t < M; t++) {
        ...
        if (
          (x.shadow &&
            x.shadow.map &&
            (b =
              x.shadow.map.texture.format === Ht
                ? x.shadow.map.texture
                : x.shadow.map.depthTexture || x.shadow.map.texture),
          x.isAmbientLight)
        )
          ((a += M.r * y), (s += M.g * y), (o += M.b * y));
        else if (x.isLightProbe) {
          for (let t = 0; t < 9; t++) i.probe[t].addScaledVector(x.sh.coefficients[t], y);
          v++;
          ...
          const r = x.shadow;
          if (
            (x.map && ((i.spotLightMap[g] = x.map), g++, r.updateMatrices(x), x.castShadow && _++),
      ...
      (u > 0 &&
        (!0 === t.has('OES_texture_float_linear')
          ? ((i.rectAreaLTC1 = Yo.LTC_FLOAT_1), (i.rectAreaLTC2 = Yo.LTC_FLOAT_2))
          : ((i.rectAreaLTC1 = Yo.LTC_HALF_1), (i.rectAreaLTC2 = Yo.LTC_HALF_2))),
        (i.ambient[0] = a),
        (i.ambient[1] = s),
        (i.ambient[2] = o));
      const x = i.hash;
...
function Eh(t, e, n) {
  ...
  const f = new Br();
  f.setAttribute('position', new Ar(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3));
  const m = new Zr(f, d),
    g = this;
  ...
  function v(n, i) {
    ...
    (d.defines.VSM_SAMPLES !== n.blurSamples &&
      ...
      (d.needsUpdate = !0),
      (p.needsUpdate = !0)),
      null === n.mapPass && (n.mapPass = new Yn(r.x, r.y, { format: Ht, type: Pt })),
      (d.uniforms.shadow_pass.value = n.map.depthTexture),
  ...
  this.render = function (e, n, o) {
    ...
    2 === e.type &&
      (hn('WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead.'),
      (e.type = 1));
    ...
    for (let f = 0, m = e.length; f < m; f++) {
      const l = e[f],
        c = l.shadow;
      if (void 0 === c) {
        hn('WebGLShadowMap:', l, 'has no shadow.');
        continue;
      }
      ...
      if (
        ...
        a.copy(c.mapSize),
        (r.x > h || r.y > h) &&
          (r.x > h && ((a.x = Math.floor(h / u.x)), (r.x = a.x * u.x), (c.mapSize.x = a.x)),
          r.y > h && ((a.y = Math.floor(h / u.y)), (r.y = a.y * u.y), (c.mapSize.y = a.y))),
        null === c.map || !0 === p)
      ) {
        if (
          (null !== c.map &&
          ...
          ((c.map = new Yn(r.x, r.y, {
            ...
            (c.map.depthTexture = new Ts(r.x, r.y, Ct)),
            (c.map.depthTexture.name = l.name + '.shadowMapDepth'),
            (c.map.depthTexture.format = Bt),
            (c.map.depthTexture.compareFunction = null),
            (c.map.depthTexture.minFilter = _t),
            (c.map.depthTexture.magFilter = _t));
        } else {
          (l.isPointLight
            ? ((c.map = new da(r.x)), (c.map.depthTexture = new Es(r.x, Rt)))
            : ((c.map = new Yn(r.x, r.y)), (c.map.depthTexture = new Ts(r.x, r.y, Rt))),
            (c.map.depthTexture.name = l.name + '.shadowMap'),
            (c.map.depthTexture.format = Bt));
          const e = t.state.buffers.depth.getReversed();
          1 === this.type
            ? ((c.map.depthTexture.compareFunction = e ? 518 : 515),
              (c.map.depthTexture.minFilter = Mt),
              (c.map.depthTexture.magFilter = Mt))
            : ((c.map.depthTexture.compareFunction = null),
              (c.map.depthTexture.minFilter = _t),
              (c.map.depthTexture.magFilter = _t));
        }
      ...
      const m = c.map.isWebGLCubeRenderTarget ? 6 : 1;
      for (let e = 0; e < m; e++) {
        if (c.map.isWebGLCubeRenderTarget) (t.setRenderTarget(c.map, e), t.clear());
          ...
          (s.set(a.x * n.x, a.y * n.y, a.x * n.z, a.y * n.w), d.viewport(s));
        }
        if (l.isPointLight) {
          const t = c.camera,
            n = c.matrix,
          ...
          (i !== t.far && ((t.far = i), t.updateProjectionMatrix()),
            bh.setFromMatrixPosition(l.matrixWorld),
            t.position.copy(bh),
            Th.copy(t.position),
            Th.add(Mh[e]),
            t.up.copy(yh[e]),
            t.lookAt(Th),
            t.updateMatrixWorld(),
            n.makeTranslation(-bh.x, -bh.y, -bh.z),
            Sh.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
            c._frustum.setFromProjectionMatrix(Sh, t.coordinateSystem, t.reversedDepth));
        } else c.updateMatrices(l);
        ((i = c.getFrustum()), M(n, o, c.camera, l, this.type));
      }
      (!0 !== c.isPointLightShadow && 3 === this.type && v(c, o), (c.needsUpdate = !1));
    }
    ((_ = this.type), (g.needsUpdate = !1), t.setRenderTarget(l, c, u));
  };
}
const wh = { [G]: 1, [X]: 6, [q]: 7, [j]: 5, [W]: 0, [K]: 2, [Z]: 4, [Y]: 3 };
function Ah(t, e) {
  const n = new (function () {
      let e = !1;
      const n = new jn();
      let i = null;
      const r = new jn(0, 0, 0, 0);
      return {
        setMask: function (n) {
  ...
  ((it[t.TEXTURE_2D] = nt(t.TEXTURE_2D, t.TEXTURE_2D, 1)),
    ...
    rt(t.CULL_FACE),
    lt(0));
  const st = { [E]: t.FUNC_ADD, [w]: t.FUNC_SUBTRACT, [A]: t.FUNC_REVERSE_SUBTRACT };
  ...
  const ot = {
    ...
    [F]: t.DST_COLOR,
    [D]: t.DST_ALPHA,
    [I]: t.ONE_MINUS_SRC_COLOR,
    [U]: t.ONE_MINUS_SRC_ALPHA,
    [O]: t.ONE_MINUS_DST_COLOR,
    [N]: t.ONE_MINUS_DST_ALPHA,
    [z]: t.CONSTANT_COLOR,
    [V]: t.ONE_MINUS_CONSTANT_COLOR,
    [k]: t.CONSTANT_ALPHA,
    [H]: t.ONE_MINUS_CONSTANT_ALPHA,
  };
  function lt(e, n, i, r, a, s, o, l, c, h) {
    if (0 !== e) {
      if ((!1 === d && (rt(t.BLEND), (d = !0)), 5 === e))
        ((a = a || n),
          (s = s || i),
          (o = o || r),
          (n === f && a === _) || (t.blendEquationSeparate(st[n], st[a]), (f = n), (_ = a)),
          (i === m && r === g && s === v && o === x) ||
            (t.blendFuncSeparate(ot[i], ot[r], ot[s], ot[o]), (m = i), (g = r), (v = s), (x = o)),
          (!1 !== l.equals(M) && c === y) || (t.blendColor(l.r, l.g, l.b, c), M.copy(l), (y = c)),
          (p = e),
          (S = !1));
      else if (e !== p || h !== S) {
        if (((f === E && _ === E) || (t.blendEquation(t.FUNC_ADD), (f = E), (_ = E)), h))
          switch (e) {
            case 1:
            ...
            case 4:
              ...
              break;
            default:
              un('WebGLState: Invalid blending: ', e);
          }
        else
          switch (e) {
            case 1:
            ...
            case 2:
              ...
              break;
            case 3:
              un('WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true');
              break;
            case 4:
              un('WebGLState: MultiplyBlending requires material.premultipliedAlpha = true');
              break;
            default:
              un('WebGLState: Invalid blending: ', e);
          }
        ((m = null), (g = null), (v = null), (x = null), M.set(0, 0, 0), (y = 0), (p = e), (S = h));
      }
    } else !0 === d && (at(t.BLEND), (d = !1));
  }
  function ct(e) {
  ...
  return {
    ...
    bindTexture: function (e, n, i) {
      ...
      let r = J[i];
      (void 0 === r && ((r = { type: void 0, texture: void 0 }), (J[i] = r)),
...
function Rh(t, e, n, i, r, a, s) {
  ...
  function f(t, e) {
    return p ? new OffscreenCanvas(t, e) : sn('canvas');
  }
  function m(t, e, n) {
    let i = 1;
    const r = G(t);
    if (((r.width > n || r.height > n) && (i = n / Math.max(r.width, r.height)), i < 1)) {
      ...
      return (
        'data' in t &&
          hn('WebGLRenderer: Image in DataTexture is too big (' + r.width + 'x' + r.height + ').'),
        t
      );
    }
    return t;
  ...
  function x(n, i, r, a, s = !1) {
    if (null !== n) {
      ...
      hn("WebGLRenderer: Attempt to use non-existing WebGL internal format '" + n + "'");
    }
    let o = i;
    if (
      (i === t.RED &&
      ...
      i === t.RGBA_INTEGER &&
        ...
        r === t.INT && (o = t.RGBA32I)),
      i === t.RGB &&
        (r === t.UNSIGNED_INT_5_9_9_9_REV && (o = t.RGB9_E5),
        r === t.UNSIGNED_INT_10F_11F_11F_REV && (o = t.R11F_G11F_B10F)),
      i === t.RGBA)
    ) {
      const e = s ? Ge : Nn.getTransfer(a);
      (r === t.FLOAT && (o = t.RGBA32F),
        r === t.HALF_FLOAT && (o = t.RGBA16F),
        r === t.UNSIGNED_BYTE && (o = e === We ? t.SRGB8_ALPHA8 : t.RGBA8),
      ...
      e
        ...
        : null === n || n === Rt || n === Ut
          ...
          : n === Ct
            ...
            : n === wt && (i = t.DEPTH_COMPONENT16),
      i
    );
  }
  function y(t, e) {
    return !0 === g(t) || (t.isFramebufferTexture && t.minFilter !== _t && t.minFilter !== Mt)
    ...
    (n.removeEventListener('dispose', b),
      (function (e) {
        ...
        for (let a = 0, o = r.length; a < o; a++) {
          const e = i.get(r[a]);
          (e.__webglTexture && (t.deleteTexture(e.__webglTexture), s.memory.textures--),
            i.remove(r[a]));
        }
        i.remove(e);
      })(n));
  ...
  function w(e, r) {
    ...
    if (
      ...
      const t = e.image;
      if (null === t) hn('WebGLRenderer: Texture marked for update but no image data found.');
      else {
        if (!1 !== t.complete) return void U(a, e, r);
        hn('WebGLRenderer: Texture marked for update but image is incomplete');
      }
  ...
  const A = { [ft]: t.REPEAT, [mt]: t.CLAMP_TO_EDGE, [gt]: t.MIRRORED_REPEAT },
    R = {
      [_t]: t.NEAREST,
  ...
  function P(n, a) {
    if (
      ...
      (n !== t.TEXTURE_3D && n !== t.TEXTURE_2D_ARRAY) ||
        t.texParameteri(n, t.TEXTURE_WRAP_R, A[a.wrapR]),
      ...
      if (a.minFilter !== xt && a.minFilter !== St) return;
      if (a.type === Ct && !1 === e.has('OES_texture_float_linear')) return;
  ...
  function I(e, n) {
    ...
    if (o !== e.__cacheKey) {
      (void 0 === a[o] &&
        ((a[o] = { texture: t.createTexture(), usedTimes: 0 }), s.memory.textures++, (i = !0)),
        a[o].usedTimes++);
  ...
  function U(e, s, o) {
    let l = t.TEXTURE_2D;
    ((s.isDataArrayTexture || s.isCompressedArrayTexture) && (l = t.TEXTURE_2D_ARRAY),
    ...
    if (h.version !== u.__version || !0 === c) {
      ...
      const e = Nn.getPrimaries(Nn.workingColorSpace),
        i = s.colorSpace === Ve ? null : Nn.getPrimaries(s.colorSpace),
        d = s.colorSpace === Ve || e === i ? t.NONE : t.BROWSER_DEFAULT_WEBGL;
      ...
      const f = a.convert(s.format, s.colorSpace),
        v = a.convert(s.type);
      let S,
        b = x(s.internalFormat, f, v, s.colorSpace, s.isVideoTexture);
      P(l, s);
      const T = s.mipmaps,
        ...
        R = y(s, p);
      if (s.isDepthTexture)
        ((b = M(s.format === zt, s.type)),
          w &&
            (E
              ? n.texStorage2D(t.TEXTURE_2D, 1, b, p.width, p.height)
              : n.texImage2D(t.TEXTURE_2D, 0, b, p.width, p.height, 0, f, v, null)));
      else if (s.isDataTexture)
        if (T.length > 0) {
          E && w && n.texStorage2D(t.TEXTURE_2D, R, b, T[0].width, T[0].height);
          for (let e = 0, i = T.length; e < i; e++)
            ((S = T[e]),
              E
                ? A && n.texSubImage2D(t.TEXTURE_2D, e, 0, 0, S.width, S.height, f, v, S.data)
                : n.texImage2D(t.TEXTURE_2D, e, b, S.width, S.height, 0, f, v, S.data));
          s.generateMipmaps = !1;
        } else
          E
            ? (w && n.texStorage2D(t.TEXTURE_2D, R, b, p.width, p.height),
              A &&
                (function (e, i, r, a) {
                  ...
                  if (0 === s.length)
                    n.texSubImage2D(t.TEXTURE_2D, 0, 0, 0, i.width, i.height, r, a, i.data);
                  else {
                    ...
                    for (let t = 1; t < s.length; t++) {
                      const e = s[o],
                        ...
                        l = L(e.start, i.width, 4);
                      n.start <= r + 1 && a === l && L(n.start + n.count - 1, i.width, 4) === a
                        ? (e.count = Math.max(e.count, n.start + n.count - e.start))
                        : (++o, (s[o] = n));
                    }
                    s.length = o + 1;
                    ...
                    for (let e = 0, u = s.length; e < u; e++) {
                      ...
                      (t.pixelStorei(t.UNPACK_SKIP_PIXELS, h),
                        ...
                        n.texSubImage2D(t.TEXTURE_2D, 0, h, u, d, p, r, a, i.data));
                    }
                    (e.clearUpdateRanges(),
            ...
            : n.texImage2D(t.TEXTURE_2D, 0, b, p.width, p.height, 0, f, v, p.data);
      else if (s.isCompressedTexture)
        if (s.isCompressedArrayTexture) {
          E && w && n.texStorage3D(t.TEXTURE_2D_ARRAY, R, b, T[0].width, T[0].height, p.depth);
          for (let e = 0, i = T.length; e < i; e++)
            if (((S = T[e]), s.format !== Ot))
              if (null !== f)
                if (E) {
                  if (A)
                    if (s.layerUpdates.size > 0) {
                      const i = Wo(S.width, S.height, s.format, s.type);
            ...
            ((S = T[e]),
              s.format !== Ot
                ? null !== f
                  ? E
                    ? A &&
                      n.compressedTexSubImage2D(t.TEXTURE_2D, e, 0, 0, S.width, S.height, f, S.data)
        ...
        if (E) {
          if ((w && n.texStorage3D(t.TEXTURE_2D_ARRAY, R, b, p.width, p.height, p.depth), A))
            if (s.layerUpdates.size > 0) {
              const e = Wo(p.width, p.height, s.format, s.type);
        ...
        } else n.texImage3D(t.TEXTURE_2D_ARRAY, 0, b, p.width, p.height, p.depth, 0, f, v, p.data);
      else if (s.isData3DTexture)
        E
          ? (w && n.texStorage3D(t.TEXTURE_3D, R, b, p.width, p.height, p.depth),
            A &&
              n.texSubImage3D(t.TEXTURE_3D, 0, 0, 0, 0, p.width, p.height, p.depth, f, v, p.data))
          : n.texImage3D(t.TEXTURE_3D, 0, b, p.width, p.height, p.depth, 0, f, v, p.data);
      else if (s.isFramebufferTexture) {
        if (w)
          if (E) n.texStorage2D(t.TEXTURE_2D, R, b, p.width, p.height);
          else {
            let e = p.width,
              i = p.height;
            for (let r = 0; r < R; r++)
              (n.texImage2D(t.TEXTURE_2D, r, b, e, i, 0, f, v, null), (e >>= 1), (i >>= 1));
          }
      } else if (T.length > 0) {
        if (E && w) {
          const e = G(T[0]);
        ...
        for (let e = 0, i = T.length; e < i; e++)
          ((S = T[e]),
            E
              ? A && n.texSubImage2D(t.TEXTURE_2D, e, 0, 0, f, v, S)
              : n.texImage2D(t.TEXTURE_2D, e, b, f, v, S));
        s.generateMipmaps = !1;
      } else if (E) {
        if (w) {
          const e = G(p);
      ...
      } else n.texImage2D(t.TEXTURE_2D, 0, b, f, v, p);
  ...
  function D(e, r, s, l, c, h) {
    ...
    (n.bindFramebuffer(t.FRAMEBUFFER, e),
      k(r)
        ? o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER, l, c, m.__webglTexture, 0, V(r))
        : (c === t.TEXTURE_2D ||
  ...
  function N(e, n, i) {
    if ((t.bindRenderbuffer(t.RENDERBUFFER, e), n.depthBuffer)) {
      ...
      (k(n)
        ? o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER, V(n), s, n.width, n.height)
        : i
          ? t.renderbufferStorageMultisample(t.RENDERBUFFER, V(n), s, n.width, n.height)
      ...
      for (let r = 0; r < e.length; r++) {
        ...
        k(n)
          ? o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER, V(n), h, n.width, n.height)
          : i
            ? t.renderbufferStorageMultisample(t.RENDERBUFFER, V(n), h, n.width, n.height)
    ...
    if (
      ...
      if (
        (void 0 === c.__webglInit &&
          ((c.__webglInit = !0), r.depthTexture.addEventListener('dispose', S)),
        void 0 === c.__webglTexture)
      ) {
        ((c.__webglTexture = t.createTexture()),
          n.bindTexture(t.TEXTURE_CUBE_MAP, c.__webglTexture),
          P(t.TEXTURE_CUBE_MAP, r.depthTexture));
        const e = a.convert(r.depthTexture.format),
          i = a.convert(r.depthTexture.type);
        let s;
        r.depthTexture.format === Bt
          ? (s = t.DEPTH_COMPONENT24)
          : r.depthTexture.format === zt && (s = t.DEPTH24_STENCIL8);
        for (let n = 0; n < 6; n++)
          t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X + n, 0, s, r.width, r.height, 0, e, i, null);
      }
    } else w(r.depthTexture, 0);
    const h = c.__webglTexture,
      u = V(r),
      d = l ? t.TEXTURE_CUBE_MAP_POSITIVE_X + s : t.TEXTURE_2D,
      p = r.depthTexture.format === zt ? t.DEPTH_STENCIL_ATTACHMENT : t.DEPTH_ATTACHMENT;
    if (r.depthTexture.format === Bt)
      k(r)
        ? o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER, p, d, h, 0, u)
        : t.framebufferTexture2D(t.FRAMEBUFFER, p, d, h, 0);
    else {
      if (r.depthTexture.format !== zt) throw new Error('Unknown depthTexture format');
      k(r)
        ? o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER, p, d, h, 0, u)
        : t.framebufferTexture2D(t.FRAMEBUFFER, p, d, h, 0);
    }
  ...
  function O(e) {
    ...
    if (e.depthTexture && !r.__autoAllocateDepthBuffer)
      if (a) for (let t = 0; t < 6; t++) F(r.__webglFramebuffer[t], e, t);
      else {
        const t = e.texture.mipmaps;
        t && t.length > 0 ? F(r.__webglFramebuffer[0], e, 0) : F(r.__webglFramebuffer, e, 0);
      }
    else if (a) {
      ...
      for (let i = 0; i < 6; i++)
        if (
          ...
          ((r.__webglDepthbuffer[i] = t.createRenderbuffer()), N(r.__webglDepthbuffer[i], e, !1));
        else {
      ...
      if (
        (i && i.length > 0
          ? n.bindFramebuffer(t.FRAMEBUFFER, r.__webglFramebuffer[0])
          : n.bindFramebuffer(t.FRAMEBUFFER, r.__webglFramebuffer),
        void 0 === r.__webglDepthbuffer)
      )
        ((r.__webglDepthbuffer = t.createRenderbuffer()), N(r.__webglDepthbuffer, e, !1));
      else {
        const n = e.stencilBuffer ? t.DEPTH_STENCIL_ATTACHMENT : t.DEPTH_ATTACHMENT,
      ...
      !0 === t.isCompressedTexture ||
        ...
        (n !== He &&
          ...
          (Nn.getTransfer(n) === We
            ...
            : un('WebGLTextures: Unsupported texture color space:', n))),
      e
    );
  }
  function G(t) {
  ...
  ((this.allocateTextureUnit = function () {
    ...
    (this.setTexture2DArray = function (e, r) {
      ...
      !1 === e.isRenderTargetTexture && e.version > 0 && a.__version !== e.version
        ? U(a, e, r)
        : (e.isExternalTexture && (a.__webglTexture = e.sourceTexture ? e.sourceTexture : null),
    ...
    (this.setTextureCube = function (e, s) {
      const o = i.get(e);
      !0 !== e.isCubeDepthTexture && e.version > 0 && o.__version !== e.version
        ? (function (e, s, o) {
            ...
            if (c.version !== h.__version || !0 === l) {
              ...
              const e = Nn.getPrimaries(Nn.workingColorSpace),
                i = s.colorSpace === Ve ? null : Nn.getPrimaries(s.colorSpace),
                u = s.colorSpace === Ve || e === i ? t.NONE : t.BROWSER_DEFAULT_WEBGL;
              (t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL, s.flipY),
                t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL, s.premultiplyAlpha),
                t.pixelStorei(t.UNPACK_ALIGNMENT, s.unpackAlignment),
              ...
              const v = f[0],
                ...
                S = a.convert(s.type),
                b = x(s.internalFormat, M, S, s.colorSpace),
              ...
              if ((P(t.TEXTURE_CUBE_MAP, s), d)) {
                T && E && n.texStorage2D(t.TEXTURE_CUBE_MAP, R, b, v.width, v.height);
                for (let e = 0; e < 6; e++) {
                  A = f[e].mipmaps;
                ...
                for (let e = 0; e < 6; e++)
                  if (p) {
                    ...
                    T
                      ? w && n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X + e, 0, 0, 0, M, S, f[e])
                      : n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X + e, 0, b, M, S, f[e]);
                    for (let i = 0; i < A.length; i++) {
                      const r = A[i];
                      T
                        ? w &&
    ...
    (this.rebindTextures = function (e, n, r) {
      const a = i.get(e);
      (void 0 !== n && D(a.__webglFramebuffer, e, e.texture, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, 0),
        void 0 !== r && O(e));
    }),
        ...
        if (e.samples > 0 && !1 === k(e)) {
          ...
          (t.bindRenderbuffer(t.RENDERBUFFER, null),
            e.depthBuffer &&
              ...
              N(o.__webglDepthRenderbuffer, e, !0)),
            n.bindFramebuffer(t.FRAMEBUFFER, null));
        }
      }
      if (h) {
        ...
        for (let r = 0, a = c.length; r < a; r++) {
          ...
          ((e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) &&
            (l = e.isWebGL3DRenderTarget ? t.TEXTURE_3D : t.TEXTURE_2D_ARRAY),
            n.bindTexture(l, s.__webglTexture),
            P(l, a),
            D(o.__webglFramebuffer, e, a, t.COLOR_ATTACHMENT0 + r, l, 0),
            g(a) && _(l));
        }
        n.unbindTexture();
      } else {
    ...
    (this.updateMultisampleRenderTarget = function (e) {
      if (e.samples > 0)
        if (!1 === k(e)) {
          ...
          d && d.length > 0
            ? n.bindFramebuffer(t.DRAW_FRAMEBUFFER, h.__webglFramebuffer[0])
            ...
            (t.blitFramebuffer(0, 0, a, s, 0, 0, a, s, o, t.NEAREST),
              !0 === l &&
                ...
                e.depthBuffer &&
                  ...
                  (B.push(c), z.push(c), t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER, z)),
...
function Ch(t, e) {
  return {
    convert: function (n, i = '') {
      ...
      if (n === bt) return t.UNSIGNED_BYTE;
      if (n === It) return t.UNSIGNED_SHORT_4_4_4_4;
      if (n === Lt) return t.UNSIGNED_SHORT_5_5_5_1;
      if (n === Dt) return t.UNSIGNED_INT_5_9_9_9_REV;
      if (n === Nt) return t.UNSIGNED_INT_10F_11F_11F_REV;
      if (n === Tt) return t.BYTE;
      if (n === Et) return t.SHORT;
      if (n === wt) return t.UNSIGNED_SHORT;
      if (n === At) return t.INT;
      if (n === Rt) return t.UNSIGNED_INT;
      if (n === Ct) return t.FLOAT;
      if (n === Pt) return t.HALF_FLOAT;
      if (1021 === n) return t.ALPHA;
      if (n === Ft) return t.RGB;
      if (n === Ot) return t.RGBA;
      if (n === Bt) return t.DEPTH_COMPONENT;
      if (n === zt) return t.DEPTH_STENCIL;
      if (n === Vt) return t.RED;
      if (n === kt) return t.RED_INTEGER;
      if (n === Ht) return t.RG;
      if (n === Gt) return t.RG_INTEGER;
      if (n === Wt) return t.RGBA_INTEGER;
      if (n === Xt || n === jt || n === qt || n === Yt)
        if (a === We) {
          if (((r = e.get('WEBGL_compressed_texture_s3tc_srgb')), null === r)) return null;
          if (n === Xt) return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;
          if (n === jt) return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
          ...
          if (n === Xt) return r.COMPRESSED_RGB_S3TC_DXT1_EXT;
          if (n === jt) return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;
          if (n === qt) return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;
          if (n === Yt) return r.COMPRESSED_RGBA_S3TC_DXT5_EXT;
        }
      if (n === Kt || n === Zt || n === Jt || n === $t) {
        if (((r = e.get('WEBGL_compressed_texture_pvrtc')), null === r)) return null;
        if (n === Kt) return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
      ...
      if (n === Qt || n === te || n === ee || n === ne || n === ie || n === re || n === ae) {
        if (((r = e.get('WEBGL_compressed_texture_etc')), null === r)) return null;
        if (n === Qt || n === te)
          return a === We ? r.COMPRESSED_SRGB8_ETC2 : r.COMPRESSED_RGB8_ETC2;
        if (n === ee)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : r.COMPRESSED_RGBA8_ETC2_EAC;
        if (n === ne) return r.COMPRESSED_R11_EAC;
        if (n === ie) return r.COMPRESSED_SIGNED_R11_EAC;
        if (n === re) return r.COMPRESSED_RG11_EAC;
        if (n === ae) return r.COMPRESSED_SIGNED_RG11_EAC;
      }
      if (
        n === se ||
        n === oe ||
        ...
        if (n === se)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : r.COMPRESSED_RGBA_ASTC_4x4_KHR;
        if (n === oe)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR : r.COMPRESSED_RGBA_ASTC_5x4_KHR;
        if (n === le)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR : r.COMPRESSED_RGBA_ASTC_5x5_KHR;
        if (n === ce)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR : r.COMPRESSED_RGBA_ASTC_6x5_KHR;
        if (n === he)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR : r.COMPRESSED_RGBA_ASTC_6x6_KHR;
        if (n === ue)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR : r.COMPRESSED_RGBA_ASTC_8x5_KHR;
        if (n === de)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR : r.COMPRESSED_RGBA_ASTC_8x6_KHR;
        if (n === pe)
          return a === We ? r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR : r.COMPRESSED_RGBA_ASTC_8x8_KHR;
        if (n === fe)
          return a === We
      ...
      if (n === Me || n === ye || n === Se) {
        ...
        if (n === ye) return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (n === Se) return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      }
      if (n === be || n === Te || n === Ee || n === we) {
        if (((r = e.get('EXT_texture_compression_rgtc')), null === r)) return null;
        if (n === be) return r.COMPRESSED_RED_RGTC1_EXT;
      ...
      return n === Ut ? t.UNSIGNED_INT_24_8 : void 0 !== t[n] ? t[n] : null;
    },
  };
}
class Ph {
  ...
  getMesh(t) {
    if (null !== this.texture && null === this.mesh) {
      ...
      this.mesh = new Zr(new As(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(t, e) {
    ...
    function I() {
      ...
      for (let t = 0; t < M.length; t++) {
        const e = y[t];
        null !== e && ((y[t] = null), M[t].disconnect(e));
      }
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (t) {
        let e = M[t];
        return (void 0 === e && ((e = new ma()), (M[t] = e)), e.getTargetRaySpace());
      }),
      (this.getControllerGrip = function (t) {
        let e = M[t];
        return (void 0 === e && ((e = new ma()), (M[t] = e)), e.getGripSpace());
      }),
      (this.getHand = function (t) {
        let e = M[t];
        return (void 0 === e && ((e = new ma()), (M[t] = e)), e.getHandSpace());
      }),
      (this.setFramebufferScaleFactor = function (t) {
        ((r = t),
          !0 === n.isPresenting &&
            hn('WebXRManager: Cannot change framebuffer scale while presenting.'));
      }),
      (this.setReferenceSpaceType = function (t) {
        ((s = t),
          !0 === n.isPresenting &&
            hn('WebXRManager: Cannot change reference space type while presenting.'));
      }),
        ...
        if (((i = c), null !== i)) {
          ...
          if (f && 'createProjectionLayer' in XRWebGLBinding.prototype) {
            let n = null,
              ...
              s = null;
            _.depth &&
              ((s = _.stencil ? e.DEPTH24_STENCIL8 : e.DEPTH_COMPONENT24),
              (n = _.stencil ? zt : Bt),
              (a = _.stencil ? Ut : Rt));
            ...
            ((h = this.getBinding()),
              ...
              (x = new Yn(u.textureWidth, u.textureHeight, {
                format: Ot,
                type: bt,
                depthTexture: new Ts(
                  u.textureWidth,
            ...
            ((d = new XRWebGLLayer(i, e, n)),
              ...
              (x = new Yn(d.framebufferWidth, d.framebufferHeight, {
                format: Ot,
                type: bt,
                colorSpace: t.outputColorSpace,
                stencilBuffer: _.stencil,
    ...
    ((this.updateCamera = function (t) {
      ...
      let e = t.near,
        n = t.far;
      (null !== m.texture &&
        (m.depthNear > 0 && (e = m.depthNear), m.depthFar > 0 && (n = m.depthFar)),
        (A.near = E.near = T.near = e),
        (A.far = E.far = T.far = n),
        (R === A.near && C === A.far) ||
          (i.updateRenderState({ depthNear: A.near, depthFar: A.far }), (R = A.near), (C = A.far)),
        (A.layers.mask = 6 | t.layers.mask),
        (T.layers.mask = 3 & A.layers.mask),
        (E.layers.mask = 5 & A.layers.mask));
      const r = t.parent,
        a = A.cameras;
      N(A, r);
      for (let i = 0; i < a.length; i++) N(a[i], r);
      (2 === a.length
        ? (function (t, e, n) {
            (U.setFromMatrixPosition(e.matrixWorld), D.setFromMatrixPosition(n.matrixWorld));
            const i = U.distanceTo(D),
        ...
        (function (t, e, n) {
          ...
          (t.matrix.decompose(t.position, t.quaternion, t.scale),
            ...
            t.isPerspectiveCamera &&
              ((t.fov = 2 * _n * Math.atan(1 / t.projectionMatrix.elements[5])), (t.zoom = 1)));
        })(t, A, r));
    }),
    ...
    (O.setAnimationLoop(function (e, r) {
      if (((c = r.getViewerPose(l || a)), (p = r), null !== c)) {
        ...
        for (let n = 0; n < e.length; n++) {
          ...
          if (null !== d) a = d.getViewport(i);
            ...
            ((a = e.viewport),
              0 === n &&
                (t.setRenderTargetTextures(x, e.colorTexture, e.depthStencilTexture),
                t.setRenderTarget(x)));
          }
          let s = w[n];
          (void 0 === s &&
            ((s = new la()), s.layers.enable(n), (s.viewport = new jn()), (w[n] = s)),
            s.matrix.fromArray(i.transform.matrix),
            ...
            0 === n &&
              (A.matrix.copy(s.matrix), A.matrix.decompose(A.position, A.quaternion, A.scale)),
      ...
      (F && F(e, r),
        r.detectedPlanes && n.dispatchEvent({ type: 'planesdetected', data: r }),
        (p = null));
    }),
...
function Dh(t, e) {
  ...
  function i(t, i) {
    ((t.opacity.value = i.opacity),
      ...
      i.emissiveMap &&
        ((t.emissiveMap.value = i.emissiveMap), n(i.emissiveMap, t.emissiveMapTransform)),
      i.specularMap &&
        ((t.specularMap.value = i.specularMap), n(i.specularMap, t.specularMapTransform)),
    ...
    (a &&
      ...
      (Lh.y *= -1),
      (Lh.z *= -1),
      a.isCubeTexture && !1 === a.isRenderTargetTexture && ((Lh.y *= -1), (Lh.z *= -1)),
      t.envMapRotation.value.setFromMatrix4(Uh.makeRotationFromEuler(Lh)),
  ...
  return {
    refreshFogUniforms: function (e, n) {
      (n.color.getRGB(e.fogColor.value, ea(t)),
        n.isFog
...
function Nh(t, e, n, i) {
  ...
  function l(t, e, n, i) {
    const r = t.value,
      a = e + '_' + n;
    if (void 0 === i[a])
      return ((i[a] = 'number' == typeof r || 'boolean' == typeof r ? r : r.clone()), !0);
    {
      const t = i[a];
            ...
            : t.isVector4
              ...
              : t.isMatrix3
                ...
                : t.isMatrix4
                  ...
                  : t.isTexture
                    ? hn('WebGLRenderer: Texture samplers can not be part of an uniforms group.')
                    : hn('WebGLRenderer: Unsupported uniform value type.', t),
      e
    );
  }
  function h(e) {
      ...
      void 0 === d &&
            ...
            for (let e = 0, r = t.length; e < r; e++) {
              ...
              for (let t = 0, e = a.length; t < e; t++) {
                ...
                ((n += o),
                  ...
                  (r.__data = new Float32Array(e.storage / Float32Array.BYTES_PER_ELEMENT)),
                  (r.__offset = n),
                  (n += e.storage));
              }
            }
        ...
        (d = (function (e) {
          const n = (function () {
            ...
            return (
              un('WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.'),
              0
            );
          })();
              ...
              if (!0 === l(i, r, n, a)) {
                ...
                for (let a = 0; a < n.length; a++) {
                  ...
                  'number' == typeof s || 'boolean' == typeof s
                    ? ((i.__data[0] = s), t.bufferSubData(t.UNIFORM_BUFFER, e + r, i.__data))
                    : s.isMatrix3
                      ? ((i.__data[0] = s.elements[0]),
                        ...
                        (i.__data[11] = 0))
                      : (s.toArray(i.__data, r), (r += o.storage / Float32Array.BYTES_PER_ELEMENT));
                }
...
class Bh {
  constructor(t = {}) {
    ...
    try {
      ...
      if (
        ('setAttribute' in e && e.setAttribute('data-engine', `three.js r${v}`),
        ...
        const e = 'webgl2';
        if (((Dt = Nt(e, t)), null === Dt))
          throw Nt(e)
            ? new Error('Error creating WebGL context with your selected attributes.')
            : new Error('Error creating WebGL context.');
      }
    } catch (le) {
      throw (un('WebGLRenderer: ' + le.message), le);
    }
    function Ft() {
      ((tt = new yl(Dt)),
        tt.init(),
        (Et = new Ch(Dt, tt)),
        (et = new nl(Dt, tt, t, Et)),
        (nt = new Ah(Dt, tt)),
        et.reversedDepthBuffer && u && nt.buffers.depth.setReversed(!0),
        (it = new Tl(Dt)),
        (rt = new ch()),
        (at = new Rh(Dt, tt, nt, rt, et, Et, it)),
        (st = new rl(E)),
        (ot = new Ml(E)),
        (lt = new jo(Dt)),
        (At = new tl(Dt, lt)),
        (ct = new Sl(Dt, lt, it, At)),
        (ht = new wl(Dt, ct, lt, it)),
        (xt = new El(Dt, et, at)),
        (gt = new il(rt)),
        (ut = new lh(E, st, ot, tt, et, At, gt)),
        (dt = new Dh(E, rt)),
        (pt = new ph()),
        (ft = new xh(tt)),
        (vt = new Qo(E, st, ot, nt, ht, p, o)),
        (_t = new Eh(E, ht, et)),
        (Ct = new Nh(Dt, it, et, nt)),
        (yt = new el(Dt, tt, it)),
        (Tt = new bl(Dt, tt, it)),
        (it.programs = ut.programs),
        (E.capabilities = et),
        (E.extensions = tt),
        (E.properties = rt),
        (E.renderLists = pt),
    ...
    (Ft(), f !== bt && (T = new Rl(f, e.width, e.height, i, r)));
    const Ot = new Ih(E, Dt);
    function Bt(t) {
      (t.preventDefault(), cn('WebGLRenderer: Context Lost.'), (w = !0));
    }
    function zt() {
      (cn('WebGLRenderer: Context Restored.'), (w = !1));
    ...
    function Vt(t) {
      un('WebGLRenderer: A WebGL context could not be created. Reason: ', t.statusMessage);
    }
    function Xt(t) {
      const e = t.target;
    ...
    ((this.xr = Ot),
      ...
      (this.setPixelRatio = function (t) {
        void 0 !== t && ((z = t), this.setSize(O, B, !1));
      }),
      ...
      (this.setSize = function (t, n, i = !0) {
        Ot.isPresenting
          ? hn("WebGLRenderer: Can't change size while VR device is presenting.")
          : ((O = t),
            (B = n),
            (e.width = Math.floor(t * z)),
            (e.height = Math.floor(n * z)),
            !0 === i && ((e.style.width = t + 'px'), (e.style.height = n + 'px')),
            null !== T && T.setSize(e.width, e.height),
            this.setViewport(0, 0, t, n));
      }),
      (this.getDrawingBufferSize = function (t) {
        return t.set(O * z, B * z).floor();
      }),
      ...
      (this.setViewport = function (t, e, n, i) {
        (t.isVector4 ? H.set(t.x, t.y, t.z, t.w) : H.set(t, e, n, i),
          nt.viewport(L.copy(H).multiplyScalar(z).round()));
      }),
      ...
      (this.setScissor = function (t, e, n, i) {
        (t.isVector4 ? G.set(t.x, t.y, t.z, t.w) : G.set(t, e, n, i),
          nt.scissor(U.copy(G).multiplyScalar(z).round()));
      }),
      (this.getScissorTest = function () {
        return W;
      }),
      (this.setScissorTest = function (t) {
        nt.setScissorTest((W = t));
      }),
        ...
        if (t) {
          ...
          if (t) {
            const t = C.texture.type,
              ...
              s = n.b;
            e
              ? ((_[0] = r), (_[1] = a), (_[2] = s), (_[3] = i), Dt.clearBufferuiv(Dt.COLOR, 0, _))
              : ((x[0] = r), (x[1] = a), (x[2] = s), (x[3] = i), Dt.clearBufferiv(Dt.COLOR, 0, x));
          } else i |= Dt.COLOR_BUFFER_BIT;
        }
        (e && (i |= Dt.DEPTH_BUFFER_BIT),
          n && ((i |= Dt.STENCIL_BUFFER_BIT), this.state.buffers.stencil.setMask(4294967295)),
          Dt.clear(i));
      }),
      ...
      (this.dispose = function () {
        (e.removeEventListener('webglcontextlost', Bt, !1),
          ...
          ut.dispose(),
          Ot.dispose(),
          Ot.removeEventListener('sessionstart', Yt),
          Ot.removeEventListener('sessionend', Kt),
          Zt.stop());
      }),
      (this.renderBufferDirect = function (t, e, n, i, r, a) {
        ...
        const s = r.isMesh && r.matrixWorld.determinant() < 0,
          o = (function (t, e, n, i, r) {
              ...
              o =
                null === C
                  ...
                  : !0 === C.isXRRenderTarget
                    ...
                    : He,
              l = (i.isMeshStandardMaterial ? ot : st).get(i.envMap || s),
              c =
            ...
            let f = 0;
            i.toneMapped && ((null !== C && !0 !== C.isXRRenderTarget) || (f = E.toneMapping));
            const m =
                        ...
                        : r.isSkinnedMesh || !0 !== _.skinning
                          ? (r.isInstancedMesh &&
                            ...
                            : void 0 === _.numClippingPlanes ||
                                (_.numClippingPlanes === gt.numPlanes &&
                                  _.numIntersection === gt.numIntersection)
                              ? (_.vertexAlphas !== c ||
                                  _.vertexTangents !== h ||
                                  _.morphTargets !== u ||
                                  _.morphNormals !== d ||
            ...
            const w = M.getUniforms(),
              A = _.uniforms;
            nt.useProgram(M.program) && ((S = !0), (b = !0), (T = !0));
            i.id !== P && ((P = i.id), (b = !0));
            if (S || I !== t) {
              (nt.buffers.depth.getReversed() &&
                !0 !== t.reversedDepth &&
                ((t._reversedDepth = !0), t.updateProjectionMatrix()),
                w.setValue(Dt, 'projectionMatrix', t.projectionMatrix),
                w.setValue(Dt, 'viewMatrix', t.matrixWorldInverse));
              const e = w.map.cameraPosition;
              (void 0 !== e && e.setValue(Dt, K.setFromMatrixPosition(t.matrixWorld)),
                et.logarithmicDepthBuffer &&
                  w.setValue(Dt, 'logDepthBufFC', 2 / (Math.log(t.far + 1) / Math.LN2)),
                (i.isMeshPhongMaterial ||
                  ...
                  i.isShaderMaterial) &&
                  w.setValue(Dt, 'isOrthographic', !0 === t.isOrthographicCamera),
                I !== t && ((I = t), (b = !0), (T = !0)));
            }
            _.needsLights &&
              (v.state.directionalShadowMap.length > 0 &&
                w.setValue(Dt, 'directionalShadowMap', v.state.directionalShadowMap, at),
              v.state.spotShadowMap.length > 0 &&
                w.setValue(Dt, 'spotShadowMap', v.state.spotShadowMap, at),
              v.state.pointShadowMap.length > 0 &&
                w.setValue(Dt, 'pointShadowMap', v.state.pointShadowMap, at));
            if (r.isSkinnedMesh) {
              (w.setOptional(Dt, r, 'bindMatrix'), w.setOptional(Dt, r, 'bindMatrixInverse'));
              const t = r.skeleton;
              t &&
                (null === t.boneTexture && t.computeBoneTexture(),
                w.setValue(Dt, 'boneTexture', t.boneTexture, at));
            }
            r.isBatchedMesh &&
              (w.setOptional(Dt, r, 'batchingTexture'),
              w.setValue(Dt, 'batchingTexture', r._matricesTexture, at),
              w.setOptional(Dt, r, 'batchingIdTexture'),
              w.setValue(Dt, 'batchingIdTexture', r._indirectTexture, at),
              w.setOptional(Dt, r, 'batchingColorTexture'),
              null !== r._colorsTexture &&
                w.setValue(Dt, 'batchingColorTexture', r._colorsTexture, at));
            const R = n.morphAttributes;
            (void 0 === R.position && void 0 === R.normal && void 0 === R.color) ||
              xt.update(r, n, M);
            (b || _.receiveShadow !== r.receiveShadow) &&
              ((_.receiveShadow = r.receiveShadow),
              w.setValue(Dt, 'receiveShadow', r.receiveShadow));
            i.isMeshGouraudMaterial &&
              null !== i.envMap &&
              ((A.envMap.value = l),
              (A.flipEnvMap.value = l.isCubeTexture && !1 === l.isRenderTargetTexture ? -1 : 1));
            i.isMeshStandardMaterial &&
              null === i.envMap &&
              null !== e.environment &&
              (A.envMapIntensity.value = e.environmentIntensity);
            void 0 !== A.dfgLUT &&
              (A.dfgLUT.value =
                (null === Oh &&
                  ((Oh = new Ia(Fh, 16, 16, Ht, Pt)),
                  (Oh.name = 'DFG_LUT'),
                  (Oh.minFilter = Mt),
                  (Oh.magFilter = Mt),
                  (Oh.wrapS = mt),
                  (Oh.wrapT = mt),
                  (Oh.generateMipmaps = !1),
                  (Oh.needsUpdate = !0)),
                Oh));
            b &&
              (w.setValue(Dt, 'toneMappingExposure', E.toneMappingExposure),
              _.needsLights &&
                ((U = T),
                ((L = A).ambientLightColor.needsUpdate = U),
              ...
              a && !0 === i.fog && dt.refreshFogUniforms(A, a),
              dt.refreshMaterialUniforms(A, i, z, B, y.state.transmissionRenderTarget[t.id]),
              Uc.upload(Dt, ie(_), A, at));
            var L, U;
            i.isShaderMaterial &&
              !0 === i.uniformsNeedUpdate &&
              (Uc.upload(Dt, ie(_), A, at), (i.uniformsNeedUpdate = !1));
            i.isSpriteMaterial && w.setValue(Dt, 'center', r.center);
            if (
              (w.setValue(Dt, 'modelViewMatrix', r.modelViewMatrix),
              w.setValue(Dt, 'normalMatrix', r.normalMatrix),
              w.setValue(Dt, 'modelMatrix', r.matrixWorld),
              i.isShaderMaterial || i.isRawShaderMaterial)
            ) {
              const t = i.uniformsGroups;
              for (let e = 0, n = t.length; e < n; e++) {
                const n = t[e];
                (Ct.update(n, M), Ct.bind(n, M));
              }
            }
            return M;
          })(t, e, n, i, r);
        ...
        let l = n.index,
          c = 1;
        if (!0 === i.wireframe) {
          if (((l = ct.getWireframeAttribute(n)), void 0 === l)) return;
          c = 2;
        }
        const h = n.drawRange,
        ...
        let d = h.start * c,
          p = (h.start + h.count) * c;
        (null !== a && ((d = Math.max(d, a.start * c)), (p = Math.min(p, (a.start + a.count) * c))),
          null !== l
        ...
        At.setup(r, i, o, n, l);
        let g = yt;
        if ((null !== l && ((m = lt.get(l)), (g = Tt), g.setIndex(m)), r.isMesh))
          !0 === i.wireframe
            ? (nt.setLineWidth(i.wireframeLinewidth * Q()), g.setMode(Dt.LINES))
        ...
        } else r.isPoints ? g.setMode(Dt.POINTS) : r.isSprite && g.setMode(Dt.TRIANGLES);
        if (r.isBatchedMesh)
          if (null !== r._multiDrawInstances)
            ...
            const t = r._multiDrawStarts,
              ...
              n = r._multiDrawCount,
              a = l ? lt.get(l).bytesPerElement : 1,
              s = rt.get(i).currentProgram.getUniforms();
            for (let i = 0; i < n; i++) (s.setValue(Dt, '_gl_DrawID', i), g.render(t[i] / a, e[i]));
          }
        ...
        return new Promise(e => {
          function n() {
            (i.forEach(function (t) {
              rt.get(t).currentProgram.isReady() && i.delete(t);
            }),
              0 !== i.size ? setTimeout(n, 10) : e(t));
          }
          null !== tt.get('KHR_parallel_shader_compile') ? n() : setTimeout(n, 10);
        });
      }));
    let qt = null;
    function Yt() {
      ...
      if (t.layers.test(e.layers))
        if (t.isGroup) n = t.renderOrder;
          ...
          if (!t.frustumCulled || X.intersectsSprite(t)) {
            ...
            const e = ht.update(t),
              r = t.material;
            r.visible && M.push(t, e, r, n, Z.z, null);
          }
        } else if (
          ...
          if (
            (i &&
              ...
              Z.applyMatrix4(t.matrixWorld).applyMatrix4(Y)),
            Array.isArray(r))
          ) {
            const i = e.groups;
            for (let a = 0, s = i.length; a < s; a++) {
              const s = i[a],
                o = r[s.materialIndex];
              o && o.visible && M.push(t, e, o, n, Z.z, s);
            }
          } else r.visible && M.push(t, e, r, n, Z.z, null);
        }
      const r = t.children;
      for (let a = 0, s = r.length; a < s; a++) Jt(r[a], e, n, i);
    }
    function $t(t, e, n, i) {
      const { opaque: r, transmissive: a, transparent: s } = t;
      (y.setupLightsView(n),
        !0 === j && gt.setGlobalState(E.clippingPlanes, n),
        i && nt.viewport(L.copy(i)),
        r.length > 0 && te(r, e, n),
        a.length > 0 && te(a, e, n),
        s.length > 0 && te(s, e, n),
    ...
    function Qt(t, e, n, i) {
      ...
      if (void 0 === y.state.transmissionRenderTarget[i.id]) {
        const t = tt.has('EXT_color_buffer_half_float') || tt.has('EXT_color_buffer_float');
        y.state.transmissionRenderTarget[i.id] = new Yn(1, 1, {
          generateMipmaps: !0,
          type: t ? Pt : bt,
          minFilter: St,
          samples: et.samples,
      ...
      const a = y.state.transmissionRenderTarget[i.id],
        s = i.viewport || L;
      a.setSize(s.z * E.transmissionResolutionScale, s.w * E.transmissionResolutionScale);
      ...
      (E.setRenderTarget(a),
        E.getClearColor(N),
        (F = E.getClearAlpha()),
        F < 1 && E.setClearColor(16777215, 0.5),
        E.clear(),
        $ && vt.render(n));
      ...
      if (
        ...
        y.setupLightsView(i),
        !0 === j && gt.setGlobalState(E.clippingPlanes, i),
        te(t, n, i),
        at.updateMultisampleRenderTarget(a),
        at.updateRenderTargetMipmap(a),
        !1 === tt.has('WEBGL_multisampled_render_to_texture'))
      ) {
        let t = !1;
        for (let r = 0, a = e.length; r < a; r++) {
          const a = e[r],
        ...
        !0 === t && (at.updateMultisampleRenderTarget(a), at.updateRenderTargetMipmap(a));
      }
    ...
    function te(t, e, n) {
      ...
      for (let r = 0, a = t.length; r < a; r++) {
        ...
        (!0 === c.allowOverride && null !== i && (c = i),
          s.layers.test(n.layers) && ee(s, e, n, o, c, l));
      }
    }
    ...
    function ne(t, e, n) {
      ...
      const i = rt.get(t),
        ...
        s = r.state.version,
        o = ut.getParameters(t, r.state, a, e, n),
        l = ut.getProgramCacheKey(o);
      let c = i.programs;
      ((i.environment = t.isMeshStandardMaterial ? e.environment : null),
        (i.fog = e.fog),
        (i.envMap = (t.isMeshStandardMaterial ? ot : st).get(t.envMap || i.environment)),
        (i.envMapRotation =
          null !== i.environment && null === t.envMap ? e.environmentRotation : t.envMapRotation),
        void 0 === c && (t.addEventListener('dispose', Xt), (c = new Map()), (i.programs = c)));
      let h = c.get(l);
      if (void 0 !== h) {
        if (i.currentProgram === h && i.lightsStateVersion === s) return (re(t, o), h);
      } else
        ((o.uniforms = ut.getUniforms(t)),
          t.onBeforeCompile(o, E),
          (h = ut.acquireProgram(o, l)),
          c.set(l, h),
          (i.uniforms = o.uniforms));
      const u = i.uniforms;
      return (
        ((t.isShaderMaterial || t.isRawShaderMaterial) && !0 !== t.clipping) ||
          (u.clippingPlanes = gt.uniform),
        re(t, o),
    ...
    function ie(t) {
      if (null === t.uniformsList) {
        ...
        t.uniformsList = Uc.seqWithValue(e.seq, t.uniforms);
      }
    ...
    (Zt.setAnimationLoop(function (t) {
      ...
      (this.setAnimationLoop = function (t) {
        ((qt = t), Ot.setAnimationLoop(t), null === t ? Zt.stop() : Zt.start());
      }),
      Ot.addEventListener('sessionstart', Yt),
      Ot.addEventListener('sessionend', Kt),
      (this.render = function (t, e) {
        if (void 0 !== e && !0 !== e.isCamera)
          return void un('WebGLRenderer.render: camera is not an instance of THREE.Camera.');
        if (!0 === w) return;
        const n = !0 === Ot.enabled && !0 === Ot.isPresenting,
          i = null !== T && (null === C || n) && T.begin(E, C);
        if (
          (!0 === t.matrixWorldAutoUpdate && t.updateMatrixWorld(),
          null === e.parent && !0 === e.matrixWorldAutoUpdate && e.updateMatrixWorld(),
          !0 !== Ot.enabled ||
            !0 !== Ot.isPresenting ||
            (null !== T && !1 !== T.isCompositing()) ||
            (!0 === Ot.cameraAutoUpdate && Ot.updateCamera(e), (e = Ot.getCamera())),
          !0 === t.isScene && t.onBeforeRender(E, t, e, C),
          (y = ft.get(t, b.length)),
          y.init(e),
          b.push(y),
          Y.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
          X.setFromProjectionMatrix(Y, nn, e.reversedDepth),
          (q = this.localClippingEnabled),
          (j = gt.init(this.clippingPlanes, q)),
          (M = pt.get(t, S.length)),
          M.init(),
          S.push(M),
          !0 === Ot.enabled && !0 === Ot.isPresenting)
        ) {
          const t = E.xr.getDepthSensingMesh();
          null !== t && Jt(t, e, -1 / 0, E.sortObjects);
        }
        (Jt(t, e, 0, E.sortObjects),
          M.finish(),
          !0 === E.sortObjects && M.sort(V, k),
          ($ = !1 === Ot.enabled || !1 === Ot.isPresenting || !1 === Ot.hasDepthSensing()),
          $ && vt.addToRenderList(M, t),
          this.info.render.frame++,
          !0 === j && gt.beginShadows());
        const r = y.state.shadowsArray;
        (_t.render(r, t, e),
          !0 === j && gt.endShadows(),
          !0 === this.info.autoReset && this.info.reset());
        if (!1 === (i && T.hasRenderPass())) {
          const n = M.opaque,
            i = M.transmissive;
          if ((y.setupLights(), e.isArrayCamera)) {
            const r = e.cameras;
            if (i.length > 0)
          ...
          } else (i.length > 0 && Qt(n, i, t, e), $ && vt.render(t), $t(M, t, e));
        }
        (null !== C &&
          0 === R &&
          (at.updateMultisampleRenderTarget(C), at.updateRenderTargetMipmap(C)),
          i && T.end(E),
          ...
          b.length > 0
            ? ((y = b[b.length - 1]),
              !0 === j && gt.setGlobalState(E.clippingPlanes, y.state.camera))
            : (y = null),
          S.pop(),
      ...
      (this.setRenderTargetTextures = function (t, e, n) {
        ...
        ((i.__autoAllocateDepthBuffer = !1 === t.resolveDepthBuffer),
          ...
          (rt.get(t.texture).__webglTexture = e),
          (rt.get(t.depthTexture).__webglTexture = i.__autoAllocateDepthBuffer ? void 0 : n),
    ...
    ((this.setRenderTarget = function (t, e = 0, n = 0) {
      ...
      if (t) {
        ...
        if (void 0 !== s.__useDefaultFramebuffer)
          return (
            nt.bindFramebuffer(Dt.FRAMEBUFFER, s.__webglFramebuffer),
            L.copy(t.viewport),
            U.copy(t.scissor),
            (D = t.scissorTest),
            nt.viewport(L),
        ...
        if (void 0 === s.__webglFramebuffer) at.setupRenderTarget(t);
        else if (s.__hasExternalTextures)
          at.rebindTextures(
            t,
            rt.get(t.texture).__webglTexture,
            rt.get(t.depthTexture).__webglTexture
          );
        ...
        const l = rt.get(t).__webglFramebuffer;
        (t.isWebGLCubeRenderTarget
          ...
          U.copy(t.scissor),
          (D = t.scissorTest));
      } else (L.copy(H).multiplyScalar(z).floor(), U.copy(G).multiplyScalar(z).floor(), (D = W));
      0 !== n && (i = ae);
      if (
        (nt.bindFramebuffer(Dt.FRAMEBUFFER, i) && nt.drawBuffers(t, i),
        nt.viewport(L),
        nt.scissor(U),
        nt.setScissorTest(D),
        r)
        ...
        for (let e = 0; e < t.textures.length; e++) {
          const r = rt.get(t.textures[e]);
          Dt.framebufferTextureLayer(
            Dt.FRAMEBUFFER,
            Dt.COLOR_ATTACHMENT0 + e,
            r.__webglTexture,
            n,
            i
          );
        ...
        if ((t.isWebGLCubeRenderTarget && void 0 !== s && (l = l[s]), l)) {
          ...
          try {
            ...
            e >= 0 &&
              ...
              n >= 0 &&
              n <= t.height - r &&
              (t.textures.length > 1 && Dt.readBuffer(Dt.COLOR_ATTACHMENT0 + o),
              Dt.readPixels(e, n, i, r, Et.convert(l), Et.convert(c), a));
          } finally {
            const t = null !== C ? rt.get(C).__webglFramebuffer : null;
            nt.bindFramebuffer(Dt.FRAMEBUFFER, t);
          }
        }
      }),
        ...
        if ((t.isWebGLCubeRenderTarget && void 0 !== s && (l = l[s]), l)) {
          if (e >= 0 && e <= t.width - i && n >= 0 && n <= t.height - r) {
            ...
            const s = t.textures[o],
              c = s.format,
              h = s.type;
            if (!et.textureFormatReadable(c))
              throw new Error(
                'THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.'
              );
            if (!et.textureTypeReadable(h))
              throw new Error(
                'THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.'
              );
            const u = Dt.createBuffer();
            (Dt.bindBuffer(Dt.PIXEL_PACK_BUFFER, u),
              Dt.bufferData(Dt.PIXEL_PACK_BUFFER, a.byteLength, Dt.STREAM_READ),
              t.textures.length > 1 && Dt.readBuffer(Dt.COLOR_ATTACHMENT0 + o),
              Dt.readPixels(e, n, i, r, Et.convert(c), Et.convert(h), 0));
            const d = null !== C ? rt.get(C).__webglFramebuffer : null;
            nt.bindFramebuffer(Dt.FRAMEBUFFER, d);
            const p = Dt.fenceSync(Dt.SYNC_GPU_COMMANDS_COMPLETE, 0);
            return (
              Dt.flush(),
              ...
              Dt.bindBuffer(Dt.PIXEL_PACK_BUFFER, u),
              Dt.getBufferSubData(Dt.PIXEL_PACK_BUFFER, 0, a),
              Dt.deleteBuffer(u),
              Dt.deleteSync(p),
              a
            );
      ...
      (this.copyFramebufferToTexture = function (t, e = null, n = 0) {
        const i = Math.pow(2, -n),
          ...
          o = null !== e ? e.y : 0;
        (at.setTexture2D(t, 0),
          Dt.copyTexSubImage2D(Dt.TEXTURE_2D, n, 0, 0, s, o, r, a),
          nt.unbindTexture());
      }));
    const se = Dt.createFramebuffer(),
      oe = Dt.createFramebuffer();
    ((this.copyTextureToTexture = function (t, e, n = null, i = null, r = 0, a = null) {
      ...
      if (null !== n)
        ...
        ((s = Math.floor(m.width * e)),
          ...
          (l = t.isDataArrayTexture ? m.depth : t.isData3DTexture ? Math.floor(m.depth * e) : 1),
          (c = 0),
          (h = 0),
          (u = 0));
      }
      null !== i ? ((d = i.x), (p = i.y), (f = i.z)) : ((d = 0), (p = 0), (f = 0));
      const g = Et.convert(e.format),
        _ = Et.convert(e.type);
      let v;
      (e.isData3DTexture
        ? (at.setTexture3D(e, 0), (v = Dt.TEXTURE_3D))
        : e.isDataArrayTexture || e.isCompressedArrayTexture
          ? (at.setTexture2DArray(e, 0), (v = Dt.TEXTURE_2D_ARRAY))
          : (at.setTexture2D(e, 0), (v = Dt.TEXTURE_2D)),
        Dt.pixelStorei(Dt.UNPACK_FLIP_Y_WEBGL, e.flipY),
        Dt.pixelStorei(Dt.UNPACK_PREMULTIPLY_ALPHA_WEBGL, e.premultiplyAlpha),
        Dt.pixelStorei(Dt.UNPACK_ALIGNMENT, e.unpackAlignment));
      const x = Dt.getParameter(Dt.UNPACK_ROW_LENGTH),
        M = Dt.getParameter(Dt.UNPACK_IMAGE_HEIGHT),
        y = Dt.getParameter(Dt.UNPACK_SKIP_PIXELS),
        S = Dt.getParameter(Dt.UNPACK_SKIP_ROWS),
        b = Dt.getParameter(Dt.UNPACK_SKIP_IMAGES);
      (Dt.pixelStorei(Dt.UNPACK_ROW_LENGTH, m.width),
        Dt.pixelStorei(Dt.UNPACK_IMAGE_HEIGHT, m.height),
        Dt.pixelStorei(Dt.UNPACK_SKIP_PIXELS, c),
        Dt.pixelStorei(Dt.UNPACK_SKIP_ROWS, h),
        Dt.pixelStorei(Dt.UNPACK_SKIP_IMAGES, u));
      const T = t.isDataArrayTexture || t.isData3DTexture,
        E = e.isDataArrayTexture || e.isData3DTexture;
      if (t.isDepthTexture) {
        const n = rt.get(t),
          i = rt.get(e),
          m = rt.get(n.__renderTarget),
          g = rt.get(i.__renderTarget);
        (nt.bindFramebuffer(Dt.READ_FRAMEBUFFER, m.__webglFramebuffer),
          nt.bindFramebuffer(Dt.DRAW_FRAMEBUFFER, g.__webglFramebuffer));
        for (let _ = 0; _ < l; _++)
          (T &&
            (Dt.framebufferTextureLayer(
              Dt.READ_FRAMEBUFFER,
            ...
            Dt.framebufferTextureLayer(
              Dt.DRAW_FRAMEBUFFER,
              Dt.COLOR_ATTACHMENT0,
              rt.get(e).__webglTexture,
              a,
              f + _
            )),
            Dt.blitFramebuffer(c, h, s, o, d, p, s, o, Dt.DEPTH_BUFFER_BIT, Dt.NEAREST));
        (nt.bindFramebuffer(Dt.READ_FRAMEBUFFER, null),
          nt.bindFramebuffer(Dt.DRAW_FRAMEBUFFER, null));
      } else if (0 !== r || t.isRenderTargetTexture || rt.has(t)) {
        const n = rt.get(t),
          i = rt.get(e);
        (nt.bindFramebuffer(Dt.READ_FRAMEBUFFER, se), nt.bindFramebuffer(Dt.DRAW_FRAMEBUFFER, oe));
        for (let t = 0; t < l; t++)
          (T
            ? Dt.framebufferTextureLayer(
                Dt.READ_FRAMEBUFFER,
            ...
            0 !== r
              ? Dt.blitFramebuffer(c, h, s, o, d, p, s, o, Dt.COLOR_BUFFER_BIT, Dt.NEAREST)
              : E
                ? Dt.copyTexSubImage3D(v, a, d, p, f + t, c, h, s, o)
                : Dt.copyTexSubImage2D(v, a, d, p, c, h, s, o));
        (nt.bindFramebuffer(Dt.READ_FRAMEBUFFER, null),
          nt.bindFramebuffer(Dt.DRAW_FRAMEBUFFER, null));
      } else
        E
          ? t.isDataTexture || t.isData3DTexture
            ? Dt.texSubImage3D(v, a, d, p, f, s, o, l, g, _, m.data)
            : e.isCompressedArrayTexture
              ? Dt.compressedTexSubImage3D(v, a, d, p, f, s, o, l, g, m.data)
              : Dt.texSubImage3D(v, a, d, p, f, s, o, l, g, _, m)
          : t.isDataTexture
            ? Dt.texSubImage2D(Dt.TEXTURE_2D, a, d, p, s, o, g, _, m.data)
            : t.isCompressedTexture
              ? Dt.compressedTexSubImage2D(Dt.TEXTURE_2D, a, d, p, m.width, m.height, g, m.data)
              : Dt.texSubImage2D(Dt.TEXTURE_2D, a, d, p, s, o, g, _, m);
      (Dt.pixelStorei(Dt.UNPACK_ROW_LENGTH, x),
        Dt.pixelStorei(Dt.UNPACK_IMAGE_HEIGHT, M),
        Dt.pixelStorei(Dt.UNPACK_SKIP_PIXELS, y),
        Dt.pixelStorei(Dt.UNPACK_SKIP_ROWS, S),
        Dt.pixelStorei(Dt.UNPACK_SKIP_IMAGES, b),
        0 === a && e.generateMipmaps && Dt.generateMipmap(v),
        nt.unbindTexture());
    }),
      (this.initRenderTarget = function (t) {
        void 0 === rt.get(t).__webglFramebuffer && at.setupRenderTarget(t);
      }),
      ...
      (this.resetState = function () {
        ((A = 0), (R = 0), (C = null), nt.reset(), At.reset());
      }),
      'undefined' != typeof __THREE_DEVTOOLS__ &&
        __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent('observe', { detail: this })));
  }
  ...
  set outputColorSpace(t) {
    ...
    ((e.drawingBufferColorSpace = Nn._getDrawingBufferColorSpace(t)),
      (e.unpackColorSpace = Nn._getUnpackColorSpace()));
  }
}
const zh = (t, e, n) => {
  let i;
...
class kh {
  constructor(t) {
    var n, i, r, a, s, o, l, c, h, u, d, p, f, m, g, _;
    (e(this, '_renderer'),
      e(this, '_rendererIsDisposable', !1),
      e(this, '_material'),
      e(this, '_scene'),
      e(this, '_camera'),
      e(this, '_quad'),
      e(this, '_renderTarget'),
      e(this, '_width'),
      e(this, '_height'),
      e(this, '_type'),
      e(this, '_colorSpace'),
      e(this, '_supportsReadPixels', !0),
      e(this, 'render', () => {
    ...
    const v = {
      ...
      anisotropy:
        void 0 !== (null == (n = t.renderTargetOptions) ? void 0 : n.anisotropy)
          ? null == (i = t.renderTargetOptions)
            ? void 0
            : i.anisotropy
          : 1,
      generateMipmaps:
        void 0 !== (null == (r = t.renderTargetOptions) ? void 0 : r.generateMipmaps) &&
        (null == (a = t.renderTargetOptions) ? void 0 : a.generateMipmaps),
      magFilter:
        void 0 !== (null == (s = t.renderTargetOptions) ? void 0 : s.magFilter)
          ? null == (o = t.renderTargetOptions)
            ? void 0
            : o.magFilter
          : Mt,
      minFilter:
        void 0 !== (null == (l = t.renderTargetOptions) ? void 0 : l.minFilter)
          ? null == (c = t.renderTargetOptions)
            ? void 0
            : c.minFilter
          : Mt,
      samples:
        void 0 !== (null == (h = t.renderTargetOptions) ? void 0 : h.samples)
          ? null == (u = t.renderTargetOptions)
            ? void 0
            : u.samples
          : void 0,
      wrapS:
        void 0 !== (null == (d = t.renderTargetOptions) ? void 0 : d.wrapS)
          ? null == (p = t.renderTargetOptions)
            ? void 0
            : p.wrapS
          : mt,
      wrapT:
        void 0 !== (null == (f = t.renderTargetOptions) ? void 0 : f.wrapT)
          ? null == (m = t.renderTargetOptions)
            ? void 0
            : m.wrapT
          : mt,
    };
    if (
      ...
      t.renderer
        ...
        : ((this._renderer = kh.instantiateRenderer()), (this._rendererIsDisposable = !0)),
      (this._scene = new ga()),
      (this._camera = new xo()),
      ...
      !((t, e, n, i) => {
        ...
        const r = new Yn(1, 1, i);
        e.setRenderTarget(r);
        const a = new Zr(new As(), new Mr({ color: 16777215 }));
        (e.render(a, n), e.setRenderTarget(null));
        const s = zh(t, r.width, r.height);
        return (
          e.readRenderTargetPixels(r, 0, 0, r.width, r.height, s),
          r.dispose(),
          a.geometry.dispose(),
          a.material.dispose(),
          (Vh = 0 !== s[0]),
      ...
      })(this._type, this._renderer, this._camera, v))
    ) {
      let t;
      if (this._type === Pt)
        t = this._renderer.extensions.has('EXT_color_buffer_float') ? Ct : void 0;
      void 0 !== t
        ? (console.warn(
    ...
    ((this._quad = new Zr(new As(), this._material)),
      this._quad.geometry.computeBoundingBox(),
      this._scene.add(this._quad),
      (this._renderTarget = new Yn(this.width, this.height, v)),
      (this._renderTarget.texture.mapping =
        void 0 !== (null == (g = t.renderTargetOptions) ? void 0 : g.mapping)
          ? null == (_ = t.renderTargetOptions)
            ? void 0
            : _.mapping
          : ct));
  }
  ...
  toArray() {
    ...
    const t = zh(this._type, this._width, this._height);
    return (
      this._renderer.readRenderTargetPixels(this._renderTarget, 0, 0, this._width, this._height, t),
      t
    );
  }
  toDataTexture(t) {
    const e = new Ia(
      ...
      Ot,
      this._type,
      (null == t ? void 0 : t.mapping) || ct,
      (null == t ? void 0 : t.wrapS) || mt,
      (null == t ? void 0 : t.wrapT) || mt,
      (null == t ? void 0 : t.magFilter) || Mt,
      (null == t ? void 0 : t.minFilter) || Mt,
      (null == t ? void 0 : t.anisotropy) || 1,
      He
    );
    return (
      (e.generateMipmaps =
        void 0 !== (null == t ? void 0 : t.generateMipmaps) &&
        (null == t ? void 0 : t.generateMipmaps)),
      e
    );
  }
...
const Wh = (t, e, n) => {
  ...
  if (i) return i[1];
  const r = new RegExp(`<${e}[^>]*>([\\s\\S]*?)</${e}>`, 'i').exec(t);
  if (r) {
    const t = r[1].match(/<rdf:li>([^<]*)<\/rdf:li>/g);
    return t && 3 === t.length ? t.map(t => t.replace(/<\/?rdf:li>/g, '')) : r[1].trim();
  }
  if (void 0 !== n) return n;
...
class Xh {
  constructor(t) {
    (e(this, 'options'),
      (this.options = {
        debug: !(!t || void 0 === t.debug) && t.debug,
        extractFII: !t || void 0 === t.extractFII || t.extractFII,
        extractNonFII: !t || void 0 === t.extractNonFII || t.extractNonFII,
      }));
  }
  extract(t) {
    return new Promise((e, n) => {
      ...
      if (65496 !== r.getUint16(0)) return void n(new Error('Not a valid jpeg'));
      const a = r.byteLength;
      let s,
        o = 2,
        l = 0;
      for (; o < a; ) {
        if (++l > 250) return void n(new Error(`Found no marker after ${l} loops 😵`));
        if (255 !== r.getUint8(o))
          return void n(
            new Error(
              `Not a valid marker at offset 0x${o.toString(16)}, found: 0x${r.getUint8(o).toString(16)}`
            )
          );
        if (((s = r.getUint8(o + 1)), i && console.log(`Marker: ${s.toString(16)}`), 226 === s)) {
          i && console.log('Found APP2 marker (0xffe2)');
          const t = o + 4;
          if (1297106432 === r.getUint32(t)) {
            const i = t + 4;
            let a;
            if (18761 === r.getUint16(i)) a = !1;
            else {
              if (19789 !== r.getUint16(i))
                return void n(new Error('No valid endianness marker found in TIFF header'));
              a = !0;
            }
            if (42 !== r.getUint16(i + 2, !a))
              return void n(new Error('Not valid TIFF data! (no 0x002A marker)'));
            const s = r.getUint32(i + 4, !a);
            if (s < 8) return void n(new Error('Not valid TIFF data! (First offset less than 8)'));
            const o = i + s,
              l = r.getUint16(o, !a),
              c = o + 2;
            let h = 0;
            for (let t = c; t < c + 12 * l; t += 12)
              45057 === r.getUint16(t, !a) && (h = r.getUint32(t + 8, !a));
            const u = o + 2 + 12 * l + 4,
              d = [];
            for (let t = u; t < u + 16 * h; t += 16) {
              const e = {
                MPType: r.getUint32(t, !a),
                size: r.getUint32(t + 4, !a),
                dataOffset: r.getUint32(t + 8, !a),
                dependantImages: r.getUint32(t + 12, !a),
                start: -1,
                end: -1,
                isFII: !1,
              };
              (e.dataOffset
                ? ((e.start = i + e.dataOffset), (e.isFII = !1))
                : ((e.start = 0), (e.isFII = !0)),
                (e.end = e.start + e.size),
                d.push(e));
            }
            if (this.options.extractNonFII && d.length) {
              ...
              for (const e of d) {
                ...
                const i = t.slice(e.start, e.end + 1, 'image/jpeg');
                n.push(i);
              }
              e(n);
            }
...
const jh = async t => {
    const e = (t => {
      let e;
      e = 'undefined' != typeof TextDecoder ? new TextDecoder().decode(t) : t.toString();
      let n = e.indexOf('<x:xmpmeta');
      for (; -1 !== n; ) {
        const t = e.indexOf('x:xmpmeta>', n),
          r = e.slice(n, t + 10);
        try {
          const t = Wh(r, 'hdrgm:GainMapMin', '0'),
            e = Wh(r, 'hdrgm:GainMapMax'),
            n = Wh(r, 'hdrgm:Gamma', '1'),
            i = Wh(r, 'hdrgm:OffsetSDR', '0.015625'),
            a = Wh(r, 'hdrgm:OffsetHDR', '0.015625'),
            s = /hdrgm:HDRCapacityMin="([^"]*)"/.exec(r),
            o = s ? s[1] : '0',
            l = /hdrgm:HDRCapacityMax="([^"]*)"/.exec(r);
          if (!l) throw new Error('Incomplete gainmap metadata');
          const c = l[1];
          return {
            gainMapMin: Array.isArray(t)
              ? t.map(t => parseFloat(t))
              : [parseFloat(t), parseFloat(t), parseFloat(t)],
            gainMapMax: Array.isArray(e)
              ? e.map(t => parseFloat(t))
              : [parseFloat(e), parseFloat(e), parseFloat(e)],
            gamma: Array.isArray(n)
              ? n.map(t => parseFloat(t))
              : [parseFloat(n), parseFloat(n), parseFloat(n)],
            offsetSdr: Array.isArray(i)
              ? i.map(t => parseFloat(t))
              : [parseFloat(i), parseFloat(i), parseFloat(i)],
            offsetHdr: Array.isArray(a)
              ? a.map(t => parseFloat(t))
              : [parseFloat(a), parseFloat(a), parseFloat(a)],
            hdrCapacityMin: parseFloat(o),
            hdrCapacityMax: parseFloat(c),
          };
        } catch (i) {}
        n = e.indexOf('<x:xmpmeta', t);
      }
    })(t);
    if (!e) throw new Gh('Gain map XMP metadata not found');
    const n = new Xh({ extractFII: !0, extractNonFII: !0 }),
      i = await n.extract(t);
    if (2 !== i.length) throw new Hh('Gain map recovery image not found');
    return {
...
class Yh extends eo {
  constructor(t, n) {
    (super(n),
      e(this, '_renderer'),
      e(this, '_renderTargetOptions'),
      e(this, '_internalLoadingManager'),
      e(this, '_config'),
      (this._config = t),
      t.renderer && (this._renderer = t.renderer),
      (this._internalLoadingManager = new Qs()));
  }
  setRenderer(t) {
  ...
  async processImages(t, e, n) {
    const i = e ? new Blob([e], { type: 'image/jpeg' }) : void 0,
      r = new Blob([t], { type: 'image/jpeg' });
    let a,
      s,
      o = !1;
    if ('undefined' == typeof createImageBitmap) {
      const t = await Promise.all([i ? qh(i) : Promise.resolve(void 0), qh(r)]);
      ((s = t[0]), (a = t[1]), (o = 'flipY' === n));
    } else {
      const t = await Promise.all([
        i ? createImageBitmap(i, { imageOrientation: n || 'flipY' }) : Promise.resolve(void 0),
        createImageBitmap(r, { imageOrientation: n || 'flipY' }),
      ]);
      ((s = t[0]), (a = t[1]));
    }
    return { sdrImage: a, gainMapImage: s, needsFlip: o };
  }
  createTextures(t, e, n) {
    const i = new Xn(e || new ImageData(2, 2), ct, mt, mt, Mt, 1008, Ot, bt, 1, He);
    ((i.flipY = n), (i.needsUpdate = !0));
    const r = new Xn(t, ct, mt, mt, Mt, 1008, Ot, bt, 1, ke);
    return ((r.flipY = n), (r.needsUpdate = !0), { gainMap: i, sdr: r });
  }
  updateQuadRenderer(t, e, n, i, r) {
    ((t.width = e.width),
      (t.height = e.height),
      (t.material.gainMap = n),
      (t.material.sdr = i),
      (t.material.gainMapMin = r.gainMapMin),
      (t.material.gainMapMax = r.gainMapMax),
      (t.material.offsetHdr = r.offsetHdr),
      (t.material.offsetSdr = r.offsetSdr),
      (t.material.gamma = r.gamma),
      (t.material.hdrCapacityMin = r.hdrCapacityMin),
      (t.material.hdrCapacityMax = r.hdrCapacityMax),
      (t.material.maxDisplayBoost = Math.pow(2, r.hdrCapacityMax)),
      (t.material.needsUpdate = !0));
  }
}
class Kh extends ia {
  constructor({
    ...
    (super({
      ...
      uniforms: {
        sdr: { value: c },
        gainMap: { value: h },
        gamma: { value: new An(1 / t[0], 1 / t[1], 1 / t[2]) },
        offsetHdr: { value: new An().fromArray(n) },
        offsetSdr: { value: new An().fromArray(i) },
        gainMapMin: { value: new An().fromArray(r) },
        gainMapMax: { value: new An().fromArray(a) },
        weightFactor: { value: (Math.log2(s) - o) / (l - o) },
      },
      blending: 0,
      depthTest: !1,
      depthWrite: !1,
    }),
      e(this, '_maxDisplayBoost'),
      e(this, '_hdrCapacityMin'),
      e(this, '_hdrCapacityMax'),
...
class Zh extends Yh {
  constructor(t, e) {
    super({ renderer: t, createMaterial: t => new Kh(t), createQuadRenderer: t => new kh(t) }, e);
  }
  async render(t, e, n, i) {
    const { sdrImage: r, gainMapImage: a, needsFlip: s } = await this.processImages(n, i, 'flipY'),
      { gainMap: o, sdr: l } = this.createTextures(r, a, s);
    (this.updateQuadRenderer(t, r, o, l, e), t.render());
  }
}
class Jh extends Zh {
  load(t, e, n, i) {
    const r = this.prepareQuadRenderer(),
      a = new ro(this._internalLoadingManager);
    return (
      ...
      a.load(
        ...
        async n => {
          ...
          try {
            const t = await jh(a);
            ((s = t.sdr), (o = t.gainMap), (l = t.metadata));
          } catch (c) {
            if (!(c instanceof Gh || c instanceof Hh)) throw c;
            (console.warn(
          ...
          try {
            await this.render(r, l, s.buffer, null == o ? void 0 : o.buffer);
          } catch (h) {
            return (
              this.manager.itemError(t),
              'function' == typeof i && i(h),
              void r.disposeOnDemandRenderer()
            );
          }
          ('function' == typeof e && e(r), this.manager.itemEnd(t), r.disposeOnDemandRenderer());
        },
        n,
        e => {
