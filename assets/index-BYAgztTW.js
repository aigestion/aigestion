...
import {
  ...
  b as useScroll,
  c as useTransform,
  d as useMotionTemplate,
} from './framer-TOZY-Io2.js';
import {
  L as Lock,
  C as ChevronRight,
  X,
  ...
  e as Monitor,
  f as ShieldCheck,
  F as FingerprintPattern,
  g as ScanLine,
  h as LayoutDashboard,
  i as Search,
  j as Bot,
  k as FolderGit2,
  l as Settings,
...
function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
  ...
  if (index == null) {
    ...
    globalHistory.replaceState(
      _extends$2({}, globalHistory.state, {
        idx: index,
      }),
      ''
    );
...
function useResolvedPath(to, _temp2) {
  ...
  let { future } = reactExports.useContext(NavigationContext);
  let { matches } = reactExports.useContext(RouteContext);
  let { pathname: locationPathname } = useLocation();
  let routePathnamesJson = JSON.stringify(
    getResolveToMatches(matches, future.v7_relativeSplatPath)
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
        className: 'absolute inset-0 bg-nexus-obsidian/40 backdrop-blur-[20px]',
      }),
    ],
  });
};
...
(function (exports$1) {
  (function () {
      ...
      play: function (sprite, internal) {
        ...
        if (self._webAudio) {
          ...
          var loadedNoReadyState =
            (window && window.ejecta) || (!node.readyState && Howler2._navigator.isCocoonJS);
        ...
        if (typeof rate === 'number') {
          ...
          for (var i = 0; i < id.length; i++) {
            ...
            if (sound) {
              ...
              var duration =
                (self._sprite[sound._sprite][0] + self._sprite[sound._sprite][1]) / 1e3 - seek;
              var timeout = (duration * 1e3) / Math.abs(sound._rate);
    ...
    var setupAudioContext = function () {
      ...
      var appVersion =
        Howler2._navigator && Howler2._navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/);
    ...
    Howl.prototype.pannerAttr = function () {
      ...
      for (var i = 0; i < ids.length; i++) {
        ...
        if (sound) {
          ...
          pa = {
            coneInnerAngle:
              typeof o.coneInnerAngle !== 'undefined' ? o.coneInnerAngle : pa.coneInnerAngle,
            coneOuterAngle:
              typeof o.coneOuterAngle !== 'undefined' ? o.coneOuterAngle : pa.coneOuterAngle,
            coneOuterGain:
              typeof o.coneOuterGain !== 'undefined' ? o.coneOuterGain : pa.coneOuterGain,
            distanceModel:
              typeof o.distanceModel !== 'undefined' ? o.distanceModel : pa.distanceModel,
            maxDistance: typeof o.maxDistance !== 'undefined' ? o.maxDistance : pa.maxDistance,
            refDistance: typeof o.refDistance !== 'undefined' ? o.refDistance : pa.refDistance,
            rolloffFactor:
              typeof o.rolloffFactor !== 'undefined' ? o.rolloffFactor : pa.rolloffFactor,
...
const SoundProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SoundContext.Provider, {
    value: { isMuted, volume, toggleMute, setGlobalVolume, playSfx },
    children,
  });
};
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              ...
              children: history.map((line, i) =>
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  'div',
                  {
                    className: line.startsWith('>') ? 'text-nexus-cyan-glow' : 'text-nexus-silver',
                    children: line,
                  },
                  i
                )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs('form', {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                  className: 'text-nexus-cyan-glow font-mono',
                  children: '$',
                }),
...
const MagneticWrapper = ({ children, className = '' }) => {
  ...
  const handleMouseMove = e => {
    ...
    const { height, width, left, top } = ((_a2 = ref.current) == null
      ? void 0
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(MagneticWrapper, {
                strength: 20,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx('button', {
                ...
                children: isMobileMenuOpen
                  ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 24 })
                  : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 24 }),
              }),
            ],
          }),
        ],
...
const NexusCursor = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
        className:
          'fixed top-0 left-0 w-8 h-8 rounded-full border border-nexus-cyan pointer-events-none z-[9999] mix-blend-difference',
        style: {
          x: cursorXSpring,
          y: cursorYSpring,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
        className:
          'fixed top-0 left-0 w-2 h-2 bg-nexus-cyan rounded-full pointer-events-none z-[9999] mix-blend-difference',
        style: {
          x: cursorX,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx('h3', {
        className: 'text-2xl font-orbitron text-glow mb-4',
        children: title,
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
        className:
          'model-viewer-wrapper w-full aspect-square relative rounded-2xl overflow-hidden bg-black/40',
        children: /* @__PURE__ */ jsxRuntimeExports.jsx('model-viewer', {
          src: modelUrl,
          poster: posterUrl,
          alt: title,
          ar: true,
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx('button', {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx('span', { children: '🚀 VER EN AR' }),
          }),
        }),
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
...
const ARProjectionLab = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    className: 'w-full flex flex-col lg:flex-row gap-12 items-center lg:items-start',
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
          ...
          children: !isScanning
            ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  className:
                    'relative aspect-video rounded-3xl overflow-hidden glass-morphism border border-white/10',
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SpatialPresentation, {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                          className:
                            'bg-cyan-400 text-black text-[10px] font-bold px-2 py-0.5 rounded-full self-start',
                          children: 'ASSET READY',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs('span', {
                          className:
                            'text-white/40 text-[10px] font-mono uppercase tracking-[0.2em]',
                          children: ['ID: ', selectedAsset.id.toUpperCase()],
                        }),
                      ],
                    }),
                  ],
            ...
            : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  exit: { opacity: 0 },
                  className:
                    'relative aspect-video rounded-3xl overflow-hidden glass-morphism border border-cyan-400/30 flex flex-col items-center justify-center bg-cyan-400/5',
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                      className: 'relative',
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Scan, {
                          className:
                            'w-12 h-12 text-cyan-400 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse',
                        }),
                      ],
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                      className: 'mt-8 text-cyan-400 font-orbitron tracking-[0.4em] text-xs',
                      children: 'CALIBRANDO ESPACIO REAL...',
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
                      className:
                        'absolute left-0 right-0 h-1 bg-cyan-400/50 shadow-[0_0_15px_#00f5ff]',
                      animate: { top: ['0%', '100%', '0%'] },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SquareDashed, {
                    className: 'w-6 h-6 text-cyan-400',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('h3', {
                    className:
                      'text-2xl font-orbitron font-bold text-white uppercase tracking-tighter',
                    children: 'LABORATORIO DE PROYECCIÓN',
                  }),
                ],
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
            className: 'glass-morphism p-6 rounded-3xl border border-white/10 space-y-4',
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                    ...
                    children: 'Detalles del Activo',
                  }),
                ],
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs('p', {
                className: 'text-xs text-nexus-silver/90 leading-relaxed italic',
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                        className: 'text-xs font-bold text-white text-glow',
                        children: '1:1 REAL',
                      }),
                    ],
                  }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.button, {
            ...
            disabled: isScanning,
            className:
              'w-full py-6 rounded-full glass-morphism border border-cyan-400/50 text-cyan-400 font-orbitron font-bold tracking-[0.2em] flex items-center justify-center gap-3 group hover:bg-cyan-400 hover:text-black transition-all',
...
const HUDCornerIndicator = ({ position, label, value, icon }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
        className:
          'flex items-center gap-3 mb-1 text-cyan-400/60 font-orbitron text-[10px] tracking-[0.2em] uppercase',
        children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
        className:
          'text-cyan-400 font-mono text-sm font-bold tracking-widest bg-cyan-400/5 px-2 py-1 rounded',
        children: value,
      }),
    ],
  });
...
const BootSequence = ({ onComplete }) => {
  ...
  const stages = [
    {
      text: 'SCANNING RETINA...',
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FingerprintPattern, { className: 'w-8 h-8' }),
    },
    {
      text: 'CONNECTING NEURAL LINK...',
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { className: 'w-8 h-8' }),
    },
    {
      text: 'CALIBRATING VITURE OPTICS...',
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { className: 'w-8 h-8' }),
    },
    {
      text: 'SYNC COMPLETE. WELCOME TO NEXUS.',
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: 'w-8 h-8' }),
    },
  ];
  reactExports.useEffect(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className:
              'relative z-10 p-12 glass-morphism rounded-full border border-cyan-500/30 text-cyan-400 flex flex-col items-center gap-6',
            children: [
              stages[stage].icon,
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                className:
                  'font-orbitron tracking-[0.3em] text-xs font-bold text-center max-w-[200px]',
                children: stages[stage].text,
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('section', {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
        children:
          isBooting &&
          /* @__PURE__ */ jsxRuntimeExports.jsx(BootSequence, { onComplete: finishBoot }),
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
            className:
              'absolute inset-0 bg-gradient-to-br from-purple-900/40 via-black to-cyan-900/40',
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
            className: 'absolute inset-0',
            children: [...Array(currentExp.particles)].map((_, i) =>
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
            className:
              'absolute inset-x-[-10%] inset-y-[-10%] z-[-1] opacity-20 pointer-events-none',
            style: { x: springX, y: springY },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              className: "w-full h-full bg-[url('/images/nexus/grid.svg')] bg-repeat opacity-30",
            }),
          }),
        ],
      }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
            children:
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(HUDCornerIndicator, {
                    position: 'top-left',
                    label: 'Signal',
                    value: 'SIGNAL: 98% AC',
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(HUDCornerIndicator, {
                    ...
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Maximize2, {
                      className: 'w-3 h-3',
                    }),
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(HUDCornerIndicator, {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                    className: 'fixed top-12 left-1/2 -translate-x-1/2 flex gap-4 z-50',
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx('button', {
                        onClick: () => {
                          playClick();
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
                    className:
                      'fixed bottom-12 left-1/2 -translate-x-1/2 px-6 py-2 glass-morphism border border-white/20 rounded-full font-orbitron text-[10px] tracking-[0.4em] text-white/40 uppercase z-50 pointer-events-none',
                    initial: { opacity: 0, y: 20 },
                    animate: { opacity: 1, y: 0 },
                    exit: { opacity: 0, y: 20 },
                    children:
              ...
              ? /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
                      className:
                        'inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-purple-600/20 to-cyan-600/20 shadow-[0_0_20px_rgba(138,43,226,0.2)] border border-purple-400/30 rounded-full mb-8',
                      initial: { scale: 0.8 },
                      animate: { scale: 1 },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                          className:
                            'w-2 h-2 bg-green-400 rounded-full animate-pulse shadow-[0_0_10px_#4ade80]',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                          className:
                            'text-green-400 font-orbitron text-[10px] font-bold tracking-[0.2em] uppercase',
                          children: 'Viture Pro XR Ready',
                        }),
                      ],
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs('h1', {
                      className:
                        'text-6xl md:text-9xl font-orbitron font-black text-white mb-6 leading-none',
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                          className:
                            'block text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/40',
                          children: 'EXPERIENCIA',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                          className:
                            'block text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-cyan-400 to-purple-400 bg-[length:200%_auto] animate-gradient-flow',
                          children: 'VITURE XR',
                        }),
                      ],
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                      className:
                        'text-xl text-nexus-silver/60 mb-12 max-w-2xl mx-auto font-light leading-relaxed italic',
                      children:
                        '"No es solo ver el futuro; es vivir dentro de él con la precisión de 11 dimensiones."',
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.button, {
                      onClick: handleXREnter,
                      className:
                        'group relative px-12 py-6 glass-morphism rounded-full text-white font-bold text-xl overflow-hidden border border-white/20 transition-all hover:border-cyan-400/50',
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                          className:
                            'absolute inset-0 bg-gradient-to-r from-purple-600/20 to-cyan-600/20 opacity-0 group-hover:opacity-100 transition-opacity',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs('span', {
                          className: 'relative z-10 flex items-center gap-4 tracking-[0.1em]',
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Maximize2, {
                              className: 'w-6 h-6 text-cyan-400',
                            }),
                    ...
                    activeMode === 'experiences'
                      ? /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
                              className:
                                'relative aspect-video rounded-3xl overflow-hidden glass-morphism border border-white/10 group',
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                      ...
                                      children: [
                                        /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                                          className:
                                            'text-[10px] font-bold text-cyan-400 tracking-[0.5em] uppercase mb-4 block',
                                          children: currentExp.badge,
                                        }),
                                        /* @__PURE__ */ jsxRuntimeExports.jsx('h3', {
                                          className:
                                            'text-4xl font-orbitron font-bold text-white mb-2',
                                          children: currentExp.title,
                                        }),
                                        /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                                          className: 'text-nexus-silver/80 italic',
                                          children: currentExp.subtitle,
                                        }),
                                      ],
                                    }),
                                  ],
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
                                  className:
                                    'absolute left-0 right-0 h-1 bg-cyan-400/50 blur-[2px] z-20',
                                  animate: { top: ['0%', '100%'] },
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                                      className: 'flex gap-2',
                                      children: experiences.map((_, idx) =>
                                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          'button',
                                          {
                                            onClick: () => {
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                                      className:
                                        'text-nexus-silver/90 text-xl font-light leading-relaxed',
                                      children: currentExp.description,
                                    }),
                                  ],
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                                  ...
                                  children: [
                                    {
                                      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelsTopLeft, {
                                        className: 'w-5 h-5',
                                      }),
                                      label: 'Holografía',
                                      val: 'Activa',
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                      ...
                                      {
                                        className:
                                          'glass-morphism p-4 rounded-2xl border border-white/5 flex items-center gap-4',
                                        children: [
                                          /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                                          ...
                                          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                            children: [
                                              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                                                className:
                                                  'text-[10px] text-white/40 uppercase tracking-tighter',
                                                children: feat.label,
                                              }),
                                              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                                                className:
                                                  'text-xs font-bold text-white tracking-widest',
                                                children: feat.val,
                                              }),
                                            ],
                                          }),
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, {
                                  ...
                                  className:
                                    'px-8 py-4 border border-red-500/30 text-red-500 rounded-full font-orbitron text-xs font-bold tracking-[0.2em] hover:bg-red-500/10 transition-colors',
        ...
        children:
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                className:
                  'absolute inset-0 bg-radial-at-center from-transparent via-transparent to-black/60',
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                className:
                  'absolute inset-0 opacity-10 mix-blend-screen bg-gradient-to-r from-red-500/10 via-green-500/10 to-blue-500/10',
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                className:
                  "absolute inset-0 bg-[url('/images/nexus/scanlines.svg')] opacity-[0.03] pointer-events-none",
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                className:
                  'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 opacity-20',
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                    className: 'absolute inset-0 border border-cyan-400/50 rounded-full',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                    className: 'absolute top-1/2 left-0 right-0 h-[1px] bg-cyan-400/50',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                    className: 'absolute left-1/2 top-0 bottom-0 w-[1px] bg-cyan-400/50',
                  }),
                ],
              }),
            ],
...
const WorkbenchProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WorkbenchContext.Provider, {
    value: {
      activeActivity,
...
const WorkbenchShell = ({ activityBar, sideBar, mainArea, bottomPanel, statusBar }) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx('aside', {
            ...
            children: activityBar,
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.aside, {
            initial: false,
                ...
                isActive &&
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                        className: 'absolute inset-0 bg-cyan-400/5 blur-lg',
                      }),
                    ],
                  }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs('button', {
          ...
          children: [
            activeActivity === 'settings' &&
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                className: 'absolute inset-0 bg-purple-500/10 blur-xl',
              }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                  children: 'Analyze the current bundle size for me.',
                }),
              }),
            ],
          }),
        ...
        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx('ul', {
                  ...
                  children: ['Overview', 'Analytics', 'Real-time', 'System Health'].map(item =>
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      'li',
                      {
                        className:
          ...
          activeActivity === 'ai' &&
            /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(DanielaPanel, {}),
            }),
...
const useEnhancedVoiceAssistant = _options => {
  ...
  const sendTextMessage = reactExports.useCallback(
    async text => {
...
const DanielaConversationPanel = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
    className: 'flex flex-col h-full bg-white/5 rounded-2xl border border-white/10 overflow-hidden',
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                    className: 'w-10 h-10 rounded-full overflow-hidden border-2 border-nexus-cyan',
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx('button', {
              ...
              children: isListening
                ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleStop, { size: 20 })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.aside, {
              initial: { x: -300 },
              animate: { x: 0 },
              exit: { x: -300 },
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, {
                                className: 'w-3 h-3 text-nexus-cyan',
                              }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                                className: `text-xs font-medium ${subscriptionColors[user.subscription]}`,
                                children: user.subscription.toUpperCase(),
                              }),
                            ],
                          }),
                        ],
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                            className: `text-sm font-medium ${isProcessing ? 'text-yellow-400' : status === 'active' ? 'text-green-400' : status === 'error' ? 'text-red-400' : 'text-nexus-silver'}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx('h1', {
                      ...
                      children:
                        (_a2 = menuItems.find(item => item.id === activeTab)) == null
                          ? void 0
                          : _a2.label,
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs('p', {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                          className: `w-2 h-2 rounded-full ${isProcessing ? 'bg-yellow-400 animate-pulse' : status === 'active' ? 'bg-green-400' : status === 'error' ? 'bg-red-400' : 'bg-nexus-silver'}`,
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                      ...
                      children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, {
                                      className: 'w-5 h-5 text-nexus-cyan',
                                    }),
                                  ],
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                                  ...
                                  children:
                                    ((_b2 =
                                      emotionalAnalysis == null
                                        ? void 0
                                        : emotionalAnalysis.emotion) == null
                                      ? void 0
                                      : _b2.toUpperCase()) || 'NEUTRAL',
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs('p', {
                                  className: 'text-nexus-silver text-sm',
                                  children: [
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, {
                                      className: 'w-5 h-5 text-nexus-violet',
                                    }),
                                  ],
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                                  className: 'text-3xl font-bold text-white',
                                  children: suggestedActions.length,
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                                  className: 'text-nexus-silver text-sm',
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, {
                                      className: 'w-5 h-5 text-nexus-gold',
                                    }),
                                  ],
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                              className: 'h-64 flex items-center justify-center text-nexus-silver',
                              children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                className: 'text-center',
                                children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                                    children: 'Gráficos de actividad próximamente',
                                  }),
                                ],
                              }),
                            }),
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx('label', {
                                      className: 'block text-sm font-medium text-nexus-silver mb-2',
                                      children: 'Nombre',
                                    }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx('input', {
                                      type: 'text',
      ...
      case 'search':
        return /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
              children: 'Search results will appear here',
            }),
          ],
        });
      case 'settings':
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs('select', {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx('option', {
                          children: 'Cyberpunk Dark (Default)',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx('option', {
                          children: 'Nebula Blue',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx('option', {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs('select', {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx('option', {
                          children: 'Professional (Technical)',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx('option', {
                          children: 'Casual (Friendly)',
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx('option', {
                          children: 'Creative (Brainstorming)',
                        }),
                      ],
                    }),
                  ],
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.svg, {
                  viewBox: '0 0 100 20',
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, {
                size: 12,
...
const WorkbenchLayout = ({ user, onLogout }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WorkbenchProvider, {
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorkbenchShell, {
...
const CursorGlow = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, {
        className:
          'fixed w-4 h-4 bg-nexus-cyan rounded-full pointer-events-none z-50 mix-blend-screen',
        style: {
          x: cursorX,
          y: cursorY,
...
const GodModeNotification = ({ title, message, type = 'info', onClose }) => {
  const icons = {
    info: /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: 'text-nexus-cyan', size: 20 }),
    success: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, {
      className: 'text-green-400',
      size: 20,
    }),
    warning: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, {
...
const NotificationProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(NotificationContext.Provider, {
    value: { notify },
    children: [
      children,
      /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
          className: 'p-8 bg-nexus-obsidian/40 backdrop-blur-xl border border-white/10 rounded-lg',
...
const Login = ({ onLogin, isAuthenticated }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Login$1, {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(MagneticWrapper, {
                  strength: 50,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
...
const AppContent = ({ loading, isAuthenticated, currentUser, handleLogin, handleLogout }) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, {
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/dashboard',
            element: isAuthenticated
              ? /* @__PURE__ */ jsxRuntimeExports.jsx(WorkbenchLayout, {
                  user: currentUser,
                  onLogout: handleLogout,
                })
              : /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: '/login' }),
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/',
            element: !isAuthenticated
              ? /* @__PURE__ */ jsxRuntimeExports.jsxs('main', {
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, {
                      title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                        children: [
                          'AIGESTION',
                          /* @__PURE__ */ jsxRuntimeExports.jsx('span', {
                            className: 'text-nexus-cyan font-light',
                            children: '.NET',
                          }),
                        ],
                      }),
                      ...
                      description:
                        'El núcleo neuronal para las empresas del mañana. Sincronización absoluta entre inteligencia artificial, IoT y logística global.',
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClientShowcase, {}),
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
                      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}),
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(DanielaShowcase, {}),
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
                      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}),
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(NexusAndroid, {}),
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
                      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}),
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(EnhancedROI, {}),
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
                      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}),
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(DecentralandOffice, {}),
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
                      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, {}),
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactSection, {}),
                    }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/lab',
            element: /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/weapon',
            element: /* @__PURE__ */ jsxRuntimeExports.jsx(WeaponDashboard, {}),
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/admin',
            element: /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx('h1', {
                    className: 'text-4xl font-orbitron text-nexus-violet-glow mb-4',
                    children: 'Admin Dashboard',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                    className: 'text-nexus-silver/60 mb-8',
                    children: 'Panel de administración avanzada',
                  }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            ...
            element: /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx('h1', {
                    className: 'text-4xl font-orbitron text-nexus-cyan-glow mb-4',
                    children: 'Client Dashboard',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                    className: 'text-nexus-silver/60 mb-8',
                    children: 'Portal exclusivo para clientes',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('a', {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            ...
            element: /* @__PURE__ */ jsxRuntimeExports.jsx('div', {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx('h1', {
                    className: 'text-4xl font-orbitron text-nexus-gold mb-4',
                    children: 'Demo Dashboard',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('p', {
                    className: 'text-nexus-silver/60 mb-8',
                    children: 'Experiencia interactiva de demostración',
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx('a', {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/daniela',
            element: /* @__PURE__ */ jsxRuntimeExports.jsx(DanielaDemo, {}),
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/daniela/demo',
            element: /* @__PURE__ */ jsxRuntimeExports.jsx(DanielaDemo, {}),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/virtual-office',
            element: /* @__PURE__ */ jsxRuntimeExports.jsx(VirtualOfficePreview, {}),
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Route, {
            path: '/virtual-office/go',
            element: /* @__PURE__ */ jsxRuntimeExports.jsx(DecentralandOffice, {}),
          }),
        ],
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}),
...
const getGroupRecursive = (classParts, classPartObject) => {
  ...
  return (_a2 = classPartObject.validators.find(({ validator }) => validator(classRest))) == null
    ? void 0
    : _a2.classGroupId;
};
...
const supabaseAnonKey =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpodnRqeWZtZ25jcnJienFwYmt0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg4ODIwNjksImV4cCI6MjA4NDQ1ODA2OX0.biJUe_dP1CScwXD7RqqR-5p74cwuOZOkawODtoO5evU';
  ...
  ((_e = class extends Removable {
    ...
    async fetch(options, fetchOptions) {
      ...
      if (
        ...
        this.state.fetchMeta !== ((_c2 = context.fetchOptions) == null ? void 0 : _c2.meta)
      ) {
        __privateMethod(this, _Query_instances, dispatch_fn).call(this, {
          type: 'fetch',
      ...
      try {
        ...
        this.setData(data);
        (_f2 = (_e2 = __privateGet(this, _cache).config).onSuccess) == null
          ? void 0
          : _f2.call(_e2, data, this);
        (_h2 = (_g2 = __privateGet(this, _cache).config).onSettled) == null
          ? void 0
          : _h2.call(_g2, data, this.state.error, this);
        return data;
      } catch (error) {
        ...
        (_j = (_i2 = __privateGet(this, _cache).config).onError) == null
          ? void 0
          : _j.call(_i2, error, this);
        (_l = (_k = __privateGet(this, _cache).config).onSettled) == null
          ? void 0
          : _l.call(_k, this.state.data, error, this);
        throw error;
      } finally {
        this.scheduleGc();
      }
...
function infiniteQueryBehavior(pages) {
  return {
    onFetch: (context, query) => {
      ...
      const direction =
        (_c2 =
          (_b2 = (_a2 = context.fetchOptions) == null ? void 0 : _a2.meta) == null
            ? void 0
            : _b2.fetchMore) == null
          ? void 0
          : _c2.direction;
...
var Mutation =
  ((_f = class extends Removable {
    ...
    continue() {
      var _a2;
      return (
        ((_a2 = __privateGet(this, _retryer2)) == null ? void 0 : _a2.continue()) ?? // continuing a mutation assumes that variables are set, mutation must have been dehydrated before
    ...
    async execute(variables) {
      ...
      try {
        if (restored) {
          ...
          const context = await ((_b2 = (_a2 = this.options).onMutate) == null
            ? void 0
            : _b2.call(_a2, variables, mutationFnContext));
        ...
        await ((_d2 = (_c2 = __privateGet(this, _mutationCache).config).onSuccess) == null
          ? void 0
          : _d2.call(_c2, data, variables, this.state.context, this, mutationFnContext));
        await ((_f2 = (_e2 = this.options).onSuccess) == null
          ? void 0
          : _f2.call(_e2, data, variables, this.state.context, mutationFnContext));
        await ((_h2 = (_g2 = __privateGet(this, _mutationCache).config).onSettled) == null
          ? void 0
          : _h2.call(
              _g2,
              data,
        ...
        await ((_j = (_i2 = this.options).onSettled) == null
          ? void 0
          : _j.call(_i2, data, null, variables, this.state.context, mutationFnContext));
        __privateMethod(this, _Mutation_instances, dispatch_fn2).call(this, {
          type: 'success',
          data,
        });
        ...
        try {
          await ((_l = (_k = __privateGet(this, _mutationCache).config).onError) == null
            ? void 0
            : _l.call(_k, error, variables, this.state.context, this, mutationFnContext));
        } catch (e) {
        ...
        try {
          await ((_n = (_m = this.options).onError) == null
            ? void 0
            : _n.call(_m, error, variables, this.state.context, mutationFnContext));
        } catch (e) {
          void Promise.reject(e);
        }
        try {
          await ((_p = (_o = __privateGet(this, _mutationCache).config).onSettled) == null
            ? void 0
            : _p.call(
                _o,
                void 0,
        ...
        try {
          await ((_r = (_q = this.options).onSettled) == null
            ? void 0
            : _r.call(_q, void 0, error, variables, this.state.context, mutationFnContext));
        } catch (e) {
          void Promise.reject(e);
        }
        __privateMethod(this, _Mutation_instances, dispatch_fn2).call(this, {
      ...
      if (typeof scope === 'string') {
        const foundMutation =
          (_a2 = __privateGet(this, _scopes).get(scope)) == null
            ? void 0
            : _a2.find(m => m !== mutation && m.state.isPaused);
...
var QueryClient =
  ((_i = class {
    ...
    getQueryData(queryKey) {
      ...
      return (_a2 = __privateGet(this, _queryCache).get(options.queryHash)) == null
        ? void 0
        : _a2.state.data;
    }
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, {
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueryProvider, {
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, {
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SoundProvider, {
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(NexusProvider, {
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationProvider, {
...
client
  ...
  .render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React$1.StrictMode, {
