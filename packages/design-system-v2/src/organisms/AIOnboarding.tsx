...
const AIOnboarding = ({ steps, onComplete, className }: AIOnboardingProps) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <Card variant="glass" className="relative overflow-hidden border-[#8a2be2]/40 bg-[#0a0a0c]/90">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-500 uppercase tracking-tighter">Step {currentStep + 1} of {steps.length}</p>
              </div>
            </div>
