...
// node_modules/@dcl/ecs/dist/components/generated/pb/decentraland/sdk/components/gltf_node_modifiers.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/GltfNodeModifiers.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/pb/decentraland/sdk/components/light_source.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/LightSource.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/pb/decentraland/sdk/components/primary_pointer_info.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/PrimaryPointerInfo.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/pb/decentraland/sdk/components/skybox_time.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/SkyboxTime.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/pb/decentraland/sdk/components/trigger_area.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/TriggerArea.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/pb/decentraland/sdk/components/trigger_area_result.gen.js
...
// node_modules/@dcl/ecs/dist/components/generated/TriggerAreaResult.gen.js
...
// node_modules/@dcl/ecs/dist/components/manual/Tags.js
...
function createArchitecture() {
  ...
  Material3.setPbrMaterial(floorMaterial, {
    albedoColor: Color42.create(0.1, 0.1, 0.12, 1),
    roughness: 0.1,
    metallic: 0.5
  });
  const glassMaterial = engine.addEntity();
  Material3.setPbrMaterial(glassMaterial, {
    albedoColor: Color42.create(0.2, 0.4, 0.8, 0.3),
    roughness: 0.1,
    metallic: 0,
    alphaTest: 0.1
  });
  ...
  Material3.setPbrMaterial(floor, {
    albedoColor: Color42.create(0.05, 0.05, 0.05, 1),
    roughness: 0.2,
    metallic: 0.1
  });
  ...
  Material3.setPbrMaterial(backWall, {
    albedoColor: Color42.create(0.1, 0.1, 0.15, 1),
    roughness: 0.5,
    metallic: 0.5
  });
  ...
  Material3.setPbrMaterial(leftGlass, {
    albedoColor: Color42.create(0.7, 0.8, 1, 0.2),
    roughness: 0,
    metallic: 0.1
  });
  ...
  Transform2.create(neonStrip, {
    position: Vector32.create(8, 5.8, 8),
    scale: Vector32.create(14, 0.1, 14)
  });
  MeshRenderer3.setBox(neonStrip);
  Material3.setPbrMaterial(neonStrip, {
    albedoColor: Color42.create(0, 0, 0, 1),
    emissiveColor: Color42.create(0.5, 0.2, 0.9, 1),
    emissiveIntensity: 5
  });
}

// src/interactables.ts
var bodyTextEntity;
function createInteractables() {
  const infoBoard = engine.addEntity();
  Transform2.create(infoBoard, {
    position: Vector32.create(8, 2.5, 15.5),
    scale: Vector32.create(6, 3, 0.1)
  });
  MeshRenderer3.setBox(infoBoard);
  Material3.setPbrMaterial(infoBoard, {
    albedoColor: Color42.Black(),
    roughness: 0.2,
    metallic: 0.8
  });
  ...
  Transform2.create(titleText, {
    ...
    // Relative to parent
    scale: Vector32.create(0.16, 0.33, 1)
    // Inverse parent scale compensation
  });
  TextShape2.create(titleText, {
    text: "AIGestion HQ",
  ...
  Transform2.create(bodyTextEntity, {
    parent: infoBoard,
    position: Vector32.create(0, -0.2, -0.6),
    scale: Vector32.create(0.16, 0.33, 1)
  });
  TextShape2.create(bodyTextEntity, {
    text: "Initializing System Link...",
    textColor: Color42.White(),
    fontSize: 3,
    textAlign: 3
  });
  const linkCube = engine.addEntity();
  Transform2.create(linkCube, {
    position: Vector32.create(12, 1, 12),
    scale: Vector32.create(1, 1, 1)
  });
  MeshRenderer3.setBox(linkCube);
  Material3.setPbrMaterial(linkCube, {
    albedoColor: Color42.Red(),
    emissiveColor: Color42.Red(),
    emissiveIntensity: 1
  });
