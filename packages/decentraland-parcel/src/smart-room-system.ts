...
export class SmartRoomSystem {
  ...
  private createIoTDevices() {
    ...
    // Entertainment
    this.createDevice('entertainment_display', 'Smart Display', 'entertainment', Vector3.create(8, 3, 0.5))
    this.createDevice('entertainment_audio', 'Audio System', 'entertainment', Vector3.create(14, 2, 8))
  ...
  // Create smart scene
  private createSmartScene(id: string, name: string, description: string, devices: string[], settings: Map<string, any>, icon: string) {
