...
export class ResponsiveUISystem {
  ...
  private createGestureTutorial() {
    ...
    this.addComponent('gestureTutorial', {
      ...
      visible: true,
      interactive: true,
      gestureHandlers: new Map([['tap', this.handleTutorialTap.bind(this)]]),
    });
  }
    ...
    const buttonConfigs = [
      {
        id: 'btnLights',
        label: '💡',
        pos: Vector3.create(2, 1.5, 2),
        color: Color4.create(1, 0.8, 0.2, 1),
      },
      {
        id: 'btnSound',
        label: '🔊',
        pos: Vector3.create(3, 1.5, 2),
        color: Color4.create(0.2, 0.8, 1, 1),
      },
      {
        id: 'btnData',
        label: '📊',
        pos: Vector3.create(4, 1.5, 2),
        color: Color4.create(0.8, 0.2, 1, 1),
      },
      {
        id: 'btnNPC',
        label: '🤖',
        pos: Vector3.create(5, 1.5, 2),
        color: Color4.create(0.2, 1, 0.8, 1),
      },
    ];
  ...
  private handleTouchEnd(event: any) {
    ...
    const endPosition = Vector3.create(
  ...
  // Detect and trigger gestures
  private detectAndTriggerGesture(
