import { Material, MeshRenderer, TextShape, Transform, engine, pointerEventsSystem } from '@dcl/sdk/ecs';
...
export function createInteractables() {
    ...
    pointerEventsSystem.onPointerDown({
        entity: linkCube,
        opts: { button: 0 /* InputAction.IA_POINTER */, hoverText: 'Access Dashboard' }
    }, () => {
