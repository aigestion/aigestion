...
export class AvatarSystem {
    ...
    const presets: AvatarPreset[] = [
      ...
      },
      {
        ...
        customization: {
          ...
          effects: [
            ...
            { type: 'particles', intensity: 0.5, color: Color3.create(0.2, 0.8, 0.8), enabled: true }
          ],
      ...
      },
      {
        ...
        customization: {
          ...
          effects: [
            { type: 'particles', intensity: 0.3, color: Color3.create(0.8, 0.4, 0.2), enabled: true }
          ],
          scale: Vector3.create(1, 2, 1),
          position: Vector3.create(8, 1, 8)
        }
    ...
    if (body) {
      switch (this.animationState.currentAnimation) {
        ...
        case 'walk':
          ...
          walkTransform.rotation = Quaternion.fromEulerDegrees(
            Math.sin(time * 4) * 5,
            0,
            0
          )
  ...
  public customizeColors(primaryColor: Color3, secondaryColor: Color3) {
    ...
    if (head) {
      ...
      if (material && material.$case === 'pbr') {
        material.pbr.albedoColor = Color4.create(secondaryColor.r, secondaryColor.g, secondaryColor.b, 1)
      }
    }
  }
