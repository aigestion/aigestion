...
batch_size = 1
guidance_scale = 15.0
prompt = "A futuristic energy reactor, sleek crystalline structure with glowing internal orbits and floating magnetic rings. High-tech, metallic, cyan and violet accents."
...
for i, latent in enumerate(latents):
    ...
    mesh = t.mesh()
    mesh.write_obj(f"sovereign_core_{i}.obj")
    print(f"✅ Generated sovereign_core_{i}.obj")
