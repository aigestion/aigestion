 ...
 */
router.post('/register-options', (req, res) => controller.generateRegistrationOptions(req, res));
router.post('/register-verify', (req, res) => controller.verifyRegistration(req, res));
router.post('/login-options', (req, res) => controller.generateAuthenticationOptions(req, res));
