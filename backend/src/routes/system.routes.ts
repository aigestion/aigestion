...
router.get('/metrics', monitoringLimit, (req, res, next) =>
  controller.getSystemMetrics(req, res, next),
);
router.get('/cpu', monitoringLimit, (req, res, next) => controller.getCPUUsage(req, res, next));
router.get('/memory', monitoringLimit, (req, res, next) =>
  controller.getMemoryUsage(req, res, next),
);
router.get('/disk', monitoringLimit, (req, res, next) => controller.getDiskUsage(req, res, next));
router.get('/network', monitoringLimit, (req, res, next) =>
  controller.getNetworkStats(req, res, next),
);
