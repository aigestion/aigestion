...
export class AnomalyDetectionService {
     ...
     */
    async analyzePatterns(data: any): Promise<{ anomalyDetected: boolean; threatLevel: 'low' | 'medium' | 'high'; message?: string }> {
        ...
        try {
            ...
            if (result.anomalyDetected) {
                logger.warn(`[AnomalyDetection] ALERT: ${result.explanation} (Level: ${result.threatLevel})`);
            }
