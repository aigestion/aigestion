...
const envSchema = z.object({
  ...
  RABBITMQ_URL: z.string().default('amqp://rabbitmq'),
  ...
  BROWSERLESS_HOST: z.string().default('ws://browserless:3001').describe('Browserless WebSocket host'),
