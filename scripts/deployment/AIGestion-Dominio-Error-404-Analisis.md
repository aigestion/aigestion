...
*El problema del dominio principal está identificado: el HTML sirve pero el JavaScript no renderiza. La solución es redirigir a los dashboards simples que funcionan perfectamente.*
