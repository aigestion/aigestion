# Create APK for Pixel 8 Pro - Final Version
# Simple APK creation without complex syntax

Write-Host "Creating APK for Pixel 8 Pro" -ForegroundColor Cyan
...
$mainActivity = 'package com.aigestion.enterprise;
