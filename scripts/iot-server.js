      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              capabilities: { type: 'array', items: { type: 'string' }, description: 'Device capabilities' }
            },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              data_points: { type: 'array', items: { type: 'string' }, description: 'Data points to collect' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              device_ids: { type: 'array', items: { type: 'string' }, description: 'Device IDs to monitor' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              device_ids: { type: 'array', items: { type: 'string' }, description: 'Device IDs to include' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              analysis_type: { type: 'string', enum: ['trend', 'anomaly', 'prediction', 'correlation'], description: 'Analysis type' }
            },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              update_type: { type: 'string', enum: ['forced', 'scheduled'], description: 'Update type' }
            },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              alert_type: { type: 'string', enum: ['create', 'list', 'update', 'delete'], description: 'Alert operation' },
              device_id: { type: 'string', description: 'Device ID' },
