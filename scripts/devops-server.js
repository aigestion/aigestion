      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              platform: { type: 'string', enum: ['github', 'gitlab', 'azure', 'jenkins', 'circleci'], description: 'CI/CD platform' },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              deployment_strategy: { type: 'string', enum: ['blue-green', 'rolling', 'canary'], description: 'Deployment strategy' }
            },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              tool: { type: 'string', enum: ['terraform', 'cloudformation', 'pulumi', 'ansible', 'kubernetes'], description: 'IaC tool' },
              action: { type: 'string', enum: ['plan', 'apply', 'destroy', 'validate'], description: 'IaC action' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              action: { type: 'string', enum: ['build', 'push', 'pull', 'run', 'stop', 'remove'], description: 'Container action' },
