...
function Check-RealCredentials {
    ...
    if ($demoCredentials.Count -gt 0) {
        ...
        Write-Host ""
        Write-ColorOutput "💡 Ejecuta: .\get-real-credentials-guide.ps1 -Action guide -Service <servicio>" "info"
    } else {
...
function Show-Help {
    ...
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide"
    Write-Host ""
    Write-ColorOutput "2. Guía por servicio específico:" "info"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service project-management"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service meta-platform"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service finance"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service analytics"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service security"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service communication"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service cloud"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action guide -Service ai-ml"
    Write-Host ""
    Write-ColorOutput "3. Verificar credenciales actuales:" "info"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action check"
    Write-Host ""
    Write-ColorOutput "4. Ayuda:" "info"
    Write-Host "   .\get-real-credentials-guide.ps1 -Action help"
    Write-Host ""
