      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              features: { type: 'array', items: { type: 'string' }, description: 'Vision features to detect' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              image_sources: { type: 'array', items: { type: 'string' }, description: 'Image sources' },
              features: { type: 'array', items: { type: 'string' }, description: 'Vision features' }
            },
