      ...
      tools: [
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              operation: { type: 'string', enum: ['get', 'put', 'delete', 'list'], description: 'KV operation' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              operation: { type: 'string', enum: ['query', 'execute', 'migrate'], description: 'D1 operation' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              operation: { type: 'string', enum: ['upload', 'download', 'delete', 'list'], description: 'R2 operation' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              operation: { type: 'string', enum: ['send', 'receive', 'purge'], description: 'Queue operation' },
        ...
        },
        {
          ...
          inputSchema: {
            type: 'object',
            properties: {
              operation: { type: 'string', enum: ['create', 'get', 'update', 'delete'], description: 'Object operation' },
