const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      'router.js',
      'EnhancedROI.js',
      'CinematicPresentation.js',
      'InteractiveShowcase.js',
      'DataVisualization.js',
      'DanielaAI.js',
      'NexusAndroid.js',
      'DanielaShowcase.js',
      'DecentralandOffice.js',
      'AdminDashboard.js',
      'Card.js',
      'ClientDashboard.js',
      'DemoDashboard.js',
...
import { r as V, a as G } from './vendor.js';
import { _ as q, c as H } from './three.js';
import { u as $, L as W, N as B, R as U, a as F, B as J } from './router.js';
const X = () =>
    r.jsxs('div', {
      ...
      children: [
        ...
        r.jsx('div', { className: 'absolute inset-0 bg-nexus-obsidian/40 backdrop-blur-[20px]' }),
      ],
    }),
  Y = [
    {
            ...
            r.jsxs(o.div, {
              ...
              children: [
                r.jsxs('h2', {
                  ...
                  children: [
                    'CASOS DE ',
                    r.jsx('span', { className: 'text-nexus-violet text-glow', children: 'ÉXITO' }),
                  ],
                }),
                r.jsx('p', {
                        ...
                        children: e.impact.map(e =>
                          r.jsxs(
                            'li',
                            {
                              ...
                              children: [
                                r.jsx('span', { className: 'h-2 w-2 rounded-full bg-nexus-cyan' }),
                                e,
                              ],
                            },
                            e
...
const Q = new (class {
    ...
    loadSound(e) {
      ...
      const t = new Promise(t => {
        ...
        (t =>
          new Promise(s => {
            const r = new Audio();
            ((r.src = t), (r.volume = 0.3), (r.preload = 'auto'));
            const o = setTimeout(() => {
              s(a());
            }, 5e3);
            (r.addEventListener(
              ...
              () => {
                clearTimeout(o);
                const t = { audio: r, isLoaded: !0, error: !1 };
                (this.audioCache.set(e, t), this.cleanupCache(), s(r));
              },
              { once: !0 }
            ),
              r.addEventListener(
  ...
  Z = () => {
    const e = V.useCallback(e => {
        try {
          Q.play(e);
        } catch (t) {}
      }, []),
      t = V.useCallback(() => e('hover_glass'), [e]),
      s = V.useCallback(() => e('click_activate'), [e]),
      a = V.useCallback(() => e('wuaw_subtle'), [e]),
      r = V.useCallback(() => e('data_pulse'), [e]);
    return { play: e, playHover: t, playClick: s, playWuaw: a, playPulse: r };
  },
  ee = () => {
    const { playHover: e, playClick: t } = Z(),
      [s, a] = V.useState(!1),
      [p, h] = V.useState(''),
      [b, g] = V.useState(0),
      f = [
        {
          id: '1',
          icon: r.jsx(l, { className: 'w-4 h-4' }),
        ...
        {
          id: '2',
          icon: r.jsx(c, { className: 'w-4 h-4' }),
        ...
        {
          id: '3',
          icon: r.jsx(d, { className: 'w-4 h-4' }),
        ...
        {
          id: '4',
          icon: r.jsx(u, { className: 'w-4 h-4' }),
        ...
        {
          id: '5',
          icon: r.jsx(x, { className: 'w-4 h-4' }),
          title: 'Estado del Sistema',
          path: '/status',
        },
        {
          id: '6',
          icon: r.jsx(m, { className: 'w-4 h-4' }),
          title: 'Iniciar Prueba Gratuita',
          action: () => alert('Starting Trial...'),
        },
      ].filter(e => e.title.toLowerCase().includes(p.toLowerCase()));
    (V.useEffect(() => {
      const r = r => {
        ('k' === r.key &&
          (r.metaKey || r.ctrlKey) &&
          (r.preventDefault(), s ? t() : e(), a(e => !e)),
          'Escape' === r.key && a(!1));
      };
      return (
    ...
    const v = e => {
      const t = f[e];
      t && (t.action && t.action(), t.path, a(!1), h(''));
    };
    return r.jsx(n, {
      children:
        s &&
            ...
            r.jsxs(o.div, {
              ...
              children: [
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsx(i, { className: 'w-5 h-5 text-nexus-cyan mr-3' }),
                    r.jsx('input', {
                      autoFocus: !0,
                      type: 'text',
                      ...
                      onKeyDown: e => {
                        ('ArrowDown' === e.key &&
                          (e.preventDefault(), g(e => Math.min(e + 1, f.length - 1))),
                          'ArrowUp' === e.key && (e.preventDefault(), g(e => Math.max(e - 1, 0))),
                          'Enter' === e.key && v(b));
                      },
                      className:
                  ...
                  children: [
                    ...
                    0 === f.length &&
                      r.jsxs('div', {
                        ...
                        children: ['No se encontraron resultados para "', p, '"'],
                      }),
                  ],
                }),
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsx('span', { children: '↑↓ para navegar' }),
                    r.jsx('span', { children: 'AIGESTION COMMAND CENTER v2.0' }),
                  ],
                }),
              ],
            }),
  ...
  se = ({ children: e }) => {
    ...
    (V.useEffect(() => {
      ...
      V.useEffect(() => {
        localStorage.setItem('nexus-audio-volume', JSON.stringify(a));
      }, [a]));
    const n = V.useCallback(() => s(e => !e), []),
      i = V.useCallback(e => o(e), []),
      l = V.useCallback(e => {}, [t]);
    return r.jsx(te.Provider, {
      value: { isMuted: t, volume: a, toggleMute: n, setGlobalVolume: i, playSfx: l },
      children: e,
    });
  },
  ae = () => {
  ...
  oe = '/sounds/hover_glass.mp3',
  ne = '/sounds/click_activate.mp3',
  ie = '/sounds/success_chime.mp3',
  le = '/sounds/menu_open.mp3',
  ce = '/sounds/data_pulse.mp3',
  de = '/sounds/error_buzzer.mp3',
  ue = '/sounds/menu_open.mp3',
  xe = (e, t) => {
    const s = V.useRef(null);
    (V.useEffect(
      () => (
        (s.current = new re({ src: [e], preload: !0, volume: t.volume })),
        () => {
          s.current?.unload();
        }
      ),
      ...
      V.useEffect(() => {
        s.current && s.current.volume(t.volume);
      }, [t.volume]));
    return [
      V.useCallback(() => {
        t.soundEnabled && s.current && s.current.play();
      }, [t.soundEnabled]),
    ];
  },
  me = () => {
    const { isMuted: e, volume: t } = ae(),
      [s] = xe(oe, { volume: 0.2 * t, soundEnabled: !e }),
      [a] = xe(ne, { volume: 0.4 * t, soundEnabled: !e }),
      [r] = xe(ie, { volume: 0.3 * t, soundEnabled: !e }),
      [o] = xe(le, { volume: 0.15 * t, soundEnabled: !e }),
      [n] = xe(ce, { volume: 0.25 * t, soundEnabled: !e }),
      [i] = xe(de, { volume: 0.4 * t, soundEnabled: !e }),
      [l] = xe(ue, { volume: 0.2 * t, soundEnabled: !e });
    return {
      playHover: s,
      playClick: a,
      playSuccess: r,
  ...
  pe = () => {
    ...
    (V.useEffect(() => {
      ...
      V.useEffect(() => {
        e && setTimeout(() => u.current?.focus(), 100);
      }, [e]));
    return r.jsx(n, {
      children:
        e &&
        r.jsx(o.div, {
          ...
          children: r.jsxs('div', {
            ...
            children: [
              r.jsx('div', { className: 'scanline pointer-events-none' }),
              r.jsx('div', {
                className:
              ...
              r.jsxs('div', {
                ...
                children: [
                  r.jsxs('span', {
                    className: 'flex items-center gap-2',
                    children: [
                      r.jsx('span', { className: 'animate-pulse', children: '●' }),
                ...
                onSubmit: e => {
                  ...
                  switch (s) {
                    ...
                    case 'daniela':
                      ...
                      break;
                    case 'status':
                      a.push('NODOS ACTIVOS: 142', 'Carga de Red: 24%', 'Sincronización: 100%');
                      break;
                    case 'exit':
                      t(!1);
                      break;
                    default:
                      a.push(`Error: Comando "${s}" no reconocido.`);
                  }
                  (d(e => [...e, ...a]), l(''));
                },
                className: 'p-4 bg-white/5 border-t border-white/5 flex items-center gap-3',
                children: [
                  r.jsx('span', { className: 'text-nexus-cyan-glow font-mono', children: '$' }),
                  r.jsx('input', {
                    ref: u,
                    type: 'text',
                    value: i,
  ...
  he = ({
    ...
    const [i, l] = V.useState(!1),
      [c, d] = V.useState(!1),
      [u, x] = V.useState({ name: '', email: '', subject: '', message: '' }),
      m =
      ...
      p = 'block text-xs font-orbitron font-bold text-nexus-cyan mb-2 tracking-wider uppercase';
    return c
      ? r.jsx('div', {
          className: `p-12 text-center rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md ${n}`,
          children: r.jsxs(o.div, {
            ...
            children: [
              r.jsx('div', {
                ...
                children: r.jsx('span', { className: 'text-4xl text-nexus-cyan', children: '✓' }),
              }),
              r.jsx('h3', {
          ...
          children: [
            r.jsxs('div', {
              ...
              children: [
                ...
                r.jsx('p', { className: 'text-gray-400 text-sm max-w-md mx-auto', children: t }),
              ],
            }),
            r.jsxs('form', {
              onSubmit: async e => {
              ...
              children: [
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsxs('div', {
                      children: [
                        r.jsx('label', { className: p, children: 'Identificación' }),
                        r.jsx('input', {
                          type: 'text',
                    ...
                    r.jsxs('div', {
                      children: [
                        r.jsx('label', { className: p, children: 'Dirección Neural' }),
                        r.jsx('input', {
                          type: 'email',
                          ...
                          className: m,
                          value: u.email,
                          onChange: e => x({ ...u, email: e.target.value }),
                        }),
                      ],
                    }),
                  ],
                ...
                r.jsxs('div', {
                  children: [
                    r.jsx('label', { className: p, children: 'Módulo' }),
                    r.jsx('input', {
                      type: 'text',
                      ...
                      className: m,
                      value: u.subject,
                      onChange: e => x({ ...u, subject: e.target.value }),
                    }),
                  ],
                }),
                r.jsxs('div', {
                  children: [
                    r.jsx('label', { className: p, children: 'Mensaje de Datos' }),
                    r.jsx('textarea', {
                      required: !0,
                      rows: 4,
                      className: m,
                      ...
                      value: u.message,
                      onChange: e => x({ ...u, message: e.target.value }),
                    }),
                  ],
                }),
                r.jsx('button', {
  ...
  be = ({ text: e, className: t = '' }) =>
    r.jsxs('div', {
      className: `relative inline-block ${t}`,
      children: [
        r.jsx('span', { className: 'relative z-10', children: e }),
        r.jsx('span', {
          className:
  ...
  ge = () => {
    const { playHover: e, playSuccess: t } = me();
                ...
                r.jsxs('h2', {
                  ...
                  children: [
                    ...
                    r.jsx('span', {
                      ...
                      children: r.jsx(be, { text: 'FUTURO HOY' }),
                    }),
                  ],
                }),
                r.jsx('p', {
                            ...
                            r.jsxs(o.div, {
                              ...
                              children: [
                                r.jsx('div', {
                                  ...
                                  children: r.jsx('span', { className: 'text-xl', children: '📧' }),
                                }),
                                r.jsxs('div', {
                                  children: [
                                    r.jsx('div', {
                        ...
                        r.jsxs('div', {
                          ...
                          children: [
                            ...
                            r.jsxs('div', {
                              className: 'flex justify-between items-center',
                              children: [
                                r.jsx('span', { className: 'text-gray-300', children: 'Sábados' }),
                                r.jsx('span', {
                                  className: 'text-nexus-cyan font-medium',
                          ...
                          children: [
                            ...
                            r.jsxs(
                              o.button,
                              {
                                ...
                                onMouseEnter: e,
                                children: [
                                  r.jsx('div', { className: 'text-2xl mb-1', children: t.icon }),
                                  r.jsx('div', { className: 'text-sm', children: t.name }),
                                ],
                              },
                              t.name
                            )
  ...
  ve = () => {
    ...
    return {
      ...
      speak: e => {
        ...
        (s && (t.voice = s), (t.onend = () => o(!1)), window.speechSynthesis.speak(t));
      },
    };
  },
  ye = () => {
    const [e, t] = V.useState(!1),
      { isListening: s, transcript: a, toggleListening: i } = ve();
    return r.jsxs('div', {
              ...
              children: [
                r.jsxs('div', {
                  ...
                  children: [
                    ...
                    r.jsx('div', { className: 'ml-auto w-12 h-px bg-nexus-cyan/20' }),
                  ],
                }),
                r.jsx('div', {
                  className:
                ...
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsx(o.button, {
                      ...
                      children: s ? '● PARAR' : '🎙️ HABLAR CON ELLA',
                    }),
                    r.jsx('div', {
                        ...
                        r.jsx(
                          'div',
                          {
                            className:
                              ...
                              (s ? 'bg-nexus-cyan animate-pulse' : 'bg-white/10'),
                          },
                          e
                        )
                      ),
          ...
          r.jsxs(o.div, {
            ...
            children: [
              r.jsxs('h2', {
                ...
                children: [
                  'PREGUNTAS ',
                  r.jsx('span', { className: 'text-nexus-violet text-glow', children: 'CLAVE' }),
                ],
              }),
              r.jsx('p', {
            ...
            children: we.map((e, t) =>
              r.jsxs(
                o.div,
                {
                  ...
                  viewport: { once: !0 },
                  children: [
                    r.jsx('h3', { className: 'text-white font-semibold mb-2', children: e.q }),
                    r.jsx('p', { className: 'text-sm text-nexus-silver/70', children: e.a }),
                  ],
                },
                e.q
              )
  ...
  Ce = ({ children: e, className: t = '' }) => {
    const s = V.useRef(null),
      [a, n] = V.useState({ x: 0, y: 0 }),
      { x: i, y: l } = a;
    return r.jsx(o.div, {
      ref: s,
      onMouseMove: e => {
        const { clientX: t, clientY: a } = e,
          {
            height: r,
            width: o,
            left: i,
            top: l,
          } = s.current?.getBoundingClientRect() || { height: 0, width: 0, left: 0, top: 0 };
        n({ x: 0.5 * (t - (i + o / 2)), y: 0.5 * (a - (l + r / 2)) });
      },
      onMouseLeave: () => {
        n({ x: 0, y: 0 });
      },
  ...
  Se = () => {
    const { isMuted: e, toggleMute: t, playSfx: s } = ae();
    return r.jsx('button', {
      onClick: () => {
        (t(), e && setTimeout(() => s('success_chime'), 100));
      },
  ...
  Ae = () => {
    const { playHover: e, playClick: t, playWhoosh: s } = me(),
      [a, i] = V.useState(!1),
      [l, c] = V.useState(!1),
      [d, u] = V.useState(!0),
      x = $();
    ...
    const m = [
        { label: '🎮 Servicios Mágicos', path: '#services', isHash: !0, emoji: '🎮' },
        { label: '📚 Casos de Éxito', path: '#cases', isHash: !0, emoji: '📚' },
        { label: '💰 Precios Divertidos', path: '#pricing', isHash: !0, emoji: '💰' },
        { label: '🎯 Plan Increíble', path: '#plan', isHash: !0, emoji: '🎯' },
        { label: '📚 Tutoriales Fáciles', path: '#tutoriales', isHash: !0, emoji: '📚' },
        { label: '💬 Contacto Amigable', path: '#contact', isHash: !0, emoji: '💬' },
          ...
          children: [
            r.jsxs(W, {
              ...
              children: [
                r.jsxs('div', {
                  className:
                    'relative z-10 w-12 h-12 mr-3 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12',
                  children: [
                    r.jsx('div', {
                      className:
                        'absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 blur-lg rounded-full opacity-50 group-hover:opacity-100 transition-opacity',
                    }),
                    r.jsx('div', {
                      className: 'absolute inset-0 flex items-center justify-center',
                      children: r.jsx(b, { className: 'w-6 h-6 text-white animate-pulse' }),
                    }),
                    r.jsx('img', {
                      src: '/images/brand/logo.png',
                      alt: 'Logo',
                      className:
                        'w-full h-full object-contain filter drop-shadow-[0_0_12px_rgba(147,51,234,0.8)]',
                    }),
                  ],
                }),
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsxs('h1', {
                      className:
                        'font-bold text-2xl tracking-[0.1em] leading-none text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:via-yellow-200 group-hover:to-pink-200 transition-all duration-300',
                      children: [
                        '🎮 AIGESTION',
                        r.jsx('span', { className: 'text-yellow-300', children: '.NET' }),
                      ],
                    }),
                    r.jsx('span', {
                      className:
                        'text-[10px] font-mono text-gray-300 tracking-[0.3em] uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-300 -mt-1',
                      children: '🎮 ¡El Sistema Más Divertido!',
                    }),
                  ],
                }),
              ],
            ...
            r.jsxs('button', {
              ...
              onMouseEnter: e,
              className:
                'hidden lg:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full text-white font-bold shadow-lg hover:scale-105 transition-all',
              children: [
                r.jsx(g, { className: 'w-4 h-4 animate-spin' }),
                r.jsxs('span', {
                  className: 'text-sm',
                  children: [d ? '😎' : '🎮', ' Modo ', d ? 'Divertido' : 'Normal'],
                }),
              ],
            }),
            r.jsx('div', {
              ...
              children: m.map(t =>
                r.jsxs(
                  W,
                  {
                    to: t.path,
                    onClick: e => {
                      t.isHash ? (e.preventDefault(), p(t.path, !0)) : p(t.path);
                    },
                    onMouseEnter: e,
                    className:
                      'relative font-bold text-sm tracking-wider uppercase transition-all duration-300 hover:scale-110 ' +
                      (x.pathname === t.path ? 'text-yellow-300' : 'text-gray-300'),
                    children: [
                      r.jsxs('span', {
                        className: 'flex items-center gap-2',
                        children: [
                          r.jsx('span', { className: 'text-lg', children: t.emoji }),
                          t.label,
                        ],
                      }),
                      r.jsx('span', {
                        className:
                          'absolute -bottom-1 left-0 w-0 h-[2px] bg-gradient-to-r from-yellow-400 to-pink-400 transition-all duration-300 group-hover:w-full',
                      }),
                    ],
                  },
                  t.label
              ...
              children: [
                ...
                r.jsx(Ce, {
                  ...
                  children: r.jsxs(W, {
                    ...
                    onClick: t,
                    className:
                      'hidden sm:flex group relative items-center gap-3 px-6 py-3 overflow-hidden rounded-full bg-gradient-to-r from-purple-600/20 to-pink-600/20 border-2 border-white/30 hover:border-yellow-400/50 transition-all duration-300 shadow-lg shadow-purple-500/30',
                    children: [
                      r.jsx('div', {
                        className:
                          'absolute inset-0 bg-gradient-to-r from-purple-600/40 via-pink-600/40 to-purple-600/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500',
                      }),
                      r.jsx('div', {
                        className:
                          'absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out',
                      }),
                      r.jsx(f, {
                        size: 16,
                        className:
                          'text-yellow-300 group-hover:text-white transition-colors animate-pulse',
                      }),
                      r.jsx('span', {
                        className:
                          'relative font-bold text-sm tracking-wider uppercase text-white group-hover:text-shadow-glow',
                        children: '🎮 ¡ENTRAR AL JUEGO!',
                      }),
                      r.jsx(v, {
                        size: 16,
                        className:
                          'text-gray-300 group-hover:text-white group-hover:translate-x-1 transition-all',
                      }),
                    ],
                  }),
                }),
                r.jsx('button', {
                  className:
                    'lg:hidden p-3 text-white hover:text-yellow-300 transition-colors bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-full border-2 border-white/30',
                  onClick: () => c(!l),
                  children: l
                    ? r.jsxs('div', {
                        className: 'flex items-center gap-2',
                        children: [
                          r.jsx(y, { size: 24 }),
                          r.jsx('span', { className: 'text-sm font-bold', children: '😎' }),
                        ],
                      })
                    : r.jsxs('div', {
                        className: 'flex items-center gap-2',
        ...
        r.jsx(n, {
          children:
            ...
            r.jsx(o.div, {
              ...
              className:
                'lg:hidden bg-gradient-to-r from-purple-900/95 via-blue-900/95 to-indigo-900/95 backdrop-blur-xl border-b-2 border-white/20 overflow-hidden',
              children: r.jsxs('div', {
                ...
                children: [
                  r.jsxs('div', {
                    ...
                    children: [
                      r.jsx('h3', {
                        ...
                        children: '🎮 ¡Menú Mágico!',
                      }),
                      r.jsx('p', {
                        className: 'text-sm text-gray-300',
                        children: 'Elige tu aventura favorita',
                      }),
                    ],
                  }),
                  m.map((e, t) =>
                    r.jsx(
                      o.div,
                      {
                        ...
                        children: r.jsxs(W, {
                          to: e.path,
                          onClick: t => {
                            e.isHash ? (t.preventDefault(), p(e.path, !0)) : p(e.path);
                          },
                          className:
                            'flex items-center gap-3 p-4 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-xl border-2 border-white/20 hover:border-yellow-400/50 transition-all hover:scale-105 hover:translate-x-2',
                          children: [
                            r.jsx('span', {
                            ...
                            r.jsxs('div', {
                              ...
                              children: [
                                ...
                                r.jsx('div', {
                                  ...
                                  children: '¡Haz clic para explorar!',
                                }),
                              ],
                            }),
                            r.jsx(v, { className: 'text-yellow-300 animate-pulse' }),
                          ],
                        }),
                      },
                      e.label
                  ...
                  r.jsx(o.div, {
                    ...
                    children: r.jsxs(W, {
                      ...
                      onClick: () => p('/login'),
                      className:
                        'w-full py-4 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full font-bold text-white text-lg shadow-lg hover:scale-105 transition-all flex items-center justify-center gap-2 border-2 border-white/30',
                      children: [
                        r.jsx(Gamepad2, { className: 'w-6 h-6' }),
                        r.jsx('span', { children: '🎮 ¡COMENZAR A JUGAR!' }),
                        r.jsx(b, { className: 'w-6 h-6' }),
                      ],
                    }),
                  }),
                ],
  ...
  Pe = () => {
    const { scrollYProgress: e } = j(),
      t = N(e, { stiffness: 100, damping: 30, restDelta: 0.001 });
    return r.jsx(o.div, {
      className:
                      ...
                      r.jsxs('div', {
                        ...
                        children: [
                          r.jsx('div', {
                            ...
                            children: r.jsx(e.icon, { className: 'w-6 h-6 text-nexus-cyan-glow' }),
                          }),
                          r.jsx('h3', {
            ...
            r.jsxs(o.div, {
              ...
              children: [
                r.jsxs('h2', {
                  ...
                  children: [
                    'TUTORIALES ',
                    r.jsx('span', { className: 'text-nexus-cyan text-glow', children: 'EN VIDEO' }),
                  ],
                }),
                r.jsx('p', {
                  className: 'text-lg text-nexus-silver/70 max-w-3xl mx-auto',
  ...
  Re = ({ title: e, message: t, type: s = 'info', onClose: a }) => {
    const n = {
      info: r.jsx(P, { className: 'text-nexus-cyan', size: 20 }),
      success: r.jsx(L, { className: 'text-green-400', size: 20 }),
      warning: r.jsx(z, { className: 'text-yellow-400', size: 20 }),
      error: r.jsx(_, { className: 'text-red-400', size: 20 }),
    };
    return r.jsxs(o.div, {
      initial: { opacity: 0, x: 100, scale: 0.9 },
      animate: { opacity: 1, x: 0, scale: 1 },
      exit: { opacity: 0, x: 50, scale: 0.95, filter: 'blur(10px)' },
      className: `pointer-events-auto min-w-[320px] max-w-md premium-glass p-1 border ${{ info: 'border-nexus-cyan/30', success: 'border-green-500/30', warning: 'border-yellow-500/30', error: 'border-red-500/30' }[s]} rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden group`,
      children: [
        r.jsxs('div', {
          className: 'relative p-4 flex gap-4',
          children: [
            r.jsx('div', { className: 'flex-shrink-0 mt-1', children: n[s] }),
            r.jsxs('div', {
              className: 'flex-grow',
              children: [
                r.jsx('h4', {
    ...
    const [t, s] = V.useState([]),
      ...
      o = V.useCallback(
        (e, t, r = 'info') => {
          ...
          (a(),
            s(s => [...s, { id: o, title: e, message: t, type: r }]),
            setTimeout(() => {
              s(e => e.filter(e => e.id !== o));
            }, 5e3));
        },
        [a]
      );
    return r.jsxs(Ve.Provider, {
      value: { notify: o },
      children: [
        e,
        r.jsx('div', {
            ...
            children: t.map(e =>
              r.jsx(
                Re,
                {
                  ...
                  message: e.message,
                  type: e.type,
                  onClose: () => s(t => t.filter(t => t.id !== e.id)),
                },
                e.id
              )
            ),
  ...
  qe = () => {
    const e = V.useContext(Ve);
    if (!e) throw new Error('useNotification must be used within a NotificationProvider');
    return e;
  },
  He = ({ onLogin: e, loading: t, error: s }) => {
    const [a, n] = V.useState({ email: '', password: '' }),
      [i, l] = V.useState(!1),
      [c, d] = V.useState({}),
      u = e => {
        const { name: t, value: s } = e.target;
        (n(e => ({ ...e, [t]: s })), c[t] && d(e => ({ ...e, [t]: void 0 })));
      };
    return r.jsx('div', {
              ...
              onSubmit: async t => {
                if (
                  ...
                  (() => {
                    ...
                    return (
                      a.email
                        ? /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.email) || (e.email = 'Email inválido')
              ...
              children: [
                r.jsxs('div', {
                  ...
                  children: [
                    ...
                    c.email && r.jsx('p', { className: 'text-red-400 text-sm', children: c.email }),
                  ],
                }),
                r.jsxs('div', {
                  className: 'space-y-2',
                      ...
                      children: [
                        ...
                        r.jsx('button', {
                          ...
                          children: i
                            ...
                            : r.jsx(T, { className: 'h-5 w-5' }),
                        }),
                      ],
                    }),
                    c.password &&
                      r.jsx('p', { className: 'text-red-400 text-sm', children: c.password }),
                  ],
                }),
                s &&
                  r.jsx(o.div, {
                    ...
                    children: r.jsxs('div', {
                      ...
                      children: [r.jsx(O, { className: 'h-4 w-4 mr-2' }), s],
                    }),
                  }),
                r.jsx('button', {
                  type: 'submit',
  ...
  $e = ({ onLogin: e, isAuthenticated: t }) => {
    const [s, a] = V.useState(!1),
      [o, n] = V.useState('');
    return t
      ? r.jsx(B, { to: '/dashboard', replace: !0 })
      : r.jsx('div', {
          ...
          children: r.jsx(He, {
            onLogin: async (t, s) => {
              ...
              try {
                ...
                n(r instanceof Error ? r.message : 'Error al iniciar sesión');
              } finally {
                a(!1);
              }
            },
...
(V.lazy(() =>
  q(() => import('./DanielaWebsite.js'), __vite__mapDeps([0, 1, 2, 3])).then(e => ({
    default: e.DanielaWebsite,
  }))
),
  V.lazy(() =>
    q(() => import('./Dashboard.js'), __vite__mapDeps([4, 1, 2, 5, 6, 7, 8])).then(e => ({
      default: e.Dashboard,
    }))
  ));
const We = V.lazy(() =>
    q(() => import('./EnhancedROI.js'), __vite__mapDeps([9, 1, 2, 5, 6, 7, 8])).then(e => ({
      default: e.EnhancedROI,
    }))
  ),
  Be = V.lazy(() =>
    q(() => import('./CinematicPresentation.js'), __vite__mapDeps([10, 1, 2, 5, 6, 7, 8])).then(
      e => ({ default: e.CinematicPresentation })
    )
  );
(V.lazy(() =>
  q(() => import('./InteractiveShowcase.js'), __vite__mapDeps([11, 1, 2, 5, 6, 7, 8])).then(e => ({
    default: e.InteractiveShowcase,
  }))
),
  V.lazy(() =>
    q(() => import('./DataVisualization.js'), __vite__mapDeps([12, 1, 2, 5, 6, 7, 8])).then(e => ({
      default: e.DataVisualization,
    }))
  ),
  V.lazy(() =>
    q(() => import('./DanielaAI.js'), __vite__mapDeps([13, 1, 2, 5, 6, 7, 8])).then(e => ({
      default: e.DanielaAI,
    }))
  ));
const Ue = V.lazy(() =>
    q(() => import('./NexusAndroid.js'), __vite__mapDeps([14, 1, 2, 5, 6, 7, 8])).then(e => ({
      default: e.NexusAndroid,
    }))
  ),
  Fe = V.lazy(() =>
    q(() => import('./DanielaShowcase.js'), __vite__mapDeps([15, 1, 2, 5, 6, 7, 8])).then(e => ({
      default: e.DanielaShowcase,
    }))
  ),
  Je = V.lazy(() =>
    q(() => import('./DecentralandOffice.js'), __vite__mapDeps([16, 1, 2])).then(e => ({
      default: e.DecentralandOffice,
    }))
  ),
  Xe = V.lazy(() =>
    q(() => import('./AdminDashboard.js'), __vite__mapDeps([17, 1, 2, 18, 5, 6, 7, 8])).then(e => ({
      default: e.AdminDashboard,
    }))
  ),
  Ye = V.lazy(() =>
    q(() => import('./ClientDashboard.js'), __vite__mapDeps([19, 1, 2, 18, 5, 6, 7, 8])).then(
      e => ({ default: e.ClientDashboard })
    )
  ),
  Ke = V.lazy(() =>
    q(() => import('./DemoDashboard.js'), __vite__mapDeps([20, 1, 2, 18, 5, 6, 7, 8])).then(e => ({
      default: e.DemoDashboard,
    }))
  ),
  Qe = V.lazy(() =>
    q(() => import('./WorkbenchLayout.js'), __vite__mapDeps([21, 1, 2, 8, 4, 5, 6, 7])).then(e => ({
      default: e.WorkbenchLayout,
    }))
  ),
  Ze = V.lazy(() =>
    q(() => import('./BillingDashboard.js'), __vite__mapDeps([22, 1, 2, 5, 6, 7, 8])).then(e => ({
      default: e.BillingDashboard,
    }))
  ),
  et = V.lazy(() =>
    q(() => import('./DanielaDemo.js'), __vite__mapDeps([23, 1, 2, 0, 3])).then(e => ({
      default: e.DanielaDemo,
    }))
  ),
  tt = V.lazy(() =>
    q(() => import('./VirtualOfficePreview.js'), __vite__mapDeps([24, 1, 2, 8, 5, 6, 7]))
  ),
  st = V.lazy(() => q(() => import('./WeaponDashboard.js'), __vite__mapDeps([25, 1, 2]))),
  at = () =>
    r.jsx('div', {
  ...
  ot = ({ loading: e, isAuthenticated: t, currentUser: s, handleLogin: a, handleLogout: o }) => {
    const { notify: n } = qe(),
      i = $();
    return (
      V.useEffect(() => {
      ...
      V.useEffect(() => {
        e || n('SISTEMA ACTIVADO', 'Protocolos Antigravity God Mode Online', 'success');
      }, [e, n]),
      r.jsxs('div', {
        className:
          ...
          r.jsxs(U, {
            children: [
              r.jsx(F, {
                path: '/login',
                element: t
                  ? r.jsx(B, { to: '/dashboard' })
                  : r.jsx($e, { onLogin: a, isAuthenticated: t }),
              }),
              r.jsx(F, {
                path: '/dashboard',
                element: t
                  ? r.jsx(Qe, { user: s, onLogout: o })
                  : r.jsxs('div', {
                        ...
                        r.jsxs('div', {
                          ...
                          children: [
                            r.jsxs('a', {
                              ...
                              children: [
                                r.jsx('h3', { children: '🏆 Panel Administrativo' }),
                                r.jsx('p', { children: 'Control administrativo y análisis' }),
                              ],
                            }),
                            r.jsxs('a', {
                              ...
                              children: [
                                r.jsx('h3', { children: '👥 Panel de Cliente' }),
                                r.jsx('p', {
                            ...
                            r.jsxs('a', {
                              ...
                              children: [
                                r.jsx('h3', { children: '🎪 Panel de Demostración' }),
                                r.jsx('p', { children: 'Demos interactivas y showcases' }),
                              ],
                            }),
                          ],
                        }),
              ...
              r.jsx(F, { path: '/dashboard/admin', element: r.jsx(Xe, {}) }),
              r.jsx(F, { path: '/dashboard/client', element: r.jsx(Ye, {}) }),
              r.jsx(F, { path: '/dashboard/demo', element: r.jsx(Ke, {}) }),
              r.jsx(F, { path: '/dashboard/billing', element: r.jsx(Ze, {}) }),
              r.jsx(F, {
                path: '/',
                element: t
                  ? r.jsx(B, { to: '/dashboard' })
                  : r.jsxs('main', {
                      children: [
                        r.jsx(V.Suspense, { fallback: r.jsx(at, {}), children: r.jsx(Be, {}) }),
                        r.jsx(V.Suspense, { fallback: r.jsx(at, {}), children: r.jsx(Fe, {}) }),
                        r.jsx(V.Suspense, { fallback: r.jsx(at, {}), children: r.jsx(Ue, {}) }),
                        r.jsx(Me, {}),
                        r.jsx(K, {}),
                        r.jsx(V.Suspense, { fallback: r.jsx(at, {}), children: r.jsx(We, {}) }),
                        r.jsx(Le, {}),
                        r.jsx(ke, {}),
                        r.jsx(Oe, {}),
                        r.jsx(V.Suspense, { fallback: r.jsx(at, {}), children: r.jsx(Je, {}) }),
                        r.jsx(je, {}),
                        r.jsx(V.Suspense, { fallback: r.jsx(at, {}), children: r.jsx(ge, {}) }),
                      ],
                    }),
              }),
              r.jsx(F, {
              ...
              r.jsx(F, { path: '/weapon', element: r.jsx(st, {}) }),
              r.jsx(F, { path: '/dashboard', element: r.jsx(B, { to: '/dashboard/' }) }),
              r.jsx(F, {
                path: '/dashboard/',
                element: r.jsxs('div', {
                  style: { minHeight: '100vh', padding: '2rem' },
                    ...
                    r.jsxs('div', {
                      ...
                      children: [
                        r.jsxs('a', {
                          ...
                          children: [
                            r.jsx('h3', { children: '🏆 Admin Dashboard' }),
                            r.jsx('p', { children: 'Administrative control and analytics' }),
                          ],
                        }),
                        r.jsxs('a', {
                          href: '/dashboard/client',
                          ...
                          children: [
                            r.jsx('h3', { children: '👥 Client Dashboard' }),
                            r.jsx('p', { children: 'Client portal and project management' }),
                          ],
                        }),
                        r.jsxs('a', {
                          href: '/dashboard/demo',
                          ...
                          children: [
                            r.jsx('h3', { children: '🎪 Demo Dashboard' }),
                            r.jsx('p', { children: 'Interactive demos and showcases' }),
                          ],
                        }),
                      ],
                    }),
              ...
              r.jsx(F, { path: '/dashboard/client', element: r.jsx(Ye, {}) }),
              r.jsx(F, { path: '/dashboard/demo', element: r.jsx(Ke, {}) }),
              r.jsx(F, { path: '/daniela', element: r.jsx(et, {}) }),
              r.jsx(F, { path: '/daniela/demo', element: r.jsx(et, {}) }),
              r.jsx(F, { path: '/virtual-office', element: r.jsx(tt, {}) }),
              r.jsx(F, { path: '/virtual-office/go', element: r.jsx(Je, {}) }),
            ],
          }),
          r.jsx(rt, {}),
          r.jsx(pe, {}),
...
function it(e) {
  ...
  if ('string' == typeof e || 'number' == typeof e) a += e;
    ...
    if (Array.isArray(e)) {
      var r = e.length;
      for (t = 0; t < r; t++) e[t] && (s = it(e[t])) && (a && (a += ' '), (a += s));
    } else for (s in e) e[s] && (a && (a += ' '), (a += s));
  return a;
}
const lt = e => {
    const t = xt(e),
      { conflictingClassGroups: s, conflictingClassGroupModifiers: a } = e;
    return {
      getClassGroupId: e => {
        const s = e.split('-');
        return ('' === s[0] && 1 !== s.length && s.shift(), ct(s, t) || ut(e));
      },
  ...
  xt = e => {
    const { theme: t, prefix: s } = e,
      a = { nextPart: new Map(), validators: [] };
    return (
      bt(Object.entries(e.classGroups), s).forEach(([e, s]) => {
        mt(s, a, e, t);
      }),
      a
    );
  ...
  mt = (e, t, s, a) => {
    e.forEach(e => {
      if ('string' == typeof e) {
        return void (('' === e ? t : pt(t, e)).classGroupId = s);
      }
      if ('function' == typeof e)
        return ht(e)
          ? void mt(e(a), t, s, a)
          : void t.validators.push({ validator: e, classGroupId: s });
  ...
  pt = (e, t) => {
    ...
    return (
      t.split('-').forEach(e => {
        (s.nextPart.has(e) || s.nextPart.set(e, { nextPart: new Map(), validators: [] }),
          (s = s.nextPart.get(e)));
      }),
      s
    );
      ...
      ? e.map(([e, s]) => [
          ...
          s.map(e =>
            'string' == typeof e
              ? t + e
              : 'object' == typeof e
                ? Object.fromEntries(Object.entries(e).map(([e, s]) => [t + e, s]))
                : e
          ),
        ])
      : e,
  gt = e => {
    ...
    let t = 0,
      ...
      a = new Map();
    const r = (r, o) => {
      (s.set(r, o), t++, t > e && ((t = 0), (a = s), (s = new Map())));
    };
    return {
      get(e) {
        let t = s.get(e);
        return void 0 !== t ? t : void 0 !== (t = a.get(e)) ? (r(e, t), t) : void 0;
      },
      set(e, t) {
        s.has(e) ? s.set(e, t) : r(e, t);
      },
    };
  },
  ft = e => {
    const { separator: t, experimentalParseClassName: s } = e,
      a = 1 === t.length,
      r = t[0],
      o = t.length,
      n = e => {
        ...
        const c = 0 === s.length ? e : e.substring(l),
          d = c.startsWith('!');
        return {
          modifiers: s,
    ...
    return s ? e => s({ className: e, parseClassName: n }) : n;
  },
  vt = e => {
    ...
    return (
      e.forEach(e => {
        '[' === e[0] ? (t.push(...s.sort(), e), (s = [])) : s.push(e);
      }),
      t.push(...s.sort()),
      t
    );
...
function wt() {
  let e,
    ...
    s = 0,
    a = '';
  for (; s < arguments.length; ) (e = arguments[s++]) && (t = jt(e)) && (a && (a += ' '), (a += t));
  return a;
}
const jt = e => {
  ...
  let t,
    s = '';
  for (let a = 0; a < e.length; a++) e[a] && (t = jt(e[a])) && (s && (s += ' '), (s += t));
  return s;
};
function Nt(e, ...t) {
  let s,
    ...
    o = function (i) {
      ...
      return (
        (s = (e => ({ cache: gt(e.cacheSize), parseClassName: ft(e), ...lt(e) }))(l)),
        (a = s.cache.get),
        (r = s.cache.set),
        (o = n),
        n(i)
  ...
  function n(e) {
    ...
    if (t) return t;
    const o = ((e, t) => {
      const { parseClassName: s, getClassGroupId: a, getConflictingClassGroupIds: r } = t,
        o = [],
        n = e.trim().split(yt);
      let i = '';
...
const kt = e => {
  ...
  Et = /^\[(?:([a-z-]+):)?(.+)\]$/i,
  Ct = /^\d+\/\d+$/,
  St = new Set(['px', 'full', 'screen']),
  At = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/,
  It =
    /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/,
  _t = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/,
  zt = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,
  Lt =
    /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,
  Pt = e => Mt(e) || St.has(e) || Ct.test(e),
  Dt = e => Jt(e, 'length', Xt),
  Mt = e => Boolean(e) && !Number.isNaN(Number(e)),
  Tt = e => Jt(e, 'number', Mt),
  Ot = e => Boolean(e) && Number.isInteger(Number(e)),
  Rt = e => e.endsWith('%') && Mt(e.slice(0, -1)),
  Vt = e => Et.test(e),
  Gt = e => At.test(e),
  qt = new Set(['length', 'size', 'percentage']),
  Ht = e => Jt(e, qt, Yt),
  $t = e => Jt(e, 'position', Yt),
  Wt = new Set(['image', 'url']),
  Bt = e => Jt(e, Wt, Qt),
  Ut = e => Jt(e, '', Kt),
  Ft = () => !0,
  Jt = (e, t, s) => {
    const a = Et.exec(e);
    return !!a && (a[1] ? ('string' == typeof t ? a[1] === t : t.has(a[1])) : s(a[2]));
  },
  Xt = e => It.test(e) && !_t.test(e),
  Yt = () => !1,
  Kt = e => zt.test(e),
  Qt = e => Lt.test(e),
  Zt = Nt(() => {
    const e = kt('colors'),
      ...
      u = kt('invert'),
      x = kt('gap'),
      m = kt('gradientColorStops'),
      p = kt('gradientColorStopPositions'),
      h = kt('inset'),
      b = kt('margin'),
      g = kt('opacity'),
      f = kt('padding'),
    ...
    return {
      ...
      theme: {
        ...
        gradientColorStopPositions: [Rt, Dt],
        inset: E(),
        margin: E(),
        opacity: _(),
        padding: C(),
      ...
      classGroups: {
        aspect: [{ aspect: ['auto', 'square', 'video', Vt] }],
        container: ['container'],
        columns: [{ columns: [Gt] }],
        'break-after': [
          {
        ...
        flex: [{ flex: ['1', 'auto', 'initial', 'none', Vt] }],
        grow: [{ grow: I() }],
        shrink: [{ shrink: I() }],
        order: [{ order: ['first', 'last', 'none', Ot, Vt] }],
        'grid-cols': [{ 'grid-cols': [Ft] }],
        'col-start-end': [{ col: ['auto', { span: ['full', Ot, Vt] }, Vt] }],
        'col-start': [{ 'col-start': A() }],
        'col-end': [{ 'col-end': A() }],
        'grid-rows': [{ 'grid-rows': [Ft] }],
        'row-start-end': [{ row: ['auto', { span: [Ot, Vt] }, Vt] }],
        'row-start': [{ 'row-start': A() }],
        'row-end': [{ 'row-end': A() }],
        'grid-flow': [{ 'grid-flow': ['row', 'col', 'dense', 'row-dense', 'col-dense'] }],
        'auto-cols': [{ 'auto-cols': ['auto', 'min', 'max', 'fr', Vt] }],
        'auto-rows': [{ 'auto-rows': ['auto', 'min', 'max', 'fr', Vt] }],
        gap: [{ gap: [x] }],
        'gap-x': [{ 'gap-x': [x] }],
        'gap-y': [{ 'gap-y': [x] }],
        'justify-content': [
        ...
        w: [{ w: ['auto', 'min', 'max', 'fit', 'svw', 'lvw', 'dvw', Vt, t] }],
        'min-w': [{ 'min-w': [Vt, t, 'min', 'max', 'fit'] }],
        'max-w': [
          { 'max-w': [Vt, t, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [Gt] }, Gt] },
        ],
        h: [{ h: [Vt, t, 'auto', 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
        'min-h': [{ 'min-h': [Vt, t, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
        'max-h': [{ 'max-h': [Vt, t, 'min', 'max', 'fit', 'svh', 'lvh', 'dvh'] }],
        size: [{ size: [Vt, t, 'auto', 'min', 'max', 'fit'] }],
        'font-size': [{ text: ['base', Gt, Dt] }],
        ...
        tracking: [{ tracking: ['tighter', 'tight', 'normal', 'wide', 'wider', 'widest', Vt] }],
        'line-clamp': [{ 'line-clamp': ['none', Mt, Tt] }],
        leading: [{ leading: ['none', 'tight', 'snug', 'normal', 'relaxed', 'loose', Pt, Vt] }],
        'list-image': [{ 'list-image': ['none', Vt] }],
        'list-style-type': [{ list: ['none', 'disc', 'decimal', Vt] }],
        ...
        'text-decoration-thickness': [{ decoration: ['auto', 'from-font', Pt, Dt] }],
        'underline-offset': [{ 'underline-offset': ['auto', Pt, Vt] }],
        ...
        'bg-image': [
          { bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, Bt] },
        ],
        'bg-color': [{ bg: [e] }],
        ...
        'outline-offset': [{ 'outline-offset': [Pt, Vt] }],
        'outline-w': [{ outline: [Pt, Dt] }],
        'outline-color': [{ outline: [e] }],
        'ring-w': [{ ring: S() }],
        'ring-w-inset': ['ring-inset'],
        'ring-color': [{ ring: [e] }],
        'ring-opacity': [{ 'ring-opacity': [g] }],
        'ring-offset-w': [{ 'ring-offset': [Pt, Dt] }],
        'ring-offset-color': [{ 'ring-offset': [e] }],
        shadow: [{ shadow: ['', 'inner', 'none', Gt, Ut] }],
        ...
        contrast: [{ contrast: [l] }],
        'drop-shadow': [{ 'drop-shadow': ['', 'none', Gt, Vt] }],
        ...
        duration: [{ duration: _() }],
        ease: [{ ease: ['linear', 'in', 'out', 'in-out', Vt] }],
        delay: [{ delay: _() }],
        animate: [{ animate: ['none', 'spin', 'ping', 'pulse', 'bounce', Vt] }],
        ...
        'will-change': [{ 'will-change': ['auto', 'scroll', 'contents', 'transform', Vt] }],
        fill: [{ fill: [e, 'none'] }],
        'stroke-w': [{ stroke: [Pt, Dt, Tt] }],
...
function es(...e) {
  return Zt(
    (function () {
      for (var e, t, s = 0, a = '', r = arguments.length; s < r; s++)
        (e = arguments[s]) && (t = it(e)) && (a && (a += ' '), (a += t));
      return a;
    })(e)
  );
}
const ts = V.forwardRef(
  (
    ...
    const u = es(
      ...
      x = () => (a ? r.jsx(R, { className: 'w-4 h-4 animate-spin' }) : o);
    return r.jsx('button', {
      ref: d,
      className: u,
      disabled: l || a,
      ...
      children:
        o && 'right' === n
          ? r.jsxs(r.Fragment, {
              children: [i, x() && r.jsx('span', { className: 'ml-2', children: x() })],
            })
          : r.jsxs(r.Fragment, {
              children: [x() && r.jsx('span', { className: 'mr-2', children: x() }), i],
            }),
    });
  }
);
ts.displayName = 'Button';
class ss extends V.Component {
  constructor(e) {
    (super(e),
      t(this, 'handleReset', () => {
...
const as = V.createContext(void 0),
  rs = ({ children: e }) => {
    const [t, s] = V.useState(!0),
      [a, o] = V.useState(!1),
      { playSuccess: n } = me();
    (V.useEffect(() => {
      t
    ...
    const i = () => o(e => !e),
      l = G.useMemo(
        () => ({ godMode: t, setGodMode: s, reduceMotion: a, toggleReduceMotion: i }),
        [t, a]
      );
    return r.jsx(as.Provider, { value: l, children: e });
  },
  os = ['admin@aigestion.net', 'nemisanalex@gmail.com'];
function ns({ children: e }) {
  ...
  return r.jsx(a, { client: t, children: e });
}
function is() {
  return r.jsx(ss, {
    children: r.jsx(ns, {
      children: r.jsx(J, {
        children: r.jsx(se, {
          children: r.jsx(rs, { children: r.jsx(Ge, { children: r.jsx(ls, {}) }) }),
        }),
      }),
    }),
  });
...
function ls() {
  const {
    ...
    const [e, t] = V.useState({
      ...
      r = V.useCallback(
        e => {
          const t = os.includes(e.email) || 'admin' === e.role,
            a = s();
          ...
          try {
            if (e?.user) {
              ...
              t({
                ...
                loading: !1,
                isAuthenticated: !0,
                isAdmin: os.includes(o.email) || 'admin' === o.role,
                isMobileApp: s(),
              });
            } else
              t({
      ...
      d = V.useCallback(async e => {}, []),
      u = V.useCallback(
        async (e, t) => {
          if ('123456' !== t) throw new Error('Código inválido. En modo demo usa: 123456');
          await c({ phone: e, phoneVerified: !0 });
        },
        [c]
      ),
      x = V.useCallback(() => e.user?.phoneVerified || !1, [e.user]);
    return (
      V.useEffect(() => {
        t(e => ({ ...e, loading: !1 }));
      }, [o]),
      {
        ...
        updateUser: c,
        verifyPhone: u,
        sendPhoneVerificationCode: d,
        checkPhoneVerification: x,
      }
    );
  })();
  return e
...
const cs = V.createContext(void 0),
  ds = ({ children: e }) => {
    const [t, s] = V.useState(!1),
      [a, o] = V.useState(null),
      n = { isLoading: t, setIsLoading: s, error: a, setError: o };
    return r.jsx(cs.Provider, { value: n, children: e });
  },
  us = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
  xs = document.getElementById('root');
if (xs)
  try {
    H.createRoot(xs).render(
      r.jsx(G.StrictMode, { children: r.jsx(ds, { children: r.jsx(is, {}) }) })
    );
  } catch (ms) {
    us &&
      (xs.innerHTML =
...
export { ts as B, be as G, Ce as M, Q as a, ve as b, es as c, qe as d, me as e, Z as u };
