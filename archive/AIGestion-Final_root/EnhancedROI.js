import { j as e, m as t, A as a } from './ui.js';
...
import './router.js';
const n = () => {
  const [n, r] = i.useState('medium'),
    [l, o] = i.useState('technology'),
    [c, d] = i.useState(0),
    [x, m] = i.useState(!1),
    { playHover: u, playClick: p } = s(),
    h = [
            ...
            children: [
              ...
              [...Array(8)].map((a, i) =>
                e.jsx(
                  t.path,
                  {
                    d: `M${15 * i} 100 Q${15 * i + 7.5} ${70 - 15 * i} ${15 * i + 15} 0`,
                    ...
                    transition: { duration: 3, delay: 0.4 * i, repeat: 1 / 0, repeatDelay: 2 },
                  },
                  i
                )
              ),
          ...
          e.jsxs(t.div, {
            ...
            children: [
              ...
              e.jsxs('p', {
                ...
                children: [
                  '"La inversión no es un gasto cuando el retorno es exponencial. ',
                  e.jsx('br', {}),
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsx('h3', {
                        ...
                        children: 'DIMENSIÓN EMPRESARIAL',
                      }),
                      e.jsx('div', {
                        ...
                        children: b.map(a =>
                          e.jsxs(
                            t.button,
                            {
                              ...
                              onMouseEnter: u,
                              children: [
                                e.jsx('span', { className: 'text-2xl mb-2', children: a.icon }),
                                e.jsx('span', {
                                  className:
                  ...
                  children: [
                    e.jsxs('div', {
                      className:
                        ...
                        (a.value > 0 ? 'text-nexus-cyan' : 'text-nexus-violet-glow'),
