import { j as e, m as s, h as a, Z as t, c as i, a as n, a1 as l, a3 as r } from './ui.js';
import { r as o } from './vendor.js';
import { DanielaWebsite as c } from './DanielaWebsite.js';
const d = () => {
  const [d, x] = o.useState('conversation'),
    [m, h] = o.useState('assistant'),
    [p, b] = o.useState('homepage'),
    g = [
      {
        icon: e.jsx(a, { className: 'w-6 h-6' }),
        title: 'Inteligencia Emocional',
        description: 'Análisis en tiempo real del estado emocional del cliente',
        color: 'from-nexus-cyan to-blue-500',
      },
      {
        icon: e.jsx(i, { className: 'w-6 h-6' }),
              ...
              children: [
                e.jsx('div', {
                  ...
                  children: e.jsx('div', {
                    ...
                    children: e.jsx(a, { className: 'w-10 h-10 text-white' }),
                  }),
                }),
                e.jsx('h1', {
                  className:
                      ...
                      children: [
                        e.jsxs('div', {
                          ...
                          children: [
                            ...
                            ['widget', 'assistant', 'advisor'].map(a =>
                              e.jsx(
                                s.button,
                                {
                                  whileHover: { scale: 1.05 },
                        ...
                        e.jsxs('div', {
                          ...
                          children: [
                            ...
                            ['homepage', 'contact', 'pricing', 'about'].map(a =>
                              e.jsx(
                                s.button,
                                {
                                  whileHover: { scale: 1.05 },
                        ...
                        children: [
                          'widget' === m &&
                            e.jsx('div', {
                              ...
                              children: e.jsx(c, { variant: 'widget', context: p }),
                            }),
                          'assistant' === m &&
                            e.jsx('div', {
                              className: 'h-96',
                              children: e.jsx(c, { variant: 'assistant', context: p }),
                            }),
                          'advisor' === m &&
                            e.jsx('div', {
                              className: 'h-96',
                              children: e.jsx(c, { variant: 'advisor', context: p }),
                            }),
                        ],
                      }),
                    }),
                      ...
                      s.div,
                      {
                        ...
                        children: [
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('div', {
                                className: `w-16 h-16 rounded-full bg-gradient-to-br ${a.color} flex items-center justify-center mb-6`,
                                children: a.icon,
                              }),
                              e.jsx('h3', {
                      ...
                      children: e.jsxs('div', {
                        ...
                        children: [
                          e.jsx('div', {
                            ...
                            children: e.jsx(t, { className: 'w-16 h-16 text-nexus-gold' }),
                          }),
                          e.jsx('p', {
