import { j as e, A as a, m as s } from './ui.js';
...
const n = new (class {
  ...
  t = ({ className: t = '', variant: c = 'assistant', context: r = 'homepage' }) => {
    ...
    (i.useEffect(() => {
      ...
      i.useEffect(() => {
        const e = async () => {
          try {
            const e = await n.checkConnectivity();
            if ((g(e), e)) {
              const e = await n.getSystemStatus();
              N(e);
            }
          } catch (e) {}
        };
        e();
        const a = setInterval(e, 3e4);
    ...
    const b = async () => {
        if (!d.trim()) return;
        const e = { id: `user-${Date.now()}`, text: d, sender: 'user', timestamp: new Date() };
        (o(a => [...a, e]), m(''), p(!0));
        try {
          const e = await n.chat(d, 'website-user', `session-${Date.now()}`),
            a = {
              id: `daniela-${Date.now()}`,
              text: e.response,
              sender: 'daniela',
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsx('div', { className: 'daniela-title', children: I() }),
                    e.jsx('div', { className: 'daniela-subtitle', children: A() }),
                  ],
                }),
                e.jsx('button', {
                  ...
                  children: [
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        e.jsx('input', {
                          ...
                          onKeyPress: e => 'Enter' === e.key && b(),
                          placeholder: 'Escribe tu pregunta...',
                        }),
                        e.jsx('button', {
                          onClick: b,
                          disabled: !d.trim() || u,
                          children: u ? e.jsx('div', { className: 'loading-spinner' }) : '→',
                        }),
                      ],
                    }),
                    l[l.length - 1]?.suggestions &&
                      e.jsx('div', {
                        ...
                        children: l[l.length - 1].suggestions.map((a, s) =>
                          e.jsx(
                            'button',
                            { className: 'suggestion-btn', onClick: () => f(a), children: a },
                            s
                          )
                        ),
                      }),
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('span', {
                            ...
                            children: h ? 'En línea' : 'Modo demostración',
                          }),
                        ],
                      }),
                    ],
                      ...
                      l.map(a =>
                        e.jsxs(
                          s.div,
                          {
                            ...
                            className: `message ${a.sender}`,
                            children: [
                              e.jsx('div', { className: 'message-content', children: a.text }),
                              e.jsx('div', {
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsxs('div', {
                          className: 'metric',
                          children: [
                            e.jsx('span', { className: 'metric-label', children: 'Versión:' }),
                            e.jsx('span', { className: 'metric-value', children: v.version }),
                          ],
                        }),
                        e.jsxs('div', {
                          className: 'metric',
                          children: [
                            ...
                            e.jsx('span', {
                              ...
                              children: v.statistics?.totalUsers || 0,
                            }),
                          ],
                        }),
                      ],
                    ...
                    children: [
                      l.map(a =>
                        e.jsxs(
                          'div',
                          {
                            className: `conversation-message ${a.sender}`,
                            children: [
                              e.jsx('div', {
                                className: 'message-avatar',
                                children: 'user' === a.sender ? '👤' : '🧠',
                              }),
                              e.jsxs('div', {
                                className: 'message-content',
                                children: [
                                  e.jsx('div', { className: 'message-text', children: a.text }),
                                  e.jsx('div', {
                                    className: 'message-time',
                                    children: a.timestamp.toLocaleTimeString(),
                                  }),
                      ...
                      e.jsx(a, {
                        children:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('div', { className: 'message-avatar', children: '🧠' }),
                              e.jsx('div', {
                                className: 'message-content',
                                children: e.jsxs('div', {
                                  className: 'typing-indicator',
                          ...
                          children: [
                            ...
                            e.jsx('div', {
                              ...
                              children: l[l.length - 1].suggestions.map((a, s) =>
                                e.jsx(
                                  'button',
                                  { className: 'action-btn', onClick: () => f(a), children: a },
                                  s
                                )
                              ),
                            }),
