...
import { r as p } from './vendor.js';
import { b as j } from './main.js';
import './index.js';
import './three.js';
import './router.js';
const g = () => {
    const [n, l] = p.useState([
        { role: 'ai', text: 'Hola, soy Daniela. ¿En qué puedo ayudarte hoy?' },
      ]),
      [r, o] = p.useState(''),
      { isListening: c, transcript: d, isSpeaking: x, toggleListening: m, speak: h } = j(),
      u = p.useRef(null);
    (p.useEffect(() => {
      d && o(d);
    }, [d]),
            ...
            n.map((t, i) =>
              e.jsx(
                s.div,
                {
                  ...
                  className: 'flex ' + ('user' === t.role ? 'justify-end' : 'justify-start'),
                  children: e.jsx('div', {
                    className:
          ...
          children: e.jsxs('div', {
            ...
            children: [
              e.jsx('button', {
                ...
                children: c ? e.jsx(t, { size: 20 }) : e.jsx(i, { size: 20 }),
              }),
              e.jsx('input', {
                type: 'text',
                value: r,
    ...
    const [a, j] = p.useState('daniela'),
      [f, v] = p.useState(!1),
      {
        ...
        const [e, s] = p.useState('idle'),
          ...
          [d, x] = p.useState(!1),
          [m, h] = p.useState(null),
          u = { emotion: 'neutral', confidence: 0.85, sentiment: 'positive' },
          b = [
            {
              id: '1',
      ...
      E = [
        { id: 'daniela', label: 'Daniela AI', icon: d, color: 'from-nexus-cyan to-nexus-violet' },
        { id: 'analytics', label: 'Analytics', icon: x, color: 'from-green-500 to-emerald-600' },
        { id: 'settings', label: 'Configuración', icon: m, color: 'from-orange-500 to-red-600' },
      ],
      C = {
      ...
      children: [
        e.jsx('div', {
          ...
          children: e.jsx('button', {
            ...
            children: f ? e.jsx(n, { className: 'w-5 h-5' }) : e.jsx(l, { className: 'w-5 h-5' }),
          }),
        }),
        e.jsx(r, {
                        ...
                        e.jsxs('div', {
                          children: [
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                e.jsx(c, { className: 'w-3 h-3 text-nexus-cyan' }),
                                e.jsx('span', {
                                  className: `text-xs font-medium ${C[t.subscription]}`,
                                  children: t.subscription.toUpperCase(),
                                }),
                              ],
                            }),
                          ],
                  ...
                  e.jsx('div', {
                    ...
                    children: e.jsxs('button', {
                      ...
                      children: [
                        ...
                        e.jsx('span', { children: 'Cerrar Sesión' }),
                      ],
                    }),
                  }),
                ],
                  ...
                  e.jsxs('div', {
                    children: [
                      e.jsx('h1', {
                        ...
                        children: E.find(e => e.id === a)?.label,
                      }),
                      e.jsxs('p', {
                        className: 'text-nexus-silver text-sm mt-1',
                        children: [
                          'daniela' === a && 'Tu asistente de IA emocional',
                          'analytics' === a && 'Métricas y análisis de uso',
                          'settings' === a && 'Configuración de tu cuenta',
                        ],
                      }),
                    ],
                  }),
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          e.jsx('div', {
                            ...
                            children: e.jsx(o, { className: 'w-4 h-4 text-white' }),
                          }),
                          e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      e.jsx(u, { className: 'w-5 h-5 text-nexus-cyan' }),
                                    ],
                                  }),
                                  e.jsx('div', {
                                ...
                                children: [
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      e.jsx(b, { className: 'w-5 h-5 text-green-400' }),
                                    ],
                                  }),
                                  e.jsx('div', {
                                    className: 'text-3xl font-bold text-white',
                                    children: y?.emotion?.toUpperCase() || 'NEUTRAL',
                                  }),
                                  e.jsxs('p', {
                                    className: 'text-nexus-silver text-sm',
                                    children: [
                                      'Confianza: ',
                                      y?.confidence ? `${Math.round(100 * y.confidence)}%` : 'N/A',
                                    ],
                                  }),
                                ],
                              }),
                                ...
                                children: [
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      e.jsx(d, { className: 'w-5 h-5 text-nexus-violet' }),
                                    ],
                                  }),
                                  e.jsx('div', {
                                    className: 'text-3xl font-bold text-white',
                                ...
                                children: [
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      e.jsx(c, { className: 'w-5 h-5 text-nexus-gold' }),
                                    ],
                                  }),
                                  e.jsx('div', {
                            ...
                            children: [
                              ...
                              e.jsx('div', {
                                ...
                                children: e.jsxs('div', {
                                  ...
                                  children: [
                                    e.jsx(x, { className: 'w-12 h-12 mx-auto mb-4 opacity-50' }),
                                    e.jsx('p', { children: 'Gráficos de actividad próximamente' }),
                                  ],
                                }),
                              }),
                            ],
                                    ...
                                    children: [
                                      ...
                                      e.jsxs('select', {
                                        className:
                                          'w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-nexus-cyan/50',
                                        children: [
                                          e.jsx('option', { children: 'Español' }),
                                          e.jsx('option', { children: 'English' }),
                                          e.jsx('option', { children: 'Português' }),
                                        ],
                                      }),
                                    ],
                                  }),
